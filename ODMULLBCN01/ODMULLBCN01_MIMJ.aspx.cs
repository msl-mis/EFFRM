...
{
	/// <summary>
	/// ODMULLBCN01_MIMJ 的摘要描述。
	/// </summary>
	public partial class ODMULLBCN01_MIMJ : tw.com.dsc.easyflowDotNet.kernelBasePage.EFMIMJBasepage
	{
		...
		protected override void MIFunction()
		{
			switch(tBtnID)
			{
				case "MasterPage_MasterPageContent_open_idname_btn":			//開窗連結外部資料庫
				{
					base.doMIByDB("OpenMIMJ01","26", @"192.168.10.22", "price");
					break;
				}
		...
		protected override void MJFunction()
		{
			...
			{
				case "OpenMIMJ01_26_open_idname":	
				{
					base.doMJByDB("OpenMIMJ01","26", @"192.168.10.22", "price","MasterPage_MasterPageContent_open_idname_txt2=no");
					break;
				}
