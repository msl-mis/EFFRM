...
{
	/// <summary>
	/// ODMMRBCN01_TEST 的摘要描述。
	/// </summary>
	public partial class ODMMRBCN01_TEST : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
	{
		//edit by teppy 2011/02/08 Start
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			AjaxPro.Utility.RegisterTypeForAjax(typeof(ODMMRBCN01_TEST));
			UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
			string tLanguageType = tClass.Language;

			//多國語系
			this.Title= MultiLanguage.GetComment("FD","ODMMRBCN01_TEST","lblTitle",this.UserInfo.Language);
			string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ODMMRBCN01_TEST", "HeadTabStrip01", tLanguageType);
			...
			this.dept.Title = MultiLanguage.GetComment("FD", "ODMMRBCN01_TEST", "dept", tLanguageType);
			this.name.Title = MultiLanguage.GetComment("FD", "ODMMRBCN01_TEST", "name", tLanguageType);
			this.txtno.Title = MultiLanguage.GetComment("FD", "ODMMRBCN01_TEST", "txtno", tLanguageType);
			this.txtordno.Title = MultiLanguage.GetComment("FD", "ODMMRBCN01_TEST", "txtordno", tLanguageType);
			this.txtpdname.Title = MultiLanguage.GetComment("FD", "ODMMRBCN01_TEST", "txtpdname", tLanguageType);
			this.txtpdno.Title = MultiLanguage.GetComment("FD", "ODMMRBCN01_TEST", "txtpdno", tLanguageType);
			this.txtpdqty.Title = MultiLanguage.GetComment("FD", "ODMMRBCN01_TEST", "txtpdqty", tLanguageType);
			this.txtreason.Title = MultiLanguage.GetComment("FD", "ODMMRBCN01_TEST", "txtreason", tLanguageType);
			this.condate.Title = MultiLanguage.GetComment("FD", "ODMMRBCN01_TEST", "condate", tLanguageType);
			this.superid.Title = MultiLanguage.GetComment("FD", "ODMMRBCN01_TEST", "superid", tLanguageType);
			this.director01.Title = MultiLanguage.GetComment("FD", "ODMMRBCN01_TEST", "director01", tLanguageType);
			this.director02.Title = MultiLanguage.GetComment("FD", "ODMMRBCN01_TEST", "director02", tLanguageType);
			this.checkbox1.Text = MultiLanguage.GetComment("FD", "ODMMRBCN01_TEST", "checkbox1", tLanguageType);
			this.checkbox2.Text = MultiLanguage.GetComment("FD", "ODMMRBCN01_TEST", "checkbox2", tLanguageType);
			this.checkbox3.Text = MultiLanguage.GetComment("FD", "ODMMRBCN01_TEST", "checkbox3", tLanguageType);
			this.checkbox4.Text = MultiLanguage.GetComment("FD", "ODMMRBCN01_TEST", "checkbox4", tLanguageType);
			this.checkbox5.Text = MultiLanguage.GetComment("FD", "ODMMRBCN01_TEST", "checkbox5", tLanguageType);
			this.director03.Title = MultiLanguage.GetComment("FD", "ODMMRBCN01_TEST", "director03", tLanguageType);
		...
		protected override void Page_Prender(object sender, EventArgs e)
		{
			...
			super1.Attributes["style"] = "display:none;";
			super1_ctrolRadio0.Checked = (super1.Value == "0"); super1_ctrolRadio0.Enabled = super1.InputEnabled;
			super1_ctrolRadio1.Checked = (super1.Value == "1"); super1_ctrolRadio1.Enabled = super1.InputEnabled;
			super1_ctrolRadio2.Checked = (super1.Value == "2"); super1_ctrolRadio2.Enabled = super1.InputEnabled;
			super1_ctrolRadio3.Checked = (super1.Value == "3"); super1_ctrolRadio3.Enabled = super1.InputEnabled;
			super1_ctrolRadio4.Checked = (super1.Value == "4"); super1_ctrolRadio4.Enabled = super1.InputEnabled;
			super2.Attributes["style"] = "display:none;";
			super2_ctrolRadio0.Checked = (super2.Value == "0"); super2_ctrolRadio0.Enabled = super2.InputEnabled;
			super2_ctrolRadio1.Checked = (super2.Value == "1"); super2_ctrolRadio1.Enabled = super2.InputEnabled;
			super2_ctrolRadio2.Checked = (super2.Value == "2"); super2_ctrolRadio2.Enabled = super2.InputEnabled;
			super2_ctrolRadio3.Checked = (super2.Value == "3"); super2_ctrolRadio3.Enabled = super2.InputEnabled;
			super2_ctrolRadio4.Checked = (super2.Value == "4"); super2_ctrolRadio4.Enabled = super2.InputEnabled;
...
this.super1_ctrolRadio0.Attributes.Add("onclick", "document.getElementById('MasterPage_MasterPageContent_super1_txt').value = '0';");
this.super1_ctrolRadio1.Attributes.Add("onclick", "document.getElementById('MasterPage_MasterPageContent_super1_txt').value = '1';");
this.super1_ctrolRadio2.Attributes.Add("onclick", "document.getElementById('MasterPage_MasterPageContent_super1_txt').value = '2';");
this.super1_ctrolRadio3.Attributes.Add("onclick", "document.getElementById('MasterPage_MasterPageContent_super1_txt').value = '3';");
this.super1_ctrolRadio4.Attributes.Add("onclick", "document.getElementById('MasterPage_MasterPageContent_super1_txt').value = '4';");
this.super2_ctrolRadio0.Attributes.Add("onclick", "document.getElementById('MasterPage_MasterPageContent_super2_txt').value = '0';");
this.super2_ctrolRadio1.Attributes.Add("onclick", "document.getElementById('MasterPage_MasterPageContent_super2_txt').value = '1';");
this.super2_ctrolRadio2.Attributes.Add("onclick", "document.getElementById('MasterPage_MasterPageContent_super2_txt').value = '2';");
this.super2_ctrolRadio3.Attributes.Add("onclick", "document.getElementById('MasterPage_MasterPageContent_super2_txt').value = '3';");
this.super2_ctrolRadio4.Attributes.Add("onclick", "document.getElementById('MasterPage_MasterPageContent_super2_txt').value = '4';");
		...
		{
			defalutHash.Add("odmmrbcntest01001", this.formID);
			defalutHash.Add("odmmrbcntest01002", this.SheetNo);
...
order by resdd003 desc";
		...
		protected override void ReGetCondValue(object[,] pAryCondValue)
		{
			...
			tDbl=0;
			try{
				tDbl = double.Parse(this.rditem.Value.Trim());
			}
			catch(Exception e){
				tDbl=0;
			}
			pAryCondValue[0, 1] = "rditem";
		...
		{
			pReport = "ODMMRBCN01_TEST";
			pReportID = "ODMMRBCN01_TEST_02";//憑證式
			pWhere = "AND (odmmrbcntest01001='" + this.formID + "') AND (odmmrbcntest01002='" + this.SheetNo + "')";
			pReportDirectory = "ODMMRBCN01_TEST";
