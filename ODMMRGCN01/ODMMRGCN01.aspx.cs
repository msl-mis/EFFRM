...
namespace tw.com.dsc.easyflowDotNet.forms
{
	...
	/// ODMMRGCN01 的摘要描述。
	/// </summary>
	public partial class ODMMRGCN01 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
	{
		//edit by teppy 2011/02/08 Start
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			AjaxPro.Utility.RegisterTypeForAjax(typeof(ODMMRGCN01));
			UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
			string tLanguageType = tClass.Language;

			//多國語系
			this.Title= MultiLanguage.GetComment("FD","ODMMRGCN01","lblTitle",this.UserInfo.Language);
			string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ODMMRGCN01", "HeadTabStrip01", tLanguageType);
			...
			this.txtno.Title = MultiLanguage.GetComment("FD", "ODMMRGCN01", "txtno", tLanguageType);
			this.date.Title = MultiLanguage.GetComment("FD", "ODMMRGCN01", "date", tLanguageType);
			this.txtuser.Title = MultiLanguage.GetComment("FD", "ODMMRGCN01", "txtuser", tLanguageType);
			this.txtmain.Title = MultiLanguage.GetComment("FD", "ODMMRGCN01", "txtmain", tLanguageType);
			this.areadescp.Title = MultiLanguage.GetComment("FD", "ODMMRGCN01", "areadescp", tLanguageType);
			this.txtdept.Title = MultiLanguage.GetComment("FD", "ODMMRGCN01", "txtdept", tLanguageType);
		...
		{
			// 作業代號
			this.TaskId = "ODMMRGCN01";
			// 表單代號
			this.formID = "ODMMRGCN01";
...
where resfc001=@resfc001 and resfc002=@resfc002 and resfc003=@resfc003 and ISNULL(resfc004,'')<>''";
		...
		{
			defalutHash.Add("odmmrgcn01001", this.formID);
			defalutHash.Add("odmmrgcn01002", this.SheetNo);
...
order by resdd003 desc";
		...
		{
			pReport = "ODMMRGCN01";
			pReportID = "ODMMRGCN01_02";//憑證式
			pWhere = "AND (odmmrgcn01001='" + this.formID + "') AND (odmmrgcn01002='" + this.SheetNo + "')";
			pReportDirectory = "ODMMRGCN01";
