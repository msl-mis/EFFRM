...
namespace tw.com.dsc.easyflowDotNet.forms
{
	...
	/// ODMREPCN01 的摘要描述。
	/// </summary>
	public partial class ODMREPCN01 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
	{
		//edit by teppy 2011/02/08 Start
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			AjaxPro.Utility.RegisterTypeForAjax(typeof(ODMREPCN01));
			UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
			string tLanguageType = tClass.Language;

			//多國語系
			this.Title= MultiLanguage.GetComment("FD","ODMREPCN01","lblTitle",this.UserInfo.Language);
			string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ODMREPCN01", "HeadTabStrip01", tLanguageType);
			...
			this.note.Text = MultiLanguage.GetComment("FD", "ODMREPCN01", "note", tLanguageType);
			this.username.Title = MultiLanguage.GetComment("FD", "ODMREPCN01", "username", tLanguageType);
			this.userid.Title = MultiLanguage.GetComment("FD", "ODMREPCN01", "userid", tLanguageType);
			this.superid.Title = MultiLanguage.GetComment("FD", "ODMREPCN01", "superid", tLanguageType);
			this.issuedate.Title = MultiLanguage.GetComment("FD", "ODMREPCN01", "issuedate", tLanguageType);
			this.serno.Title = MultiLanguage.GetComment("FD", "ODMREPCN01", "serno", tLanguageType);
			this.suppiler.Title = MultiLanguage.GetComment("FD", "ODMREPCN01", "suppiler", tLanguageType);
			this.suppartno.Title = MultiLanguage.GetComment("FD", "ODMREPCN01", "suppartno", tLanguageType);
			this.mslpartno.Title = MultiLanguage.GetComment("FD", "ODMREPCN01", "mslpartno", tLanguageType);
			this.sampleqty.Title = MultiLanguage.GetComment("FD", "ODMREPCN01", "sampleqty", tLanguageType);
			this.receiveddate.Title = MultiLanguage.GetComment("FD", "ODMREPCN01", "receiveddate", tLanguageType);
			this.whys.Title = MultiLanguage.GetComment("FD", "ODMREPCN01", "whys", tLanguageType);
			this.description.Title = MultiLanguage.GetComment("FD", "ODMREPCN01", "description", tLanguageType);
			this.opensetion.Title = MultiLanguage.GetComment("FD", "ODMREPCN01", "opensetion", tLanguageType);
			this.opensetion01.Title = MultiLanguage.GetComment("FD", "ODMREPCN01", "opensetion01", tLanguageType);
		...
		{
			// 作業代號
			this.TaskId = "ODMREPCN01";
			// 表單代號
			this.formID = "ODMREPCN01";
...
where resfc001=@resfc001 and resfc002=@resfc002 and resfc003=@resfc003 and ISNULL(resfc004,'')<>''";
		...
		protected override void settingClientFunction()
		{
			...
			opensetion.TxtInput.Attributes.Add("onblur",MIMJUtil.getBlurParams("MasterPage_MasterPageContent_opensetion_txt","OpenMIMJ01_17_opensetion","MasterPage_MasterPageContent_opensetion_txt"));
			opensetion.TxtInput.Attributes.Add("onchange","AddtoHash('MasterPage_MasterPageContent_opensetion_txt');");

			opensetion01.HtmImg.Attributes.Add("onclick",MIMJUtil.getClickParams("MasterPage_MasterPageContent_opensetion01_btn","MasterPage_MasterPageContent_opensetion01_txt","S"));
			opensetion01.TxtInput.Attributes.Add("onblur",MIMJUtil.getBlurParams("MasterPage_MasterPageContent_opensetion01_txt","OpenMIMJ01_17_opensetion01","MasterPage_MasterPageContent_opensetion01_txt"));
			opensetion01.TxtInput.Attributes.Add("onchange","AddtoHash('MasterPage_MasterPageContent_opensetion01_txt');");
		...
		protected override void buildMiMjManager(Hashtable pMiMjManager)
		{
			...
			if ( FormStatus == EFFormStatus.CREATE ) {
				...
				pMiMjManager.Add("opensetion01_0", opensetion01);
		...
		{
			defalutHash.Add("odmrepcn01001", this.formID);
			defalutHash.Add("odmrepcn01002", this.SheetNo);
...
order by resdd003 desc";
		...
		{
			pReport = "ODMREPCN01";
			pReportID = "ODMREPCN01_02";//憑證式
			pWhere = "AND (odmrepcn01001='" + this.formID + "') AND (odmrepcn01002='" + this.SheetNo + "')";
			pReportDirectory = "ODMREPCN01";
