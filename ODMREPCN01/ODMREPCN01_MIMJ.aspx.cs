...
{
	/// <summary>
	/// ODMREPCN01_MIMJ 的摘要描述。
	/// </summary>
	public partial class ODMREPCN01_MIMJ : tw.com.dsc.easyflowDotNet.kernelBasePage.EFMIMJBasepage
	{
		...
		protected override void MIFunction()
		{
			switch(tBtnID)
			{
				...
				case "MasterPage_MasterPageContent_opensetion01_btn":			//其它類型開窗
				{
					base.doMI("OpenMIMJ01","17");
					break;
				}
		...
		protected override void MJFunction()
		{
			...
			{
				case "OpenMIMJ01_17_opensetion":	
				{
					base.doMJ("OpenMIMJ01","17","MasterPage_MasterPageContent_opensetion_txt2=resal002");
					break;
				}
				case "OpenMIMJ01_17_opensetion01":	
				{
					base.doMJ("OpenMIMJ01","17","MasterPage_MasterPageContent_opensetion01_txt2=resal002");
					break;
				}
