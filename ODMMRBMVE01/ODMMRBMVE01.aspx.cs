...
namespace tw.com.dsc.easyflowDotNet.forms
{
	...
	/// ODMMRBMVE01 的摘要描述。
	/// </summary>
	public partial class ODMMRBMVE01 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
	{
		//edit by teppy 2011/02/08 Start
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			AjaxPro.Utility.RegisterTypeForAjax(typeof(ODMMRBMVE01));
			UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
			string tLanguageType = tClass.Language;

			//多國語系
			this.Title= MultiLanguage.GetComment("FD","ODMMRBMVE01","lblTitle",this.UserInfo.Language);
			string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ODMMRBMVE01", "HeadTabStrip01", tLanguageType);
			...
			this.dept.Title = MultiLanguage.GetComment("FD", "ODMMRBMVE01", "dept", tLanguageType);
			this.name.Title = MultiLanguage.GetComment("FD", "ODMMRBMVE01", "name", tLanguageType);
			this.txtno.Title = MultiLanguage.GetComment("FD", "ODMMRBMVE01", "txtno", tLanguageType);
			this.txtordno.Title = MultiLanguage.GetComment("FD", "ODMMRBMVE01", "txtordno", tLanguageType);
			this.txtpdname.Title = MultiLanguage.GetComment("FD", "ODMMRBMVE01", "txtpdname", tLanguageType);
			this.txtpdno.Title = MultiLanguage.GetComment("FD", "ODMMRBMVE01", "txtpdno", tLanguageType);
			this.txtpdqty.Title = MultiLanguage.GetComment("FD", "ODMMRBMVE01", "txtpdqty", tLanguageType);
			this.txtreason.Title = MultiLanguage.GetComment("FD", "ODMMRBMVE01", "txtreason", tLanguageType);
			this.condate.Title = MultiLanguage.GetComment("FD", "ODMMRBMVE01", "condate", tLanguageType);
			this.superid.Title = MultiLanguage.GetComment("FD", "ODMMRBMVE01", "superid", tLanguageType);
		...
		{
			// 作業代號
			this.TaskId = "ODMMRBMVE01";
			// 表單代號
			this.formID = "ODMMRBMVE01";
...
this.rditem_ctrolRadio2.Attributes.Add("onclick", "document.getElementById('MasterPage_MasterPageContent_rditem_txt').value = '2';");
		...
		{
			defalutHash.Add("odmmrbmve01001", this.formID);
			defalutHash.Add("odmmrbmve01002", this.SheetNo);
...
order by resdd003 desc";
		...
		{
			pReport = "ODMMRBMVE01";
			pReportID = "ODMMRBMVE01_02";//憑證式
			pWhere = "AND (odmmrbmve01001='" + this.formID + "') AND (odmmrbmve01002='" + this.SheetNo + "')";
			pReportDirectory = "ODMMRBMVE01";
