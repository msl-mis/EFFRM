...
namespace tw.com.dsc.easyflowDotNet.forms
{
	...
	/// ODMADDAPPLY01 的摘要描述。
	/// </summary>
	public partial class ODMADDAPPLY01 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
	{
		//edit by teppy 2011/02/08 Start
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			AjaxPro.Utility.RegisterTypeForAjax(typeof(ODMADDAPPLY01));
			UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
			string tLanguageType = tClass.Language;

			//多國語系
			this.Title= MultiLanguage.GetComment("FD","ODMADDAPPLY01","lblTitle",this.UserInfo.Language);
			string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ODMADDAPPLY01", "HeadTabStrip01", tLanguageType);
			...
			this.lblamount.Text = MultiLanguage.GetComment("FD", "ODMADDAPPLY01", "lblamount", tLanguageType);
			this.lblaplydate.Text = MultiLanguage.GetComment("FD", "ODMADDAPPLY01", "lblaplydate", tLanguageType);
			this.lblcomp.Text = MultiLanguage.GetComment("FD", "ODMADDAPPLY01", "lblcomp", tLanguageType);
			this.lblcomp01.Text = MultiLanguage.GetComment("FD", "ODMADDAPPLY01", "lblcomp01", tLanguageType);
			this.lblcomp02.Text = MultiLanguage.GetComment("FD", "ODMADDAPPLY01", "lblcomp02", tLanguageType);
			this.lblcomp03.Text = MultiLanguage.GetComment("FD", "ODMADDAPPLY01", "lblcomp03", tLanguageType);
			this.lbldate.Text = MultiLanguage.GetComment("FD", "ODMADDAPPLY01", "lbldate", tLanguageType);
			this.lbldept.Text = MultiLanguage.GetComment("FD", "ODMADDAPPLY01", "lbldept", tLanguageType);
			this.lblfirm.Text = MultiLanguage.GetComment("FD", "ODMADDAPPLY01", "lblfirm", tLanguageType);
			this.lblitem.Text = MultiLanguage.GetComment("FD", "ODMADDAPPLY01", "lblitem", tLanguageType);
			this.lblitem01.Text = MultiLanguage.GetComment("FD", "ODMADDAPPLY01", "lblitem01", tLanguageType);
			this.lblitem02.Text = MultiLanguage.GetComment("FD", "ODMADDAPPLY01", "lblitem02", tLanguageType);
			this.lblitem03.Text = MultiLanguage.GetComment("FD", "ODMADDAPPLY01", "lblitem03", tLanguageType);
			this.lblname.Text = MultiLanguage.GetComment("FD", "ODMADDAPPLY01", "lblname", tLanguageType);
			this.lblno.Text = MultiLanguage.GetComment("FD", "ODMADDAPPLY01", "lblno", tLanguageType);
			this.lblother.Text = MultiLanguage.GetComment("FD", "ODMADDAPPLY01", "lblother", tLanguageType);
			this.lblprice.Text = MultiLanguage.GetComment("FD", "ODMADDAPPLY01", "lblprice", tLanguageType);
			this.lblreason.Text = MultiLanguage.GetComment("FD", "ODMADDAPPLY01", "lblreason", tLanguageType);
			this.lbltitle01.Text = MultiLanguage.GetComment("FD", "ODMADDAPPLY01", "lbltitle01", tLanguageType);
			this.lbltitle02.Text = MultiLanguage.GetComment("FD", "ODMADDAPPLY01", "lbltitle02", tLanguageType);
			this.no01.Text = MultiLanguage.GetComment("FD", "ODMADDAPPLY01", "no01", tLanguageType);
			this.no02.Text = MultiLanguage.GetComment("FD", "ODMADDAPPLY01", "no02", tLanguageType);
			this.no03.Text = MultiLanguage.GetComment("FD", "ODMADDAPPLY01", "no03", tLanguageType);
			this.no04.Text = MultiLanguage.GetComment("FD", "ODMADDAPPLY01", "no04", tLanguageType);
			this.title.Text = MultiLanguage.GetComment("FD", "ODMADDAPPLY01", "title", tLanguageType);
			this.title01.Text = MultiLanguage.GetComment("FD", "ODMADDAPPLY01", "title01", tLanguageType);
			this.applydate.Title = MultiLanguage.GetComment("FD", "ODMADDAPPLY01", "applydate", tLanguageType);
			this.empl1.Title = MultiLanguage.GetComment("FD", "ODMADDAPPLY01", "empl1", tLanguageType);
			this.txtuser.Title = MultiLanguage.GetComment("FD", "ODMADDAPPLY01", "txtuser", tLanguageType);
			this.txtdept.Title = MultiLanguage.GetComment("FD", "ODMADDAPPLY01", "txtdept", tLanguageType);
			this.txtno01.Title = MultiLanguage.GetComment("FD", "ODMADDAPPLY01", "txtno01", tLanguageType);
			this.txtno02.Title = MultiLanguage.GetComment("FD", "ODMADDAPPLY01", "txtno02", tLanguageType);
			this.txtno03.Title = MultiLanguage.GetComment("FD", "ODMADDAPPLY01", "txtno03", tLanguageType);
			this.txtno04.Title = MultiLanguage.GetComment("FD", "ODMADDAPPLY01", "txtno04", tLanguageType);
			this.txtname01.Title = MultiLanguage.GetComment("FD", "ODMADDAPPLY01", "txtname01", tLanguageType);
			this.txtamt01.Title = MultiLanguage.GetComment("FD", "ODMADDAPPLY01", "txtamt01", tLanguageType);
			this.txtprice01.Title = MultiLanguage.GetComment("FD", "ODMADDAPPLY01", "txtprice01", tLanguageType);
			this.txtcomp01.Title = MultiLanguage.GetComment("FD", "ODMADDAPPLY01", "txtcomp01", tLanguageType);
			this.datetime1.Title = MultiLanguage.GetComment("FD", "ODMADDAPPLY01", "datetime1", tLanguageType);
			this.txtother.Title = MultiLanguage.GetComment("FD", "ODMADDAPPLY01", "txtother", tLanguageType);
			this.txtname02.Title = MultiLanguage.GetComment("FD", "ODMADDAPPLY01", "txtname02", tLanguageType);
			this.txtname03.Title = MultiLanguage.GetComment("FD", "ODMADDAPPLY01", "txtname03", tLanguageType);
			this.txtname04.Title = MultiLanguage.GetComment("FD", "ODMADDAPPLY01", "txtname04", tLanguageType);
			this.txtamt02.Title = MultiLanguage.GetComment("FD", "ODMADDAPPLY01", "txtamt02", tLanguageType);
			this.txtamt03.Title = MultiLanguage.GetComment("FD", "ODMADDAPPLY01", "txtamt03", tLanguageType);
			this.txtamt04.Title = MultiLanguage.GetComment("FD", "ODMADDAPPLY01", "txtamt04", tLanguageType);
			this.txtprice02.Title = MultiLanguage.GetComment("FD", "ODMADDAPPLY01", "txtprice02", tLanguageType);
			this.txtprice03.Title = MultiLanguage.GetComment("FD", "ODMADDAPPLY01", "txtprice03", tLanguageType);
			this.txtprice04.Title = MultiLanguage.GetComment("FD", "ODMADDAPPLY01", "txtprice04", tLanguageType);
			this.txtcomp02.Title = MultiLanguage.GetComment("FD", "ODMADDAPPLY01", "txtcomp02", tLanguageType);
			this.txtcomp03.Title = MultiLanguage.GetComment("FD", "ODMADDAPPLY01", "txtcomp03", tLanguageType);
			this.txtcomp04.Title = MultiLanguage.GetComment("FD", "ODMADDAPPLY01", "txtcomp04", tLanguageType);
			this.datetime2.Title = MultiLanguage.GetComment("FD", "ODMADDAPPLY01", "datetime2", tLanguageType);
			this.datetime3.Title = MultiLanguage.GetComment("FD", "ODMADDAPPLY01", "datetime3", tLanguageType);
			this.datetime4.Title = MultiLanguage.GetComment("FD", "ODMADDAPPLY01", "datetime4", tLanguageType);
			this.txtresaon.Title = MultiLanguage.GetComment("FD", "ODMADDAPPLY01", "txtresaon", tLanguageType);
...
this.txtresaon.ToolTip = this.txtresaon.Text;
			...
			rdmsl.Attributes["style"] = "display:none;";
			rdmsl_ctrolRadio0.Checked = (rdmsl.Value == "0"); rdmsl_ctrolRadio0.Enabled = rdmsl.InputEnabled;
			rdmsl_ctrolRadio1.Checked = (rdmsl.Value == "1"); rdmsl_ctrolRadio1.Enabled = rdmsl.InputEnabled;
			rdmsl_ctrolRadio2.Checked = (rdmsl.Value == "2"); rdmsl_ctrolRadio2.Enabled = rdmsl.InputEnabled;
		...
		{
			// 作業代號
			this.TaskId = "ODMADDAPPLY01";
			// 表單代號
			this.formID = "ODMADDAPPLY01";
...
this.rdmsl_ctrolRadio0.Attributes.Add("onclick", "document.getElementById('MasterPage_MasterPageContent_rdmsl_txt').value = '0';");
this.rdmsl_ctrolRadio1.Attributes.Add("onclick", "document.getElementById('MasterPage_MasterPageContent_rdmsl_txt').value = '1';");
this.rdmsl_ctrolRadio2.Attributes.Add("onclick", "document.getElementById('MasterPage_MasterPageContent_rdmsl_txt').value = '2';");
		...
		{
			defalutHash.Add("odmaddapply01001", this.formID);
			defalutHash.Add("odmaddapply01002", this.SheetNo);
...
order by resdd003 desc";
		...
		{
			pReport = "ODMADDAPPLY01";
			pReportID = "ODMADDAPPLY01_02";//憑證式
			pWhere = "AND (odmaddapply01001='" + this.formID + "') AND (odmaddapply01002='" + this.SheetNo + "')";
			pReportDirectory = "ODMADDAPPLY01";
