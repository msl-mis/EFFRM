...
{
	/// <summary>
	/// ODMPURPAY01_TEST_MIMJ 的摘要描述。
	/// </summary>
	public partial class ODMPURPAY01_TEST_MIMJ : tw.com.dsc.easyflowDotNet.kernelBasePage.EFMIMJBasepage
	{
		...
		protected override void MIFunction()
		{
			switch(tBtnID)
			{
				case "MasterPage_MasterPageContent_querypur_btn":			//開窗連結外部資料庫
				{
		...
		protected override void MJFunction()
		{
			...
			{
				case "OpenMIMJ01_05_querypur":	
				{
					base.doMJByDB("OpenMIMJ01","05", @"192.168.10.31", "MSLCN","MasterPage_MasterPageContent_querypur_txt2=TC001","MasterPage_MasterPageContent_ma002_txt=MA002","MasterPage_MasterPageContent_na003_txt=NA003","MasterPage_MasterPageContent_totalamt_txt=Totalamt","MasterPage_MasterPageContent_tc005_txt=TC005");
					break;
				}
