...
namespace tw.com.dsc.easyflowDotNet.forms
{
	...
	/// ODMCOTCN01 的摘要描述。
	/// </summary>
	public partial class ODMCOTCN01 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
	{
		//edit by teppy 2011/02/08 Start
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			AjaxPro.Utility.RegisterTypeForAjax(typeof(ODMCOTCN01));
			UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
			string tLanguageType = tClass.Language;

			//多國語系
			this.Title= MultiLanguage.GetComment("FD","ODMCOTCN01","lblTitle",this.UserInfo.Language);
			string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ODMCOTCN01", "HeadTabStrip01", tLanguageType);
			...
			this.txtdept.Title = MultiLanguage.GetComment("FD", "ODMCOTCN01", "txtdept", tLanguageType);
			this.date.Title = MultiLanguage.GetComment("FD", "ODMCOTCN01", "date", tLanguageType);
			this.txtmain.Title = MultiLanguage.GetComment("FD", "ODMCOTCN01", "txtmain", tLanguageType);
			this.empl1.Title = MultiLanguage.GetComment("FD", "ODMCOTCN01", "empl1", tLanguageType);
			this.empl2.Title = MultiLanguage.GetComment("FD", "ODMCOTCN01", "empl2", tLanguageType);
			this.name.Title = MultiLanguage.GetComment("FD", "ODMCOTCN01", "name", tLanguageType);
		...
		{
			// 作業代號
			this.TaskId = "ODMCOTCN01";
			// 表單代號
			this.formID = "ODMCOTCN01";
...
where resfc001=@resfc001 and resfc002=@resfc002 and resfc003=@resfc003 and ISNULL(resfc004,'')<>''";
		...
		{
			defalutHash.Add("odmcotcn01001", this.formID);
			defalutHash.Add("odmcotcn01002", this.SheetNo);
...
order by resdd003 desc";
		...
		{
			pReport = "ODMCOTCN01";
			pReportID = "ODMCOTCN01_02";//憑證式
			pWhere = "AND (odmcotcn01001='" + this.formID + "') AND (odmcotcn01002='" + this.SheetNo + "')";
			pReportDirectory = "ODMCOTCN01";
