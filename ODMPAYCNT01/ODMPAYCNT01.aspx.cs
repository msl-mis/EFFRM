...
namespace tw.com.dsc.easyflowDotNet.forms
{
	...
	/// ODMPAYCNT01 的摘要描述。
	/// </summary>
	public partial class ODMPAYCNT01 : EFBasePage2
	{
		//edit by teppy 2011/02/08 Start
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			AjaxPro.Utility.RegisterTypeForAjax(typeof(ODMPAYCNT01));
			UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
			string tLanguageType = tClass.Language;

			//多國語系
			this.Title= MultiLanguage.GetComment("FD","ODMPAYCNT01","lblTitle",this.UserInfo.Language);
			string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ODMPAYCNT01", "HeadTabStrip01", tLanguageType);
			...
			string tBodyTabStrip01Text = MultiLanguage.GetComment("FD", "ODMPAYCNT01", "BodyTabStrip01", tLanguageType);
			...
			this.txtuser.Title = MultiLanguage.GetComment("FD", "ODMPAYCNT01", "txtuser", tLanguageType);
			this.usedate.Title = MultiLanguage.GetComment("FD", "ODMPAYCNT01", "usedate", tLanguageType);
			this.querypurno.Title = MultiLanguage.GetComment("FD", "ODMPAYCNT01", "querypurno", tLanguageType);
			this.na003.Title = MultiLanguage.GetComment("FD", "ODMPAYCNT01", "na003", tLanguageType);
			this.tc027.Title = MultiLanguage.GetComment("FD", "ODMPAYCNT01", "tc027", tLanguageType);
			this.paydate.Title = MultiLanguage.GetComment("FD", "ODMPAYCNT01", "paydate", tLanguageType);
			this.ma001.Title = MultiLanguage.GetComment("FD", "ODMPAYCNT01", "ma001", tLanguageType);
			this.ma002.Title = MultiLanguage.GetComment("FD", "ODMPAYCNT01", "ma002", tLanguageType);
			this.tc005.Title = MultiLanguage.GetComment("FD", "ODMPAYCNT01", "tc005", tLanguageType);
			this.totalamt.Title = MultiLanguage.GetComment("FD", "ODMPAYCNT01", "totalamt", tLanguageType);
			this.newid.Title = MultiLanguage.GetComment("FD", "ODMPAYCNT01", "newid", tLanguageType);
			this.txtnote.Title = MultiLanguage.GetComment("FD", "ODMPAYCNT01", "txtnote", tLanguageType);
			this.txtother.Title = MultiLanguage.GetComment("FD", "ODMPAYCNT01", "txtother", tLanguageType);
			this.querypurno01.Title = MultiLanguage.GetComment("FD", "ODMPAYCNT01", "querypurno01", tLanguageType);
			this.querypurno02.Title = MultiLanguage.GetComment("FD", "ODMPAYCNT01", "querypurno02", tLanguageType);
			this.querypurno03.Title = MultiLanguage.GetComment("FD", "ODMPAYCNT01", "querypurno03", tLanguageType);
			this.tc027_01.Title = MultiLanguage.GetComment("FD", "ODMPAYCNT01", "tc027_01", tLanguageType);
			this.tc027_02.Title = MultiLanguage.GetComment("FD", "ODMPAYCNT01", "tc027_02", tLanguageType);
			this.tc027_03.Title = MultiLanguage.GetComment("FD", "ODMPAYCNT01", "tc027_03", tLanguageType);
			this.na003_01.Title = MultiLanguage.GetComment("FD", "ODMPAYCNT01", "na003_01", tLanguageType);
			this.na003_02.Title = MultiLanguage.GetComment("FD", "ODMPAYCNT01", "na003_02", tLanguageType);
			this.na003_03.Title = MultiLanguage.GetComment("FD", "ODMPAYCNT01", "na003_03", tLanguageType);
			this.paydate01.Title = MultiLanguage.GetComment("FD", "ODMPAYCNT01", "paydate01", tLanguageType);
			this.paydate02.Title = MultiLanguage.GetComment("FD", "ODMPAYCNT01", "paydate02", tLanguageType);
			this.paydate03.Title = MultiLanguage.GetComment("FD", "ODMPAYCNT01", "paydate03", tLanguageType);
			this.ma001_01.Title = MultiLanguage.GetComment("FD", "ODMPAYCNT01", "ma001_01", tLanguageType);
			this.ma001_02.Title = MultiLanguage.GetComment("FD", "ODMPAYCNT01", "ma001_02", tLanguageType);
			this.ma001_03.Title = MultiLanguage.GetComment("FD", "ODMPAYCNT01", "ma001_03", tLanguageType);
			this.ma002_01.Title = MultiLanguage.GetComment("FD", "ODMPAYCNT01", "ma002_01", tLanguageType);
			this.ma002_02.Title = MultiLanguage.GetComment("FD", "ODMPAYCNT01", "ma002_02", tLanguageType);
			this.ma002_03.Title = MultiLanguage.GetComment("FD", "ODMPAYCNT01", "ma002_03", tLanguageType);
			this.tc005_01.Title = MultiLanguage.GetComment("FD", "ODMPAYCNT01", "tc005_01", tLanguageType);
			this.tc005_02.Title = MultiLanguage.GetComment("FD", "ODMPAYCNT01", "tc005_02", tLanguageType);
			this.tc005_03.Title = MultiLanguage.GetComment("FD", "ODMPAYCNT01", "tc005_03", tLanguageType);
			this.txtamt.Title = MultiLanguage.GetComment("FD", "ODMPAYCNT01", "txtamt", tLanguageType);
			this.txtamt01.Title = MultiLanguage.GetComment("FD", "ODMPAYCNT01", "txtamt01", tLanguageType);
			this.txtamt02.Title = MultiLanguage.GetComment("FD", "ODMPAYCNT01", "txtamt02", tLanguageType);
			this.txtamt03.Title = MultiLanguage.GetComment("FD", "ODMPAYCNT01", "txtamt03", tLanguageType);
			this.lblno.Text = MultiLanguage.GetComment("FD", "ODMPAYCNT01_d01", "lblno", tLanguageType);
			this.lblprice.Text = MultiLanguage.GetComment("FD", "ODMPAYCNT01_d01", "lblprice", tLanguageType);
			this.lblpurno.Text = MultiLanguage.GetComment("FD", "ODMPAYCNT01_d01", "lblpurno", tLanguageType);
			this.lblpurprice.Text = MultiLanguage.GetComment("FD", "ODMPAYCNT01_d01", "lblpurprice", tLanguageType);
			this.lblqry.Text = MultiLanguage.GetComment("FD", "ODMPAYCNT01_d01", "lblqry", tLanguageType);
			this.lblspeci.Text = MultiLanguage.GetComment("FD", "ODMPAYCNT01_d01", "lblspeci", tLanguageType);
			this.querypurtc.Title = MultiLanguage.GetComment("FD", "ODMPAYCNT01_d01", "querypurtc", tLanguageType);
			this.td004.Title = MultiLanguage.GetComment("FD", "ODMPAYCNT01_d01", "td004", tLanguageType);
			this.td006.Title = MultiLanguage.GetComment("FD", "ODMPAYCNT01_d01", "td006", tLanguageType);
			this.td008.Title = MultiLanguage.GetComment("FD", "ODMPAYCNT01_d01", "td008", tLanguageType);
			this.td010.Title = MultiLanguage.GetComment("FD", "ODMPAYCNT01_d01", "td010", tLanguageType);
			this.td011.Title = MultiLanguage.GetComment("FD", "ODMPAYCNT01_d01", "td011", tLanguageType);
			this.purnob.Title = MultiLanguage.GetComment("FD", "ODMPAYCNT01_d01", "purnob", tLanguageType);
			...
			base._BtnDetailSave.TabIndex=551;
			base._BtnDetailExit.TabIndex=552;
			#endregion 自訂排序
...
this.na003_03.ToolTip = this.na003_03.Text;
		...
		{
			// 作業代號
			this.TaskId = "ODMPAYCNT01";
			// 表單代號
			this.formID = "ODMPAYCNT01";
			...
			for(int i=0;i<intBody01RowCount;i++){
				...
				if(ttd008.Length>0){
					...
					if(!Regex.IsMatch(ttd008, @"^-?(?:\d+|\d{1,3}(?:,\d{3})+)(?:\.\d+)?$")){
						//輸入的資料不符合float數值格式 !
						tRetMsg += "「" + MultiLanguage.GetComment("FD", "ODMPAYCNT01_d01", "td008", tLanguageType) + "」  " + tFloatErrMsg + "\r\n";
						break;
					}
				}
			}
			...
			for(int i=0;i<intBody01RowCount;i++){
				...
				if(ttd010.Length>0){
					...
					if(!Regex.IsMatch(ttd010, @"^-?(?:\d+|\d{1,3}(?:,\d{3})+)(?:\.\d+)?$")){
						//輸入的資料不符合float數值格式 !
						tRetMsg += "「" + MultiLanguage.GetComment("FD", "ODMPAYCNT01_d01", "td010", tLanguageType) + "」  " + tFloatErrMsg + "\r\n";
						break;
					}
				}
			}
			...
			for(int i=0;i<intBody01RowCount;i++){
				...
				if(ttd011.Length>0){
					...
					if(!Regex.IsMatch(ttd011, @"^-?(?:\d+|\d{1,3}(?:,\d{3})+)(?:\.\d+)?$")){
						//輸入的資料不符合float數值格式 !
						tRetMsg += "「" + MultiLanguage.GetComment("FD", "ODMPAYCNT01_d01", "td011", tLanguageType) + "」  " + tFloatErrMsg + "\r\n";
						break;
					}
				}
			}
...
where resfc001=@resfc001 and resfc002=@resfc002 and resfc003=@resfc003 and ISNULL(resfc004,'')<>''";
		...
		protected override void settingClientFunction()
		{
			...
			querypurno.TxtInput.Attributes.Add("onblur",MIMJUtil.getBlurParams("MasterPage_MasterPageContent_querypurno_txt","OpenMIMJ01_11_querypurno","MasterPage_MasterPageContent_querypurno_txt"));
			...
			querypurno01.TxtInput.Attributes.Add("onblur",MIMJUtil.getBlurParams("MasterPage_MasterPageContent_querypurno01_txt","OpenMIMJ01_11_querypurno01","MasterPage_MasterPageContent_querypurno01_txt"));
			...
			querypurno02.TxtInput.Attributes.Add("onblur",MIMJUtil.getBlurParams("MasterPage_MasterPageContent_querypurno02_txt","OpenMIMJ01_11_querypurno02","MasterPage_MasterPageContent_querypurno02_txt"));
			...
			querypurno03.TxtInput.Attributes.Add("onblur",MIMJUtil.getBlurParams("MasterPage_MasterPageContent_querypurno03_txt","OpenMIMJ01_11_querypurno03","MasterPage_MasterPageContent_querypurno03_txt"));
			...
			querypurtc.TxtInput.Attributes.Add("onblur",MIMJUtil.getBlurParams("MasterPage_MasterPageContent_querypurtc_txt","OpenMIMJ01_12_querypurtc_d01","MasterPage_MasterPageContent_querypurtc_txt")+";isDetailSaveButtonEnabled('GridUserControl1_Button9');");
...
this.rddept_ctrolRadio1.Attributes.Add("onclick", "document.getElementById('MasterPage_MasterPageContent_rddept_txt').value = '1';");
		...
		{
			defalutHash.Add("odmpaycnt01a001", this.formID);
			defalutHash.Add("odmpaycnt01a002", this.SheetNo);
...
order by resdd003 desc";
		...
		protected override Hashtable setGridFormate(Hashtable pGridsHash)
		{
			...
			//自動產生序號
			MasterObj.DetailObjs[0].setIncrementalFields("odmpaycnt01b003", "odmpaycnt01b001;odmpaycnt01b002", 4, "");
		return pGridsHash;
		}
		...
		protected override void settingHeaderShown()
		{
			...
			if (FormStatus == EFFormStatus.CREATE)
			{
				...
				{
				GridUserControl1.ShowColumns("querypurtc", 80, gridUserControl.GridColumnAlign.Center);
				GridUserControl1.ShowColumns("purnob", 70, gridUserControl.GridColumnAlign.Left);
		...
		{
			pReport = "ODMPAYCNT01";
			pReportID = "ODMPAYCNT01_02";//憑證式
			pWhere = "AND (odmpaycnt01a001='" + this.formID + "') AND (odmpaycnt01a002='" + this.SheetNo + "')";
			pReportDirectory = "ODMPAYCNT01";
		...
		protected override void SetDetailDefaultValue(System.Collections.Generic.Dictionary<string, string> dictDetail)
		{
			...
			//單身一欄位預設值
			dictDetail.Add("odmpaycnt01b001", formID);
			dictDetail.Add("odmpaycnt01b002", SheetNo);
