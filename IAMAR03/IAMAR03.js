...
function CustomerSaveCheck(tStatus)
{
	...
	//不允許空白驗證
	var tiamar03003 = $('#MasterPage_MasterPageContent_iamar03003_txt');
	if(tiamar03003.length>0){
		var tiamar03003Value = $('#MasterPage_MasterPageContent_iamar03003_txt').val().trim();
		if (tiamar03003Value.length==0){
			//欄位不允許空白 !
			tErr += '「' + getI18NForSpecial('FD', 'IAMAR03', 'iamar03003', '../../_Common/PlatFormUtil/KernelPage/I18N/I18NForJs.aspx') + '」  ' + tFieldNotFilledMsg + '\r\n';
		}
	}
...
{ 
   ...
   var tRetVal = tw.com.dsc.easyflowDotNet.forms.IAMAR03.GetDetialRowCount(universalID); 
   if(tRetVal.value == '0') 
   { 
...
function emsOnload()
{
    ...
    {        
         ...
         divContext.innerHTML = document.getElementById("MasterPage_MasterPageContent_iamar03004_txt").value;
