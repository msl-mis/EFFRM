...
namespace tw.com.dsc.easyflowDotNet.forms
{
	...
	/// ODMRSKCN01 的摘要描述。
	/// </summary>
	public partial class ODMRSKCN01 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
	{
		//edit by teppy 2011/02/08 Start
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			AjaxPro.Utility.RegisterTypeForAjax(typeof(ODMRSKCN01));
			UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
			string tLanguageType = tClass.Language;

			//多國語系
			this.Title= MultiLanguage.GetComment("FD","ODMRSKCN01","lblTitle",this.UserInfo.Language);
			string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ODMRSKCN01", "HeadTabStrip01", tLanguageType);
			...
			this.lblnote.Text = MultiLanguage.GetComment("FD", "ODMRSKCN01", "lblnote", tLanguageType);
			this.aplydate.Title = MultiLanguage.GetComment("FD", "ODMRSKCN01", "aplydate", tLanguageType);
			this.username.Title = MultiLanguage.GetComment("FD", "ODMRSKCN01", "username", tLanguageType);
			this.contact.Title = MultiLanguage.GetComment("FD", "ODMRSKCN01", "contact", tLanguageType);
		...
		{
			// 作業代號
			this.TaskId = "ODMRSKCN01";
			// 表單代號
			this.formID = "ODMRSKCN01";
...
where resfc001=@resfc001 and resfc002=@resfc002 and resfc003=@resfc003 and ISNULL(resfc004,'')<>''";
		...
		{
			defalutHash.Add("odmrskcn01001", this.formID);
			defalutHash.Add("odmrskcn01002", this.SheetNo);
...
order by resdd003 desc";
		...
		{
			pReport = "ODMRSKCN01";
			pReportID = "ODMRSKCN01_02";//憑證式
			pWhere = "AND (odmrskcn01001='" + this.formID + "') AND (odmrskcn01002='" + this.SheetNo + "')";
			pReportDirectory = "ODMRSKCN01";
