...
namespace tw.com.dsc.easyflowDotNet.forms
{
	...
	/// ODMPDBOUNS01 的摘要描述。
	/// </summary>
	public partial class ODMPDBOUNS01 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
	{
		//edit by teppy 2011/02/08 Start
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			AjaxPro.Utility.RegisterTypeForAjax(typeof(ODMPDBOUNS01));
			UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
			string tLanguageType = tClass.Language;

			//多國語系
			this.Title= MultiLanguage.GetComment("FD","ODMPDBOUNS01","lblTitle",this.UserInfo.Language);
			string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ODMPDBOUNS01", "HeadTabStrip01", tLanguageType);
			...
			this.lblcontact.Text = MultiLanguage.GetComment("FD", "ODMPDBOUNS01", "lblcontact", tLanguageType);
			this.lbldate.Text = MultiLanguage.GetComment("FD", "ODMPDBOUNS01", "lbldate", tLanguageType);
			this.lbldept.Text = MultiLanguage.GetComment("FD", "ODMPDBOUNS01", "lbldept", tLanguageType);
			this.title.Text = MultiLanguage.GetComment("FD", "ODMPDBOUNS01", "title", tLanguageType);
			this.txtdept.Title = MultiLanguage.GetComment("FD", "ODMPDBOUNS01", "txtdept", tLanguageType);
			this.date.Title = MultiLanguage.GetComment("FD", "ODMPDBOUNS01", "date", tLanguageType);
			this.txtmain.Title = MultiLanguage.GetComment("FD", "ODMPDBOUNS01", "txtmain", tLanguageType);
		...
		{
			// 作業代號
			this.TaskId = "ODMPDBOUNS01";
			// 表單代號
			this.formID = "ODMPDBOUNS01";
...
where resfc001=@resfc001 and resfc002=@resfc002 and resfc003=@resfc003 and ISNULL(resfc004,'')<>''";
		...
		{
			defalutHash.Add("odmpdbouns01001", this.formID);
			defalutHash.Add("odmpdbouns01002", this.SheetNo);
...
order by resdd003 desc";
		...
		{
			pReport = "ODMPDBOUNS01";
			pReportID = "ODMPDBOUNS01_02";//憑證式
			pWhere = "AND (odmpdbouns01001='" + this.formID + "') AND (odmpdbouns01002='" + this.SheetNo + "')";
			pReportDirectory = "ODMPDBOUNS01";
