...
<cc1:DscOpenQuery id='deptid' runat='server' title='DeptID' ShowTitle='False'
	style="Z-INDEX: 660; POSITION: absolute; LEFT: 513px; TOP: 42px;"
...
<cc1:DscTextBox id='kind' runat='server' title='一般類別' ShowTitle='False'
	style="display:none;Z-INDEX:660; POSITION: absolute; LEFT: 105px; TOP: 78px;">
	<FrmFieldKeys FrmID='FrmODMFPAYCN02' BOID='ODMFPAYCN02' FieldName='kind'></FrmFieldKeys>
</cc1:DscTextBox>
<asp:RadioButton ID='kind_ctrolRadio0' runat='server' GroupName='kind' Text='' Value='0' style='position:absolute;top:78px;left:105px;z-index:660;'/>
<asp:RadioButton ID='kind_ctrolRadio1' runat='server' GroupName='kind' Text='' Value='1' style='position:absolute;top:78px;left:170px;z-index:660;'/>
<asp:RadioButton ID='kind_ctrolRadio2' runat='server' GroupName='kind' Text='' Value='2' style='position:absolute;top:78px;left:233px;z-index:660;'/>
...
<script src="ODMFPAYCN02.js?NoCache=20230905001" type="text/javascript"></script>
</asp:Content>
