...
namespace tw.com.dsc.easyflowDotNet.forms
{
	...
	public partial class ODMFPAYCN02 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
	{
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			this.chkatt03.Text = MultiLanguage.GetComment("FD", "ODMFPAYCN02", "chkatt03", tLanguageType);
			...
			this.curr01.Title = MultiLanguage.GetComment("FD", "ODMFPAYCN02", "curr01", tLanguageType);
			this.curr02.Title = MultiLanguage.GetComment("FD", "ODMFPAYCN02", "curr02", tLanguageType);
			this.curr03.Title = MultiLanguage.GetComment("FD", "ODMFPAYCN02", "curr03", tLanguageType);
			this.curr04.Title = MultiLanguage.GetComment("FD", "ODMFPAYCN02", "curr04", tLanguageType);
			this.curr05.Title = MultiLanguage.GetComment("FD", "ODMFPAYCN02", "curr05", tLanguageType);
