...
namespace tw.com.dsc.easyflowDotNet.forms
{
    ...
    /// ODMCONVL01 的摘要描述。
    /// </summary>
    public partial class ODMCONVL01 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
    {
        //edit by teppy 2011/02/08 Start
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            AjaxPro.Utility.RegisterTypeForAjax(typeof(ODMCONVL01));
            UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
            string tLanguageType = tClass.Language;

            //多國語系
            this.Title = MultiLanguage.GetComment("FD", "ODMCONVL01", "lblTitle", this.UserInfo.Language);
            string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ODMCONVL01", "HeadTabStrip01", tLanguageType);
            ...
            this.txtdept.Title = MultiLanguage.GetComment("FD", "ODMCONVL01", "txtdept", tLanguageType);
            this.date.Title = MultiLanguage.GetComment("FD", "ODMCONVL01", "date", tLanguageType);
            this.txtmain.Title = MultiLanguage.GetComment("FD", "ODMCONVL01", "txtmain", tLanguageType);
            this.txtuser.Title = MultiLanguage.GetComment("FD", "ODMCONVL01", "txtuser", tLanguageType);
            this.totalmoney.Title = MultiLanguage.GetComment("FD", "ODMCONVL01", "totalmoney", tLanguageType);
            this.superid.Title = MultiLanguage.GetComment("FD", "ODMCONVL01", "superid", tLanguageType);
        ...
        {
            // 作業代號
            this.TaskId = "ODMCONVL01";
            // 表單代號
            this.formID = "ODMCONVL01";
...
where resfc001=@resfc001 and resfc002=@resfc002 and resfc003=@resfc003 and ISNULL(resfc004,'')<>''";
        ...
        {
            defalutHash.Add("odmconvl01001", this.formID);
            defalutHash.Add("odmconvl01002", this.SheetNo);
...
order by resdd003 desc";
        ...
        {
            pReport = "ODMCONVL01";
            pReportID = "ODMCONVL01_02";//憑證式
            pWhere = "AND (odmconvl01001='" + this.formID + "') AND (odmconvl01002='" + this.SheetNo + "')";
            pReportDirectory = "ODMCONVL01";
