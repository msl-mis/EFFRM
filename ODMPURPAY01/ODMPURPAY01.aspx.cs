...
namespace tw.com.dsc.easyflowDotNet.forms
{
	...
	/// ODMPURPAY01 的摘要描述。
	/// </summary>
	public partial class ODMPURPAY01 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
	{
		//edit by teppy 2011/02/08 Start
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			AjaxPro.Utility.RegisterTypeForAjax(typeof(ODMPURPAY01));
			UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
			string tLanguageType = tClass.Language;

			//多國語系
			this.Title= MultiLanguage.GetComment("FD","ODMPURPAY01","lblTitle",this.UserInfo.Language);
			string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ODMPURPAY01", "HeadTabStrip01", tLanguageType);
			...
			this.lblmsl.Text = MultiLanguage.GetComment("FD", "ODMPURPAY01", "lblmsl", tLanguageType);
			this.username.Title = MultiLanguage.GetComment("FD", "ODMPURPAY01", "username", tLanguageType);
			this.datetime1.Title = MultiLanguage.GetComment("FD", "ODMPURPAY01", "datetime1", tLanguageType);
			this.purno01.Title = MultiLanguage.GetComment("FD", "ODMPURPAY01", "purno01", tLanguageType);
			this.paymeth01.Title = MultiLanguage.GetComment("FD", "ODMPURPAY01", "paymeth01", tLanguageType);
			this.datetime2.Title = MultiLanguage.GetComment("FD", "ODMPURPAY01", "datetime2", tLanguageType);
			this.payee01.Title = MultiLanguage.GetComment("FD", "ODMPURPAY01", "payee01", tLanguageType);
			this.curr01.Title = MultiLanguage.GetComment("FD", "ODMPURPAY01", "curr01", tLanguageType);
			this.money01.Title = MultiLanguage.GetComment("FD", "ODMPURPAY01", "money01", tLanguageType);
			this.purno02.Title = MultiLanguage.GetComment("FD", "ODMPURPAY01", "purno02", tLanguageType);
			this.paymeth02.Title = MultiLanguage.GetComment("FD", "ODMPURPAY01", "paymeth02", tLanguageType);
			this.datetime3.Title = MultiLanguage.GetComment("FD", "ODMPURPAY01", "datetime3", tLanguageType);
			this.payee02.Title = MultiLanguage.GetComment("FD", "ODMPURPAY01", "payee02", tLanguageType);
			this.curr02.Title = MultiLanguage.GetComment("FD", "ODMPURPAY01", "curr02", tLanguageType);
			this.money02.Title = MultiLanguage.GetComment("FD", "ODMPURPAY01", "money02", tLanguageType);
			this.purno03.Title = MultiLanguage.GetComment("FD", "ODMPURPAY01", "purno03", tLanguageType);
			this.paymeth03.Title = MultiLanguage.GetComment("FD", "ODMPURPAY01", "paymeth03", tLanguageType);
			this.datetime4.Title = MultiLanguage.GetComment("FD", "ODMPURPAY01", "datetime4", tLanguageType);
			this.payee03.Title = MultiLanguage.GetComment("FD", "ODMPURPAY01", "payee03", tLanguageType);
			this.curr03.Title = MultiLanguage.GetComment("FD", "ODMPURPAY01", "curr03", tLanguageType);
			this.money03.Title = MultiLanguage.GetComment("FD", "ODMPURPAY01", "money03", tLanguageType);
			this.purno04.Title = MultiLanguage.GetComment("FD", "ODMPURPAY01", "purno04", tLanguageType);
			this.paymeth04.Title = MultiLanguage.GetComment("FD", "ODMPURPAY01", "paymeth04", tLanguageType);
			this.datetime5.Title = MultiLanguage.GetComment("FD", "ODMPURPAY01", "datetime5", tLanguageType);
			this.payee04.Title = MultiLanguage.GetComment("FD", "ODMPURPAY01", "payee04", tLanguageType);
			this.curr04.Title = MultiLanguage.GetComment("FD", "ODMPURPAY01", "curr04", tLanguageType);
			this.money04.Title = MultiLanguage.GetComment("FD", "ODMPURPAY01", "money04", tLanguageType);
			this.purno05.Title = MultiLanguage.GetComment("FD", "ODMPURPAY01", "purno05", tLanguageType);
			this.paymeth05.Title = MultiLanguage.GetComment("FD", "ODMPURPAY01", "paymeth05", tLanguageType);
			this.datetime6.Title = MultiLanguage.GetComment("FD", "ODMPURPAY01", "datetime6", tLanguageType);
			this.payee05.Title = MultiLanguage.GetComment("FD", "ODMPURPAY01", "payee05", tLanguageType);
			this.curr05.Title = MultiLanguage.GetComment("FD", "ODMPURPAY01", "curr05", tLanguageType);
			this.money05.Title = MultiLanguage.GetComment("FD", "ODMPURPAY01", "money05", tLanguageType);
			this.mtotal.Title = MultiLanguage.GetComment("FD", "ODMPURPAY01", "mtotal", tLanguageType);
			this.textarea1.Title = MultiLanguage.GetComment("FD", "ODMPURPAY01", "textarea1", tLanguageType);
			this.rate.Title = MultiLanguage.GetComment("FD", "ODMPURPAY01", "rate", tLanguageType);
			this.payother.Title = MultiLanguage.GetComment("FD", "ODMPURPAY01", "payother", tLanguageType);
			this.payarea01.Title = MultiLanguage.GetComment("FD", "ODMPURPAY01", "payarea01", tLanguageType);
			this.payarea02.Title = MultiLanguage.GetComment("FD", "ODMPURPAY01", "payarea02", tLanguageType);
			this.payarea03.Title = MultiLanguage.GetComment("FD", "ODMPURPAY01", "payarea03", tLanguageType);
			this.payarea04.Title = MultiLanguage.GetComment("FD", "ODMPURPAY01", "payarea04", tLanguageType);
...
this.payarea01.ToolTip = this.payarea01.Text;
this.payarea02.ToolTip = this.payarea02.Text;
this.payarea03.ToolTip = this.payarea03.Text;
this.payarea04.ToolTip = this.payarea04.Text;
			...
			comp.Attributes["style"] = "display:none;";
			comp_ctrolRadio0.Checked = (comp.Value == "0"); comp_ctrolRadio0.Enabled = comp.InputEnabled;
			comp_ctrolRadio1.Checked = (comp.Value == "1"); comp_ctrolRadio1.Enabled = comp.InputEnabled;
			comp_ctrolRadio2.Checked = (comp.Value == "2"); comp_ctrolRadio2.Enabled = comp.InputEnabled;
			comp_ctrolRadio3.Checked = (comp.Value == "3"); comp_ctrolRadio3.Enabled = comp.InputEnabled;
			comp_ctrolRadio4.Checked = (comp.Value == "4"); comp_ctrolRadio4.Enabled = comp.InputEnabled;
			...
			radio1.Attributes["style"] = "display:none;";
			radio1_ctrolRadio0.Checked = (radio1.Value == "0"); radio1_ctrolRadio0.Enabled = radio1.InputEnabled;
		...
		{
			// 作業代號
			this.TaskId = "ODMPURPAY01";
			// 表單代號
			this.formID = "ODMPURPAY01";
...
this.comp_ctrolRadio0.Attributes.Add("onclick", "document.getElementById('MasterPage_MasterPageContent_comp_txt').value = '0';");
this.comp_ctrolRadio1.Attributes.Add("onclick", "document.getElementById('MasterPage_MasterPageContent_comp_txt').value = '1';");
this.comp_ctrolRadio2.Attributes.Add("onclick", "document.getElementById('MasterPage_MasterPageContent_comp_txt').value = '2';");
this.comp_ctrolRadio3.Attributes.Add("onclick", "document.getElementById('MasterPage_MasterPageContent_comp_txt').value = '3';");
this.comp_ctrolRadio4.Attributes.Add("onclick", "document.getElementById('MasterPage_MasterPageContent_comp_txt').value = '4';");
...
this.radio1_ctrolRadio0.Attributes.Add("onclick", "document.getElementById('MasterPage_MasterPageContent_radio1_txt').value = '0';");
...
this.rddept_ctrolRadio1.Attributes.Add("onclick", "document.getElementById('MasterPage_MasterPageContent_rddept_txt').value = '1';");
		...
		{
			defalutHash.Add("comp", "1");
			defalutHash.Add("odmpurpay01001", this.formID);
			defalutHash.Add("odmpurpay01002", this.SheetNo);
			defalutHash.Add("username", this.UserInfo.LoginName.ToString());
			defalutHash.Add("datetime1", DateTime.Now.ToString("yyyyMMdd"));
			defalutHash.Add("rate", "1");
		}
...
order by resdd003 desc";
		...
		protected override void ReGetCondValue(object[,] pAryCondValue)
		{
			...
			tDbl=4;
			try{
				tDbl = double.Parse(this.comp.Value.Trim());
			}
			catch(Exception e){
				tDbl=4;
			}
			pAryCondValue[0, 1] = "comwell";
			...
			tValue="";
			try{
				tValue = (this.curr01.Value.Trim());
			}
			catch(Exception e){
				tValue="";
			}
			pAryCondValue[0, 10] = "cur";
			pAryCondValue[1, 10] = tValue; 
		...
		{
			pReport = "ODMPURPAY01";
			pReportID = "ODMPURPAY01_02";//憑證式
			pWhere = "AND (odmpurpay01001='" + this.formID + "') AND (odmpurpay01002='" + this.SheetNo + "')";
			pReportDirectory = "ODMPURPAY01";
