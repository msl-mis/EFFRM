...
namespace tw.com.dsc.easyflowDotNet.forms
{
	...
	/// ODMTEST 的摘要描述。
	/// </summary>
	public partial class ODMTEST : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
	{
		//edit by teppy 2011/02/08 Start
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			AjaxPro.Utility.RegisterTypeForAjax(typeof(ODMTEST));
			UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
			string tLanguageType = tClass.Language;

			//多國語系
			this.Title= MultiLanguage.GetComment("FD","ODMTEST","lblTitle",this.UserInfo.Language);
			string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ODMTEST", "HeadTabStrip01", tLanguageType);
			...
			this.label1.Text = MultiLanguage.GetComment("FD", "ODMTEST", "label1", tLanguageType);
			this.label2.Text = MultiLanguage.GetComment("FD", "ODMTEST", "label2", tLanguageType);
			this.label4.Text = MultiLanguage.GetComment("FD", "ODMTEST", "label4", tLanguageType);
			this.label5.Text = MultiLanguage.GetComment("FD", "ODMTEST", "label5", tLanguageType);
			this.dept.Title = MultiLanguage.GetComment("FD", "ODMTEST", "dept", tLanguageType);
			this.username.Title = MultiLanguage.GetComment("FD", "ODMTEST", "username", tLanguageType);
			this.payee.Title = MultiLanguage.GetComment("FD", "ODMTEST", "payee", tLanguageType);
			this.checkbox1.Text = MultiLanguage.GetComment("FD", "ODMTEST", "checkbox1", tLanguageType);
			this.checkbox2.Text = MultiLanguage.GetComment("FD", "ODMTEST", "checkbox2", tLanguageType);
			this.checkbox3.Text = MultiLanguage.GetComment("FD", "ODMTEST", "checkbox3", tLanguageType);
			this.checkbox4.Text = MultiLanguage.GetComment("FD", "ODMTEST", "checkbox4", tLanguageType);
			this.checkbox5.Text = MultiLanguage.GetComment("FD", "ODMTEST", "checkbox5", tLanguageType);
			this.chkother.Title = MultiLanguage.GetComment("FD", "ODMTEST", "chkother", tLanguageType);
			this.textarea1.Title = MultiLanguage.GetComment("FD", "ODMTEST", "textarea1", tLanguageType);
			this.money01.Title = MultiLanguage.GetComment("FD", "ODMTEST", "money01", tLanguageType);
			this.textarea2.Title = MultiLanguage.GetComment("FD", "ODMTEST", "textarea2", tLanguageType);
			this.money02.Title = MultiLanguage.GetComment("FD", "ODMTEST", "money02", tLanguageType);
			this.textarea3.Title = MultiLanguage.GetComment("FD", "ODMTEST", "textarea3", tLanguageType);
			this.money03.Title = MultiLanguage.GetComment("FD", "ODMTEST", "money03", tLanguageType);
			this.textarea4.Title = MultiLanguage.GetComment("FD", "ODMTEST", "textarea4", tLanguageType);
			this.money04.Title = MultiLanguage.GetComment("FD", "ODMTEST", "money04", tLanguageType);
			this.textarea5.Title = MultiLanguage.GetComment("FD", "ODMTEST", "textarea5", tLanguageType);
			this.money05.Title = MultiLanguage.GetComment("FD", "ODMTEST", "money05", tLanguageType);
			this.mtotal.Title = MultiLanguage.GetComment("FD", "ODMTEST", "mtotal", tLanguageType);
			this.checkbox6.Text = MultiLanguage.GetComment("FD", "ODMTEST", "checkbox6", tLanguageType);
			this.inv01.Title = MultiLanguage.GetComment("FD", "ODMTEST", "inv01", tLanguageType);
			this.checkbox7.Text = MultiLanguage.GetComment("FD", "ODMTEST", "checkbox7", tLanguageType);
			this.inv02.Title = MultiLanguage.GetComment("FD", "ODMTEST", "inv02", tLanguageType);
			this.checkbox8.Text = MultiLanguage.GetComment("FD", "ODMTEST", "checkbox8", tLanguageType);
			this.checkbox9.Text = MultiLanguage.GetComment("FD", "ODMTEST", "checkbox9", tLanguageType);
			this.checkbox10.Text = MultiLanguage.GetComment("FD", "ODMTEST", "checkbox10", tLanguageType);
			this.orderno.Title = MultiLanguage.GetComment("FD", "ODMTEST", "orderno", tLanguageType);
			this.attother.Title = MultiLanguage.GetComment("FD", "ODMTEST", "attother", tLanguageType);
			this.other.Text = MultiLanguage.GetComment("FD", "ODMTEST", "other", tLanguageType);
			this.payother.Title = MultiLanguage.GetComment("FD", "ODMTEST", "payother", tLanguageType);
			this.seltype.Title = MultiLanguage.GetComment("FD", "ODMTEST", "seltype", tLanguageType);
			this.selitem.Title = MultiLanguage.GetComment("FD", "ODMTEST", "selitem", tLanguageType);
			this.purorder.Title = MultiLanguage.GetComment("FD", "ODMTEST", "purorder", tLanguageType);
			this.datetime1.Title = MultiLanguage.GetComment("FD", "ODMTEST", "datetime1", tLanguageType);
			this.selusefactor.Title = MultiLanguage.GetComment("FD", "ODMTEST", "selusefactor", tLanguageType);
			this.itemname.Title = MultiLanguage.GetComment("FD", "ODMTEST", "itemname", tLanguageType);
			this.typename.Title = MultiLanguage.GetComment("FD", "ODMTEST", "typename", tLanguageType);
			this.opentype.Title = MultiLanguage.GetComment("FD", "ODMTEST", "opentype", tLanguageType);
...
ScriptManager.RegisterStartupScript(this, typeof(string), "InitCalculated", "InitCalculated();", true);
						ScriptManager.RegisterStartupScript(this, typeof(string), "InitOnChangeItem", "InitOnChangeItem();", true);
			#endregion 增加初始設定
		}
		#endregion
...
this.other.Text = String.Empty;
			...
			#region 自訂下拉選項
			#region 單頭頁籤Head01-seltype下拉選項
			if(!IsPostBack)
			{
				this.seltype.Items.Clear();//清空所有選項
				tSQL = @"select distinct type_id,type_name from odca_type"; 
				tReturnValue = createSQLSERVERDataTable(tSQL, "Persist Security Info=False;server=192.168.10.22; database=Price; User ID=sa; pwd=yzf;;Min Pool Size=0;Max Pool Size=500;Connect Timeout=600;", "type_id", "type_name");
				createSelectItemFromDB(tReturnValue, seltype);
				this.seltype.Items.Insert(0, new ListItem("", ""));
				if(MasterObj.NowRow != null)
				{
					seltype.DDLInput.SelectedValue = (MasterObj.NowRow["seltype"].Value == null ? "" : MasterObj.NowRow["seltype"].Value.ToString());
				}

				//轉會表單
				if(base.CmdForwardApproveForm == "Y" && MasterObj.NewRow != null)
				{
					seltype.DDLInput.SelectedValue = (MasterObj.NewRow["seltype"].Value == null ? "" : MasterObj.NewRow["seltype"].Value.ToString());
				}
			...
			#endregion 單頭頁籤Head01-seltype下拉選項

			#region 單頭頁籤Head01-selitem下拉選項
			if(!IsPostBack)
			{
				this.selitem.Items.Clear();//清空所有選項
				tSQL = @"select distinct type_id,item_name from odca_item"; 
				tReturnValue = createSQLSERVERDataTable(tSQL, "Persist Security Info=False;server=192.168.10.22; database=Price; User ID=sa; pwd=yzf;;Min Pool Size=0;Max Pool Size=500;Connect Timeout=600;", "type_id", "item_name");
				createSelectItemFromDB(tReturnValue, selitem);
				this.selitem.Items.Insert(0, new ListItem("", ""));
				if(MasterObj.NowRow != null)
				{
					selitem.DDLInput.SelectedValue = (MasterObj.NowRow["selitem"].Value == null ? "" : MasterObj.NowRow["selitem"].Value.ToString());
				}

				//轉會表單
				if(base.CmdForwardApproveForm == "Y" && MasterObj.NewRow != null)
				{
					selitem.DDLInput.SelectedValue = (MasterObj.NewRow["selitem"].Value == null ? "" : MasterObj.NewRow["selitem"].Value.ToString());
				}
			...
			#endregion 單頭頁籤Head01-selitem下拉選項
			#endregion 自訂下拉選項
...
where resfc001=@resfc001 and resfc002=@resfc002 and resfc003=@resfc003 and ISNULL(resfc004,'')<>''";
		...
		#region 自訂Ajax
		#region 重新取得selitem下拉選項
		[AjaxPro.AjaxMethod(AjaxPro.HttpSessionStateRequirement.ReadWrite)]
		public string ajaxGetselitemItem(string pseltypeVal)
		{
			string strReturn="";
			string tSQL = @"select distinct type_id,item_name from odca_item 
 where type_id=N'"+pseltypeVal+"' ";
			strReturn = createSQLSERVERDataTable(tSQL, "Persist Security Info=False;server=192.168.10.22; database=Price; User ID=sa; pwd=yzf;;Min Pool Size=0;Max Pool Size=500;Connect Timeout=600;", "type_id", "item_name");
			return strReturn;
		}
		#endregion 重新取得selitem下拉選項
		#endregion 自訂Ajax
		...
		protected override void settingClientFunction()
		{
			...
			opentype.TxtInput.Attributes.Add("onblur",MIMJUtil.getBlurParams("MasterPage_MasterPageContent_opentype_txt","OpenMIMJ01_20_opentype","MasterPage_MasterPageContent_opentype_txt"));
			opentype.TxtInput.Attributes.Add("onchange","AddtoHash('MasterPage_MasterPageContent_opentype_txt');");
			...
			string strseltype_onChangeScript=String.Empty;
			if(this.seltype.DDLInput.Attributes["onchange"]!=null){strseltype_onChangeScript=this.seltype.DDLInput.Attributes["onchange"].ToString();}
			this.seltype.DDLInput.Attributes.Add("onchange", "seltype_onChange();"+strseltype_onChangeScript);


this.checkbox5.Attributes.Add("onclick", " if($('#MasterPage_MasterPageContent_checkbox5_chk')[0].checked){{$('#MasterPage_MasterPageContent_chkother').show();}} else{{$('#MasterPage_MasterPageContent_chkother').hide();}} ");
this.checkbox6.Attributes.Add("onclick", " if($('#MasterPage_MasterPageContent_checkbox6_chk')[0].checked){{$('#MasterPage_MasterPageContent_inv01').show();}} else{{$('#MasterPage_MasterPageContent_inv01').hide();}} ");
this.checkbox7.Attributes.Add("onclick", " if($('#MasterPage_MasterPageContent_checkbox7_chk')[0].checked){{$('#MasterPage_MasterPageContent_inv02').show();}} else{{$('#MasterPage_MasterPageContent_inv02').hide();}} ");
this.checkbox8.Attributes.Add("onclick", " if($('#MasterPage_MasterPageContent_checkbox8_chk')[0].checked){{$('#MasterPage_MasterPageContent_orderno').show();}} else{{$('#MasterPage_MasterPageContent_orderno').hide();}} ");
...
this.chpay_ctrolRadio2.Attributes.Add("onclick", "InitTriggerMust('" + base.FormStatus.ToString() + "');document.getElementById('MasterPage_MasterPageContent_chpay_txt').value = '2';");
		...
		{
			defalutHash.Add("odmtest001", this.formID);
			defalutHash.Add("odmtest002", this.SheetNo);
...
order by resdd003 desc";
		...
		protected override void ReGetCondValue(object[,] pAryCondValue)
		{
			...
			tValue="";
			try{
				tValue = (this.paypee.Value.Trim());
			}
			catch(Exception e){
				tValue="";
			}
			pAryCondValue[0, 0] = "ven";
		...
		{
			pReport = "ODMTEST";
			pReportID = "ODMTEST_02";//憑證式
			pWhere = "AND (odmtest001='" + this.formID + "') AND (odmtest002='" + this.SheetNo + "')";
			pReportDirectory = "ODMTEST";
