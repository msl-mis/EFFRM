...
namespace tw.com.dsc.easyflowDotNet.forms
{
	...
	/// ODMFPAYCN01 的摘要描述。
	/// </summary>
	public partial class ODMFPAYCN01 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
	{
		//edit by teppy 2011/02/08 Start
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			AjaxPro.Utility.RegisterTypeForAjax(typeof(ODMFPAYCN01));
			UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
			string tLanguageType = tClass.Language;

			//多國語系
			this.Title= MultiLanguage.GetComment("FD","ODMFPAYCN01","lblTitle",this.UserInfo.Language);
			string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ODMFPAYCN01", "HeadTabStrip01", tLanguageType);
			...
			this.datetime1.Title = MultiLanguage.GetComment("FD", "ODMFPAYCN01", "datetime1", tLanguageType);
			this.dept.Title = MultiLanguage.GetComment("FD", "ODMFPAYCN01", "dept", tLanguageType);
			this.username.Title = MultiLanguage.GetComment("FD", "ODMFPAYCN01", "username", tLanguageType);
			this.payee.Title = MultiLanguage.GetComment("FD", "ODMFPAYCN01", "payee", tLanguageType);
			this.chkitem01.Text = MultiLanguage.GetComment("FD", "ODMFPAYCN01", "chkitem01", tLanguageType);
			this.chkitem02.Text = MultiLanguage.GetComment("FD", "ODMFPAYCN01", "chkitem02", tLanguageType);
			this.chkitem03.Text = MultiLanguage.GetComment("FD", "ODMFPAYCN01", "chkitem03", tLanguageType);
			this.chkitem04.Text = MultiLanguage.GetComment("FD", "ODMFPAYCN01", "chkitem04", tLanguageType);
			this.chkitem05.Text = MultiLanguage.GetComment("FD", "ODMFPAYCN01", "chkitem05", tLanguageType);
			this.chkother.Title = MultiLanguage.GetComment("FD", "ODMFPAYCN01", "chkother", tLanguageType);
			this.textarea1.Title = MultiLanguage.GetComment("FD", "ODMFPAYCN01", "textarea1", tLanguageType);
			this.money01.Title = MultiLanguage.GetComment("FD", "ODMFPAYCN01", "money01", tLanguageType);
			this.textarea2.Title = MultiLanguage.GetComment("FD", "ODMFPAYCN01", "textarea2", tLanguageType);
			this.money02.Title = MultiLanguage.GetComment("FD", "ODMFPAYCN01", "money02", tLanguageType);
			this.textarea3.Title = MultiLanguage.GetComment("FD", "ODMFPAYCN01", "textarea3", tLanguageType);
			this.money03.Title = MultiLanguage.GetComment("FD", "ODMFPAYCN01", "money03", tLanguageType);
			this.textarea4.Title = MultiLanguage.GetComment("FD", "ODMFPAYCN01", "textarea4", tLanguageType);
			this.money04.Title = MultiLanguage.GetComment("FD", "ODMFPAYCN01", "money04", tLanguageType);
			this.textarea5.Title = MultiLanguage.GetComment("FD", "ODMFPAYCN01", "textarea5", tLanguageType);
			this.money05.Title = MultiLanguage.GetComment("FD", "ODMFPAYCN01", "money05", tLanguageType);
			this.mtotal.Title = MultiLanguage.GetComment("FD", "ODMFPAYCN01", "mtotal", tLanguageType);
			this.chkatt01.Text = MultiLanguage.GetComment("FD", "ODMFPAYCN01", "chkatt01", tLanguageType);
			this.inv01.Title = MultiLanguage.GetComment("FD", "ODMFPAYCN01", "inv01", tLanguageType);
			this.chkatt02.Text = MultiLanguage.GetComment("FD", "ODMFPAYCN01", "chkatt02", tLanguageType);
			this.inv02.Title = MultiLanguage.GetComment("FD", "ODMFPAYCN01", "inv02", tLanguageType);
			this.chkatt03.Text = MultiLanguage.GetComment("FD", "ODMFPAYCN01", "chkatt03", tLanguageType);
			this.chkatt04.Text = MultiLanguage.GetComment("FD", "ODMFPAYCN01", "chkatt04", tLanguageType);
			this.chkatt05.Text = MultiLanguage.GetComment("FD", "ODMFPAYCN01", "chkatt05", tLanguageType);
			this.orderno.Title = MultiLanguage.GetComment("FD", "ODMFPAYCN01", "orderno", tLanguageType);
			this.attother.Title = MultiLanguage.GetComment("FD", "ODMFPAYCN01", "attother", tLanguageType);
			this.other.Text = MultiLanguage.GetComment("FD", "ODMFPAYCN01", "other", tLanguageType);
			this.payother.Title = MultiLanguage.GetComment("FD", "ODMFPAYCN01", "payother", tLanguageType);
			this.empl1.Title = MultiLanguage.GetComment("FD", "ODMFPAYCN01", "empl1", tLanguageType);
			this.empl2.Title = MultiLanguage.GetComment("FD", "ODMFPAYCN01", "empl2", tLanguageType);
			this.curr01.Title = MultiLanguage.GetComment("FD", "ODMFPAYCN01", "curr01", tLanguageType);
			this.curr02.Title = MultiLanguage.GetComment("FD", "ODMFPAYCN01", "curr02", tLanguageType);
			this.curr03.Title = MultiLanguage.GetComment("FD", "ODMFPAYCN01", "curr03", tLanguageType);
			this.curr04.Title = MultiLanguage.GetComment("FD", "ODMFPAYCN01", "curr04", tLanguageType);
			this.curr05.Title = MultiLanguage.GetComment("FD", "ODMFPAYCN01", "curr05", tLanguageType);
			this.curr06.Title = MultiLanguage.GetComment("FD", "ODMFPAYCN01", "curr06", tLanguageType);
...
this.other.Text = String.Empty;
		...
		{
			// 作業代號
			this.TaskId = "ODMFPAYCN01";
			// 表單代號
			this.formID = "ODMFPAYCN01";
...
this.kind_ctrolRadio2.Attributes.Add("onclick", "document.getElementById('MasterPage_MasterPageContent_kind_txt').value = '2';");
		...
		{
			defalutHash.Add("odmfpaycn01001", this.formID);
			defalutHash.Add("odmfpaycn01002", this.SheetNo);
...
order by resdd003 desc";
		...
		{
			pReport = "ODMFPAYCN01";
			pReportID = "ODMFPAYCN01_02";//憑證式
			pWhere = "AND (odmfpaycn01001='" + this.formID + "') AND (odmfpaycn01002='" + this.SheetNo + "')";
			pReportDirectory = "ODMFPAYCN01";
