...
function CustomerSaveCheck_Head(tStatus) {
	...
	if (tcontact.length > 0) {
		...
		if (tcontactValue.length == 0) {
			//欄位不允許空白 !
			tErr += '「' + getI18NForSpecial('FD', 'ODMPRVL01', 'contact', '../../_Common/PlatformUtil/KernelPage/I18N/I18NForJs.aspx') + '」  ' + tFieldNotFilledMsg + '\r\n';
		}
	}
	...
	if (tdatetime1.length > 0) {
		...
		if (tdatetime1Value.length == 0) {
			//欄位不允許空白 !
			tErr += '「' + getI18NForSpecial('FD', 'ODMPRVL01', 'datetime1', '../../_Common/PlatformUtil/KernelPage/I18N/I18NForJs.aspx') + '」  ' + tFieldNotFilledMsg + '\r\n';
		}
	}
	...
	if (tdept.length > 0) {
		...
		if (tdeptValue.length == 0) {
			//欄位不允許空白 !
			tErr += '「' + getI18NForSpecial('FD', 'ODMPRVL01', 'dept', '../../_Common/PlatformUtil/KernelPage/I18N/I18NForJs.aspx') + '」  ' + tFieldNotFilledMsg + '\r\n';
		}
	}
	...
	if (tmoney01.length > 0) {
		...
		if (tmoney01Value.length == 0) {
			//欄位不允許空白 !
			tErr += '「' + getI18NForSpecial('FD', 'ODMPRVL01', 'money01', '../../_Common/PlatformUtil/KernelPage/I18N/I18NForJs.aspx') + '」  ' + tFieldNotFilledMsg + '\r\n';
		}
	}
	...
	if (tmoney01.length > 0) {
		...
		if (tmoney01Value.length > 0) {
			if (!/^-?(?:\d+|\d{1,3}(?:,\d{3})+)(?:\.\d+)?$/.test(tmoney01Value)) {
				//輸入的資料不符合float數值格式 !
				tErr += '「' + getI18NForSpecial('FD', 'ODMPRVL01', 'money01', '../../_Common/PlatformUtil/KernelPage/I18N/I18NForJs.aspx') + '」  ' + tFloatErrMsg + '\r\n';
			}
			else {
	...
	if (tmoney02.length > 0) {
		...
		if (tmoney02Value.length > 0) {
			if (!/^-?(?:\d+|\d{1,3}(?:,\d{3})+)(?:\.\d+)?$/.test(tmoney02Value)) {
				//輸入的資料不符合float數值格式 !
				tErr += '「' + getI18NForSpecial('FD', 'ODMPRVL01', 'money02', '../../_Common/PlatformUtil/KernelPage/I18N/I18NForJs.aspx') + '」  ' + tFloatErrMsg + '\r\n';
			}
			else {
	...
	if (tmoney03.length > 0) {
		...
		if (tmoney03Value.length > 0) {
			if (!/^-?(?:\d+|\d{1,3}(?:,\d{3})+)(?:\.\d+)?$/.test(tmoney03Value)) {
				//輸入的資料不符合float數值格式 !
				tErr += '「' + getI18NForSpecial('FD', 'ODMPRVL01', 'money03', '../../_Common/PlatformUtil/KernelPage/I18N/I18NForJs.aspx') + '」  ' + tFloatErrMsg + '\r\n';
			}
			else {
	...
	if (tmoney04.length > 0) {
		...
		if (tmoney04Value.length > 0) {
			if (!/^-?(?:\d+|\d{1,3}(?:,\d{3})+)(?:\.\d+)?$/.test(tmoney04Value)) {
				//輸入的資料不符合float數值格式 !
				tErr += '「' + getI18NForSpecial('FD', 'ODMPRVL01', 'money04', '../../_Common/PlatformUtil/KernelPage/I18N/I18NForJs.aspx') + '」  ' + tFloatErrMsg + '\r\n';
			}
			else {
	...
	if (tmoney05.length > 0) {
		...
		if (tmoney05Value.length > 0) {
			if (!/^-?(?:\d+|\d{1,3}(?:,\d{3})+)(?:\.\d+)?$/.test(tmoney05Value)) {
				//輸入的資料不符合float數值格式 !
				tErr += '「' + getI18NForSpecial('FD', 'ODMPRVL01', 'money05', '../../_Common/PlatformUtil/KernelPage/I18N/I18NForJs.aspx') + '」  ' + tFloatErrMsg + '\r\n';
			}
			else {
	...
	if (tmoney06.length > 0) {
		...
		if (tmoney06Value.length > 0) {
			if (!/^-?(?:\d+|\d{1,3}(?:,\d{3})+)(?:\.\d+)?$/.test(tmoney06Value)) {
				//輸入的資料不符合float數值格式 !
				tErr += '「' + getI18NForSpecial('FD', 'ODMPRVL01', 'money06', '../../_Common/PlatformUtil/KernelPage/I18N/I18NForJs.aspx') + '」  ' + tFloatErrMsg + '\r\n';
			}
			else {
	...
	if (tmoney07.length > 0) {
		...
		if (tmoney07Value.length > 0) {
			if (!/^-?(?:\d+|\d{1,3}(?:,\d{3})+)(?:\.\d+)?$/.test(tmoney07Value)) {
				//輸入的資料不符合float數值格式 !
				tErr += '「' + getI18NForSpecial('FD', 'ODMPRVL01', 'money07', '../../_Common/PlatformUtil/KernelPage/I18N/I18NForJs.aspx') + '」  ' + tFloatErrMsg + '\r\n';
			}
			else {
	...
	if (tmoney08.length > 0) {
		...
		if (tmoney08Value.length > 0) {
			if (!/^-?(?:\d+|\d{1,3}(?:,\d{3})+)(?:\.\d+)?$/.test(tmoney08Value)) {
				//輸入的資料不符合float數值格式 !
				tErr += '「' + getI18NForSpecial('FD', 'ODMPRVL01', 'money08', '../../_Common/PlatformUtil/KernelPage/I18N/I18NForJs.aspx') + '」  ' + tFloatErrMsg + '\r\n';
			}
			else {
	...
	if (tmoney09.length > 0) {
		...
		if (tmoney09Value.length > 0) {
			if (!/^-?(?:\d+|\d{1,3}(?:,\d{3})+)(?:\.\d+)?$/.test(tmoney09Value)) {
				//輸入的資料不符合float數值格式 !
				tErr += '「' + getI18NForSpecial('FD', 'ODMPRVL01', 'money09', '../../_Common/PlatformUtil/KernelPage/I18N/I18NForJs.aspx') + '」  ' + tFloatErrMsg + '\r\n';
			}
			else {
	...
	if (tmoney10.length > 0) {
		...
		if (tmoney10Value.length > 0) {
			if (!/^-?(?:\d+|\d{1,3}(?:,\d{3})+)(?:\.\d+)?$/.test(tmoney10Value)) {
				//輸入的資料不符合float數值格式 !
				tErr += '「' + getI18NForSpecial('FD', 'ODMPRVL01', 'money10', '../../_Common/PlatformUtil/KernelPage/I18N/I18NForJs.aspx') + '」  ' + tFloatErrMsg + '\r\n';
			}
			else {
	...
	if (tpayee01.length > 0) {
		...
		if (tpayee01Value.length == 0) {
			//欄位不允許空白 !
			tErr += '「' + getI18NForSpecial('FD', 'ODMPRVL01', 'payee01', '../../_Common/PlatformUtil/KernelPage/I18N/I18NForJs.aspx') + '」  ' + tFieldNotFilledMsg + '\r\n';
		}
	}
	...
	if (tpermoney01.length > 0) {
		...
		if (tpermoney01Value.length == 0) {
			//欄位不允許空白 !
			tErr += '「' + getI18NForSpecial('FD', 'ODMPRVL01', 'permoney01', '../../_Common/PlatformUtil/KernelPage/I18N/I18NForJs.aspx') + '」  ' + tFieldNotFilledMsg + '\r\n';
		}
	}
	...
	if (tpermoney01.length > 0) {
		...
		if (tpermoney01Value.length > 0) {
			if (!/^-?(?:\d+|\d{1,3}(?:,\d{3})+)(?:\.\d+)?$/.test(tpermoney01Value)) {
				//輸入的資料不符合float數值格式 !
				tErr += '「' + getI18NForSpecial('FD', 'ODMPRVL01', 'permoney01', '../../_Common/PlatformUtil/KernelPage/I18N/I18NForJs.aspx') + '」  ' + tFloatErrMsg + '\r\n';
			}
			else {
	...
	if (tpermoney02.length > 0) {
		...
		if (tpermoney02Value.length > 0) {
			if (!/^-?(?:\d+|\d{1,3}(?:,\d{3})+)(?:\.\d+)?$/.test(tpermoney02Value)) {
				//輸入的資料不符合float數值格式 !
				tErr += '「' + getI18NForSpecial('FD', 'ODMPRVL01', 'permoney02', '../../_Common/PlatformUtil/KernelPage/I18N/I18NForJs.aspx') + '」  ' + tFloatErrMsg + '\r\n';
			}
			else {
	...
	if (tpermoney03.length > 0) {
		...
		if (tpermoney03Value.length > 0) {
			if (!/^-?(?:\d+|\d{1,3}(?:,\d{3})+)(?:\.\d+)?$/.test(tpermoney03Value)) {
				//輸入的資料不符合float數值格式 !
				tErr += '「' + getI18NForSpecial('FD', 'ODMPRVL01', 'permoney03', '../../_Common/PlatformUtil/KernelPage/I18N/I18NForJs.aspx') + '」  ' + tFloatErrMsg + '\r\n';
			}
			else {
	...
	if (tpermoney04.length > 0) {
		...
		if (tpermoney04Value.length > 0) {
			if (!/^-?(?:\d+|\d{1,3}(?:,\d{3})+)(?:\.\d+)?$/.test(tpermoney04Value)) {
				//輸入的資料不符合float數值格式 !
				tErr += '「' + getI18NForSpecial('FD', 'ODMPRVL01', 'permoney04', '../../_Common/PlatformUtil/KernelPage/I18N/I18NForJs.aspx') + '」  ' + tFloatErrMsg + '\r\n';
			}
			else {
	...
	if (tpermoney05.length > 0) {
		...
		if (tpermoney05Value.length > 0) {
			if (!/^-?(?:\d+|\d{1,3}(?:,\d{3})+)(?:\.\d+)?$/.test(tpermoney05Value)) {
				//輸入的資料不符合float數值格式 !
				tErr += '「' + getI18NForSpecial('FD', 'ODMPRVL01', 'permoney05', '../../_Common/PlatformUtil/KernelPage/I18N/I18NForJs.aspx') + '」  ' + tFloatErrMsg + '\r\n';
			}
			else {
	...
	if (tpermoney06.length > 0) {
		...
		if (tpermoney06Value.length > 0) {
			if (!/^-?(?:\d+|\d{1,3}(?:,\d{3})+)(?:\.\d+)?$/.test(tpermoney06Value)) {
				//輸入的資料不符合float數值格式 !
				tErr += '「' + getI18NForSpecial('FD', 'ODMPRVL01', 'permoney06', '../../_Common/PlatformUtil/KernelPage/I18N/I18NForJs.aspx') + '」  ' + tFloatErrMsg + '\r\n';
			}
			else {
	...
	if (tpermoney07.length > 0) {
		...
		if (tpermoney07Value.length > 0) {
			if (!/^-?(?:\d+|\d{1,3}(?:,\d{3})+)(?:\.\d+)?$/.test(tpermoney07Value)) {
				//輸入的資料不符合float數值格式 !
				tErr += '「' + getI18NForSpecial('FD', 'ODMPRVL01', 'permoney07', '../../_Common/PlatformUtil/KernelPage/I18N/I18NForJs.aspx') + '」  ' + tFloatErrMsg + '\r\n';
			}
			else {
	...
	if (tpermoney08.length > 0) {
		...
		if (tpermoney08Value.length > 0) {
			if (!/^-?(?:\d+|\d{1,3}(?:,\d{3})+)(?:\.\d+)?$/.test(tpermoney08Value)) {
				//輸入的資料不符合float數值格式 !
				tErr += '「' + getI18NForSpecial('FD', 'ODMPRVL01', 'permoney08', '../../_Common/PlatformUtil/KernelPage/I18N/I18NForJs.aspx') + '」  ' + tFloatErrMsg + '\r\n';
			}
			else {
	...
	if (tpermoney09.length > 0) {
		...
		if (tpermoney09Value.length > 0) {
			if (!/^-?(?:\d+|\d{1,3}(?:,\d{3})+)(?:\.\d+)?$/.test(tpermoney09Value)) {
				//輸入的資料不符合float數值格式 !
				tErr += '「' + getI18NForSpecial('FD', 'ODMPRVL01', 'permoney09', '../../_Common/PlatformUtil/KernelPage/I18N/I18NForJs.aspx') + '」  ' + tFloatErrMsg + '\r\n';
			}
			else {
	...
	if (tpermoney10.length > 0) {
		...
		if (tpermoney10Value.length > 0) {
			if (!/^-?(?:\d+|\d{1,3}(?:,\d{3})+)(?:\.\d+)?$/.test(tpermoney10Value)) {
				//輸入的資料不符合float數值格式 !
				tErr += '「' + getI18NForSpecial('FD', 'ODMPRVL01', 'permoney10', '../../_Common/PlatformUtil/KernelPage/I18N/I18NForJs.aspx') + '」  ' + tFloatErrMsg + '\r\n';
			}
			else {
	...
	if (tqty01.length > 0) {
		...
		if (tqty01Value.length == 0) {
			//欄位不允許空白 !
			tErr += '「' + getI18NForSpecial('FD', 'ODMPRVL01', 'qty01', '../../_Common/PlatformUtil/KernelPage/I18N/I18NForJs.aspx') + '」  ' + tFieldNotFilledMsg + '\r\n';
		}
	}
	...
	if (tqty01.length > 0) {
		...
		if (tqty01Value.length > 0) {
			if (!/^-?(?:\d+|\d{1,3}(?:,\d{3})+)(?:\.\d+)?$/.test(tqty01Value)) {
				//輸入的資料不符合float數值格式 !
				tErr += '「' + getI18NForSpecial('FD', 'ODMPRVL01', 'qty01', '../../_Common/PlatformUtil/KernelPage/I18N/I18NForJs.aspx') + '」  ' + tFloatErrMsg + '\r\n';
			}
			else {
	...
	if (tqty02.length > 0) {
		...
		if (tqty02Value.length > 0) {
			if (!/^-?(?:\d+|\d{1,3}(?:,\d{3})+)(?:\.\d+)?$/.test(tqty02Value)) {
				//輸入的資料不符合float數值格式 !
				tErr += '「' + getI18NForSpecial('FD', 'ODMPRVL01', 'qty02', '../../_Common/PlatformUtil/KernelPage/I18N/I18NForJs.aspx') + '」  ' + tFloatErrMsg + '\r\n';
			}
			else {
	...
	if (tqty03.length > 0) {
		...
		if (tqty03Value.length > 0) {
			if (!/^-?(?:\d+|\d{1,3}(?:,\d{3})+)(?:\.\d+)?$/.test(tqty03Value)) {
				//輸入的資料不符合float數值格式 !
				tErr += '「' + getI18NForSpecial('FD', 'ODMPRVL01', 'qty03', '../../_Common/PlatformUtil/KernelPage/I18N/I18NForJs.aspx') + '」  ' + tFloatErrMsg + '\r\n';
			}
			else {
	...
	if (tqty04.length > 0) {
		...
		if (tqty04Value.length > 0) {
			if (!/^-?(?:\d+|\d{1,3}(?:,\d{3})+)(?:\.\d+)?$/.test(tqty04Value)) {
				//輸入的資料不符合float數值格式 !
				tErr += '「' + getI18NForSpecial('FD', 'ODMPRVL01', 'qty04', '../../_Common/PlatformUtil/KernelPage/I18N/I18NForJs.aspx') + '」  ' + tFloatErrMsg + '\r\n';
			}
			else {
	...
	if (tqty05.length > 0) {
		...
		if (tqty05Value.length > 0) {
			if (!/^-?(?:\d+|\d{1,3}(?:,\d{3})+)(?:\.\d+)?$/.test(tqty05Value)) {
				//輸入的資料不符合float數值格式 !
				tErr += '「' + getI18NForSpecial('FD', 'ODMPRVL01', 'qty05', '../../_Common/PlatformUtil/KernelPage/I18N/I18NForJs.aspx') + '」  ' + tFloatErrMsg + '\r\n';
			}
			else {
	...
	if (tqty06.length > 0) {
		...
		if (tqty06Value.length > 0) {
			if (!/^-?(?:\d+|\d{1,3}(?:,\d{3})+)(?:\.\d+)?$/.test(tqty06Value)) {
				//輸入的資料不符合float數值格式 !
				tErr += '「' + getI18NForSpecial('FD', 'ODMPRVL01', 'qty06', '../../_Common/PlatformUtil/KernelPage/I18N/I18NForJs.aspx') + '」  ' + tFloatErrMsg + '\r\n';
			}
			else {
	...
	if (tqty07.length > 0) {
		...
		if (tqty07Value.length > 0) {
			if (!/^-?(?:\d+|\d{1,3}(?:,\d{3})+)(?:\.\d+)?$/.test(tqty07Value)) {
				//輸入的資料不符合float數值格式 !
				tErr += '「' + getI18NForSpecial('FD', 'ODMPRVL01', 'qty07', '../../_Common/PlatformUtil/KernelPage/I18N/I18NForJs.aspx') + '」  ' + tFloatErrMsg + '\r\n';
			}
			else {
	...
	if (tqty08.length > 0) {
		...
		if (tqty08Value.length > 0) {
			if (!/^-?(?:\d+|\d{1,3}(?:,\d{3})+)(?:\.\d+)?$/.test(tqty08Value)) {
				//輸入的資料不符合float數值格式 !
				tErr += '「' + getI18NForSpecial('FD', 'ODMPRVL01', 'qty08', '../../_Common/PlatformUtil/KernelPage/I18N/I18NForJs.aspx') + '」  ' + tFloatErrMsg + '\r\n';
			}
			else {
	...
	if (tqty09.length > 0) {
		...
		if (tqty09Value.length > 0) {
			if (!/^-?(?:\d+|\d{1,3}(?:,\d{3})+)(?:\.\d+)?$/.test(tqty09Value)) {
				//輸入的資料不符合float數值格式 !
				tErr += '「' + getI18NForSpecial('FD', 'ODMPRVL01', 'qty09', '../../_Common/PlatformUtil/KernelPage/I18N/I18NForJs.aspx') + '」  ' + tFloatErrMsg + '\r\n';
			}
			else {
	...
	if (tqty10.length > 0) {
		...
		if (tqty10Value.length > 0) {
			if (!/^-?(?:\d+|\d{1,3}(?:,\d{3})+)(?:\.\d+)?$/.test(tqty10Value)) {
				//輸入的資料不符合float數值格式 !
				tErr += '「' + getI18NForSpecial('FD', 'ODMPRVL01', 'qty10', '../../_Common/PlatformUtil/KernelPage/I18N/I18NForJs.aspx') + '」  ' + tFloatErrMsg + '\r\n';
			}
			else {
	...
	if (ttotalmoney.length > 0) {
		...
		if (ttotalmoneyValue.length > 0) {
			if (!/^-?(?:\d+|\d{1,3}(?:,\d{3})+)(?:\.\d+)?$/.test(ttotalmoneyValue)) {
				//輸入的資料不符合float數值格式 !
				tErr += '「' + getI18NForSpecial('FD', 'ODMPRVL01', 'totalmoney', '../../_Common/PlatformUtil/KernelPage/I18N/I18NForJs.aspx') + '」  ' + tFloatErrMsg + '\r\n';
			}
			else {
	...
	if ($('#MasterPage_MasterPageContent_' + pNumberContrlID + '_txt').length > 0 && $('#MasterPage_MasterPageContent_' + pNumberContrlID + '_txt').is(':visible')) {
		...
		if (tControlNumValue.length > 0) {
			if (isNaN(tControlNumValue)) {
				...
				tControlNumValue = tw.com.dsc.easyflowDotNet.forms.ODMPRVL01.ajaxGetFixedNum(tControlNumValue, pDecimalPlaces).value;
			...
			var tControlWordValue = tw.com.dsc.easyflowDotNet.forms.ODMPRVL01.ajaxGetMoneyWord(tControlNumValue).value;
...
function jsDoDispatch(pFormID, pSheetNo, pDispatchFormID) {
	...
	if (window.confirm(tConfirmSTR.split('[')[0].toString() + "\r\n\r\n" + tConfirmSTR.split('[')[1].toString())) {
		var bResult = tw.com.dsc.easyflowDotNet.forms.ODMPRVL01.ajaxDoDispatchForm(pFormID, pSheetNo, pDispatchFormID).value;
