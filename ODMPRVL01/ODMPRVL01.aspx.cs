...
namespace tw.com.dsc.easyflowDotNet.forms
{
    ...
    /// ODMPRVL01 的摘要描述。
    /// </summary>
    public partial class ODMPRVL01 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
    {
        //edit by teppy 2011/02/08 Start
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            AjaxPro.Utility.RegisterTypeForAjax(typeof(ODMPRVL01));
            UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
            string tLanguageType = tClass.Language;

            //多國語系
            this.Title = MultiLanguage.GetComment("FD", "ODMPRVL01", "lblTitle", this.UserInfo.Language);
            string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ODMPRVL01", "HeadTabStrip01", tLanguageType);
            ...
            this.dept.Title = MultiLanguage.GetComment("FD", "ODMPRVL01", "dept", tLanguageType);
            this.datetime1.Title = MultiLanguage.GetComment("FD", "ODMPRVL01", "datetime1", tLanguageType);
            this.username.Title = MultiLanguage.GetComment("FD", "ODMPRVL01", "username", tLanguageType);
            this.contact.Title = MultiLanguage.GetComment("FD", "ODMPRVL01", "contact", tLanguageType);
            this.payee01.Title = MultiLanguage.GetComment("FD", "ODMPRVL01", "payee01", tLanguageType);
            this.permoney01.Title = MultiLanguage.GetComment("FD", "ODMPRVL01", "permoney01", tLanguageType);
            this.qty01.Title = MultiLanguage.GetComment("FD", "ODMPRVL01", "qty01", tLanguageType);
            this.money01.Title = MultiLanguage.GetComment("FD", "ODMPRVL01", "money01", tLanguageType);
            this.payee02.Title = MultiLanguage.GetComment("FD", "ODMPRVL01", "payee02", tLanguageType);
            this.permoney02.Title = MultiLanguage.GetComment("FD", "ODMPRVL01", "permoney02", tLanguageType);
            this.qty02.Title = MultiLanguage.GetComment("FD", "ODMPRVL01", "qty02", tLanguageType);
            this.money02.Title = MultiLanguage.GetComment("FD", "ODMPRVL01", "money02", tLanguageType);
            this.payee03.Title = MultiLanguage.GetComment("FD", "ODMPRVL01", "payee03", tLanguageType);
            this.permoney03.Title = MultiLanguage.GetComment("FD", "ODMPRVL01", "permoney03", tLanguageType);
            this.qty03.Title = MultiLanguage.GetComment("FD", "ODMPRVL01", "qty03", tLanguageType);
            this.money03.Title = MultiLanguage.GetComment("FD", "ODMPRVL01", "money03", tLanguageType);
            this.payee04.Title = MultiLanguage.GetComment("FD", "ODMPRVL01", "payee04", tLanguageType);
            this.permoney04.Title = MultiLanguage.GetComment("FD", "ODMPRVL01", "permoney04", tLanguageType);
            this.qty04.Title = MultiLanguage.GetComment("FD", "ODMPRVL01", "qty04", tLanguageType);
            this.money04.Title = MultiLanguage.GetComment("FD", "ODMPRVL01", "money04", tLanguageType);
            this.payee05.Title = MultiLanguage.GetComment("FD", "ODMPRVL01", "payee05", tLanguageType);
            this.permoney05.Title = MultiLanguage.GetComment("FD", "ODMPRVL01", "permoney05", tLanguageType);
            this.qty05.Title = MultiLanguage.GetComment("FD", "ODMPRVL01", "qty05", tLanguageType);
            this.money05.Title = MultiLanguage.GetComment("FD", "ODMPRVL01", "money05", tLanguageType);
            this.payee06.Title = MultiLanguage.GetComment("FD", "ODMPRVL01", "payee06", tLanguageType);
            this.permoney06.Title = MultiLanguage.GetComment("FD", "ODMPRVL01", "permoney06", tLanguageType);
            this.qty06.Title = MultiLanguage.GetComment("FD", "ODMPRVL01", "qty06", tLanguageType);
            this.money06.Title = MultiLanguage.GetComment("FD", "ODMPRVL01", "money06", tLanguageType);
            this.payee07.Title = MultiLanguage.GetComment("FD", "ODMPRVL01", "payee07", tLanguageType);
            this.permoney07.Title = MultiLanguage.GetComment("FD", "ODMPRVL01", "permoney07", tLanguageType);
            this.qty07.Title = MultiLanguage.GetComment("FD", "ODMPRVL01", "qty07", tLanguageType);
            this.money07.Title = MultiLanguage.GetComment("FD", "ODMPRVL01", "money07", tLanguageType);
            this.payee08.Title = MultiLanguage.GetComment("FD", "ODMPRVL01", "payee08", tLanguageType);
            this.permoney08.Title = MultiLanguage.GetComment("FD", "ODMPRVL01", "permoney08", tLanguageType);
            this.qty08.Title = MultiLanguage.GetComment("FD", "ODMPRVL01", "qty08", tLanguageType);
            this.money08.Title = MultiLanguage.GetComment("FD", "ODMPRVL01", "money08", tLanguageType);
            this.payee09.Title = MultiLanguage.GetComment("FD", "ODMPRVL01", "payee09", tLanguageType);
            this.permoney09.Title = MultiLanguage.GetComment("FD", "ODMPRVL01", "permoney09", tLanguageType);
            this.qty09.Title = MultiLanguage.GetComment("FD", "ODMPRVL01", "qty09", tLanguageType);
            this.money09.Title = MultiLanguage.GetComment("FD", "ODMPRVL01", "money09", tLanguageType);
            this.payee10.Title = MultiLanguage.GetComment("FD", "ODMPRVL01", "payee10", tLanguageType);
            this.permoney10.Title = MultiLanguage.GetComment("FD", "ODMPRVL01", "permoney10", tLanguageType);
            this.qty10.Title = MultiLanguage.GetComment("FD", "ODMPRVL01", "qty10", tLanguageType);
            this.money10.Title = MultiLanguage.GetComment("FD", "ODMPRVL01", "money10", tLanguageType);
            this.totalmoney.Title = MultiLanguage.GetComment("FD", "ODMPRVL01", "totalmoney", tLanguageType);
            this.superid.Title = MultiLanguage.GetComment("FD", "ODMPRVL01", "superid", tLanguageType);
        ...
        {
            // 作業代號
            this.TaskId = "ODMPRVL01";
            // 表單代號
            this.formID = "ODMPRVL01";
...
where resfc001=@resfc001 and resfc002=@resfc002 and resfc003=@resfc003 and ISNULL(resfc004,'')<>''";
        ...
        {
            defalutHash.Add("odmprvl01001", this.formID);
            defalutHash.Add("odmprvl01002", this.SheetNo);
...
order by resdd003 desc";
        ...
        {
            pReport = "ODMPRVL01";
            pReportID = "ODMPRVL01_02";//憑證式
            pWhere = "AND (odmprvl01001='" + this.formID + "') AND (odmprvl01002='" + this.SheetNo + "')";
            pReportDirectory = "ODMPRVL01";
