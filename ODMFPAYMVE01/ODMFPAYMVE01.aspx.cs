...
namespace tw.com.dsc.easyflowDotNet.forms
{
    ...
    /// ODMFPAYMVE01 的摘要描述。
    /// </summary>
    public partial class ODMFPAYMVE01 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
    {
        //edit by teppy 2011/02/08 Start
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            AjaxPro.Utility.RegisterTypeForAjax(typeof(ODMFPAYMVE01));
            UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
            string tLanguageType = tClass.Language;

            //多國語系
            this.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE01", "lblTitle", this.UserInfo.Language);
            string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ODMFPAYMVE01", "HeadTabStrip01", tLanguageType);
            ...
            this.datetime1.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE01", "datetime1", tLanguageType);
            this.dept.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE01", "dept", tLanguageType);
            this.username.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE01", "username", tLanguageType);
            this.payee.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE01", "payee", tLanguageType);
            this.chkitem01.Text = MultiLanguage.GetComment("FD", "ODMFPAYMVE01", "chkitem01", tLanguageType);
            this.chkitem02.Text = MultiLanguage.GetComment("FD", "ODMFPAYMVE01", "chkitem02", tLanguageType);
            this.chkitem03.Text = MultiLanguage.GetComment("FD", "ODMFPAYMVE01", "chkitem03", tLanguageType);
            this.chkitem04.Text = MultiLanguage.GetComment("FD", "ODMFPAYMVE01", "chkitem04", tLanguageType);
            this.chkitem05.Text = MultiLanguage.GetComment("FD", "ODMFPAYMVE01", "chkitem05", tLanguageType);
            this.chkother.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE01", "chkother", tLanguageType);
            this.textarea1.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE01", "textarea1", tLanguageType);
            this.money01.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE01", "money01", tLanguageType);
            this.textarea2.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE01", "textarea2", tLanguageType);
            this.money02.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE01", "money02", tLanguageType);
            this.textarea3.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE01", "textarea3", tLanguageType);
            this.money03.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE01", "money03", tLanguageType);
            this.textarea4.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE01", "textarea4", tLanguageType);
            this.money04.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE01", "money04", tLanguageType);
            this.textarea5.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE01", "textarea5", tLanguageType);
            this.money05.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE01", "money05", tLanguageType);
            this.mtotal.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE01", "mtotal", tLanguageType);
            this.chkatt01.Text = MultiLanguage.GetComment("FD", "ODMFPAYMVE01", "chkatt01", tLanguageType);
            this.inv01.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE01", "inv01", tLanguageType);
            this.chkatt02.Text = MultiLanguage.GetComment("FD", "ODMFPAYMVE01", "chkatt02", tLanguageType);
            this.inv02.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE01", "inv02", tLanguageType);
            this.chkatt03.Text = MultiLanguage.GetComment("FD", "ODMFPAYMVE01", "chkatt03", tLanguageType);
            this.chkatt04.Text = MultiLanguage.GetComment("FD", "ODMFPAYMVE01", "chkatt04", tLanguageType);
            this.chkatt05.Text = MultiLanguage.GetComment("FD", "ODMFPAYMVE01", "chkatt05", tLanguageType);
            this.orderno.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE01", "orderno", tLanguageType);
            this.attother.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE01", "attother", tLanguageType);
            this.other.Text = MultiLanguage.GetComment("FD", "ODMFPAYMVE01", "other", tLanguageType);
            this.payother.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE01", "payother", tLanguageType);
            this.empl1.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE01", "empl1", tLanguageType);
            this.empl2.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE01", "empl2", tLanguageType);
            this.paydate.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE01", "paydate", tLanguageType);
            this.cur01.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE01", "cur01", tLanguageType);
            this.cur03.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE01", "cur03", tLanguageType);
            this.cur02.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE01", "cur02", tLanguageType);
            this.cur04.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE01", "cur04", tLanguageType);
            this.cur05.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE01", "cur05", tLanguageType);
            this.curr.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE01", "curr", tLanguageType);
        ...
        {
            // 作業代號
            this.TaskId = "ODMFPAYMVE01";
            // 表單代號
            this.formID = "ODMFPAYMVE01";
...
where resfc001=@resfc001 and resfc002=@resfc002 and resfc003=@resfc003 and ISNULL(resfc004,'')<>''";
        ...
        protected override void settingClientFunction()
        {
            ...
            #region //^_^ 20230216 edit by 16386 tingwei 0000256084_38_0001
            //三位一撇
        ...
        {
            defalutHash.Add("odmfpaymve01001", this.formID);
            defalutHash.Add("odmfpaymve01002", this.SheetNo);
            ...
            defalutHash.Add("cur01", "VND");
            defalutHash.Add("cur03", "VND");
            defalutHash.Add("cur02", "VND");
            defalutHash.Add("cur04", "VND");
            defalutHash.Add("cur05", "VND");
            defalutHash.Add("curr", "VND");

            //^_^ 20230216 edit by 16386 tingwei 0000256084_38_0001↓
            defalutHash.Add("money01", "0");
            defalutHash.Add("money02", "0");
            defalutHash.Add("money03", "0");
            defalutHash.Add("money04", "0");
            defalutHash.Add("money05", "0");
            //^_^ 20230216 edit by 16386 tingwei 0000256084_38_0001↑
...
order by resdd003 desc";
        ...
        {
            pReport = "ODMFPAYMVE01";
            pReportID = "ODMFPAYMVE01_02";//憑證式
            pWhere = "AND (odmfpaymve01001='" + this.formID + "') AND (odmfpaymve01002='" + this.SheetNo + "')";
            pReportDirectory = "ODMFPAYMVE01";
