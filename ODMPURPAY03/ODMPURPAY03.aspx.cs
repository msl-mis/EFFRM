...
namespace tw.com.dsc.easyflowDotNet.forms
{
	...
	/// ODMPURPAY03 的摘要描述。
	/// </summary>
	public partial class ODMPURPAY03 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
	{
		//edit by teppy 2011/02/08 Start
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			AjaxPro.Utility.RegisterTypeForAjax(typeof(ODMPURPAY03));
			UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
			string tLanguageType = tClass.Language;

			//多國語系
			this.Title= MultiLanguage.GetComment("FD","ODMPURPAY03","lblTitle",this.UserInfo.Language);
			string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ODMPURPAY03", "HeadTabStrip01", tLanguageType);
			...
			this.txtuser.Title = MultiLanguage.GetComment("FD", "ODMPURPAY03", "txtuser", tLanguageType);
			this.usedate.Title = MultiLanguage.GetComment("FD", "ODMPURPAY03", "usedate", tLanguageType);
			this.querypurno.Title = MultiLanguage.GetComment("FD", "ODMPURPAY03", "querypurno", tLanguageType);
			this.na003.Title = MultiLanguage.GetComment("FD", "ODMPURPAY03", "na003", tLanguageType);
			this.tc027.Title = MultiLanguage.GetComment("FD", "ODMPURPAY03", "tc027", tLanguageType);
			this.paydate.Title = MultiLanguage.GetComment("FD", "ODMPURPAY03", "paydate", tLanguageType);
			this.ma001.Title = MultiLanguage.GetComment("FD", "ODMPURPAY03", "ma001", tLanguageType);
			this.ma002.Title = MultiLanguage.GetComment("FD", "ODMPURPAY03", "ma002", tLanguageType);
			this.tc005.Title = MultiLanguage.GetComment("FD", "ODMPURPAY03", "tc005", tLanguageType);
			this.totalamt.Title = MultiLanguage.GetComment("FD", "ODMPURPAY03", "totalamt", tLanguageType);
			this.txtnote.Title = MultiLanguage.GetComment("FD", "ODMPURPAY03", "txtnote", tLanguageType);
			this.txtother.Title = MultiLanguage.GetComment("FD", "ODMPURPAY03", "txtother", tLanguageType);
			this.querypurno01.Title = MultiLanguage.GetComment("FD", "ODMPURPAY03", "querypurno01", tLanguageType);
			this.querypurno02.Title = MultiLanguage.GetComment("FD", "ODMPURPAY03", "querypurno02", tLanguageType);
			this.querypurno03.Title = MultiLanguage.GetComment("FD", "ODMPURPAY03", "querypurno03", tLanguageType);
			this.tc027_01.Title = MultiLanguage.GetComment("FD", "ODMPURPAY03", "tc027_01", tLanguageType);
			this.tc027_02.Title = MultiLanguage.GetComment("FD", "ODMPURPAY03", "tc027_02", tLanguageType);
			this.tc027_03.Title = MultiLanguage.GetComment("FD", "ODMPURPAY03", "tc027_03", tLanguageType);
			this.na003_01.Title = MultiLanguage.GetComment("FD", "ODMPURPAY03", "na003_01", tLanguageType);
			this.na003_02.Title = MultiLanguage.GetComment("FD", "ODMPURPAY03", "na003_02", tLanguageType);
			this.na003_03.Title = MultiLanguage.GetComment("FD", "ODMPURPAY03", "na003_03", tLanguageType);
			this.paydate01.Title = MultiLanguage.GetComment("FD", "ODMPURPAY03", "paydate01", tLanguageType);
			this.paydate02.Title = MultiLanguage.GetComment("FD", "ODMPURPAY03", "paydate02", tLanguageType);
			this.paydate03.Title = MultiLanguage.GetComment("FD", "ODMPURPAY03", "paydate03", tLanguageType);
			this.ma001_01.Title = MultiLanguage.GetComment("FD", "ODMPURPAY03", "ma001_01", tLanguageType);
			this.ma001_02.Title = MultiLanguage.GetComment("FD", "ODMPURPAY03", "ma001_02", tLanguageType);
			this.ma001_03.Title = MultiLanguage.GetComment("FD", "ODMPURPAY03", "ma001_03", tLanguageType);
			this.ma002_01.Title = MultiLanguage.GetComment("FD", "ODMPURPAY03", "ma002_01", tLanguageType);
			this.ma002_02.Title = MultiLanguage.GetComment("FD", "ODMPURPAY03", "ma002_02", tLanguageType);
			this.ma002_03.Title = MultiLanguage.GetComment("FD", "ODMPURPAY03", "ma002_03", tLanguageType);
			this.tc005_01.Title = MultiLanguage.GetComment("FD", "ODMPURPAY03", "tc005_01", tLanguageType);
			this.tc005_02.Title = MultiLanguage.GetComment("FD", "ODMPURPAY03", "tc005_02", tLanguageType);
			this.tc005_03.Title = MultiLanguage.GetComment("FD", "ODMPURPAY03", "tc005_03", tLanguageType);
			this.txtamt.Title = MultiLanguage.GetComment("FD", "ODMPURPAY03", "txtamt", tLanguageType);
			this.txtamt01.Title = MultiLanguage.GetComment("FD", "ODMPURPAY03", "txtamt01", tLanguageType);
			this.txtamt02.Title = MultiLanguage.GetComment("FD", "ODMPURPAY03", "txtamt02", tLanguageType);
			this.txtamt03.Title = MultiLanguage.GetComment("FD", "ODMPURPAY03", "txtamt03", tLanguageType);
...
this.na003_03.ToolTip = this.na003_03.Text;
		...
		{
			// 作業代號
			this.TaskId = "ODMPURPAY03";
			// 表單代號
			this.formID = "ODMPURPAY03";
...
this.rddept_ctrolRadio1.Attributes.Add("onclick", "document.getElementById('MasterPage_MasterPageContent_rddept_txt').value = '1';");
		...
		{
			defalutHash.Add("odmpurpay03001", this.formID);
			defalutHash.Add("odmpurpay03002", this.SheetNo);
...
order by resdd003 desc";
		...
		protected override void ReGetCondValue(object[,] pAryCondValue)
		{
			...
			tDbl=0;
			try{
				tDbl = double.Parse(this.totalamt.Value.Trim());
			}
			catch(Exception e){
				tDbl=0;
			}
			pAryCondValue[0, 3] = "totalamt";
		...
		{
			pReport = "ODMPURPAY03";
			pReportID = "ODMPURPAY03_02";//憑證式
			pWhere = "AND (odmpurpay03001='" + this.formID + "') AND (odmpurpay03002='" + this.SheetNo + "')";
			pReportDirectory = "ODMPURPAY03";
