...
namespace tw.com.dsc.easyflowDotNet.forms
{
	...
	/// ODMMRRPCN01 的摘要描述。
	/// </summary>
	public partial class ODMMRRPCN01 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
	{
		//edit by teppy 2011/02/08 Start
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			AjaxPro.Utility.RegisterTypeForAjax(typeof(ODMMRRPCN01));
			UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
			string tLanguageType = tClass.Language;

			//多國語系
			this.Title= MultiLanguage.GetComment("FD","ODMMRRPCN01","lblTitle",this.UserInfo.Language);
			string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ODMMRRPCN01", "HeadTabStrip01", tLanguageType);
			...
			this.txtno.Title = MultiLanguage.GetComment("FD", "ODMMRRPCN01", "txtno", tLanguageType);
			this.date.Title = MultiLanguage.GetComment("FD", "ODMMRRPCN01", "date", tLanguageType);
			this.txtuser.Title = MultiLanguage.GetComment("FD", "ODMMRRPCN01", "txtuser", tLanguageType);
			this.txtmain.Title = MultiLanguage.GetComment("FD", "ODMMRRPCN01", "txtmain", tLanguageType);
			this.areadescp.Title = MultiLanguage.GetComment("FD", "ODMMRRPCN01", "areadescp", tLanguageType);
			this.txtdept.Title = MultiLanguage.GetComment("FD", "ODMMRRPCN01", "txtdept", tLanguageType);
			this.queryno.Title = MultiLanguage.GetComment("FD", "ODMMRRPCN01", "queryno", tLanguageType);
			this.dept.Title = MultiLanguage.GetComment("FD", "ODMMRRPCN01", "dept", tLanguageType);
			this.txtpunish.Title = MultiLanguage.GetComment("FD", "ODMMRRPCN01", "txtpunish", tLanguageType);
			this.txtamt.Title = MultiLanguage.GetComment("FD", "ODMMRRPCN01", "txtamt", tLanguageType);
			this.queryno01.Title = MultiLanguage.GetComment("FD", "ODMMRRPCN01", "queryno01", tLanguageType);
			this.dept01.Title = MultiLanguage.GetComment("FD", "ODMMRRPCN01", "dept01", tLanguageType);
			this.txtpunish01.Title = MultiLanguage.GetComment("FD", "ODMMRRPCN01", "txtpunish01", tLanguageType);
			this.txtpunish02.Title = MultiLanguage.GetComment("FD", "ODMMRRPCN01", "txtpunish02", tLanguageType);
			this.dept02.Title = MultiLanguage.GetComment("FD", "ODMMRRPCN01", "dept02", tLanguageType);
			this.txtamt01.Title = MultiLanguage.GetComment("FD", "ODMMRRPCN01", "txtamt01", tLanguageType);
			this.txtamt02.Title = MultiLanguage.GetComment("FD", "ODMMRRPCN01", "txtamt02", tLanguageType);
			this.queryno02.Title = MultiLanguage.GetComment("FD", "ODMMRRPCN01", "queryno02", tLanguageType);
			this.name.Title = MultiLanguage.GetComment("FD", "ODMMRRPCN01", "name", tLanguageType);
			this.name01.Title = MultiLanguage.GetComment("FD", "ODMMRRPCN01", "name01", tLanguageType);
			this.name02.Title = MultiLanguage.GetComment("FD", "ODMMRRPCN01", "name02", tLanguageType);
			this.queryno03.Title = MultiLanguage.GetComment("FD", "ODMMRRPCN01", "queryno03", tLanguageType);
			this.name03.Title = MultiLanguage.GetComment("FD", "ODMMRRPCN01", "name03", tLanguageType);
			this.name04.Title = MultiLanguage.GetComment("FD", "ODMMRRPCN01", "name04", tLanguageType);
			this.name05.Title = MultiLanguage.GetComment("FD", "ODMMRRPCN01", "name05", tLanguageType);
			this.name06.Title = MultiLanguage.GetComment("FD", "ODMMRRPCN01", "name06", tLanguageType);
			this.name07.Title = MultiLanguage.GetComment("FD", "ODMMRRPCN01", "name07", tLanguageType);
			this.dept03.Title = MultiLanguage.GetComment("FD", "ODMMRRPCN01", "dept03", tLanguageType);
			this.txtpunish03.Title = MultiLanguage.GetComment("FD", "ODMMRRPCN01", "txtpunish03", tLanguageType);
			this.txtamt03.Title = MultiLanguage.GetComment("FD", "ODMMRRPCN01", "txtamt03", tLanguageType);
			this.queryno04.Title = MultiLanguage.GetComment("FD", "ODMMRRPCN01", "queryno04", tLanguageType);
			this.queryno05.Title = MultiLanguage.GetComment("FD", "ODMMRRPCN01", "queryno05", tLanguageType);
			this.queryno06.Title = MultiLanguage.GetComment("FD", "ODMMRRPCN01", "queryno06", tLanguageType);
			this.queryno07.Title = MultiLanguage.GetComment("FD", "ODMMRRPCN01", "queryno07", tLanguageType);
			this.dept04.Title = MultiLanguage.GetComment("FD", "ODMMRRPCN01", "dept04", tLanguageType);
			this.dept05.Title = MultiLanguage.GetComment("FD", "ODMMRRPCN01", "dept05", tLanguageType);
			this.dept06.Title = MultiLanguage.GetComment("FD", "ODMMRRPCN01", "dept06", tLanguageType);
			this.dept07.Title = MultiLanguage.GetComment("FD", "ODMMRRPCN01", "dept07", tLanguageType);
			this.txtpunish04.Title = MultiLanguage.GetComment("FD", "ODMMRRPCN01", "txtpunish04", tLanguageType);
			this.txtpunish05.Title = MultiLanguage.GetComment("FD", "ODMMRRPCN01", "txtpunish05", tLanguageType);
			this.txtpunish06.Title = MultiLanguage.GetComment("FD", "ODMMRRPCN01", "txtpunish06", tLanguageType);
			this.txtpunish07.Title = MultiLanguage.GetComment("FD", "ODMMRRPCN01", "txtpunish07", tLanguageType);
			this.txtamt04.Title = MultiLanguage.GetComment("FD", "ODMMRRPCN01", "txtamt04", tLanguageType);
			this.txtamt05.Title = MultiLanguage.GetComment("FD", "ODMMRRPCN01", "txtamt05", tLanguageType);
			this.txtamt06.Title = MultiLanguage.GetComment("FD", "ODMMRRPCN01", "txtamt06", tLanguageType);
			this.txtamt07.Title = MultiLanguage.GetComment("FD", "ODMMRRPCN01", "txtamt07", tLanguageType);
		...
		protected override void Page_Prender(object sender, EventArgs e)
		{
			...
			if(strToolTipParameter=="Y"){
				this.areadescp.ToolTip = this.areadescp.Text;
		...
		{
			// 作業代號
			this.TaskId = "ODMMRRPCN01";
			// 表單代號
			this.formID = "ODMMRRPCN01";
...
where resfc001=@resfc001 and resfc002=@resfc002 and resfc003=@resfc003 and ISNULL(resfc004,'')<>''";
		...
		{
			defalutHash.Add("odmmrrpcn01001", this.formID);
			defalutHash.Add("odmmrrpcn01002", this.SheetNo);
...
order by resdd003 desc";
		...
		{
			pReport = "ODMMRRPCN01";
			pReportID = "ODMMRRPCN01_02";//憑證式
			pWhere = "AND (odmmrrpcn01001='" + this.formID + "') AND (odmmrrpcn01002='" + this.SheetNo + "')";
			pReportDirectory = "ODMMRRPCN01";
