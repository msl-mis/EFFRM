...
namespace tw.com.dsc.easyflowDotNet.forms
{
	...
	/// ODMACRPAY01 的摘要描述。
	/// </summary>
	public partial class ODMACRPAY01 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
	{
		//edit by teppy 2011/02/08 Start
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			AjaxPro.Utility.RegisterTypeForAjax(typeof(ODMACRPAY01));
			UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
			string tLanguageType = tClass.Language;

			//多國語系
			this.Title= MultiLanguage.GetComment("FD","ODMACRPAY01","lblTitle",this.UserInfo.Language);
			string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ODMACRPAY01", "HeadTabStrip01", tLanguageType);
			...
			this.datetime1.Title = MultiLanguage.GetComment("FD", "ODMACRPAY01", "datetime1", tLanguageType);
			this.dept.Title = MultiLanguage.GetComment("FD", "ODMACRPAY01", "dept", tLanguageType);
			this.username.Title = MultiLanguage.GetComment("FD", "ODMACRPAY01", "username", tLanguageType);
			this.payee.Title = MultiLanguage.GetComment("FD", "ODMACRPAY01", "payee", tLanguageType);
			this.checkbox1.Text = MultiLanguage.GetComment("FD", "ODMACRPAY01", "checkbox1", tLanguageType);
			this.checkbox2.Text = MultiLanguage.GetComment("FD", "ODMACRPAY01", "checkbox2", tLanguageType);
			this.checkbox3.Text = MultiLanguage.GetComment("FD", "ODMACRPAY01", "checkbox3", tLanguageType);
			this.checkbox4.Text = MultiLanguage.GetComment("FD", "ODMACRPAY01", "checkbox4", tLanguageType);
			this.checkbox5.Text = MultiLanguage.GetComment("FD", "ODMACRPAY01", "checkbox5", tLanguageType);
			this.chkother.Title = MultiLanguage.GetComment("FD", "ODMACRPAY01", "chkother", tLanguageType);
			this.textarea1.Title = MultiLanguage.GetComment("FD", "ODMACRPAY01", "textarea1", tLanguageType);
			this.money01.Title = MultiLanguage.GetComment("FD", "ODMACRPAY01", "money01", tLanguageType);
			this.textarea2.Title = MultiLanguage.GetComment("FD", "ODMACRPAY01", "textarea2", tLanguageType);
			this.money02.Title = MultiLanguage.GetComment("FD", "ODMACRPAY01", "money02", tLanguageType);
			this.textarea3.Title = MultiLanguage.GetComment("FD", "ODMACRPAY01", "textarea3", tLanguageType);
			this.money03.Title = MultiLanguage.GetComment("FD", "ODMACRPAY01", "money03", tLanguageType);
			this.textarea4.Title = MultiLanguage.GetComment("FD", "ODMACRPAY01", "textarea4", tLanguageType);
			this.money04.Title = MultiLanguage.GetComment("FD", "ODMACRPAY01", "money04", tLanguageType);
			this.textarea5.Title = MultiLanguage.GetComment("FD", "ODMACRPAY01", "textarea5", tLanguageType);
			this.money05.Title = MultiLanguage.GetComment("FD", "ODMACRPAY01", "money05", tLanguageType);
			this.mtotal.Title = MultiLanguage.GetComment("FD", "ODMACRPAY01", "mtotal", tLanguageType);
			this.checkbox6.Text = MultiLanguage.GetComment("FD", "ODMACRPAY01", "checkbox6", tLanguageType);
			this.inv01.Title = MultiLanguage.GetComment("FD", "ODMACRPAY01", "inv01", tLanguageType);
			this.checkbox7.Text = MultiLanguage.GetComment("FD", "ODMACRPAY01", "checkbox7", tLanguageType);
			this.inv02.Title = MultiLanguage.GetComment("FD", "ODMACRPAY01", "inv02", tLanguageType);
			this.checkbox8.Text = MultiLanguage.GetComment("FD", "ODMACRPAY01", "checkbox8", tLanguageType);
			this.checkbox9.Text = MultiLanguage.GetComment("FD", "ODMACRPAY01", "checkbox9", tLanguageType);
			this.checkbox10.Text = MultiLanguage.GetComment("FD", "ODMACRPAY01", "checkbox10", tLanguageType);
			this.orderno.Title = MultiLanguage.GetComment("FD", "ODMACRPAY01", "orderno", tLanguageType);
			this.attother.Title = MultiLanguage.GetComment("FD", "ODMACRPAY01", "attother", tLanguageType);
			this.other.Text = MultiLanguage.GetComment("FD", "ODMACRPAY01", "other", tLanguageType);
			this.payother.Title = MultiLanguage.GetComment("FD", "ODMACRPAY01", "payother", tLanguageType);
			this.empl1.Title = MultiLanguage.GetComment("FD", "ODMACRPAY01", "empl1", tLanguageType);
			this.empl2.Title = MultiLanguage.GetComment("FD", "ODMACRPAY01", "empl2", tLanguageType);
...
this.other.Text = String.Empty;
		...
		{
			// 作業代號
			this.TaskId = "ODMACRPAY01";
			// 表單代號
			this.formID = "ODMACRPAY01";
...
this.comp_ctrolRadio4.Attributes.Add("onclick", "document.getElementById('MasterPage_MasterPageContent_comp_txt').value = '4';");
		...
		protected override void SetDefaultValue(Hashtable defalutHash)
		{
			...
			defalutHash.Add("odmacrpay01001", this.formID);
			defalutHash.Add("odmacrpay01002", this.SheetNo);
...
order by resdd003 desc";
		...
		protected override void ReGetCondValue(object[,] pAryCondValue)
		{
			...
			pAryCondValue[0, 4] = "SenderID";
			pAryCondValue[1, 4] = tValue; 
		...
		{
			pReport = "ODMACRPAY01";
			pReportID = "ODMACRPAY01_02";//憑證式
			pWhere = "AND (odmacrpay01001='" + this.formID + "') AND (odmacrpay01002='" + this.SheetNo + "')";
			pReportDirectory = "ODMACRPAY01";
