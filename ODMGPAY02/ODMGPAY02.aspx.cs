...
namespace tw.com.dsc.easyflowDotNet.forms
{
	...
	/// ODMGPAY02 的摘要描述。
	/// </summary>
	public partial class ODMGPAY02 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
	{
		//edit by teppy 2011/02/08 Start
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			AjaxPro.Utility.RegisterTypeForAjax(typeof(ODMGPAY02));
			UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
			string tLanguageType = tClass.Language;

			//多國語系
			this.Title= MultiLanguage.GetComment("FD","ODMGPAY02","lblTitle",this.UserInfo.Language);
			string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ODMGPAY02", "HeadTabStrip01", tLanguageType);
			...
			this.label2.Text = MultiLanguage.GetComment("FD", "ODMGPAY02", "label2", tLanguageType);
			this.label3.Text = MultiLanguage.GetComment("FD", "ODMGPAY02", "label3", tLanguageType);
			this.label4.Text = MultiLanguage.GetComment("FD", "ODMGPAY02", "label4", tLanguageType);
			this.datetime1.Title = MultiLanguage.GetComment("FD", "ODMGPAY02", "datetime1", tLanguageType);
			this.dept.Title = MultiLanguage.GetComment("FD", "ODMGPAY02", "dept", tLanguageType);
			this.username.Title = MultiLanguage.GetComment("FD", "ODMGPAY02", "username", tLanguageType);
			this.payee.Title = MultiLanguage.GetComment("FD", "ODMGPAY02", "payee", tLanguageType);
			this.chkother.Title = MultiLanguage.GetComment("FD", "ODMGPAY02", "chkother", tLanguageType);
			this.textarea1.Title = MultiLanguage.GetComment("FD", "ODMGPAY02", "textarea1", tLanguageType);
			this.money01.Title = MultiLanguage.GetComment("FD", "ODMGPAY02", "money01", tLanguageType);
			this.money02.Title = MultiLanguage.GetComment("FD", "ODMGPAY02", "money02", tLanguageType);
			this.textarea3.Title = MultiLanguage.GetComment("FD", "ODMGPAY02", "textarea3", tLanguageType);
			this.money03.Title = MultiLanguage.GetComment("FD", "ODMGPAY02", "money03", tLanguageType);
			this.textarea4.Title = MultiLanguage.GetComment("FD", "ODMGPAY02", "textarea4", tLanguageType);
			this.money04.Title = MultiLanguage.GetComment("FD", "ODMGPAY02", "money04", tLanguageType);
			this.mtotal.Title = MultiLanguage.GetComment("FD", "ODMGPAY02", "mtotal", tLanguageType);
			this.inv01.Title = MultiLanguage.GetComment("FD", "ODMGPAY02", "inv01", tLanguageType);
			this.inv02.Title = MultiLanguage.GetComment("FD", "ODMGPAY02", "inv02", tLanguageType);
			this.orderno.Title = MultiLanguage.GetComment("FD", "ODMGPAY02", "orderno", tLanguageType);
			this.attother.Title = MultiLanguage.GetComment("FD", "ODMGPAY02", "attother", tLanguageType);
			this.other.Text = MultiLanguage.GetComment("FD", "ODMGPAY02", "other", tLanguageType);
			this.payother.Title = MultiLanguage.GetComment("FD", "ODMGPAY02", "payother", tLanguageType);
			this.authorID.Title = MultiLanguage.GetComment("FD", "ODMGPAY02", "authorID", tLanguageType);
			this.SuperID.Title = MultiLanguage.GetComment("FD", "ODMGPAY02", "SuperID", tLanguageType);
			this.chkkind01.Text = MultiLanguage.GetComment("FD", "ODMGPAY02", "chkkind01", tLanguageType);
			this.chkkind02.Text = MultiLanguage.GetComment("FD", "ODMGPAY02", "chkkind02", tLanguageType);
			this.chkkind03.Text = MultiLanguage.GetComment("FD", "ODMGPAY02", "chkkind03", tLanguageType);
			this.chkkind04.Text = MultiLanguage.GetComment("FD", "ODMGPAY02", "chkkind04", tLanguageType);
			this.chkkind05.Text = MultiLanguage.GetComment("FD", "ODMGPAY02", "chkkind05", tLanguageType);
			this.chkpay01.Text = MultiLanguage.GetComment("FD", "ODMGPAY02", "chkpay01", tLanguageType);
			this.chkpay02.Text = MultiLanguage.GetComment("FD", "ODMGPAY02", "chkpay02", tLanguageType);
			this.txtord.Title = MultiLanguage.GetComment("FD", "ODMGPAY02", "txtord", tLanguageType);
			this.txtpayday.Title = MultiLanguage.GetComment("FD", "ODMGPAY02", "txtpayday", tLanguageType);
			this.chkpay03.Text = MultiLanguage.GetComment("FD", "ODMGPAY02", "chkpay03", tLanguageType);
			this.chkpay04.Text = MultiLanguage.GetComment("FD", "ODMGPAY02", "chkpay04", tLanguageType);
			this.chkadd01.Text = MultiLanguage.GetComment("FD", "ODMGPAY02", "chkadd01", tLanguageType);
			this.chkadd02.Text = MultiLanguage.GetComment("FD", "ODMGPAY02", "chkadd02", tLanguageType);
			this.textarea2.Title = MultiLanguage.GetComment("FD", "ODMGPAY02", "textarea2", tLanguageType);
			this.chkadd04.Text = MultiLanguage.GetComment("FD", "ODMGPAY02", "chkadd04", tLanguageType);
			this.chkadd05.Text = MultiLanguage.GetComment("FD", "ODMGPAY02", "chkadd05", tLanguageType);
			this.useyear.Title = MultiLanguage.GetComment("FD", "ODMGPAY02", "useyear", tLanguageType);
			this.usedetp.Title = MultiLanguage.GetComment("FD", "ODMGPAY02", "usedetp", tLanguageType);
			this.opentype01.Title = MultiLanguage.GetComment("FD", "ODMGPAY02", "opentype01", tLanguageType);
			this.openitem01.Title = MultiLanguage.GetComment("FD", "ODMGPAY02", "openitem01", tLanguageType);
			this.opentype02.Title = MultiLanguage.GetComment("FD", "ODMGPAY02", "opentype02", tLanguageType);
			this.openitem02.Title = MultiLanguage.GetComment("FD", "ODMGPAY02", "openitem02", tLanguageType);
			this.opentype03.Title = MultiLanguage.GetComment("FD", "ODMGPAY02", "opentype03", tLanguageType);
			this.openitem03.Title = MultiLanguage.GetComment("FD", "ODMGPAY02", "openitem03", tLanguageType);
			this.openitem04.Title = MultiLanguage.GetComment("FD", "ODMGPAY02", "openitem04", tLanguageType);
			this.opentype04.Title = MultiLanguage.GetComment("FD", "ODMGPAY02", "opentype04", tLanguageType);
			this.curr.Title = MultiLanguage.GetComment("FD", "ODMGPAY02", "curr", tLanguageType);
...
this.chkadd05.Text = String.Empty;
		...
		{
			// 作業代號
			this.TaskId = "ODMGPAY02";
			// 表單代號
			this.formID = "ODMGPAY02";
...
this.kind_ctrolRadio2.Attributes.Add("onclick", "document.getElementById('MasterPage_MasterPageContent_kind_txt').value = '2';");
		...
		{
			defalutHash.Add("odmgpay02001", this.formID);
			defalutHash.Add("odmgpay02002", this.SheetNo);
...
order by resdd003 desc";
		...
		protected override void ReGetCondValue(object[,] pAryCondValue)
		{
			...
			tValue="";
			try{
				tValue = (this.authorID.Value.Trim());
			}
			catch(Exception e){
				tValue="";
			}
		...
		{
			pReport = "ODMGPAY02";
			pReportID = "ODMGPAY02_02";//憑證式
			pWhere = "AND (odmgpay02001='" + this.formID + "') AND (odmgpay02002='" + this.SheetNo + "')";
			pReportDirectory = "ODMGPAY02";
