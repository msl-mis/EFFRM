<%@ Page language="c#" CodeFile="ODMSYSMDFVL01.aspx.cs" MasterPageFile="~/src/_Common/AppUtil/EFMasterPage/EFBaseMasterPage.master" AutoEventWireup="false" enableEventValidation="false" Inherits="tw.com.dsc.easyflowDotNet.forms.ODMSYSMDFVL01" %>
<%@ Register TagPrefix="uc1" TagName="gridUserControl" Src="../../_Common/PlatformUtil/KernelPage/Grid/gridUserControl.ascx" %>
<%@ Register TagPrefix="iewc" Namespace="Microsoft.Web.UI.WebControls" Assembly="Microsoft.Web.UI.WebControls" %>
<%@ Register TagPrefix="cc1" Namespace="tw.com.dsc.dscDotNet.dscWebControls" Assembly="PlatformUtil" %>

<asp:Content ID="ODMSYSMDFVL01FormContent" ContentPlaceHolderID="MasterPageContent" runat="server">
	<!--單檔架構 -->
	<!--2009/03/19:Joseph:<div id="cover" style="OVERFLOW: auto; WIDTH: 100%;">-->
		<div id="cover" style="WIDTH: 100%;">
			<div id="createRecord" style="WIDTH: 100%; HEIGHT: 100%" runat="server">
				<cc1:DscPanel id="ecPnlMaster" runat="server" Width="98%" IniHTML='&#10;<div style="OVERFLOW: auto; WIDTH: 100%; POSITION: relative; HEIGHT: 100%" ms_positioning="GridLayout"></div>'
					FrmDefineKeys-FrmType="Query" FrmDefineKeys-FrmID="FrmODMSYSMDFVL01" FrmDefineKeys-BOID="ODMSYSMDFVL01"
...
<cc1:DscTextBox id='odmsysmdfvl01001' runat='server' title='表單代號'
	style='display: none; Z-INDEX: 101; POSITION: absolute; LEFT: 245px; TOP: 16px;'
	TxtInput_TabIndex='0'>
	<INPUTSTYLE Width='120px'></INPUTSTYLE>
	<TITLESTYLE Width='110px'></TITLESTYLE>
	<FRMFIELDKEYS FrmID='FrmODMSYSMDFVL01' BOID='ODMSYSMDFVL01' FieldName='odmsysmdfvl01001'></FRMFIELDKEYS>
</cc1:DscTextBox>
<cc1:DscTextBox id='odmsysmdfvl01002' runat='server' title='表單單號'
	style='display: none; Z-INDEX: 102; POSITION: absolute; LEFT: 245px; TOP: 49px;'
	TxtInput_TabIndex='0'>
	<INPUTSTYLE Width='120px'></INPUTSTYLE>
	<TITLESTYLE Width='110px'></TITLESTYLE>
	<FRMFIELDKEYS FrmID='FrmODMSYSMDFVL01' BOID='ODMSYSMDFVL01' FieldName='odmsysmdfvl01002'></FRMFIELDKEYS>
</cc1:DscTextBox>
...
<cc1:DscTextBox id='texdept' runat='server' title='部門' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMSYSMDFVL01' BOID='ODMSYSMDFVL01' FieldName='texdept'></FrmFieldKeys>
...
<cc1:DscDateAssistant2 ID='datetime1' runat='server' Title='申請日期' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMSYSMDFVL01' BOID='ODMSYSMDFVL01' FieldName='datetime1'></FrmFieldKeys>
...
<cc1:DscDateAssistant2 ID='datetime2' runat='server' Title='希望修改日期' ShowTitle='False'
	...
	BtnVisible='True' ImgSrc='../../_Common/AppUtil/Themes/images/Program/calender.gif'>
	<InputStyle Width='90px' Height='26px' CssClass='Edit20' />
	<FrmFieldKeys FrmID='FrmODMSYSMDFVL01' BOID='ODMSYSMDFVL01' FieldName='datetime2'></FrmFieldKeys>
</cc1:DscDateAssistant2>
<cc1:DscTextBox id='sysname' runat='server' title='系統名稱' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMSYSMDFVL01' BOID='ODMSYSMDFVL01' FieldName='sysname'></FrmFieldKeys>
	<TitleStyle Width='100px'></TitleStyle>
...
<cc1:DscTextBox id='pdname' runat='server' title='作業名稱及代號' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMSYSMDFVL01' BOID='ODMSYSMDFVL01' FieldName='pdname'></FrmFieldKeys>
	<TitleStyle Width='100px'></TitleStyle>
...
<cc1:DscTextBox id='content' runat='server' title='內容說明' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMSYSMDFVL01' BOID='ODMSYSMDFVL01' FieldName='content'></FrmFieldKeys>
	<TitleStyle Width='100px'></TitleStyle>
...
<cc1:DscTextBox id='rditem' runat='server' title='一般異動 Thay đổi thông thường' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMSYSMDFVL01' BOID='ODMSYSMDFVL01' FieldName='rditem'></FrmFieldKeys>
</cc1:DscTextBox>
...
<!--引用JavaScript-->
<script src="ODMSYSMDFVL01.js?NoCache=202207291705" type="text/javascript"></script>
</asp:Content>
