...
namespace tw.com.dsc.easyflowDotNet.forms
{
	...
	/// ODMSYSMDFVL01 的摘要描述。
	/// </summary>
	public partial class ODMSYSMDFVL01 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
	{
		//edit by teppy 2011/02/08 Start
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			AjaxPro.Utility.RegisterTypeForAjax(typeof(ODMSYSMDFVL01));
			UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
			string tLanguageType = tClass.Language;

			//多國語系
			this.Title= MultiLanguage.GetComment("FD","ODMSYSMDFVL01","lblTitle",this.UserInfo.Language);
			string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ODMSYSMDFVL01", "HeadTabStrip01", tLanguageType);
			...
			this.texdept.Title = MultiLanguage.GetComment("FD", "ODMSYSMDFVL01", "texdept", tLanguageType);
			this.datetime1.Title = MultiLanguage.GetComment("FD", "ODMSYSMDFVL01", "datetime1", tLanguageType);
			this.datetime2.Title = MultiLanguage.GetComment("FD", "ODMSYSMDFVL01", "datetime2", tLanguageType);
			this.sysname.Title = MultiLanguage.GetComment("FD", "ODMSYSMDFVL01", "sysname", tLanguageType);
			this.pdname.Title = MultiLanguage.GetComment("FD", "ODMSYSMDFVL01", "pdname", tLanguageType);
			this.content.Title = MultiLanguage.GetComment("FD", "ODMSYSMDFVL01", "content", tLanguageType);
...
this.content.ToolTip = this.content.Text;
		...
		{
			// 作業代號
			this.TaskId = "ODMSYSMDFVL01";
			// 表單代號
			this.formID = "ODMSYSMDFVL01";
...
this.rditem_ctrolRadio1.Attributes.Add("onclick", "document.getElementById('MasterPage_MasterPageContent_rditem_txt').value = '1';");
		...
		{
			defalutHash.Add("odmsysmdfvl01001", this.formID);
			defalutHash.Add("odmsysmdfvl01002", this.SheetNo);
...
order by resdd003 desc";
		...
		{
			pReport = "ODMSYSMDFVL01";
			pReportID = "ODMSYSMDFVL01_02";//憑證式
			pWhere = "AND (odmsysmdfvl01001='" + this.formID + "') AND (odmsysmdfvl01002='" + this.SheetNo + "')";
			pReportDirectory = "ODMSYSMDFVL01";
