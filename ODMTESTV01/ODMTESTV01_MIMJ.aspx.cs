...
{
	/// <summary>
	/// ODMTESTV01_MIMJ 的摘要描述。
	/// </summary>
	public partial class ODMTESTV01_MIMJ : tw.com.dsc.easyflowDotNet.kernelBasePage.EFMIMJBasepage
	{
		...
		protected override void MIFunction()
		{
			switch(tBtnID)
			{
				...
				case "MasterPage_MasterPageContent_opentype_btn":			//開窗連結外部資料庫
				{
					base.doMIByDB("OpenMIMJ01","20", @"192.168.10.22", "price");
					break;
				}
				case "MasterPage_MasterPageContent_openitem_btn":			//開窗連結外部資料庫
				{
				...
				case "MasterPage_MasterPageContent_eftype_btn":			//開窗連結外部資料庫
				{
					base.doMIByDB("OpenMIMJ01","20", @"192.168.10.22", "price");
					break;
				}
				case "MasterPage_MasterPageContent_efitem_btn":			//開窗連結外部資料庫
				{
					base.doMIByDB("TrigMIMJ01","05", @"192.168.10.22", "price");
					break;
				}
		...
		protected override void MJFunction()
		{
			...
			switch(tMJ)//欄位ID命名要規則化
			{
				...
				case "OpenMIMJ01_20_opentype":	
				{
					base.doMJByDB("OpenMIMJ01","20", @"192.168.10.22", "price","MasterPage_MasterPageContent_opentype_txt2=type_name","MasterPage_MasterPageContent_typename_txt=type_name");
					break;
				}
				case "TrigMIMJ01_05_openitem":	
				{
					base.doMJByDB("TrigMIMJ01","05", @"192.168.10.22", "price","MasterPage_MasterPageContent_openitem_txt2=item_name","MasterPage_MasterPageContent_itemname_txt=item_name");
					break;
				}
				case "OpenMIMJ01_20_opentype01":	
				{
					...
					if(bSelfResult)
					{
						if (tAllInputValues["MasterPage_MasterPageContent_openitem_txt"] != null && tAllInputValues["MasterPage_MasterPageContent_openitem_txt"].ToString().Length > 0){
							string[] aryParamger = new string[2];
							aryParamger[0]=tAllInputValues["MasterPage_MasterPageContent_openitem_txt"].ToString();
							aryParamger[1]=tAllInputValues["MasterPage_MasterPageContent_opentype01_txt"].ToString();
							//自訂MsgCode
							bool bTriggerMJ=getMJResultByDB("TrigMIMJ01","05",aryParamger,FinalList, @"192.168.10.22", "price","MasterPage_MasterPageContent_openitem_txt2=item_name");
							if(!bTriggerMJ){
								base.FinalList.Add("MasterPage_MasterPageContent_openitem_txt", "value", "");
								base.FinalList.Add("MasterPage_MasterPageContent_openitem_txt2", "value", "");
								string strErrorMsg = "「'+$('#MasterPage_MasterPageContent_openitem_lbl').text()+'」"+MultiLanguage.GetComment("PSMSG", "MJValidationError", "保留",this.UserInfo.Language.ToString().Trim());
				...
				case "OpenMIMJ01_20_eftype":	
				{
					bSelfResult = getMJResultByDB("OpenMIMJ01","20",1,FinalList, @"192.168.10.22", "price","MasterPage_MasterPageContent_eftype_txt2=type_name");
					if(bSelfResult)
					{
						if (tAllInputValues["MasterPage_MasterPageContent_efitem_txt"] != null && tAllInputValues["MasterPage_MasterPageContent_efitem_txt"].ToString().Length > 0){
							string[] aryParamger = new string[2];
							aryParamger[0]=tAllInputValues["MasterPage_MasterPageContent_efitem_txt"].ToString();
							aryParamger[1]=tAllInputValues["MasterPage_MasterPageContent_eftype_txt"].ToString();
							//自訂MsgCode
							bool bTriggerMJ=getMJResultByDB("TrigMIMJ01","05",aryParamger,FinalList, @"192.168.10.22", "price","MasterPage_MasterPageContent_efitem_txt2=item_name");
							if(!bTriggerMJ){
								base.FinalList.Add("MasterPage_MasterPageContent_efitem_txt", "value", "");
								base.FinalList.Add("MasterPage_MasterPageContent_efitem_txt2", "value", "");
								string strErrorMsg = "「'+$('#MasterPage_MasterPageContent_efitem_lbl').text()+'」"+MultiLanguage.GetComment("PSMSG", "MJValidationError", "保留",this.UserInfo.Language.ToString().Trim());
								base.FinalList.Insert(0,"alert('"+strErrorMsg+"')");
							}
						}
					}
				...
				case "TrigMIMJ01_05_efitem":	
				{
					base.doMJByDB("TrigMIMJ01","05", @"192.168.10.22", "price","MasterPage_MasterPageContent_efitem_txt2=item_name");
					break;
				}
