...
namespace tw.com.dsc.easyflowDotNet.forms
{
	...
	/// ODMTESTV01 的摘要描述。
	/// </summary>
	public partial class ODMTESTV01 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
	{
		//edit by teppy 2011/02/08 Start
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			AjaxPro.Utility.RegisterTypeForAjax(typeof(ODMTESTV01));
			UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
			string tLanguageType = tClass.Language;

			//多國語系
			this.Title= MultiLanguage.GetComment("FD","ODMTESTV01","lblTitle",this.UserInfo.Language);
			string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ODMTESTV01", "HeadTabStrip01", tLanguageType);
			...
			this.datetime1.Title = MultiLanguage.GetComment("FD", "ODMTESTV01", "datetime1", tLanguageType);
			this.dept.Title = MultiLanguage.GetComment("FD", "ODMTESTV01", "dept", tLanguageType);
			this.username.Title = MultiLanguage.GetComment("FD", "ODMTESTV01", "username", tLanguageType);
			this.payee.Title = MultiLanguage.GetComment("FD", "ODMTESTV01", "payee", tLanguageType);
			this.chkitem01.Text = MultiLanguage.GetComment("FD", "ODMTESTV01", "chkitem01", tLanguageType);
			this.chkitem02.Text = MultiLanguage.GetComment("FD", "ODMTESTV01", "chkitem02", tLanguageType);
			this.chkitem03.Text = MultiLanguage.GetComment("FD", "ODMTESTV01", "chkitem03", tLanguageType);
			this.chkitem04.Text = MultiLanguage.GetComment("FD", "ODMTESTV01", "chkitem04", tLanguageType);
			this.chkitem05.Text = MultiLanguage.GetComment("FD", "ODMTESTV01", "chkitem05", tLanguageType);
			this.chkother.Title = MultiLanguage.GetComment("FD", "ODMTESTV01", "chkother", tLanguageType);
			this.textarea1.Title = MultiLanguage.GetComment("FD", "ODMTESTV01", "textarea1", tLanguageType);
			this.money01.Title = MultiLanguage.GetComment("FD", "ODMTESTV01", "money01", tLanguageType);
			this.textarea2.Title = MultiLanguage.GetComment("FD", "ODMTESTV01", "textarea2", tLanguageType);
			this.money02.Title = MultiLanguage.GetComment("FD", "ODMTESTV01", "money02", tLanguageType);
			this.textarea3.Title = MultiLanguage.GetComment("FD", "ODMTESTV01", "textarea3", tLanguageType);
			this.money03.Title = MultiLanguage.GetComment("FD", "ODMTESTV01", "money03", tLanguageType);
			this.textarea4.Title = MultiLanguage.GetComment("FD", "ODMTESTV01", "textarea4", tLanguageType);
			this.money04.Title = MultiLanguage.GetComment("FD", "ODMTESTV01", "money04", tLanguageType);
			this.textarea5.Title = MultiLanguage.GetComment("FD", "ODMTESTV01", "textarea5", tLanguageType);
			this.money05.Title = MultiLanguage.GetComment("FD", "ODMTESTV01", "money05", tLanguageType);
			this.mtotal.Title = MultiLanguage.GetComment("FD", "ODMTESTV01", "mtotal", tLanguageType);
			this.chkatt01.Text = MultiLanguage.GetComment("FD", "ODMTESTV01", "chkatt01", tLanguageType);
			this.inv01.Title = MultiLanguage.GetComment("FD", "ODMTESTV01", "inv01", tLanguageType);
			this.chkatt02.Text = MultiLanguage.GetComment("FD", "ODMTESTV01", "chkatt02", tLanguageType);
			this.inv02.Title = MultiLanguage.GetComment("FD", "ODMTESTV01", "inv02", tLanguageType);
			this.chkatt03.Text = MultiLanguage.GetComment("FD", "ODMTESTV01", "chkatt03", tLanguageType);
			this.chkatt04.Text = MultiLanguage.GetComment("FD", "ODMTESTV01", "chkatt04", tLanguageType);
			this.chkatt05.Text = MultiLanguage.GetComment("FD", "ODMTESTV01", "chkatt05", tLanguageType);
			this.orderno.Title = MultiLanguage.GetComment("FD", "ODMTESTV01", "orderno", tLanguageType);
			this.attother.Title = MultiLanguage.GetComment("FD", "ODMTESTV01", "attother", tLanguageType);
			this.other.Text = MultiLanguage.GetComment("FD", "ODMTESTV01", "other", tLanguageType);
			this.payother.Title = MultiLanguage.GetComment("FD", "ODMTESTV01", "payother", tLanguageType);
			this.empl1.Title = MultiLanguage.GetComment("FD", "ODMTESTV01", "empl1", tLanguageType);
			this.empl2.Title = MultiLanguage.GetComment("FD", "ODMTESTV01", "empl2", tLanguageType);
			this.curr01.Title = MultiLanguage.GetComment("FD", "ODMTESTV01", "curr01", tLanguageType);
			this.curr02.Title = MultiLanguage.GetComment("FD", "ODMTESTV01", "curr02", tLanguageType);
			this.curr03.Title = MultiLanguage.GetComment("FD", "ODMTESTV01", "curr03", tLanguageType);
			this.curr04.Title = MultiLanguage.GetComment("FD", "ODMTESTV01", "curr04", tLanguageType);
			this.curr05.Title = MultiLanguage.GetComment("FD", "ODMTESTV01", "curr05", tLanguageType);
			this.curr06.Title = MultiLanguage.GetComment("FD", "ODMTESTV01", "curr06", tLanguageType);
			this.opentype.Title = MultiLanguage.GetComment("FD", "ODMTESTV01", "opentype", tLanguageType);
			this.typename.Title = MultiLanguage.GetComment("FD", "ODMTESTV01", "typename", tLanguageType);
			this.openitem.Title = MultiLanguage.GetComment("FD", "ODMTESTV01", "openitem", tLanguageType);
			this.opentype01.Title = MultiLanguage.GetComment("FD", "ODMTESTV01", "opentype01", tLanguageType);
			this.typename01.Title = MultiLanguage.GetComment("FD", "ODMTESTV01", "typename01", tLanguageType);
			this.itemname.Title = MultiLanguage.GetComment("FD", "ODMTESTV01", "itemname", tLanguageType);
			this.eftype.Title = MultiLanguage.GetComment("FD", "ODMTESTV01", "eftype", tLanguageType);
			this.efitem.Title = MultiLanguage.GetComment("FD", "ODMTESTV01", "efitem", tLanguageType);
...
this.other.Text = String.Empty;
		...
		{
			// 作業代號
			this.TaskId = "ODMTESTV01";
			// 表單代號
			this.formID = "ODMTESTV01";
...
where resfc001=@resfc001 and resfc002=@resfc002 and resfc003=@resfc003 and ISNULL(resfc004,'')<>''";
		...
		protected override void settingClientFunction()
		{
			...
			openitem.HtmImg.Attributes.Add("onclick",MIMJUtil.getClickParams_Fields("MasterPage_MasterPageContent_openitem_btn","MasterPage_MasterPageContent_opentype01_txt","MasterPage_MasterPageContent_openitem_txt","S"));
			openitem.TxtInput.Attributes.Add("onblur",MIMJUtil.getBlurParams("MasterPage_MasterPageContent_openitem_txt","TrigMIMJ01_05_openitem","MasterPage_MasterPageContent_openitem_txt,MasterPage_MasterPageContent_opentype01_txt"));
			...
			opentype01.TxtInput.Attributes.Add("onblur",MIMJUtil.getBlurParams("MasterPage_MasterPageContent_opentype01_txt","OpenMIMJ01_20_opentype01","MasterPage_MasterPageContent_opentype01_txt,MasterPage_MasterPageContent_openitem_txt")+";InitTriggerOpen();");
			...
			eftype.HtmImg.Attributes.Add("onclick",MIMJUtil.getClickParams("MasterPage_MasterPageContent_eftype_btn","MasterPage_MasterPageContent_eftype_txt","S"));
			eftype.TxtInput.Attributes.Add("onblur",MIMJUtil.getBlurParams("MasterPage_MasterPageContent_eftype_txt","OpenMIMJ01_20_eftype","MasterPage_MasterPageContent_eftype_txt,MasterPage_MasterPageContent_efitem_txt")+";InitTriggerOpen();");
			eftype.TxtInput.Attributes.Add("onchange","FunOnChange_eftype();InitTriggerOpen();AddtoHash('MasterPage_MasterPageContent_eftype_txt');");

			efitem.HtmImg.Attributes.Add("onclick",MIMJUtil.getClickParams_Fields("MasterPage_MasterPageContent_efitem_btn","MasterPage_MasterPageContent_eftype_txt","MasterPage_MasterPageContent_efitem_txt","S"));
			efitem.TxtInput.Attributes.Add("onblur",MIMJUtil.getBlurParams("MasterPage_MasterPageContent_efitem_txt","TrigMIMJ01_05_efitem","MasterPage_MasterPageContent_efitem_txt,MasterPage_MasterPageContent_eftype_txt"));
			efitem.TxtInput.Attributes.Add("onchange","AddtoHash('MasterPage_MasterPageContent_efitem_txt');");
...
this.kind_ctrolRadio2.Attributes.Add("onclick", "document.getElementById('MasterPage_MasterPageContent_kind_txt').value = '2';");
		...
		protected override void buildMiMjManager(Hashtable pMiMjManager)
		{
			...
			if ( FormStatus == EFFormStatus.CREATE ) {
				...
				pMiMjManager.Add("eftype_0", eftype);
				pMiMjManager.Add("efitem_0", efitem);
		...
		{
			defalutHash.Add("odmtestv01001", this.formID);
			defalutHash.Add("odmtestv01002", this.SheetNo);
			...
			defalutHash.Add("curr01", "RMB");
			defalutHash.Add("curr02", "RMB");
			defalutHash.Add("curr03", "RMB");
			defalutHash.Add("curr04", "RMB");
...
order by resdd003 desc";
		...
		{
			pReport = "ODMTESTV01";
			pReportID = "ODMTESTV01_02";//憑證式
			pWhere = "AND (odmtestv01001='" + this.formID + "') AND (odmtestv01002='" + this.SheetNo + "')";
			pReportDirectory = "ODMTESTV01";
