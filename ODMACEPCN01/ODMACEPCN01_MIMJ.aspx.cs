...
{
	/// <summary>
	/// ODMACEPCN01_MIMJ 的摘要描述。
	/// </summary>
	public partial class ODMACEPCN01_MIMJ : tw.com.dsc.easyflowDotNet.kernelBasePage.EFMIMJBasepage
	{
		...
		protected override void MIFunction()
		{
			switch(tBtnID)
			{
				case "MasterPage_MasterPageContent_opendetp_btn":			//其它類型開窗
				{
					base.doMI("OpenMIMJ01","16");
					break;
				}
				case "MasterPage_MasterPageContent_opensection_btn":			//其它類型開窗
				{
					base.doMI("OpenMIMJ01","17");
					break;
				}
		...
		protected override void MJFunction()
		{
			...
			{
				case "OpenMIMJ01_16_opendetp":	
				{
					base.doMJ("OpenMIMJ01","16","MasterPage_MasterPageContent_opendetp_txt2=resal002","MasterPage_MasterPageContent_usedept_txt=resal002");
					break;
				}
				case "OpenMIMJ01_17_opensection":	
				{
					base.doMJ("OpenMIMJ01","17","MasterPage_MasterPageContent_opensection_txt2=resal002","MasterPage_MasterPageContent_txtdept_txt=resal002");
					break;
				}
