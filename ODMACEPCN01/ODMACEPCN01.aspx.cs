...
namespace tw.com.dsc.easyflowDotNet.forms
{
	...
	/// ODMACEPCN01 的摘要描述。
	/// </summary>
	public partial class ODMACEPCN01 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
	{
		//edit by teppy 2011/02/08 Start
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			AjaxPro.Utility.RegisterTypeForAjax(typeof(ODMACEPCN01));
			UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
			string tLanguageType = tClass.Language;

			//多國語系
			this.Title= MultiLanguage.GetComment("FD","ODMACEPCN01","lblTitle",this.UserInfo.Language);
			string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ODMACEPCN01", "HeadTabStrip01", tLanguageType);
			...
			this.txtidno.Title = MultiLanguage.GetComment("FD", "ODMACEPCN01", "txtidno", tLanguageType);
			this.buyqty.Title = MultiLanguage.GetComment("FD", "ODMACEPCN01", "buyqty", tLanguageType);
			this.buydate.Title = MultiLanguage.GetComment("FD", "ODMACEPCN01", "buydate", tLanguageType);
			this.acceptdated.Title = MultiLanguage.GetComment("FD", "ODMACEPCN01", "acceptdated", tLanguageType);
			this.txtdept.Title = MultiLanguage.GetComment("FD", "ODMACEPCN01", "txtdept", tLanguageType);
			this.username.Title = MultiLanguage.GetComment("FD", "ODMACEPCN01", "username", tLanguageType);
			this.audit.Title = MultiLanguage.GetComment("FD", "ODMACEPCN01", "audit", tLanguageType);
			this.usedept.Title = MultiLanguage.GetComment("FD", "ODMACEPCN01", "usedept", tLanguageType);
			this.relatename.Title = MultiLanguage.GetComment("FD", "ODMACEPCN01", "relatename", tLanguageType);
			this.qualified.Title = MultiLanguage.GetComment("FD", "ODMACEPCN01", "qualified", tLanguageType);
			this.contect.Title = MultiLanguage.GetComment("FD", "ODMACEPCN01", "contect", tLanguageType);
			this.opendetp.Title = MultiLanguage.GetComment("FD", "ODMACEPCN01", "opendetp", tLanguageType);
			this.superid.Title = MultiLanguage.GetComment("FD", "ODMACEPCN01", "superid", tLanguageType);
			this.authorid.Title = MultiLanguage.GetComment("FD", "ODMACEPCN01", "authorid", tLanguageType);
			this.opensection.Title = MultiLanguage.GetComment("FD", "ODMACEPCN01", "opensection", tLanguageType);
		...
		{
			// 作業代號
			this.TaskId = "ODMACEPCN01";
			// 表單代號
			this.formID = "ODMACEPCN01";
...
where resfc001=@resfc001 and resfc002=@resfc002 and resfc003=@resfc003 and ISNULL(resfc004,'')<>''";
		...
		protected override void settingClientFunction()
		{
			...
			opendetp.TxtInput.Attributes.Add("onblur",MIMJUtil.getBlurParams("MasterPage_MasterPageContent_opendetp_txt","OpenMIMJ01_16_opendetp","MasterPage_MasterPageContent_opendetp_txt"));
			...
			opensection.TxtInput.Attributes.Add("onblur",MIMJUtil.getBlurParams("MasterPage_MasterPageContent_opensection_txt","OpenMIMJ01_17_opensection","MasterPage_MasterPageContent_opensection_txt"));
...
this.rditem_ctrolRadio2.Attributes.Add("onclick", "document.getElementById('MasterPage_MasterPageContent_rditem_txt').value = '2';");
		...
		{
			defalutHash.Add("odmacepcn01001", this.formID);
			defalutHash.Add("odmacepcn01002", this.SheetNo);
...
order by resdd003 desc";
		...
		{
			pReport = "ODMACEPCN01";
			pReportID = "ODMACEPCN01_02";//憑證式
			pWhere = "AND (odmacepcn01001='" + this.formID + "') AND (odmacepcn01002='" + this.SheetNo + "')";
			pReportDirectory = "ODMACEPCN01";
