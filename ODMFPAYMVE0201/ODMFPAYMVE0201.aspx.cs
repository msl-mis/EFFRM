...
{
	/// <summary>
	/// ODMFPAYMVE0201 的摘要描述。
	/// </summary>
	public partial class ODMFPAYMVE0201 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
	{
		//edit by teppy 2011/02/08 Start
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			AjaxPro.Utility.RegisterTypeForAjax(typeof(ODMFPAYMVE0201));
			UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
			string tLanguageType = tClass.Language;

			//多國語系
			this.Title= MultiLanguage.GetComment("FD","ODMFPAYMVE0201","lblTitle",this.UserInfo.Language);
			string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ODMFPAYMVE0201", "HeadTabStrip01", tLanguageType);
			...
			this.lblcn.Text = MultiLanguage.GetComment("FD", "ODMFPAYMVE0201", "lblcn", tLanguageType);
			this.lblvn.Text = MultiLanguage.GetComment("FD", "ODMFPAYMVE0201", "lblvn", tLanguageType);
			this.lblyear.Text = MultiLanguage.GetComment("FD", "ODMFPAYMVE0201", "lblyear", tLanguageType);
			this.datetime1.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE0201", "datetime1", tLanguageType);
			this.dept.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE0201", "dept", tLanguageType);
			this.username.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE0201", "username", tLanguageType);
			this.payee.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE0201", "payee", tLanguageType);
			this.chkitem01.Text = MultiLanguage.GetComment("FD", "ODMFPAYMVE0201", "chkitem01", tLanguageType);
			this.chkitem02.Text = MultiLanguage.GetComment("FD", "ODMFPAYMVE0201", "chkitem02", tLanguageType);
			this.chkitem03.Text = MultiLanguage.GetComment("FD", "ODMFPAYMVE0201", "chkitem03", tLanguageType);
			this.chkitem04.Text = MultiLanguage.GetComment("FD", "ODMFPAYMVE0201", "chkitem04", tLanguageType);
			this.chkitem05.Text = MultiLanguage.GetComment("FD", "ODMFPAYMVE0201", "chkitem05", tLanguageType);
			this.chkother.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE0201", "chkother", tLanguageType);
			this.payother.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE0201", "payother", tLanguageType);
			this.orderno.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE0201", "orderno", tLanguageType);
			this.textarea1.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE0201", "textarea1", tLanguageType);
			this.opentype01.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE0201", "opentype01", tLanguageType);
			this.openitem01.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE0201", "openitem01", tLanguageType);
			this.money01.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE0201", "money01", tLanguageType);
			this.textarea2.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE0201", "textarea2", tLanguageType);
			this.opentype02.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE0201", "opentype02", tLanguageType);
			this.openitem02.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE0201", "openitem02", tLanguageType);
			this.money02.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE0201", "money02", tLanguageType);
			this.textarea3.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE0201", "textarea3", tLanguageType);
			this.opentype03.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE0201", "opentype03", tLanguageType);
			this.openitem03.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE0201", "openitem03", tLanguageType);
			this.money03.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE0201", "money03", tLanguageType);
			this.textarea4.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE0201", "textarea4", tLanguageType);
			this.opentype04.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE0201", "opentype04", tLanguageType);
			this.openitem04.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE0201", "openitem04", tLanguageType);
			this.money04.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE0201", "money04", tLanguageType);
			this.textarea5.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE0201", "textarea5", tLanguageType);
			this.opentype05.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE0201", "opentype05", tLanguageType);
			this.openitem05.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE0201", "openitem05", tLanguageType);
			this.money05.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE0201", "money05", tLanguageType);
			this.mtotal.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE0201", "mtotal", tLanguageType);
			this.chkatt01.Text = MultiLanguage.GetComment("FD", "ODMFPAYMVE0201", "chkatt01", tLanguageType);
			this.inv01.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE0201", "inv01", tLanguageType);
			this.chkatt02.Text = MultiLanguage.GetComment("FD", "ODMFPAYMVE0201", "chkatt02", tLanguageType);
			this.SenderID.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE0201", "SenderID", tLanguageType);
			this.chkatt04.Text = MultiLanguage.GetComment("FD", "ODMFPAYMVE0201", "chkatt04", tLanguageType);
			this.inv02.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE0201", "inv02", tLanguageType);
			this.SuperID.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE0201", "SuperID", tLanguageType);
			this.chkatt05.Text = MultiLanguage.GetComment("FD", "ODMFPAYMVE0201", "chkatt05", tLanguageType);
			this.other.Text = MultiLanguage.GetComment("FD", "ODMFPAYMVE0201", "other", tLanguageType);
			this.attother.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE0201", "attother", tLanguageType);
			this.curr.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE0201", "curr", tLanguageType);
			this.useyear.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE0201", "useyear", tLanguageType);
			this.paydate.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE0201", "paydate", tLanguageType);
			this.safeno.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE0201", "safeno", tLanguageType);
			this.safename.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVE0201", "safename", tLanguageType);
...
this.other.Text = String.Empty;
		...
		{
			// 作業代號
			this.TaskId = "ODMFPAYMVE0201";
			// 表單代號
			this.formID = "ODMFPAYMVE0201";
...
this.kind01_ctrolRadio1.Attributes.Add("onclick", "document.getElementById('MasterPage_MasterPageContent_kind01_txt').value = '1';");
		...
		{
			defalutHash.Add("odmfpaymve0201001", this.formID);
			defalutHash.Add("odmfpaymve0201002", this.SheetNo);
...
order by resdd003 desc";
		...
		{
			pReport = "ODMFPAYMVE0201";
			pReportID = "ODMFPAYMVE0201_02";//憑證式
			pWhere = "AND (odmfpaymve0201001='" + this.formID + "') AND (odmfpaymve0201002='" + this.SheetNo + "')";
			pReportDirectory = "ODMFPAYMVE0201";
