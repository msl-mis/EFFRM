...
namespace tw.com.dsc.easyflowDotNet.forms
{
	...
	/// ODMRSCCN01 的摘要描述。
	/// </summary>
	public partial class ODMRSCCN01 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
	{
		//edit by teppy 2011/02/08 Start
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			AjaxPro.Utility.RegisterTypeForAjax(typeof(ODMRSCCN01));
			UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
			string tLanguageType = tClass.Language;

			//多國語系
			this.Title= MultiLanguage.GetComment("FD","ODMRSCCN01","lblTitle",this.UserInfo.Language);
			string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ODMRSCCN01", "HeadTabStrip01", tLanguageType);
			...
			this.label1.Text = MultiLanguage.GetComment("FD", "ODMRSCCN01", "label1", tLanguageType);
			this.username.Title = MultiLanguage.GetComment("FD", "ODMRSCCN01", "username", tLanguageType);
			this.datetime1.Title = MultiLanguage.GetComment("FD", "ODMRSCCN01", "datetime1", tLanguageType);
			this.datetime2.Title = MultiLanguage.GetComment("FD", "ODMRSCCN01", "datetime2", tLanguageType);
			this.dept01.Title = MultiLanguage.GetComment("FD", "ODMRSCCN01", "dept01", tLanguageType);
			this.id01.Title = MultiLanguage.GetComment("FD", "ODMRSCCN01", "id01", tLanguageType);
			this.name01.Title = MultiLanguage.GetComment("FD", "ODMRSCCN01", "name01", tLanguageType);
			this.debt01.Title = MultiLanguage.GetComment("FD", "ODMRSCCN01", "debt01", tLanguageType);
			this.amt01.Title = MultiLanguage.GetComment("FD", "ODMRSCCN01", "amt01", tLanguageType);
			this.dept02.Title = MultiLanguage.GetComment("FD", "ODMRSCCN01", "dept02", tLanguageType);
			this.id02.Title = MultiLanguage.GetComment("FD", "ODMRSCCN01", "id02", tLanguageType);
			this.name02.Title = MultiLanguage.GetComment("FD", "ODMRSCCN01", "name02", tLanguageType);
			this.debt02.Title = MultiLanguage.GetComment("FD", "ODMRSCCN01", "debt02", tLanguageType);
			this.amt02.Title = MultiLanguage.GetComment("FD", "ODMRSCCN01", "amt02", tLanguageType);
			this.dept03.Title = MultiLanguage.GetComment("FD", "ODMRSCCN01", "dept03", tLanguageType);
			this.id03.Title = MultiLanguage.GetComment("FD", "ODMRSCCN01", "id03", tLanguageType);
			this.name03.Title = MultiLanguage.GetComment("FD", "ODMRSCCN01", "name03", tLanguageType);
			this.debt03.Title = MultiLanguage.GetComment("FD", "ODMRSCCN01", "debt03", tLanguageType);
			this.amt03.Title = MultiLanguage.GetComment("FD", "ODMRSCCN01", "amt03", tLanguageType);
			this.dept04.Title = MultiLanguage.GetComment("FD", "ODMRSCCN01", "dept04", tLanguageType);
			this.id04.Title = MultiLanguage.GetComment("FD", "ODMRSCCN01", "id04", tLanguageType);
			this.name04.Title = MultiLanguage.GetComment("FD", "ODMRSCCN01", "name04", tLanguageType);
			this.debt04.Title = MultiLanguage.GetComment("FD", "ODMRSCCN01", "debt04", tLanguageType);
			this.amt04.Title = MultiLanguage.GetComment("FD", "ODMRSCCN01", "amt04", tLanguageType);
			this.dept05.Title = MultiLanguage.GetComment("FD", "ODMRSCCN01", "dept05", tLanguageType);
			this.id05.Title = MultiLanguage.GetComment("FD", "ODMRSCCN01", "id05", tLanguageType);
			this.name05.Title = MultiLanguage.GetComment("FD", "ODMRSCCN01", "name05", tLanguageType);
			this.debt05.Title = MultiLanguage.GetComment("FD", "ODMRSCCN01", "debt05", tLanguageType);
			this.amt05.Title = MultiLanguage.GetComment("FD", "ODMRSCCN01", "amt05", tLanguageType);
			this.dept06.Title = MultiLanguage.GetComment("FD", "ODMRSCCN01", "dept06", tLanguageType);
			this.id06.Title = MultiLanguage.GetComment("FD", "ODMRSCCN01", "id06", tLanguageType);
			this.name06.Title = MultiLanguage.GetComment("FD", "ODMRSCCN01", "name06", tLanguageType);
			this.debt06.Title = MultiLanguage.GetComment("FD", "ODMRSCCN01", "debt06", tLanguageType);
			this.amt06.Title = MultiLanguage.GetComment("FD", "ODMRSCCN01", "amt06", tLanguageType);
			this.dept07.Title = MultiLanguage.GetComment("FD", "ODMRSCCN01", "dept07", tLanguageType);
			this.id07.Title = MultiLanguage.GetComment("FD", "ODMRSCCN01", "id07", tLanguageType);
			this.name07.Title = MultiLanguage.GetComment("FD", "ODMRSCCN01", "name07", tLanguageType);
			this.debt07.Title = MultiLanguage.GetComment("FD", "ODMRSCCN01", "debt07", tLanguageType);
			this.amt07.Title = MultiLanguage.GetComment("FD", "ODMRSCCN01", "amt07", tLanguageType);
			this.dept08.Title = MultiLanguage.GetComment("FD", "ODMRSCCN01", "dept08", tLanguageType);
			this.id08.Title = MultiLanguage.GetComment("FD", "ODMRSCCN01", "id08", tLanguageType);
			this.name08.Title = MultiLanguage.GetComment("FD", "ODMRSCCN01", "name08", tLanguageType);
			this.debt08.Title = MultiLanguage.GetComment("FD", "ODMRSCCN01", "debt08", tLanguageType);
			this.amt08.Title = MultiLanguage.GetComment("FD", "ODMRSCCN01", "amt08", tLanguageType);
			this.dept09.Title = MultiLanguage.GetComment("FD", "ODMRSCCN01", "dept09", tLanguageType);
			this.id09.Title = MultiLanguage.GetComment("FD", "ODMRSCCN01", "id09", tLanguageType);
			this.name09.Title = MultiLanguage.GetComment("FD", "ODMRSCCN01", "name09", tLanguageType);
			this.debt09.Title = MultiLanguage.GetComment("FD", "ODMRSCCN01", "debt09", tLanguageType);
			this.amt09.Title = MultiLanguage.GetComment("FD", "ODMRSCCN01", "amt09", tLanguageType);
			this.dept10.Title = MultiLanguage.GetComment("FD", "ODMRSCCN01", "dept10", tLanguageType);
			this.id10.Title = MultiLanguage.GetComment("FD", "ODMRSCCN01", "id10", tLanguageType);
			this.name10.Title = MultiLanguage.GetComment("FD", "ODMRSCCN01", "name10", tLanguageType);
			this.debt10.Title = MultiLanguage.GetComment("FD", "ODMRSCCN01", "debt10", tLanguageType);
			this.amt10.Title = MultiLanguage.GetComment("FD", "ODMRSCCN01", "amt10", tLanguageType);
			this.totamt.Title = MultiLanguage.GetComment("FD", "ODMRSCCN01", "totamt", tLanguageType);
		...
		{
			// 作業代號
			this.TaskId = "ODMRSCCN01";
			// 表單代號
			this.formID = "ODMRSCCN01";
...
where resfc001=@resfc001 and resfc002=@resfc002 and resfc003=@resfc003 and ISNULL(resfc004,'')<>''";
		...
		{
			defalutHash.Add("odmrsccn01001", this.formID);
			defalutHash.Add("odmrsccn01002", this.SheetNo);
...
order by resdd003 desc";
		...
		{
			pReport = "ODMRSCCN01";
			pReportID = "ODMRSCCN01_02";//憑證式
			pWhere = "AND (odmrsccn01001='" + this.formID + "') AND (odmrsccn01002='" + this.SheetNo + "')";
			pReportDirectory = "ODMRSCCN01";
