<%@ page language="c#" masterpagefile="~\src\_Common\AppUtil\EFMasterPage\EFBaseMasterPage.master" autoeventwireup="false" inherits="tw.com.dsc.easyflowDotNet.forms.RESE007, src.FRM.RESE007" %>

<%@ Register TagPrefix="cc1" Namespace="tw.com.dsc.dscDotNet.dscWebControls" Assembly="PlatformUtil" %>
<%@ Register TagPrefix="iewc" Namespace="Microsoft.Web.UI.WebControls" Assembly="Microsoft.Web.UI.WebControls" %>
<%@ Register TagPrefix="uc1" TagName="gridUserControl" Src="../../_Common/PlatformUtil/KernelPage/Grid/gridUserControl.ascx" %>
<asp:Content ID="RESE007FormContent" ContentPlaceHolderID="MasterPageContent" runat="server">
    <!--單檔架構 -->

    <script src="RESE007.js" type="text/javascript"></script>

    <!--2009/03/19:Joseph:<div id="cover" style="OVERFLOW: auto; WIDTH: 100%;">-->
    <div id="cover" style="width: 100%;">
        <div id="createRecord" style="width: 98%; height: 100%" runat="server">
            <cc1:DscPanel ID="ecPnlMaster" runat="server" Width="98%" IniHTML='&#10;<div style="OVERFLOW: auto; WIDTH: 100%; POSITION: relative; HEIGHT: 100%" ms_positioning="GridLayout"></div>'
                FrmDefineKeys-FrmType="Query" FrmDefineKeys-FrmID="FrmRESE007" FrmDefineKeys-BOID="RESE007"
                ...
                <cc1:DscPanel ID="divheadDefault" Style="display: block" runat="server" Width="100%"
                    ...
                    <div class="TabPage" style="position: relative; height: 400px; left: 0px; top: 0px;">
                        ...
                        <!--此區間放入各種dsc元件-->
                        <cc1:DscTextBox ID="efstn003" runat="server" Style="z-index: 105; left: 3px; position: absolute;
                            top: 16px" TextMode="MultiLine" Title="問題說明" TitleWidth="120px" Width="520px">
                            <FrmFieldKeys FrmID="FrmRESE007" BOID="RESE007" FieldName="efstn003" />
                            <InputStyle CssClass="Edit20" Height="70px" Width="400px" />
                            <Validator MsgF0001="" MsgF0002="" ValidatorExpression="" ValidatorMsg="" ValidatorName="" />
                            <TitleStyle Width="120px" />
                        </cc1:DscTextBox>
                        <cc1:DscTextBox ID="efstn004" runat="server" Style="z-index: 105; left: 3px; position: absolute;
                            top: 98px" TextMode="MultiLine" Title="原因分析" TitleWidth="120px" Width="520px">
                            <FrmFieldKeys FrmID="FrmRESE007" BOID="RESE007" FieldName="efstn004" />
                            <InputStyle CssClass="Edit20" Height="70px" Width="400px" />
                            <Validator MsgF0001="" MsgF0002="" ValidatorExpression="" ValidatorMsg="" ValidatorName="" />
                            <TitleStyle Width="120px" />
                        </cc1:DscTextBox>
                        <cc1:DscTextBox ID="efstn005" runat="server" Style="z-index: 105; left: 3px; position: absolute;
                            top: 180px" TextMode="MultiLine" Title="改善對策" TitleWidth="120px" Width="520px">
                            <FrmFieldKeys FrmID="FrmRESE007" BOID="RESE007" FieldName="efstn005" />
                            <InputStyle CssClass="Edit20" Height="70px" Width="400px" />
                            <Validator MsgF0001="" MsgF0002="" ValidatorExpression="" ValidatorMsg="" ValidatorName="" />
                            <TitleStyle Width="120px" />
                        </cc1:DscTextBox>
                        <cc1:DscTextBox ID="efstn006" runat="server" Style="z-index: 105; left: 3px; position: absolute;
                            top: 261px" TextMode="MultiLine" Title="預防措施" TitleWidth="120px" Width="520px">
                            <FrmFieldKeys FrmID="FrmRESE007" BOID="RESE007" FieldName="efstn006" />
                            <InputStyle CssClass="Edit20" Height="70px" Width="400px" />
                            <Validator MsgF0001="" MsgF0002="" ValidatorExpression="" ValidatorMsg="" ValidatorName="" />
                            <TitleStyle Width="120px" />
                        </cc1:DscTextBox>
                ...
                <cc1:DscPanel ID="hdnDisplayInHTML" Style="display: none; z-index: 116; left: 264px;
                    ...
                    <div style="overflow: auto; width: 100%; position: relative; height: 100%; background-color: transparent">
                        <cc1:DscTextBox ID="efstn001" Title="DscTextBox:" Style="z-index: 101; left: 245px;
                            ...
                            <FrmFieldKeys FrmID="FrmRESE007" BOID="RESE007" FieldName="efstn001"></FrmFieldKeys>
                            <Validator MsgF0001="" MsgF0002="" ValidatorExpression="" ValidatorMsg="" ValidatorName="" />
                        </cc1:DscTextBox>
                        <cc1:DscTextBox ID="efstn002" Title="DscTextBox:" Style="z-index: 102; left: 245px;
                            position: absolute; top: 49px" runat="server" Cellpanding="2" TitleWidth="110px"
                            border="0" CellNo1CssClass="" CellNo2CssClass="" cellpadding="2" cellspacing="0"
                            LangText="DscTextBox:" TitleType="TitleLang01" TxtInput_TabIndex="0">
                            <InputStyle Width="120px"></InputStyle>
                            <TitleStyle Width="110px"></TitleStyle>
                            <FrmFieldKeys FrmID="FrmRESE007" BOID="RESE007" FieldName="efstn002"></FrmFieldKeys>
                            <Validator MsgF0001="" MsgF0002="" ValidatorExpression="" ValidatorMsg="" ValidatorName="" />
                        </cc1:DscTextBox>
                                                                        <cc1:DscTextBox ID="efstn007" runat="server"  TextMode="MultiLine" Title="預防措施" TitleWidth="0px" Width="0px" Height="1px">
                            <FrmFieldKeys FrmID="FrmRESE007" BOID="RESE007" FieldName="efstn007" />
