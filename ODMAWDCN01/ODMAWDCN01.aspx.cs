...
namespace tw.com.dsc.easyflowDotNet.forms
{
	...
	/// ODMAWDCN01 的摘要描述。
	/// </summary>
	public partial class ODMAWDCN01 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
	{
		//edit by teppy 2011/02/08 Start
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			AjaxPro.Utility.RegisterTypeForAjax(typeof(ODMAWDCN01));
			UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
			string tLanguageType = tClass.Language;

			//多國語系
			this.Title= MultiLanguage.GetComment("FD","ODMAWDCN01","lblTitle",this.UserInfo.Language);
			string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ODMAWDCN01", "HeadTabStrip01", tLanguageType);
			...
			this.txtdept.Title = MultiLanguage.GetComment("FD", "ODMAWDCN01", "txtdept", tLanguageType);
			this.date.Title = MultiLanguage.GetComment("FD", "ODMAWDCN01", "date", tLanguageType);
			this.txtmain.Title = MultiLanguage.GetComment("FD", "ODMAWDCN01", "txtmain", tLanguageType);
			this.txtuser.Title = MultiLanguage.GetComment("FD", "ODMAWDCN01", "txtuser", tLanguageType);
			this.totalmoney.Title = MultiLanguage.GetComment("FD", "ODMAWDCN01", "totalmoney", tLanguageType);
		...
		{
			// 作業代號
			this.TaskId = "ODMAWDCN01";
			// 表單代號
			this.formID = "ODMAWDCN01";
...
where resfc001=@resfc001 and resfc002=@resfc002 and resfc003=@resfc003 and ISNULL(resfc004,'')<>''";
		...
		{
			defalutHash.Add("odmawdcn01001", this.formID);
			defalutHash.Add("odmawdcn01002", this.SheetNo);
...
order by resdd003 desc";
		...
		{
			pReport = "ODMAWDCN01";
			pReportID = "ODMAWDCN01_02";//憑證式
			pWhere = "AND (odmawdcn01001='" + this.formID + "') AND (odmawdcn01002='" + this.SheetNo + "')";
			pReportDirectory = "ODMAWDCN01";
