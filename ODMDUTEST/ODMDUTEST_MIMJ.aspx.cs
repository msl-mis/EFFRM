...
{
	/// <summary>
	/// ODMDUTEST_MIMJ 的摘要描述。
	/// </summary>
	public partial class ODMDUTEST_MIMJ : tw.com.dsc.easyflowDotNet.kernelBasePage.EFMIMJBasepage
	{
		...
		protected override void MIFunction()
		{
			switch(tBtnID)
			{
				case "MasterPage_MasterPageContent_newopenquery1_btn":			//其它類型開窗
				{
					base.doMI("RESAK","01");
					break;
				}
				case "MasterPage_MasterPageContent_newopenquery2_btn":			//其它類型開窗
				{
					base.doMI("OpenMIMJ01","15");
					break;
				}
				...
				case "MasterPage_MasterPageContent_newopenquery3_btn":			//其它類型開窗
				{
					base.doMI("TrigMIMJ01","06");
					break;
				}
		...
		protected override void MJFunction()
		{
			...
			{
				case "RESAK_01_newopenquery1_d01":	
				{
					base.doMJ("RESAK","01","MasterPage_MasterPageContent_newopenquery1_txt2=resak002");
					break;
				}
				case "OpenMIMJ01_15_newopenquery2_d01":	
				{
					base.doMJ("OpenMIMJ01","15","MasterPage_MasterPageContent_newopenquery2_txt2=resal002");
					break;
				}
				case "部門代號_dept1_d01":	
				{
					bSelfResult = getMJResult("RESAL","01",1,FinalList,"MasterPage_MasterPageContent_dept1_txt2=resal002");
					if(bSelfResult)
					{
						if (tAllInputValues["MasterPage_MasterPageContent_newopenquery3_txt"] != null && tAllInputValues["MasterPage_MasterPageContent_newopenquery3_txt"].ToString().Length > 0){
							string[] aryParamger = new string[2];
							aryParamger[0]=tAllInputValues["MasterPage_MasterPageContent_newopenquery3_txt"].ToString();
							aryParamger[1]=tAllInputValues["MasterPage_MasterPageContent_dept1_txt"].ToString();
							//自訂MsgCode
							bool bTriggerMJ=getMJResult("TrigMIMJ01","06",aryParamger,FinalList,"MasterPage_MasterPageContent_newopenquery3_txt2=resak002");
							if(!bTriggerMJ){
								base.FinalList.Add("MasterPage_MasterPageContent_newopenquery3_txt", "value", "");
								base.FinalList.Add("MasterPage_MasterPageContent_newopenquery3_txt2", "value", "");
								string strErrorMsg = "「'+$('#MasterPage_MasterPageContent_newopenquery3_lbl').text()+'」"+MultiLanguage.GetComment("PSMSG", "MJValidationError", "保留",this.UserInfo.Language.ToString().Trim());
								base.FinalList.Insert(0,"alert('"+strErrorMsg+"')");
								base.FinalList.Insert(1,"FunOnChange_dept1();");
							}
						}
					}
				...
				case "TrigMIMJ01_06_newopenquery3_d01":	
				{
					base.doMJ("TrigMIMJ01","06","MasterPage_MasterPageContent_newopenquery3_txt2=resak002");
					break;
				}
