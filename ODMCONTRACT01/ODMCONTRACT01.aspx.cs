...
namespace tw.com.dsc.easyflowDotNet.forms
{
	...
	/// ODMCONTRACT01 的摘要描述。
	/// </summary>
	public partial class ODMCONTRACT01 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
	{
		//edit by teppy 2011/02/08 Start
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			AjaxPro.Utility.RegisterTypeForAjax(typeof(ODMCONTRACT01));
			UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
			string tLanguageType = tClass.Language;

			//多國語系
			this.Title= MultiLanguage.GetComment("FD","ODMCONTRACT01","lblTitle",this.UserInfo.Language);
			string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ODMCONTRACT01", "HeadTabStrip01", tLanguageType);
			...
			this.lblcontact.Text = MultiLanguage.GetComment("FD", "ODMCONTRACT01", "lblcontact", tLanguageType);
			this.lbldate.Text = MultiLanguage.GetComment("FD", "ODMCONTRACT01", "lbldate", tLanguageType);
			this.lbldept.Text = MultiLanguage.GetComment("FD", "ODMCONTRACT01", "lbldept", tLanguageType);
			this.title.Text = MultiLanguage.GetComment("FD", "ODMCONTRACT01", "title", tLanguageType);
			this.txtdept.Title = MultiLanguage.GetComment("FD", "ODMCONTRACT01", "txtdept", tLanguageType);
			this.date.Title = MultiLanguage.GetComment("FD", "ODMCONTRACT01", "date", tLanguageType);
			this.txtmain.Title = MultiLanguage.GetComment("FD", "ODMCONTRACT01", "txtmain", tLanguageType);
			this.empl1.Title = MultiLanguage.GetComment("FD", "ODMCONTRACT01", "empl1", tLanguageType);
			this.empl2.Title = MultiLanguage.GetComment("FD", "ODMCONTRACT01", "empl2", tLanguageType);
		...
		{
			// 作業代號
			this.TaskId = "ODMCONTRACT01";
			// 表單代號
			this.formID = "ODMCONTRACT01";
...
where resfc001=@resfc001 and resfc002=@resfc002 and resfc003=@resfc003 and ISNULL(resfc004,'')<>''";
		...
		{
			defalutHash.Add("odmcontract01001", this.formID);
			defalutHash.Add("odmcontract01002", this.SheetNo);
...
order by resdd003 desc";
		...
		{
			pReport = "ODMCONTRACT01";
			pReportID = "ODMCONTRACT01_02";//憑證式
			pWhere = "AND (odmcontract01001='" + this.formID + "') AND (odmcontract01002='" + this.SheetNo + "')";
			pReportDirectory = "ODMCONTRACT01";
