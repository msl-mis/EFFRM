<%@ page language="c#" masterpagefile="~/src/_Common/AppUtil/EFMasterPage/EFBaseMasterPage.master" autoeventwireup="false" inherits="tw.com.dsc.easyflowDotNet.forms.EMVAR01, src.FRM.EMVAR01" %>

<%@ Register TagPrefix="cc1" Namespace="tw.com.dsc.dscDotNet.dscWebControls" Assembly="PlatformUtil" %>
<%@ Register TagPrefix="iewc" Namespace="Microsoft.Web.UI.WebControls" Assembly="Microsoft.Web.UI.WebControls" %>
<%@ Register TagPrefix="uc1" TagName="gridUserControl" Src="../../_Common/PlatformUtil/KernelPage/Grid/gridUserControl.ascx" %>
<asp:Content ID="EMVAR01FormContent" ContentPlaceHolderID="MasterPageContent" runat="server">
    <!--單檔架構 -->

    <script src="../../_Common/JS/jquery-1.4.2.js" type="text/javascript"></script>

    <script src="EMVAR01.js" type="text/javascript"></script>

    <!--2009/03/19:Joseph:<div id="cover" style="OVERFLOW: auto; WIDTH: 100%;">-->
    <div id="cover" style="width: 100%;">
        <div id="createRecord" style="width: 100%; height: 100%" runat="server">
            <cc1:DscPanel ID="ecPnlMaster" runat="server" Width="98%" IniHTML='&#10;<div style="OVERFLOW: auto; WIDTH: 100%; POSITION: relative; HEIGHT: 100%" ms_positioning="GridLayout"></div>'
                FrmDefineKeys-FrmType="Query" FrmDefineKeys-FrmID="FrmEMVAR01" FrmDefineKeys-BOID="EMVAR01"
                                ...
                                <tr>
                                    <td align="center">
                                        ...
                                        <tr>
                                            ...
                                            <td align="left">
                                                <cc1:DscTextBox ID="emvar01003" runat="server" ShowTitle="false" Cellpanding="0" TxtInput_TabIndex="101" border="0" cellpadding="0"
                                                    cellspacing="0" TextMode="MultiLine" TitleLocation="_Left">
                                                    <FrmFieldKeys FrmID="FrmEMVAR01" BOID="EMVAR01" FieldName="emvar01003"></FrmFieldKeys>
                                ...
                                <tr>
                                    <td align="center">
                                        ...
                                        <tr>
                                            ...
                                            <td align="left">
                                                <cc1:DscTextBox ID="emvar01006" runat="server" ShowTitle="false" Cellpanding="0" TxtInput_TabIndex="101" border="0" cellpadding="0"
                                                    cellspacing="0" TextMode="MultiLine" TitleLocation="_Left">
                                                    <FrmFieldKeys FrmID="FrmEMVAR01" BOID="EMVAR01" FieldName="emvar01006"></FrmFieldKeys>
                                                    <InputStyle Height="150px" Width="600px"></InputStyle>
                                                </cc1:DscTextBox>
                                            </td>                                        
                                        </tr>
                ...
                <cc1:DscPanel ID="hdnDisplayInHTML" Style="display: none; z-index: 116; left: 264px;
                    ...
                    <div style="overflow: auto; width: 100%; position: relative; height: 100%; background-color: transparent">
                        <cc1:DscTextBox ID="emvar01001" Title="DscTextBox:" Style="z-index: 101; left: 245px;
                            ...
                            <FrmFieldKeys FrmID="FrmEMVAR01" BOID="EMVAR01" FieldName="emvar01001"></FrmFieldKeys>
                            <Validator MsgF0001="" MsgF0002="" ValidatorExpression="" ValidatorMsg="" ValidatorName="" />
                        </cc1:DscTextBox>
                        <cc1:DscTextBox ID="emvar01002" Title="DscTextBox:" Style="z-index: 102; left: 245px;
                            position: absolute; top: 49px" runat="server" Cellpanding="2" TitleWidth="110px"
                            border="0" CellNo1CssClass="" CellNo2CssClass="" cellpadding="2" cellspacing="0"
                            LangText="DscTextBox:" TitleType="TitleLang01" TxtInput_TabIndex="0">
                            <InputStyle Width="120px"></InputStyle>
                            <TitleStyle Width="110px"></TitleStyle>
                            <FrmFieldKeys FrmID="FrmEMVAR01" BOID="EMVAR01" FieldName="emvar01002"></FrmFieldKeys>
                            <Validator MsgF0001="" MsgF0002="" ValidatorExpression="" ValidatorMsg="" ValidatorName="" />
                        </cc1:DscTextBox>
                        <cc1:DscTextBox ID="emvar01004" Title="帳款內容" Style="z-index: 699; left: 77px; position: absolute;
                            ...
                            <FrmFieldKeys FrmID="FrmEMVAR01" BOID="EMVAR01" FieldName="emvar01004"></FrmFieldKeys>
                        ...
                        <cc1:DscTextBox ID="emvar01005" Title="text2" Style="z-index: 698; left: 78px; position: absolute;
                            ...
                            cellspacing="0" Text="" TitleType="TitleLang01">
                            <FrmFieldKeys FrmID="FrmEMVAR01" BOID="EMVAR01" FieldName="emvar01005"></FrmFieldKeys>
                            <TitleStyle Width="100px"></TitleStyle>
                            <InputStyle Width="559px" Height="57px" CssClass="Edit20"></InputStyle>
                            <Validator ValidatorMsg="" ValidatorExpression="" MsgF0001="" MsgF0002="" ValidatorName="">
                            </Validator>
                        </cc1:DscTextBox>
                        <cc1:DscTextBox ID="emvar01007" Title="text2" Style="z-index: 698; left: 78px; position: absolute;
                            top: 421px" runat="server" LangText="text2" Cellpanding="0" TitleWidth="120px"
                            TxtInput_TabIndex="103" border="0" CellNo1CssClass="" CellNo2CssClass="" cellpadding="0"
                            cellspacing="0" Text="" TitleType="TitleLang01">
                            <FrmFieldKeys FrmID="FrmEMVAR01" BOID="EMVAR01" FieldName="emvar01007"></FrmFieldKeys>
                            <TitleStyle Width="100px"></TitleStyle>
                            <InputStyle Width="559px" Height="57px" CssClass="Edit20"></InputStyle>
                            <Validator ValidatorMsg="" ValidatorExpression="" MsgF0001="" MsgF0002="" ValidatorName="">
                            </Validator>
