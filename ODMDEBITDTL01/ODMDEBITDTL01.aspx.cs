...
namespace tw.com.dsc.easyflowDotNet.forms
{
	...
	/// ODMDEBITDTL01 的摘要描述。
	/// </summary>
	public partial class ODMDEBITDTL01 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
	{
		//edit by teppy 2011/02/08 Start
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			AjaxPro.Utility.RegisterTypeForAjax(typeof(ODMDEBITDTL01));
			UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
			string tLanguageType = tClass.Language;

			//多國語系
			this.Title= MultiLanguage.GetComment("FD","ODMDEBITDTL01","lblTitle",this.UserInfo.Language);
			string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ODMDEBITDTL01", "HeadTabStrip01", tLanguageType);
			...
			this.lblcontact.Text = MultiLanguage.GetComment("FD", "ODMDEBITDTL01", "lblcontact", tLanguageType);
			this.lbltitle.Text = MultiLanguage.GetComment("FD", "ODMDEBITDTL01", "lbltitle", tLanguageType);
			this.lbltxt.Text = MultiLanguage.GetComment("FD", "ODMDEBITDTL01", "lbltxt", tLanguageType);
			this.lbltxt01.Text = MultiLanguage.GetComment("FD", "ODMDEBITDTL01", "lbltxt01", tLanguageType);
			this.lbltxt02.Text = MultiLanguage.GetComment("FD", "ODMDEBITDTL01", "lbltxt02", tLanguageType);
			this.lbltxt03.Text = MultiLanguage.GetComment("FD", "ODMDEBITDTL01", "lbltxt03", tLanguageType);
			this.lbltxt04.Text = MultiLanguage.GetComment("FD", "ODMDEBITDTL01", "lbltxt04", tLanguageType);
			this.lbluser.Text = MultiLanguage.GetComment("FD", "ODMDEBITDTL01", "lbluser", tLanguageType);
			this.txtother.Title = MultiLanguage.GetComment("FD", "ODMDEBITDTL01", "txtother", tLanguageType);
			this.txtcontact.Title = MultiLanguage.GetComment("FD", "ODMDEBITDTL01", "txtcontact", tLanguageType);
			this.usedate.Title = MultiLanguage.GetComment("FD", "ODMDEBITDTL01", "usedate", tLanguageType);
		...
		{
			// 作業代號
			this.TaskId = "ODMDEBITDTL01";
			// 表單代號
			this.formID = "ODMDEBITDTL01";
...
this.rditem_ctrolRadio3.Attributes.Add("onclick", "InitTriggerMust('" + base.FormStatus.ToString() + "');document.getElementById('MasterPage_MasterPageContent_rditem_txt').value = '3';");
		...
		{
			defalutHash.Add("odmdebitdtl01001", this.formID);
			defalutHash.Add("odmdebitdtl01002", this.SheetNo);
...
order by resdd003 desc";
		...
		{
			pReport = "ODMDEBITDTL01";
			pReportID = "ODMDEBITDTL01_02";//憑證式
			pWhere = "AND (odmdebitdtl01001='" + this.formID + "') AND (odmdebitdtl01002='" + this.SheetNo + "')";
			pReportDirectory = "ODMDEBITDTL01";
