...
namespace tw.com.dsc.easyflowDotNet.forms
{
	...
	/// ODMAPYCN01 的摘要描述。
	/// </summary>
	public partial class ODMAPYCN01 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
	{
		//edit by teppy 2011/02/08 Start
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			AjaxPro.Utility.RegisterTypeForAjax(typeof(ODMAPYCN01));
			UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
			string tLanguageType = tClass.Language;

			//多國語系
			this.Title= MultiLanguage.GetComment("FD","ODMAPYCN01","lblTitle",this.UserInfo.Language);
			string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ODMAPYCN01", "HeadTabStrip01", tLanguageType);
			...
			this.txtuser.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "txtuser", tLanguageType);
			this.applydate.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "applydate", tLanguageType);
			this.txtno01.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "txtno01", tLanguageType);
			this.txtname01.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "txtname01", tLanguageType);
			this.txtamt01.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "txtamt01", tLanguageType);
			this.txtunit01.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "txtunit01", tLanguageType);
			this.txtprice01.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "txtprice01", tLanguageType);
			this.txtcomp01.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "txtcomp01", tLanguageType);
			this.datetime1.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "datetime1", tLanguageType);
			this.txtno02.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "txtno02", tLanguageType);
			this.txtname02.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "txtname02", tLanguageType);
			this.txtamt02.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "txtamt02", tLanguageType);
			this.txtunit02.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "txtunit02", tLanguageType);
			this.txtprice02.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "txtprice02", tLanguageType);
			this.txtcomp02.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "txtcomp02", tLanguageType);
			this.datetime2.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "datetime2", tLanguageType);
			this.txtno03.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "txtno03", tLanguageType);
			this.txtname03.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "txtname03", tLanguageType);
			this.txtamt03.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "txtamt03", tLanguageType);
			this.txtunit03.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "txtunit03", tLanguageType);
			this.txtprice03.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "txtprice03", tLanguageType);
			this.txtcomp03.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "txtcomp03", tLanguageType);
			this.txtother.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "txtother", tLanguageType);
			this.datetime3.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "datetime3", tLanguageType);
			this.txtno04.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "txtno04", tLanguageType);
			this.txtname04.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "txtname04", tLanguageType);
			this.txtamt04.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "txtamt04", tLanguageType);
			this.txtunit04.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "txtunit04", tLanguageType);
			this.txtprice04.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "txtprice04", tLanguageType);
			this.txtcomp04.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "txtcomp04", tLanguageType);
			this.datetime4.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "datetime4", tLanguageType);
			this.txtno05.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "txtno05", tLanguageType);
			this.txtname05.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "txtname05", tLanguageType);
			this.txtamt05.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "txtamt05", tLanguageType);
			this.txtunit05.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "txtunit05", tLanguageType);
			this.txtprice05.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "txtprice05", tLanguageType);
			this.txtcomp05.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "txtcomp05", tLanguageType);
			this.datetime5.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "datetime5", tLanguageType);
			this.txtno06.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "txtno06", tLanguageType);
			this.txtname06.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "txtname06", tLanguageType);
			this.txtamt06.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "txtamt06", tLanguageType);
			this.txtunit06.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "txtunit06", tLanguageType);
			this.txtprice06.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "txtprice06", tLanguageType);
			this.txtcomp06.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "txtcomp06", tLanguageType);
			this.datetime6.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "datetime6", tLanguageType);
			this.txtno07.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "txtno07", tLanguageType);
			this.txtname07.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "txtname07", tLanguageType);
			this.txtamt07.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "txtamt07", tLanguageType);
			this.txtunit07.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "txtunit07", tLanguageType);
			this.txtprice07.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "txtprice07", tLanguageType);
			this.txtcomp07.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "txtcomp07", tLanguageType);
			this.datetime7.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "datetime7", tLanguageType);
			this.txtno08.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "txtno08", tLanguageType);
			this.txtname08.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "txtname08", tLanguageType);
			this.txtamt08.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "txtamt08", tLanguageType);
			this.txtunit08.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "txtunit08", tLanguageType);
			this.txtprice08.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "txtprice08", tLanguageType);
			this.txtcomp08.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "txtcomp08", tLanguageType);
			this.datetime8.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "datetime8", tLanguageType);
			this.txtresaon.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "txtresaon", tLanguageType);
			this.empl1.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "empl1", tLanguageType);
			this.txtdept.Title = MultiLanguage.GetComment("FD", "ODMAPYCN01", "txtdept", tLanguageType);
...
this.txtresaon.ToolTip = this.txtresaon.Text;
		...
		{
			// 作業代號
			this.TaskId = "ODMAPYCN01";
			// 表單代號
			this.formID = "ODMAPYCN01";
...
this.rditem_ctrolRadio3.Attributes.Add("onclick", "InitTriggerMust('" + base.FormStatus.ToString() + "');document.getElementById('MasterPage_MasterPageContent_rditem_txt').value = '3';");
		...
		{
			defalutHash.Add("odmapycn01001", this.formID);
			defalutHash.Add("odmapycn01002", this.SheetNo);
...
order by resdd003 desc";
		...
		{
			pReport = "ODMAPYCN01";
			pReportID = "ODMAPYCN01_02";//憑證式
			pWhere = "AND (odmapycn01001='" + this.formID + "') AND (odmapycn01002='" + this.SheetNo + "')";
			pReportDirectory = "ODMAPYCN01";
