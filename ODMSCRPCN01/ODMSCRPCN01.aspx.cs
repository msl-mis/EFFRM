...
namespace tw.com.dsc.easyflowDotNet.forms
{
	...
	/// ODMSCRPCN01 的摘要描述。
	/// </summary>
	public partial class ODMSCRPCN01 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
	{
		//edit by teppy 2011/02/08 Start
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			AjaxPro.Utility.RegisterTypeForAjax(typeof(ODMSCRPCN01));
			UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
			string tLanguageType = tClass.Language;

			//多國語系
			this.Title= MultiLanguage.GetComment("FD","ODMSCRPCN01","lblTitle",this.UserInfo.Language);
			string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ODMSCRPCN01", "HeadTabStrip01", tLanguageType);
			...
			this.buydate.Title = MultiLanguage.GetComment("FD", "ODMSCRPCN01", "buydate", tLanguageType);
			this.materialsno.Title = MultiLanguage.GetComment("FD", "ODMSCRPCN01", "materialsno", tLanguageType);
			this.materialname.Title = MultiLanguage.GetComment("FD", "ODMSCRPCN01", "materialname", tLanguageType);
			this.location.Title = MultiLanguage.GetComment("FD", "ODMSCRPCN01", "location", tLanguageType);
			this.materialspec.Title = MultiLanguage.GetComment("FD", "ODMSCRPCN01", "materialspec", tLanguageType);
			this.scrpqty.Title = MultiLanguage.GetComment("FD", "ODMSCRPCN01", "scrpqty", tLanguageType);
			this.assprice.Title = MultiLanguage.GetComment("FD", "ODMSCRPCN01", "assprice", tLanguageType);
			this.scrpreason.Title = MultiLanguage.GetComment("FD", "ODMSCRPCN01", "scrpreason", tLanguageType);
			this.userid.Title = MultiLanguage.GetComment("FD", "ODMSCRPCN01", "userid", tLanguageType);
			this.superid.Title = MultiLanguage.GetComment("FD", "ODMSCRPCN01", "superid", tLanguageType);
			this.outprice.Title = MultiLanguage.GetComment("FD", "ODMSCRPCN01", "outprice", tLanguageType);
...
this.scrpreason.ToolTip = this.scrpreason.Text;
		...
		{
			// 作業代號
			this.TaskId = "ODMSCRPCN01";
			// 表單代號
			this.formID = "ODMSCRPCN01";
...
order by resdd003 desc";
		...
		{
			pReport = "ODMSCRPCN01";
			pReportID = "ODMSCRPCN01_02";//憑證式
			pWhere = "AND (odmscrpcn01001='" + this.formID + "') AND (odmscrpcn01002='" + this.SheetNo + "')";
			pReportDirectory = "ODMSCRPCN01";
