...
namespace tw.com.dsc.easyflowDotNet.forms
{
	...
	/// ODMSIGNOFF01 的摘要描述。
	/// </summary>
	public partial class ODMSIGNOFF01 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
	{
		//edit by teppy 2011/02/08 Start
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			AjaxPro.Utility.RegisterTypeForAjax(typeof(ODMSIGNOFF01));
			UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
			string tLanguageType = tClass.Language;

			//多國語系
			this.Title= MultiLanguage.GetComment("FD","ODMSIGNOFF01","lblTitle",this.UserInfo.Language);
			string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ODMSIGNOFF01", "HeadTabStrip01", tLanguageType);
			...
			this.category.Text = MultiLanguage.GetComment("FD", "ODMSIGNOFF01", "category", tLanguageType);
			this.comp.Text = MultiLanguage.GetComment("FD", "ODMSIGNOFF01", "comp", tLanguageType);
			this.contact.Text = MultiLanguage.GetComment("FD", "ODMSIGNOFF01", "contact", tLanguageType);
			this.label1.Text = MultiLanguage.GetComment("FD", "ODMSIGNOFF01", "label1", tLanguageType);
			this.label10.Text = MultiLanguage.GetComment("FD", "ODMSIGNOFF01", "label10", tLanguageType);
			this.label11.Text = MultiLanguage.GetComment("FD", "ODMSIGNOFF01", "label11", tLanguageType);
			this.label12.Text = MultiLanguage.GetComment("FD", "ODMSIGNOFF01", "label12", tLanguageType);
			this.label2.Text = MultiLanguage.GetComment("FD", "ODMSIGNOFF01", "label2", tLanguageType);
			this.label3.Text = MultiLanguage.GetComment("FD", "ODMSIGNOFF01", "label3", tLanguageType);
			this.label4.Text = MultiLanguage.GetComment("FD", "ODMSIGNOFF01", "label4", tLanguageType);
			this.label5.Text = MultiLanguage.GetComment("FD", "ODMSIGNOFF01", "label5", tLanguageType);
			this.label6.Text = MultiLanguage.GetComment("FD", "ODMSIGNOFF01", "label6", tLanguageType);
			this.label7.Text = MultiLanguage.GetComment("FD", "ODMSIGNOFF01", "label7", tLanguageType);
			this.label8.Text = MultiLanguage.GetComment("FD", "ODMSIGNOFF01", "label8", tLanguageType);
			this.label9.Text = MultiLanguage.GetComment("FD", "ODMSIGNOFF01", "label9", tLanguageType);
			this.main.Text = MultiLanguage.GetComment("FD", "ODMSIGNOFF01", "main", tLanguageType);
			this.title.Text = MultiLanguage.GetComment("FD", "ODMSIGNOFF01", "title", tLanguageType);
			this.text1.Title = MultiLanguage.GetComment("FD", "ODMSIGNOFF01", "text1", tLanguageType);
			this.textarea1.Title = MultiLanguage.GetComment("FD", "ODMSIGNOFF01", "textarea1", tLanguageType);
			this.username.Title = MultiLanguage.GetComment("FD", "ODMSIGNOFF01", "username", tLanguageType);
			this.datetime1.Title = MultiLanguage.GetComment("FD", "ODMSIGNOFF01", "datetime1", tLanguageType);
			this.text2.Title = MultiLanguage.GetComment("FD", "ODMSIGNOFF01", "text2", tLanguageType);
			this.empl1.Title = MultiLanguage.GetComment("FD", "ODMSIGNOFF01", "empl1", tLanguageType);
			this.empl2.Title = MultiLanguage.GetComment("FD", "ODMSIGNOFF01", "empl2", tLanguageType);
		...
		protected override void Page_Prender(object sender, EventArgs e)
		{
			...
			cate.Attributes["style"] = "display:none;";
			cate_ctrolRadio0.Checked = (cate.Value == "0"); cate_ctrolRadio0.Enabled = cate.InputEnabled;
			cate_ctrolRadio1.Checked = (cate.Value == "1"); cate_ctrolRadio1.Enabled = cate.InputEnabled;
			cate_ctrolRadio2.Checked = (cate.Value == "2"); cate_ctrolRadio2.Enabled = cate.InputEnabled;
			cate_ctrolRadio3.Checked = (cate.Value == "3"); cate_ctrolRadio3.Enabled = cate.InputEnabled;
			cate_ctrolRadio4.Checked = (cate.Value == "4"); cate_ctrolRadio4.Enabled = cate.InputEnabled;
			rdcomp.Attributes["style"] = "display:none;";
			rdcomp_ctrolRadio0.Checked = (rdcomp.Value == "0"); rdcomp_ctrolRadio0.Enabled = rdcomp.InputEnabled;
			rdcomp_ctrolRadio1.Checked = (rdcomp.Value == "1"); rdcomp_ctrolRadio1.Enabled = rdcomp.InputEnabled;
			rdcomp_ctrolRadio2.Checked = (rdcomp.Value == "2"); rdcomp_ctrolRadio2.Enabled = rdcomp.InputEnabled;
			rdcomp_ctrolRadio3.Checked = (rdcomp.Value == "3"); rdcomp_ctrolRadio3.Enabled = rdcomp.InputEnabled;
			rdcomp_ctrolRadio4.Checked = (rdcomp.Value == "4"); rdcomp_ctrolRadio4.Enabled = rdcomp.InputEnabled;
		...
		{
			// 作業代號
			this.TaskId = "ODMSIGNOFF01";
			// 表單代號
			this.formID = "ODMSIGNOFF01";
...
this.cate_ctrolRadio0.Attributes.Add("onclick", "InitTriggerMust('" + base.FormStatus.ToString() + "');document.getElementById('MasterPage_MasterPageContent_cate_txt').value = '0';");
this.cate_ctrolRadio1.Attributes.Add("onclick", "InitTriggerMust('" + base.FormStatus.ToString() + "');document.getElementById('MasterPage_MasterPageContent_cate_txt').value = '1';");
this.cate_ctrolRadio2.Attributes.Add("onclick", "InitTriggerMust('" + base.FormStatus.ToString() + "');document.getElementById('MasterPage_MasterPageContent_cate_txt').value = '2';");
this.cate_ctrolRadio3.Attributes.Add("onclick", "InitTriggerMust('" + base.FormStatus.ToString() + "');document.getElementById('MasterPage_MasterPageContent_cate_txt').value = '3';");
this.cate_ctrolRadio4.Attributes.Add("onclick", "InitTriggerMust('" + base.FormStatus.ToString() + "');document.getElementById('MasterPage_MasterPageContent_cate_txt').value = '4';");
this.rdcomp_ctrolRadio0.Attributes.Add("onclick", "document.getElementById('MasterPage_MasterPageContent_rdcomp_txt').value = '0';");
this.rdcomp_ctrolRadio1.Attributes.Add("onclick", "document.getElementById('MasterPage_MasterPageContent_rdcomp_txt').value = '1';");
this.rdcomp_ctrolRadio2.Attributes.Add("onclick", "document.getElementById('MasterPage_MasterPageContent_rdcomp_txt').value = '2';");
this.rdcomp_ctrolRadio3.Attributes.Add("onclick", "document.getElementById('MasterPage_MasterPageContent_rdcomp_txt').value = '3';");
this.rdcomp_ctrolRadio4.Attributes.Add("onclick", "document.getElementById('MasterPage_MasterPageContent_rdcomp_txt').value = '4';");
		...
		{
			defalutHash.Add("odmsignoff01001", this.formID);
			defalutHash.Add("odmsignoff01002", this.SheetNo);
...
order by resdd003 desc";
		...
		protected override void ReGetCondValue(object[,] pAryCondValue)
		{
			...
			tDbl=3;
			try{
				tDbl = double.Parse(this.cate.Value.Trim());
			}
			catch(Exception e){
				tDbl=3;
			}
			pAryCondValue[0, 0] = "cate04";
		...
		{
			pReport = "ODMSIGNOFF01";
			pReportID = "ODMSIGNOFF01_02";//憑證式
			pWhere = "AND (odmsignoff01001='" + this.formID + "') AND (odmsignoff01002='" + this.SheetNo + "')";
			pReportDirectory = "ODMSIGNOFF01";
