...
namespace tw.com.dsc.easyflowDotNet.forms
{
	...
	/// ODMSGNCN01 的摘要描述。
	/// </summary>
	public partial class ODMSGNCN01 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
	{
		//edit by teppy 2011/02/08 Start
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			AjaxPro.Utility.RegisterTypeForAjax(typeof(ODMSGNCN01));
			UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
			string tLanguageType = tClass.Language;

			//多國語系
			this.Title= MultiLanguage.GetComment("FD","ODMSGNCN01","lblTitle",this.UserInfo.Language);
			string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ODMSGNCN01", "HeadTabStrip01", tLanguageType);
			...
			this.txtmain.Title = MultiLanguage.GetComment("FD", "ODMSGNCN01", "txtmain", tLanguageType);
			this.textarea1.Title = MultiLanguage.GetComment("FD", "ODMSGNCN01", "textarea1", tLanguageType);
			this.username.Title = MultiLanguage.GetComment("FD", "ODMSGNCN01", "username", tLanguageType);
			this.datetime1.Title = MultiLanguage.GetComment("FD", "ODMSGNCN01", "datetime1", tLanguageType);
			this.text2.Title = MultiLanguage.GetComment("FD", "ODMSGNCN01", "text2", tLanguageType);
			this.empl1.Title = MultiLanguage.GetComment("FD", "ODMSGNCN01", "empl1", tLanguageType);
			this.empl2.Title = MultiLanguage.GetComment("FD", "ODMSGNCN01", "empl2", tLanguageType);
		...
		protected override void Page_Prender(object sender, EventArgs e)
		{
			...
			cate_ctrolRadio5.Checked = (cate.Value == "5"); cate_ctrolRadio5.Enabled = cate.InputEnabled;
		...
		{
			// 作業代號
			this.TaskId = "ODMSGNCN01";
			// 表單代號
			this.formID = "ODMSGNCN01";
...
this.cate_ctrolRadio5.Attributes.Add("onclick", "InitTriggerMust('" + base.FormStatus.ToString() + "');document.getElementById('MasterPage_MasterPageContent_cate_txt').value = '5';");
		...
		{
			defalutHash.Add("odmsgncn01001", this.formID);
			defalutHash.Add("odmsgncn01002", this.SheetNo);
...
order by resdd003 desc";
		...
		protected override void ReGetCondValue(object[,] pAryCondValue)
		{
			...
			tDbl=0;
			try{
				tDbl = double.Parse(this.empl2.Value.Trim());
			}
			catch(Exception e){
				tDbl=0;
			}
			...
			tDbl=0;
			try{
				tDbl = double.Parse(this.empl1.Value.Trim());
			}
			catch(Exception e){
				tDbl=0;
			}
			pAryCondValue[0, 6] = "ID";
		...
		{
			pReport = "ODMSGNCN01";
			pReportID = "ODMSGNCN01_02";//憑證式
			pWhere = "AND (odmsgncn01001='" + this.formID + "') AND (odmsgncn01002='" + this.SheetNo + "')";
			pReportDirectory = "ODMSGNCN01";
