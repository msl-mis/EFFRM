...
namespace tw.com.dsc.easyflowDotNet.forms
{
	...
	/// ODMREPMVE01 的摘要描述。
	/// </summary>
	public partial class ODMREPMVE01 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
	{
		//edit by teppy 2011/02/08 Start
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			AjaxPro.Utility.RegisterTypeForAjax(typeof(ODMREPMVE01));
			UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
			string tLanguageType = tClass.Language;

			//多國語系
			this.Title= MultiLanguage.GetComment("FD","ODMREPMVE01","lblTitle",this.UserInfo.Language);
			string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ODMREPMVE01", "HeadTabStrip01", tLanguageType);
			...
			this.note.Text = MultiLanguage.GetComment("FD", "ODMREPMVE01", "note", tLanguageType);
			this.username.Title = MultiLanguage.GetComment("FD", "ODMREPMVE01", "username", tLanguageType);
			this.userid.Title = MultiLanguage.GetComment("FD", "ODMREPMVE01", "userid", tLanguageType);
			this.superid.Title = MultiLanguage.GetComment("FD", "ODMREPMVE01", "superid", tLanguageType);
			this.issuedate.Title = MultiLanguage.GetComment("FD", "ODMREPMVE01", "issuedate", tLanguageType);
			this.serno.Title = MultiLanguage.GetComment("FD", "ODMREPMVE01", "serno", tLanguageType);
			this.suppiler.Title = MultiLanguage.GetComment("FD", "ODMREPMVE01", "suppiler", tLanguageType);
			this.suppartno.Title = MultiLanguage.GetComment("FD", "ODMREPMVE01", "suppartno", tLanguageType);
			this.mslpartno.Title = MultiLanguage.GetComment("FD", "ODMREPMVE01", "mslpartno", tLanguageType);
			this.sampleqty.Title = MultiLanguage.GetComment("FD", "ODMREPMVE01", "sampleqty", tLanguageType);
			this.receiveddate.Title = MultiLanguage.GetComment("FD", "ODMREPMVE01", "receiveddate", tLanguageType);
			this.whys.Title = MultiLanguage.GetComment("FD", "ODMREPMVE01", "whys", tLanguageType);
			this.description.Title = MultiLanguage.GetComment("FD", "ODMREPMVE01", "description", tLanguageType);
			this.opensetion.Title = MultiLanguage.GetComment("FD", "ODMREPMVE01", "opensetion", tLanguageType);
			this.opensection2.Title = MultiLanguage.GetComment("FD", "ODMREPMVE01", "opensection2", tLanguageType);
		...
		protected override void Page_Prender(object sender, EventArgs e)
		{
			...
			if(strToolTipParameter=="Y"){
				this.description.ToolTip = this.description.Text;
		...
		{
			// 作業代號
			this.TaskId = "ODMREPMVE01";
			// 表單代號
			this.formID = "ODMREPMVE01";
...
where resfc001=@resfc001 and resfc002=@resfc002 and resfc003=@resfc003 and ISNULL(resfc004,'')<>''";
		...
		protected override void settingClientFunction()
		{
			...
			//單頭控制項
			opensetion.HtmImg.Attributes.Add("onclick",MIMJUtil.getClickParams("MasterPage_MasterPageContent_opensetion_btn","MasterPage_MasterPageContent_opensetion_txt","S"));
			opensetion.TxtInput.Attributes.Add("onblur",MIMJUtil.getBlurParams("MasterPage_MasterPageContent_opensetion_txt","OpenMIMJ01_18_opensetion","MasterPage_MasterPageContent_opensetion_txt"));
			opensetion.TxtInput.Attributes.Add("onchange","AddtoHash('MasterPage_MasterPageContent_opensetion_txt');");

			opensection2.HtmImg.Attributes.Add("onclick",MIMJUtil.getClickParams("MasterPage_MasterPageContent_opensection2_btn","MasterPage_MasterPageContent_opensection2_txt","S"));
			opensection2.TxtInput.Attributes.Add("onblur",MIMJUtil.getBlurParams("MasterPage_MasterPageContent_opensection2_txt","OpenMIMJ01_18_opensection2","MasterPage_MasterPageContent_opensection2_txt"));
			opensection2.TxtInput.Attributes.Add("onchange","AddtoHash('MasterPage_MasterPageContent_opensection2_txt');");
		...
		protected override void buildMiMjManager(Hashtable pMiMjManager)
		{
			...
			if ( FormStatus == EFFormStatus.CREATE ) {
				pMiMjManager.Add("opensetion_0", opensetion);
				pMiMjManager.Add("opensection2_0", opensection2);
		...
		{
			defalutHash.Add("odmrepmve01001", this.formID);
			defalutHash.Add("odmrepmve01002", this.SheetNo);
...
order by resdd003 desc";
		...
		{
			pReport = "ODMREPMVE01";
			pReportID = "ODMREPMVE01_02";//憑證式
			pWhere = "AND (odmrepmve01001='" + this.formID + "') AND (odmrepmve01002='" + this.SheetNo + "')";
			pReportDirectory = "ODMREPMVE01";
