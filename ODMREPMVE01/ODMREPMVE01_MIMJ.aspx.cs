...
{
	/// <summary>
	/// ODMREPMVE01_MIMJ 的摘要描述。
	/// </summary>
	public partial class ODMREPMVE01_MIMJ : tw.com.dsc.easyflowDotNet.kernelBasePage.EFMIMJBasepage
	{
		...
		protected override void MIFunction()
		{
			switch(tBtnID)
			{
				case "MasterPage_MasterPageContent_opensetion_btn":			//其它類型開窗
				{
					base.doMI("OpenMIMJ01","18");
					break;
				}
				case "MasterPage_MasterPageContent_opensection2_btn":			//其它類型開窗
				{
					base.doMI("OpenMIMJ01","18");
					break;
				}
		...
		protected override void MJFunction()
		{
			...
			{
				case "OpenMIMJ01_18_opensetion":	
				{
					base.doMJ("OpenMIMJ01","18","MasterPage_MasterPageContent_opensetion_txt2=resal002");
					break;
				}
				case "OpenMIMJ01_18_opensection2":	
				{
					base.doMJ("OpenMIMJ01","18","MasterPage_MasterPageContent_opensection2_txt2=resal002");
					break;
				}
