...
namespace tw.com.dsc.easyflowDotNet.forms
{
	...
	/// ODMMRBCN01 的摘要描述。
	/// </summary>
	public partial class ODMMRBCN01 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
	{
		//edit by teppy 2011/02/08 Start
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			AjaxPro.Utility.RegisterTypeForAjax(typeof(ODMMRBCN01));
			UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
			string tLanguageType = tClass.Language;

			//多國語系
			this.Title= MultiLanguage.GetComment("FD","ODMMRBCN01","lblTitle",this.UserInfo.Language);
			string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ODMMRBCN01", "HeadTabStrip01", tLanguageType);
			...
			this.dept.Title = MultiLanguage.GetComment("FD", "ODMMRBCN01", "dept", tLanguageType);
			this.name.Title = MultiLanguage.GetComment("FD", "ODMMRBCN01", "name", tLanguageType);
			this.txtno.Title = MultiLanguage.GetComment("FD", "ODMMRBCN01", "txtno", tLanguageType);
			this.txtordno.Title = MultiLanguage.GetComment("FD", "ODMMRBCN01", "txtordno", tLanguageType);
			this.txtpdname.Title = MultiLanguage.GetComment("FD", "ODMMRBCN01", "txtpdname", tLanguageType);
			this.txtpdno.Title = MultiLanguage.GetComment("FD", "ODMMRBCN01", "txtpdno", tLanguageType);
			this.txtpdqty.Title = MultiLanguage.GetComment("FD", "ODMMRBCN01", "txtpdqty", tLanguageType);
			this.txtreason.Title = MultiLanguage.GetComment("FD", "ODMMRBCN01", "txtreason", tLanguageType);
			this.condate.Title = MultiLanguage.GetComment("FD", "ODMMRBCN01", "condate", tLanguageType);
			this.superid.Title = MultiLanguage.GetComment("FD", "ODMMRBCN01", "superid", tLanguageType);
		...
		{
			// 作業代號
			this.TaskId = "ODMMRBCN01";
			// 表單代號
			this.formID = "ODMMRBCN01";
...
this.rditem_ctrolRadio2.Attributes.Add("onclick", "document.getElementById('MasterPage_MasterPageContent_rditem_txt').value = '2';");
		...
		{
			defalutHash.Add("odmmrbcn01001", this.formID);
			defalutHash.Add("odmmrbcn01002", this.SheetNo);
...
order by resdd003 desc";
		...
		{
			pReport = "ODMMRBCN01";
			pReportID = "ODMMRBCN01_02";//憑證式
			pWhere = "AND (odmmrbcn01001='" + this.formID + "') AND (odmmrbcn01002='" + this.SheetNo + "')";
			pReportDirectory = "ODMMRBCN01";
