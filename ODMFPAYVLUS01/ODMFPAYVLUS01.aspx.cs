...
namespace tw.com.dsc.easyflowDotNet.forms
{
    ...
    /// ODMFPAYVLUS01 的摘要描述。
    /// </summary>
    public partial class ODMFPAYVLUS01 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
    {
        //edit by teppy 2011/02/08 Start
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            AjaxPro.Utility.RegisterTypeForAjax(typeof(ODMFPAYVLUS01));
            UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
            string tLanguageType = tClass.Language;

            //多國語系
            this.Title = MultiLanguage.GetComment("FD", "ODMFPAYVLUS01", "lblTitle", this.UserInfo.Language);
            string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ODMFPAYVLUS01", "HeadTabStrip01", tLanguageType);
            ...
            this.lblcn.Text = MultiLanguage.GetComment("FD", "ODMFPAYVLUS01", "lblcn", tLanguageType);
            this.lblvn.Text = MultiLanguage.GetComment("FD", "ODMFPAYVLUS01", "lblvn", tLanguageType);
            this.lblyear.Text = MultiLanguage.GetComment("FD", "ODMFPAYVLUS01", "lblyear", tLanguageType);
            this.datetime1.Title = MultiLanguage.GetComment("FD", "ODMFPAYVLUS01", "datetime1", tLanguageType);
            this.dept.Title = MultiLanguage.GetComment("FD", "ODMFPAYVLUS01", "dept", tLanguageType);
            this.username.Title = MultiLanguage.GetComment("FD", "ODMFPAYVLUS01", "username", tLanguageType);
            this.payee.Title = MultiLanguage.GetComment("FD", "ODMFPAYVLUS01", "payee", tLanguageType);
            this.chkitem01.Text = MultiLanguage.GetComment("FD", "ODMFPAYVLUS01", "chkitem01", tLanguageType);
            this.chkitem02.Text = MultiLanguage.GetComment("FD", "ODMFPAYVLUS01", "chkitem02", tLanguageType);
            this.chkitem03.Text = MultiLanguage.GetComment("FD", "ODMFPAYVLUS01", "chkitem03", tLanguageType);
            this.chkitem04.Text = MultiLanguage.GetComment("FD", "ODMFPAYVLUS01", "chkitem04", tLanguageType);
            this.chkother.Title = MultiLanguage.GetComment("FD", "ODMFPAYVLUS01", "chkother", tLanguageType);
            this.textarea1.Title = MultiLanguage.GetComment("FD", "ODMFPAYVLUS01", "textarea1", tLanguageType);
            this.opentype01.Title = MultiLanguage.GetComment("FD", "ODMFPAYVLUS01", "opentype01", tLanguageType);
            this.money01.Title = MultiLanguage.GetComment("FD", "ODMFPAYVLUS01", "money01", tLanguageType);
            this.textarea2.Title = MultiLanguage.GetComment("FD", "ODMFPAYVLUS01", "textarea2", tLanguageType);
            this.opentype02.Title = MultiLanguage.GetComment("FD", "ODMFPAYVLUS01", "opentype02", tLanguageType);
            this.money02.Title = MultiLanguage.GetComment("FD", "ODMFPAYVLUS01", "money02", tLanguageType);
            this.openitem01.Title = MultiLanguage.GetComment("FD", "ODMFPAYVLUS01", "openitem01", tLanguageType);
            this.textarea3.Title = MultiLanguage.GetComment("FD", "ODMFPAYVLUS01", "textarea3", tLanguageType);
            this.opentype03.Title = MultiLanguage.GetComment("FD", "ODMFPAYVLUS01", "opentype03", tLanguageType);
            this.money03.Title = MultiLanguage.GetComment("FD", "ODMFPAYVLUS01", "money03", tLanguageType);
            this.mtotal.Title = MultiLanguage.GetComment("FD", "ODMFPAYVLUS01", "mtotal", tLanguageType);
            this.openitem02.Title = MultiLanguage.GetComment("FD", "ODMFPAYVLUS01", "openitem02", tLanguageType);
            this.chkatt01.Text = MultiLanguage.GetComment("FD", "ODMFPAYVLUS01", "chkatt01", tLanguageType);
            this.inv01.Title = MultiLanguage.GetComment("FD", "ODMFPAYVLUS01", "inv01", tLanguageType);
            this.chkatt02.Text = MultiLanguage.GetComment("FD", "ODMFPAYVLUS01", "chkatt02", tLanguageType);
            this.inv02.Title = MultiLanguage.GetComment("FD", "ODMFPAYVLUS01", "inv02", tLanguageType);
            this.openitem03.Title = MultiLanguage.GetComment("FD", "ODMFPAYVLUS01", "openitem03", tLanguageType);
            this.chkatt04.Text = MultiLanguage.GetComment("FD", "ODMFPAYVLUS01", "chkatt04", tLanguageType);
            this.chkatt05.Text = MultiLanguage.GetComment("FD", "ODMFPAYVLUS01", "chkatt05", tLanguageType);
            this.other.Text = MultiLanguage.GetComment("FD", "ODMFPAYVLUS01", "other", tLanguageType);
            this.attother.Title = MultiLanguage.GetComment("FD", "ODMFPAYVLUS01", "attother", tLanguageType);
            this.orderno.Title = MultiLanguage.GetComment("FD", "ODMFPAYVLUS01", "orderno", tLanguageType);
            this.chkitem05.Text = MultiLanguage.GetComment("FD", "ODMFPAYVLUS01", "chkitem05", tLanguageType);
            this.payother.Title = MultiLanguage.GetComment("FD", "ODMFPAYVLUS01", "payother", tLanguageType);
            this.SenderID.Title = MultiLanguage.GetComment("FD", "ODMFPAYVLUS01", "SenderID", tLanguageType);
            this.SuperID.Title = MultiLanguage.GetComment("FD", "ODMFPAYVLUS01", "SuperID", tLanguageType);
            this.paydate.Title = MultiLanguage.GetComment("FD", "ODMFPAYVLUS01", "paydate", tLanguageType);
            this.curr.Title = MultiLanguage.GetComment("FD", "ODMFPAYVLUS01", "curr", tLanguageType);
            this.useyear.Title = MultiLanguage.GetComment("FD", "ODMFPAYVLUS01", "useyear", tLanguageType);
            #region 三位一撇
            //^_^ 20230411 Peggy 
            //三位一撇
        ...
        {
            // 作業代號
            this.TaskId = "ODMFPAYVLUS01";
            // 表單代號
            this.formID = "ODMFPAYVLUS01";
...
where resfc001=@resfc001 and resfc002=@resfc002 and resfc003=@resfc003 and ISNULL(resfc004,'')<>''";
        ...
        {
            defalutHash.Add("odmfpayvlus01001", this.formID);
            defalutHash.Add("odmfpayvlus01002", this.SheetNo);
...
order by resdd003 desc";
        ...
        {
            pReport = "ODMFPAYVLUS01";
            pReportID = "ODMFPAYVLUS01_02";//憑證式
            pWhere = "AND (odmfpayvlus01001='" + this.formID + "') AND (odmfpayvlus01002='" + this.SheetNo + "')";
            pReportDirectory = "ODMFPAYVLUS01";
