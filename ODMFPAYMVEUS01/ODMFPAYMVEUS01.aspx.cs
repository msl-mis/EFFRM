...
{
	/// <summary>
	/// ODMFPAYMVEUS01 的摘要描述。
	/// </summary>
	public partial class ODMFPAYMVEUS01 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
	{
		//edit by teppy 2011/02/08 Start
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			AjaxPro.Utility.RegisterTypeForAjax(typeof(ODMFPAYMVEUS01));
			UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
			string tLanguageType = tClass.Language;

			//多國語系
			this.Title= MultiLanguage.GetComment("FD","ODMFPAYMVEUS01","lblTitle",this.UserInfo.Language);
			string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ODMFPAYMVEUS01", "HeadTabStrip01", tLanguageType);
			...
			this.datetime1.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVEUS01", "datetime1", tLanguageType);
			this.dept.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVEUS01", "dept", tLanguageType);
			this.username.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVEUS01", "username", tLanguageType);
			this.payee.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVEUS01", "payee", tLanguageType);
			this.chkitem01.Text = MultiLanguage.GetComment("FD", "ODMFPAYMVEUS01", "chkitem01", tLanguageType);
			this.chkitem02.Text = MultiLanguage.GetComment("FD", "ODMFPAYMVEUS01", "chkitem02", tLanguageType);
			this.chkitem03.Text = MultiLanguage.GetComment("FD", "ODMFPAYMVEUS01", "chkitem03", tLanguageType);
			this.chkitem04.Text = MultiLanguage.GetComment("FD", "ODMFPAYMVEUS01", "chkitem04", tLanguageType);
			this.chkitem05.Text = MultiLanguage.GetComment("FD", "ODMFPAYMVEUS01", "chkitem05", tLanguageType);
			this.chkother.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVEUS01", "chkother", tLanguageType);
			this.textarea1.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVEUS01", "textarea1", tLanguageType);
			this.money01.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVEUS01", "money01", tLanguageType);
			this.textarea2.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVEUS01", "textarea2", tLanguageType);
			this.money02.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVEUS01", "money02", tLanguageType);
			this.textarea3.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVEUS01", "textarea3", tLanguageType);
			this.money03.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVEUS01", "money03", tLanguageType);
			this.textarea4.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVEUS01", "textarea4", tLanguageType);
			this.money04.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVEUS01", "money04", tLanguageType);
			this.textarea5.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVEUS01", "textarea5", tLanguageType);
			this.money05.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVEUS01", "money05", tLanguageType);
			this.mtotal.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVEUS01", "mtotal", tLanguageType);
			this.chkatt01.Text = MultiLanguage.GetComment("FD", "ODMFPAYMVEUS01", "chkatt01", tLanguageType);
			this.inv01.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVEUS01", "inv01", tLanguageType);
			this.chkatt02.Text = MultiLanguage.GetComment("FD", "ODMFPAYMVEUS01", "chkatt02", tLanguageType);
			this.inv02.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVEUS01", "inv02", tLanguageType);
			this.chkatt03.Text = MultiLanguage.GetComment("FD", "ODMFPAYMVEUS01", "chkatt03", tLanguageType);
			this.chkatt04.Text = MultiLanguage.GetComment("FD", "ODMFPAYMVEUS01", "chkatt04", tLanguageType);
			this.chkatt05.Text = MultiLanguage.GetComment("FD", "ODMFPAYMVEUS01", "chkatt05", tLanguageType);
			this.orderno.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVEUS01", "orderno", tLanguageType);
			this.attother.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVEUS01", "attother", tLanguageType);
			this.other.Text = MultiLanguage.GetComment("FD", "ODMFPAYMVEUS01", "other", tLanguageType);
			this.payother.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVEUS01", "payother", tLanguageType);
			this.empl1.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVEUS01", "empl1", tLanguageType);
			this.empl2.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVEUS01", "empl2", tLanguageType);
			this.paydate.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVEUS01", "paydate", tLanguageType);
			this.cur01.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVEUS01", "cur01", tLanguageType);
			this.cur03.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVEUS01", "cur03", tLanguageType);
			this.cur02.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVEUS01", "cur02", tLanguageType);
			this.cur04.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVEUS01", "cur04", tLanguageType);
			this.cur05.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVEUS01", "cur05", tLanguageType);
			this.curr.Title = MultiLanguage.GetComment("FD", "ODMFPAYMVEUS01", "curr", tLanguageType);
...
this.other.Text = String.Empty;
		...
		{
			// 作業代號
			this.TaskId = "ODMFPAYMVEUS01";
			// 表單代號
			this.formID = "ODMFPAYMVEUS01";
...
this.rdtc_ctrolRadio0.Attributes.Add("onclick", "InitTriggerMust('" + base.FormStatus.ToString() + "');document.getElementById('MasterPage_MasterPageContent_rdtc_txt').value = '0';");
this.rdtc_ctrolRadio1.Attributes.Add("onclick", "InitTriggerMust('" + base.FormStatus.ToString() + "');document.getElementById('MasterPage_MasterPageContent_rdtc_txt').value = '1';");
...
this.rdtc_ctrolRadio4.Attributes.Add("onclick", "InitTriggerMust('" + base.FormStatus.ToString() + "');document.getElementById('MasterPage_MasterPageContent_rdtc_txt').value = '4';");
		...
		{
			defalutHash.Add("odmfpaymveus01001", this.formID);
			defalutHash.Add("odmfpaymveus01002", this.SheetNo);
			...
			defalutHash.Add("cur01", "USD");
			defalutHash.Add("cur03", "USD");
			defalutHash.Add("cur02", "USD");
			defalutHash.Add("cur04", "VND");
			defalutHash.Add("cur05", "VND");
...
order by resdd003 desc";
		...
		protected override void ReGetCondValue(object[,] pAryCondValue)
		{
			...
			tValue="";
			try{
				tValue = (this.cur01.Value.Trim());
			}
			catch(Exception e){
				tValue="";
			}
			pAryCondValue[0, 0] = "curr01";
		...
		{
			pReport = "ODMFPAYMVEUS01";
			pReportID = "ODMFPAYMVEUS01_02";//憑證式
			pWhere = "AND (odmfpaymveus01001='" + this.formID + "') AND (odmfpaymveus01002='" + this.SheetNo + "')";
			pReportDirectory = "ODMFPAYMVEUS01";
