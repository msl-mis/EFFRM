...
namespace tw.com.dsc.easyflowDotNet.forms
{
	...
	/// PURPAY001 的摘要描述。
	/// </summary>
	public partial class PURPAY001 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
	{
		//edit by teppy 2011/02/08 Start
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			AjaxPro.Utility.RegisterTypeForAjax(typeof(PURPAY001));
			UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
			string tLanguageType = tClass.Language;

			//多國語系
			this.Title= MultiLanguage.GetComment("FD","PURPAY001","lblTitle",this.UserInfo.Language);
			string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "PURPAY001", "HeadTabStrip01", tLanguageType);
			...
			this.username.Title = MultiLanguage.GetComment("FD", "PURPAY001", "username", tLanguageType);
			this.datetime1.Title = MultiLanguage.GetComment("FD", "PURPAY001", "datetime1", tLanguageType);
			this.purno01.Title = MultiLanguage.GetComment("FD", "PURPAY001", "purno01", tLanguageType);
			this.paymeth01.Title = MultiLanguage.GetComment("FD", "PURPAY001", "paymeth01", tLanguageType);
			this.datetime2.Title = MultiLanguage.GetComment("FD", "PURPAY001", "datetime2", tLanguageType);
			this.payee01.Title = MultiLanguage.GetComment("FD", "PURPAY001", "payee01", tLanguageType);
			this.curr01.Title = MultiLanguage.GetComment("FD", "PURPAY001", "curr01", tLanguageType);
			this.money01.Title = MultiLanguage.GetComment("FD", "PURPAY001", "money01", tLanguageType);
			this.purno02.Title = MultiLanguage.GetComment("FD", "PURPAY001", "purno02", tLanguageType);
			this.paymeth02.Title = MultiLanguage.GetComment("FD", "PURPAY001", "paymeth02", tLanguageType);
			this.datetime3.Title = MultiLanguage.GetComment("FD", "PURPAY001", "datetime3", tLanguageType);
			this.payee02.Title = MultiLanguage.GetComment("FD", "PURPAY001", "payee02", tLanguageType);
			this.curr02.Title = MultiLanguage.GetComment("FD", "PURPAY001", "curr02", tLanguageType);
			this.money02.Title = MultiLanguage.GetComment("FD", "PURPAY001", "money02", tLanguageType);
			this.purno03.Title = MultiLanguage.GetComment("FD", "PURPAY001", "purno03", tLanguageType);
			this.paymeth03.Title = MultiLanguage.GetComment("FD", "PURPAY001", "paymeth03", tLanguageType);
			this.datetime4.Title = MultiLanguage.GetComment("FD", "PURPAY001", "datetime4", tLanguageType);
			this.payee03.Title = MultiLanguage.GetComment("FD", "PURPAY001", "payee03", tLanguageType);
			this.curr03.Title = MultiLanguage.GetComment("FD", "PURPAY001", "curr03", tLanguageType);
			this.money03.Title = MultiLanguage.GetComment("FD", "PURPAY001", "money03", tLanguageType);
			this.purno04.Title = MultiLanguage.GetComment("FD", "PURPAY001", "purno04", tLanguageType);
			this.paymeth04.Title = MultiLanguage.GetComment("FD", "PURPAY001", "paymeth04", tLanguageType);
			this.datetime5.Title = MultiLanguage.GetComment("FD", "PURPAY001", "datetime5", tLanguageType);
			this.payee04.Title = MultiLanguage.GetComment("FD", "PURPAY001", "payee04", tLanguageType);
			this.curr04.Title = MultiLanguage.GetComment("FD", "PURPAY001", "curr04", tLanguageType);
			this.money04.Title = MultiLanguage.GetComment("FD", "PURPAY001", "money04", tLanguageType);
			this.purno05.Title = MultiLanguage.GetComment("FD", "PURPAY001", "purno05", tLanguageType);
			this.paymeth05.Title = MultiLanguage.GetComment("FD", "PURPAY001", "paymeth05", tLanguageType);
			this.datetime6.Title = MultiLanguage.GetComment("FD", "PURPAY001", "datetime6", tLanguageType);
			this.payee05.Title = MultiLanguage.GetComment("FD", "PURPAY001", "payee05", tLanguageType);
			this.curr05.Title = MultiLanguage.GetComment("FD", "PURPAY001", "curr05", tLanguageType);
			this.money05.Title = MultiLanguage.GetComment("FD", "PURPAY001", "money05", tLanguageType);
			this.mtotal.Title = MultiLanguage.GetComment("FD", "PURPAY001", "mtotal", tLanguageType);
			this.textarea1.Title = MultiLanguage.GetComment("FD", "PURPAY001", "textarea1", tLanguageType);
		...
		{
			// 作業代號
			this.TaskId = "PURPAY001";
			// 表單代號
			this.formID = "PURPAY001";
...
where resfc001=@resfc001 and resfc002=@resfc002 and resfc003=@resfc003 and ISNULL(resfc004,'')<>''";
		...
		{
			defalutHash.Add("purpaid001001", this.formID);
			defalutHash.Add("purpaid001002", this.SheetNo);
...
order by resdd003 desc";
		...
		protected override void ReGetCondValue(object[,] pAryCondValue)
		{
			...
			tDbl=0;
			try{
				tDbl = tDbl + double.Parse(this.money01.Value.Trim()); 
tDbl = tDbl + double.Parse(this.money02.Value.Trim());
			}
			catch(Exception e){
				tDbl=0;
			}
		...
		{
			pReport = "PURPAY001";
			pReportID = "PURPAY001_02";//憑證式
			pWhere = "AND (purpaid001001='" + this.formID + "') AND (purpaid001002='" + this.SheetNo + "')";
			pReportDirectory = "PURPAY001";
