...
namespace tw.com.dsc.easyflowDotNet.forms
{
    ...
    /// ODMEXPVL01 的摘要描述。
    /// </summary>
    public partial class ODMEXPVL01 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
    {
        //edit by teppy 2011/02/08 Start
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            AjaxPro.Utility.RegisterTypeForAjax(typeof(ODMEXPVL01));
            UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
            string tLanguageType = tClass.Language;

            //多國語系
            this.Title = MultiLanguage.GetComment("FD", "ODMEXPVL01", "lblTitle", this.UserInfo.Language);
            string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ODMEXPVL01", "HeadTabStrip01", tLanguageType);
            ...
            this.dept.Title = MultiLanguage.GetComment("FD", "ODMEXPVL01", "dept", tLanguageType);
            this.name.Title = MultiLanguage.GetComment("FD", "ODMEXPVL01", "name", tLanguageType);
            this.expdate.Title = MultiLanguage.GetComment("FD", "ODMEXPVL01", "expdate", tLanguageType);
            this.item01.Title = MultiLanguage.GetComment("FD", "ODMEXPVL01", "item01", tLanguageType);
            this.item02.Title = MultiLanguage.GetComment("FD", "ODMEXPVL01", "item02", tLanguageType);
            this.item03.Title = MultiLanguage.GetComment("FD", "ODMEXPVL01", "item03", tLanguageType);
            this.money01.Title = MultiLanguage.GetComment("FD", "ODMEXPVL01", "money01", tLanguageType);
            this.money02.Title = MultiLanguage.GetComment("FD", "ODMEXPVL01", "money02", tLanguageType);
            this.money03.Title = MultiLanguage.GetComment("FD", "ODMEXPVL01", "money03", tLanguageType);
            this.totomoney.Title = MultiLanguage.GetComment("FD", "ODMEXPVL01", "totomoney", tLanguageType);
            this.superid.Title = MultiLanguage.GetComment("FD", "ODMEXPVL01", "superid", tLanguageType);
        ...
        protected override void Page_Prender(object sender, EventArgs e)
        {
            ...
            {
                this.item01.ToolTip = this.item01.Text;
                this.item02.ToolTip = this.item02.Text;
                this.item03.ToolTip = this.item03.Text;
        ...
        {
            // 作業代號
            this.TaskId = "ODMEXPVL01";
            // 表單代號
            this.formID = "ODMEXPVL01";
...
where resfc001=@resfc001 and resfc002=@resfc002 and resfc003=@resfc003 and ISNULL(resfc004,'')<>''";
        ...
        {
            defalutHash.Add("odmexpvl01001", this.formID);
            defalutHash.Add("odmexpvl01002", this.SheetNo);
...
order by resdd003 desc";
        ...
        protected override void ReGetCondValue(object[,] pAryCondValue)
        {
            ...
            try
            {
                tDbl = double.Parse(this.totomoney.Value.Trim());
            }
            catch (Exception e)
            {
                tDbl = 0;
        ...
        {
            pReport = "ODMEXPVL01";
            pReportID = "ODMEXPVL01_02";//憑證式
            pWhere = "AND (odmexpvl01001='" + this.formID + "') AND (odmexpvl01002='" + this.SheetNo + "')";
            pReportDirectory = "ODMEXPVL01";
