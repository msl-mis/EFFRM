...
namespace tw.com.dsc.easyflowDotNet.forms
{
	...
	/// ODMACPS01 的摘要描述。
	/// </summary>
	public partial class ODMACPS01 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
	{
		//edit by teppy 2011/02/08 Start
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			AjaxPro.Utility.RegisterTypeForAjax(typeof(ODMACPS01));
			UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
			string tLanguageType = tClass.Language;

			//多國語系
			this.Title= MultiLanguage.GetComment("FD","ODMACPS01","lblTitle",this.UserInfo.Language);
			string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ODMACPS01", "HeadTabStrip01", tLanguageType);
			...
			this.username.Title = MultiLanguage.GetComment("FD", "ODMACPS01", "username", tLanguageType);
			this.tabletime.Title = MultiLanguage.GetComment("FD", "ODMACPS01", "tabletime", tLanguageType);
			this.note.Title = MultiLanguage.GetComment("FD", "ODMACPS01", "note", tLanguageType);
			this.datetime1.Title = MultiLanguage.GetComment("FD", "ODMACPS01", "datetime1", tLanguageType);
		...
		{
			// 作業代號
			this.TaskId = "ODMACPS01";
			// 表單代號
			this.formID = "ODMACPS01";
...
where resfc001=@resfc001 and resfc002=@resfc002 and resfc003=@resfc003 and ISNULL(resfc004,'')<>''";
		...
		{
			defalutHash.Add("odmacps01001", this.formID);
			defalutHash.Add("odmacps01002", this.SheetNo);
...
order by resdd003 desc";
		...
		{
			pReport = "ODMACPS01";
			pReportID = "ODMACPS01_02";//憑證式
			pWhere = "AND (odmacps01001='" + this.formID + "') AND (odmacps01002='" + this.SheetNo + "')";
			pReportDirectory = "ODMACPS01";
