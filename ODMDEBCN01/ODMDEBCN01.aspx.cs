...
namespace tw.com.dsc.easyflowDotNet.forms
{
	...
	/// ODMDEBCN01 的摘要描述。
	/// </summary>
	public partial class ODMDEBCN01 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
	{
		//edit by teppy 2011/02/08 Start
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			AjaxPro.Utility.RegisterTypeForAjax(typeof(ODMDEBCN01));
			UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
			string tLanguageType = tClass.Language;

			//多國語系
			this.Title= MultiLanguage.GetComment("FD","ODMDEBCN01","lblTitle",this.UserInfo.Language);
			string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ODMDEBCN01", "HeadTabStrip01", tLanguageType);
			...
			this.lblcontact.Text = MultiLanguage.GetComment("FD", "ODMDEBCN01", "lblcontact", tLanguageType);
			this.lbltitle.Text = MultiLanguage.GetComment("FD", "ODMDEBCN01", "lbltitle", tLanguageType);
			this.lbluser.Text = MultiLanguage.GetComment("FD", "ODMDEBCN01", "lbluser", tLanguageType);
			this.txtother.Title = MultiLanguage.GetComment("FD", "ODMDEBCN01", "txtother", tLanguageType);
			this.txtcontact.Title = MultiLanguage.GetComment("FD", "ODMDEBCN01", "txtcontact", tLanguageType);
			this.usedate.Title = MultiLanguage.GetComment("FD", "ODMDEBCN01", "usedate", tLanguageType);
		...
		{
			// 作業代號
			this.TaskId = "ODMDEBCN01";
			// 表單代號
			this.formID = "ODMDEBCN01";
...
this.rditem_ctrolRadio3.Attributes.Add("onclick", "InitTriggerMust('" + base.FormStatus.ToString() + "');document.getElementById('MasterPage_MasterPageContent_rditem_txt').value = '3';");
		...
		{
			defalutHash.Add("odmdebcn01001", this.formID);
			defalutHash.Add("odmdebcn01002", this.SheetNo);
...
order by resdd003 desc";
		...
		{
			pReport = "ODMDEBCN01";
			pReportID = "ODMDEBCN01_02";//憑證式
			pWhere = "AND (odmdebcn01001='" + this.formID + "') AND (odmdebcn01002='" + this.SheetNo + "')";
			pReportDirectory = "ODMDEBCN01";
