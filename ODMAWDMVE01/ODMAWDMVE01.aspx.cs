...
namespace tw.com.dsc.easyflowDotNet.forms
{
	...
	/// ODMAWDMVE01 的摘要描述。
	/// </summary>
	public partial class ODMAWDMVE01 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
	{
		//edit by teppy 2011/02/08 Start
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			AjaxPro.Utility.RegisterTypeForAjax(typeof(ODMAWDMVE01));
			UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
			string tLanguageType = tClass.Language;

			//多國語系
			this.Title= MultiLanguage.GetComment("FD","ODMAWDMVE01","lblTitle",this.UserInfo.Language);
			string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ODMAWDMVE01", "HeadTabStrip01", tLanguageType);
			...
			this.txtdept.Title = MultiLanguage.GetComment("FD", "ODMAWDMVE01", "txtdept", tLanguageType);
			this.date.Title = MultiLanguage.GetComment("FD", "ODMAWDMVE01", "date", tLanguageType);
		...
		{
			// 作業代號
			this.TaskId = "ODMAWDMVE01";
			// 表單代號
			this.formID = "ODMAWDMVE01";
...
where resfc001=@resfc001 and resfc002=@resfc002 and resfc003=@resfc003 and ISNULL(resfc004,'')<>''";
		...
		{
			defalutHash.Add("odmawdmve01001", this.formID);
			defalutHash.Add("odmawdmve01002", this.SheetNo);
...
order by resdd003 desc";
		...
		{
			pReport = "ODMAWDMVE01";
			pReportID = "ODMAWDMVE01_02";//憑證式
			pWhere = "AND (odmawdmve01001='" + this.formID + "') AND (odmawdmve01002='" + this.SheetNo + "')";
			pReportDirectory = "ODMAWDMVE01";
