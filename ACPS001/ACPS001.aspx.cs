...
namespace tw.com.dsc.easyflowDotNet.forms
{
	...
	/// ACPS001 的摘要描述。
	/// </summary>
	public partial class ACPS001 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
	{
		//edit by teppy 2011/02/08 Start
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			AjaxPro.Utility.RegisterTypeForAjax(typeof(ACPS001));
			UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
			string tLanguageType = tClass.Language;

			//多國語系
			this.Title= MultiLanguage.GetComment("FD","ACPS001","lblTitle",this.UserInfo.Language);
			string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ACPS001", "HeadTabStrip01", tLanguageType);
			...
			this.username.Title = MultiLanguage.GetComment("FD", "ACPS001", "username", tLanguageType);
			this.tabletime.Title = MultiLanguage.GetComment("FD", "ACPS001", "tabletime", tLanguageType);
			this.note.Title = MultiLanguage.GetComment("FD", "ACPS001", "note", tLanguageType);
			this.datetime1.Title = MultiLanguage.GetComment("FD", "ACPS001", "datetime1", tLanguageType);
...
where resfc001=@resfc001 and resfc002=@resfc002 and resfc003=@resfc003 and ISNULL(resfc004,'')<>''";
		...
		{
			defalutHash.Add("acpitable001", this.formID);
			defalutHash.Add("acpitable002", this.SheetNo);
...
order by resdd003 desc";
		...
		{
			pReport = "ACPS001";
			pReportID = "ACPS001_02";//憑證式
			pWhere = "AND (acpitable001='" + this.formID + "') AND (acpitable002='" + this.SheetNo + "')";
			pReportDirectory = "ACPS001";
