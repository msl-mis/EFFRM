...
namespace tw.com.dsc.easyflowDotNet.forms
{
	...
	/// ODMGPAY_TEST 的摘要描述。
	/// </summary>
	public partial class ODMGPAY_TEST : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
	{
		//edit by teppy 2011/02/08 Start
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			AjaxPro.Utility.RegisterTypeForAjax(typeof(ODMGPAY_TEST));
			UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
			string tLanguageType = tClass.Language;

			//多國語系
			this.Title= MultiLanguage.GetComment("FD","ODMGPAY_TEST","lblTitle",this.UserInfo.Language);
			string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ODMGPAY_TEST", "HeadTabStrip01", tLanguageType);
			...
			this.datetime1.Title = MultiLanguage.GetComment("FD", "ODMGPAY_TEST", "datetime1", tLanguageType);
			this.dept.Title = MultiLanguage.GetComment("FD", "ODMGPAY_TEST", "dept", tLanguageType);
			this.username.Title = MultiLanguage.GetComment("FD", "ODMGPAY_TEST", "username", tLanguageType);
			this.payee.Title = MultiLanguage.GetComment("FD", "ODMGPAY_TEST", "payee", tLanguageType);
			this.chkother.Title = MultiLanguage.GetComment("FD", "ODMGPAY_TEST", "chkother", tLanguageType);
			this.textarea1.Title = MultiLanguage.GetComment("FD", "ODMGPAY_TEST", "textarea1", tLanguageType);
			this.money01.Title = MultiLanguage.GetComment("FD", "ODMGPAY_TEST", "money01", tLanguageType);
			this.textarea2.Title = MultiLanguage.GetComment("FD", "ODMGPAY_TEST", "textarea2", tLanguageType);
			this.money02.Title = MultiLanguage.GetComment("FD", "ODMGPAY_TEST", "money02", tLanguageType);
			this.textarea3.Title = MultiLanguage.GetComment("FD", "ODMGPAY_TEST", "textarea3", tLanguageType);
			this.money03.Title = MultiLanguage.GetComment("FD", "ODMGPAY_TEST", "money03", tLanguageType);
			this.textarea4.Title = MultiLanguage.GetComment("FD", "ODMGPAY_TEST", "textarea4", tLanguageType);
			this.money04.Title = MultiLanguage.GetComment("FD", "ODMGPAY_TEST", "money04", tLanguageType);
			this.textarea5.Title = MultiLanguage.GetComment("FD", "ODMGPAY_TEST", "textarea5", tLanguageType);
			this.money05.Title = MultiLanguage.GetComment("FD", "ODMGPAY_TEST", "money05", tLanguageType);
			this.mtotal.Title = MultiLanguage.GetComment("FD", "ODMGPAY_TEST", "mtotal", tLanguageType);
			this.inv01.Title = MultiLanguage.GetComment("FD", "ODMGPAY_TEST", "inv01", tLanguageType);
			this.inv02.Title = MultiLanguage.GetComment("FD", "ODMGPAY_TEST", "inv02", tLanguageType);
			this.orderno.Title = MultiLanguage.GetComment("FD", "ODMGPAY_TEST", "orderno", tLanguageType);
			this.attother.Title = MultiLanguage.GetComment("FD", "ODMGPAY_TEST", "attother", tLanguageType);
			this.other.Text = MultiLanguage.GetComment("FD", "ODMGPAY_TEST", "other", tLanguageType);
			this.payother.Title = MultiLanguage.GetComment("FD", "ODMGPAY_TEST", "payother", tLanguageType);
			this.empl1.Title = MultiLanguage.GetComment("FD", "ODMGPAY_TEST", "empl1", tLanguageType);
			this.empl2.Title = MultiLanguage.GetComment("FD", "ODMGPAY_TEST", "empl2", tLanguageType);
			this.chkkind01.Text = MultiLanguage.GetComment("FD", "ODMGPAY_TEST", "chkkind01", tLanguageType);
			this.chkkind02.Text = MultiLanguage.GetComment("FD", "ODMGPAY_TEST", "chkkind02", tLanguageType);
			this.chkkind03.Text = MultiLanguage.GetComment("FD", "ODMGPAY_TEST", "chkkind03", tLanguageType);
			this.chkkind04.Text = MultiLanguage.GetComment("FD", "ODMGPAY_TEST", "chkkind04", tLanguageType);
			this.chkkind05.Text = MultiLanguage.GetComment("FD", "ODMGPAY_TEST", "chkkind05", tLanguageType);
			this.chkpay01.Text = MultiLanguage.GetComment("FD", "ODMGPAY_TEST", "chkpay01", tLanguageType);
			this.chkpay02.Text = MultiLanguage.GetComment("FD", "ODMGPAY_TEST", "chkpay02", tLanguageType);
			this.txtord.Title = MultiLanguage.GetComment("FD", "ODMGPAY_TEST", "txtord", tLanguageType);
			this.txtpayday.Title = MultiLanguage.GetComment("FD", "ODMGPAY_TEST", "txtpayday", tLanguageType);
			this.chkpay03.Text = MultiLanguage.GetComment("FD", "ODMGPAY_TEST", "chkpay03", tLanguageType);
			this.chkpay04.Text = MultiLanguage.GetComment("FD", "ODMGPAY_TEST", "chkpay04", tLanguageType);
			this.selcurr01.Title = MultiLanguage.GetComment("FD", "ODMGPAY_TEST", "selcurr01", tLanguageType);
			this.selcurr02.Title = MultiLanguage.GetComment("FD", "ODMGPAY_TEST", "selcurr02", tLanguageType);
			this.selcurr03.Title = MultiLanguage.GetComment("FD", "ODMGPAY_TEST", "selcurr03", tLanguageType);
			this.selcurr04.Title = MultiLanguage.GetComment("FD", "ODMGPAY_TEST", "selcurr04", tLanguageType);
			this.selcurr05.Title = MultiLanguage.GetComment("FD", "ODMGPAY_TEST", "selcurr05", tLanguageType);
			this.selcurr06.Title = MultiLanguage.GetComment("FD", "ODMGPAY_TEST", "selcurr06", tLanguageType);
			this.chkadd01.Text = MultiLanguage.GetComment("FD", "ODMGPAY_TEST", "chkadd01", tLanguageType);
			this.chkadd02.Text = MultiLanguage.GetComment("FD", "ODMGPAY_TEST", "chkadd02", tLanguageType);
			this.chkadd03.Text = MultiLanguage.GetComment("FD", "ODMGPAY_TEST", "chkadd03", tLanguageType);
			this.chkadd04.Text = MultiLanguage.GetComment("FD", "ODMGPAY_TEST", "chkadd04", tLanguageType);
			this.chkadd05.Text = MultiLanguage.GetComment("FD", "ODMGPAY_TEST", "chkadd05", tLanguageType);
...
this.chkadd05.Text = String.Empty;
		...
		{
			// 作業代號
			this.TaskId = "ODMGPAY_TEST";
			// 表單代號
			this.formID = "ODMGPAY_TEST";
...
this.chkadd03.Attributes.Add("onclick", " if($('#MasterPage_MasterPageContent_chkadd03_chk')[0].checked){{$('#MasterPage_MasterPageContent_orderno').show();}} else{{$('#MasterPage_MasterPageContent_orderno').hide();}} ");
		...
		{
			defalutHash.Add("odmgpaytest001", this.formID);
			defalutHash.Add("odmgpaytest002", this.SheetNo);
...
order by resdd003 desc";
		...
		{
			pReport = "ODMGPAY_TEST";
			pReportID = "ODMGPAY_TEST_02";//憑證式
			pWhere = "AND (odmgpaytest001='" + this.formID + "') AND (odmgpaytest002='" + this.SheetNo + "')";
			pReportDirectory = "ODMGPAY_TEST";
