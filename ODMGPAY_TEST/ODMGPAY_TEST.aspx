<%@ Page language="c#" CodeFile="ODMGPAY_TEST.aspx.cs" MasterPageFile="~/src/_Common/AppUtil/EFMasterPage/EFBaseMasterPage.master" AutoEventWireup="false" enableEventValidation="false" Inherits="tw.com.dsc.easyflowDotNet.forms.ODMGPAY_TEST" %>
<%@ Register TagPrefix="uc1" TagName="gridUserControl" Src="../../_Common/PlatformUtil/KernelPage/Grid/gridUserControl.ascx" %>
<%@ Register TagPrefix="iewc" Namespace="Microsoft.Web.UI.WebControls" Assembly="Microsoft.Web.UI.WebControls" %>
<%@ Register TagPrefix="cc1" Namespace="tw.com.dsc.dscDotNet.dscWebControls" Assembly="PlatformUtil" %>

<asp:Content ID="ODMGPAY_TESTFormContent" ContentPlaceHolderID="MasterPageContent" runat="server">
	<!--單檔架構 -->
	<!--2009/03/19:Joseph:<div id="cover" style="OVERFLOW: auto; WIDTH: 100%;">-->
		<div id="cover" style="WIDTH: 100%;">
			<div id="createRecord" style="WIDTH: 100%; HEIGHT: 100%" runat="server">
				<cc1:DscPanel id="ecPnlMaster" runat="server" Width="98%" IniHTML='&#10;<div style="OVERFLOW: auto; WIDTH: 100%; POSITION: relative; HEIGHT: 100%" ms_positioning="GridLayout"></div>'
					FrmDefineKeys-FrmType="Query" FrmDefineKeys-FrmID="FrmODMGPAY_TEST" FrmDefineKeys-BOID="ODMGPAY_TEST"
...
<cc1:DscTextBox id='odmgpaytest001' runat='server' title='表單代號'
	style='display: none; Z-INDEX: 101; POSITION: absolute; LEFT: 245px; TOP: 16px;'
	TxtInput_TabIndex='0'>
	<INPUTSTYLE Width='120px'></INPUTSTYLE>
	<TITLESTYLE Width='110px'></TITLESTYLE>
	<FRMFIELDKEYS FrmID='FrmODMGPAY_TEST' BOID='ODMGPAY_TEST' FieldName='odmgpaytest001'></FRMFIELDKEYS>
</cc1:DscTextBox>
<cc1:DscTextBox id='odmgpaytest002' runat='server' title='表單單號'
	style='display: none; Z-INDEX: 102; POSITION: absolute; LEFT: 245px; TOP: 49px;'
	TxtInput_TabIndex='0'>
	<INPUTSTYLE Width='120px'></INPUTSTYLE>
	<TITLESTYLE Width='110px'></TITLESTYLE>
	<FRMFIELDKEYS FrmID='FrmODMGPAY_TEST' BOID='ODMGPAY_TEST' FieldName='odmgpaytest002'></FRMFIELDKEYS>
</cc1:DscTextBox>
...
<cc1:DscDateAssistant2 ID='datetime1' runat='server' Title='datetime1' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMGPAY_TEST' BOID='ODMGPAY_TEST' FieldName='datetime1'></FrmFieldKeys>
...
<cc1:DscTextBox id='dept' runat='server' title='部門' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMGPAY_TEST' BOID='ODMGPAY_TEST' FieldName='dept'></FrmFieldKeys>
...
<cc1:DscTextBox id='username' runat='server' title='請款人' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMGPAY_TEST' BOID='ODMGPAY_TEST' FieldName='username'></FrmFieldKeys>
	<TitleStyle Width='100px'></TitleStyle>
...
<cc1:DscTextBox id='payee' runat='server' title='受款人' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMGPAY_TEST' BOID='ODMGPAY_TEST' FieldName='payee'></FrmFieldKeys>
	<TitleStyle Width='100px'></TitleStyle>
...
<cc1:DscTextBox id='chkother' runat='server' title='其他' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMGPAY_TEST' BOID='ODMGPAY_TEST' FieldName='chkother'></FrmFieldKeys>
	<TitleStyle Width='100px'></TitleStyle>
...
<cc1:DscTextBox id='textarea1' runat='server' title='內容01' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMGPAY_TEST' BOID='ODMGPAY_TEST' FieldName='textarea1'></FrmFieldKeys>
	<TitleStyle Width='100px'></TitleStyle>
...
<cc1:DscTextBox id='money01' runat='server' title='金額01' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMGPAY_TEST' BOID='ODMGPAY_TEST' FieldName='money01'></FrmFieldKeys>
	<TitleStyle Width='100px'></TitleStyle>
...
<cc1:DscTextBox id='textarea2' runat='server' title='內容02' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMGPAY_TEST' BOID='ODMGPAY_TEST' FieldName='textarea2'></FrmFieldKeys>
	<TitleStyle Width='100px'></TitleStyle>
	<InputStyle Width='455px' Height='38px' CssClass='Edit20'></InputStyle>
</cc1:DscTextBox>
<cc1:DscTextBox id='money02' runat='server' title='金額02' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMGPAY_TEST' BOID='ODMGPAY_TEST' FieldName='money02'></FrmFieldKeys>
	<TitleStyle Width='100px'></TitleStyle>
	<InputStyle Width='70px' Height='25px' CssClass='Edit20'></InputStyle>
</cc1:DscTextBox>
<cc1:DscTextBox id='textarea3' runat='server' title='內容03' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMGPAY_TEST' BOID='ODMGPAY_TEST' FieldName='textarea3'></FrmFieldKeys>
	<TitleStyle Width='100px'></TitleStyle>
	<InputStyle Width='455px' Height='38px' CssClass='Edit20'></InputStyle>
</cc1:DscTextBox>
<cc1:DscTextBox id='money03' runat='server' title='金額03' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMGPAY_TEST' BOID='ODMGPAY_TEST' FieldName='money03'></FrmFieldKeys>
	<TitleStyle Width='100px'></TitleStyle>
	<InputStyle Width='70px' Height='25px' CssClass='Edit20'></InputStyle>
</cc1:DscTextBox>
<cc1:DscTextBox id='textarea4' runat='server' title='內容04' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMGPAY_TEST' BOID='ODMGPAY_TEST' FieldName='textarea4'></FrmFieldKeys>
	<TitleStyle Width='100px'></TitleStyle>
	<InputStyle Width='455px' Height='38px' CssClass='Edit20'></InputStyle>
</cc1:DscTextBox>
<cc1:DscTextBox id='money04' runat='server' title='金額04' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMGPAY_TEST' BOID='ODMGPAY_TEST' FieldName='money04'></FrmFieldKeys>
	<TitleStyle Width='100px'></TitleStyle>
	<InputStyle Width='70px' Height='25px' CssClass='Edit20'></InputStyle>
</cc1:DscTextBox>
<cc1:DscTextBox id='textarea5' runat='server' title='內容05' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMGPAY_TEST' BOID='ODMGPAY_TEST' FieldName='textarea5'></FrmFieldKeys>
	<TitleStyle Width='100px'></TitleStyle>
	<InputStyle Width='455px' Height='38px' CssClass='Edit20'></InputStyle>
</cc1:DscTextBox>
<cc1:DscTextBox id='money05' runat='server' title='金額05' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMGPAY_TEST' BOID='ODMGPAY_TEST' FieldName='money05'></FrmFieldKeys>
	<TitleStyle Width='100px'></TitleStyle>
	<InputStyle Width='70px' Height='25px' CssClass='Edit20'></InputStyle>
</cc1:DscTextBox>
<cc1:DscTextBox id='mtotal' runat='server' title='總金額' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMGPAY_TEST' BOID='ODMGPAY_TEST' FieldName='mtotal'></FrmFieldKeys>
	<TitleStyle Width='100px'></TitleStyle>
	<InputStyle Width='70px' Height='25px' CssClass='Edit20'></InputStyle>
</cc1:DscTextBox>
<cc1:DscTextBox id='inv01' runat='server' title='發票張數' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMGPAY_TEST' BOID='ODMGPAY_TEST' FieldName='inv01'></FrmFieldKeys>
	<TitleStyle Width='100px'></TitleStyle>
...
<cc1:DscTextBox id='inv02' runat='server' title='數據張數' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMGPAY_TEST' BOID='ODMGPAY_TEST' FieldName='inv02'></FrmFieldKeys>
	<TitleStyle Width='100px'></TitleStyle>
...
<cc1:DscTextBox id='orderno' runat='server' title='訂購單號' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMGPAY_TEST' BOID='ODMGPAY_TEST' FieldName='orderno'></FrmFieldKeys>
	<TitleStyle Width='100px'></TitleStyle>
...
<cc1:DscTextBox id='attother' runat='server' title='其他附件' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMGPAY_TEST' BOID='ODMGPAY_TEST' FieldName='attother'></FrmFieldKeys>
	<TitleStyle Width='100px'></TitleStyle>
...
<cc1:DscCheckBox ID='other' runat='server' Text='其他附件' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMGPAY_TEST' BOID='ODMGPAY_TEST' FieldName='other'></FrmFieldKeys>
</cc1:DscCheckBox>
<cc1:DscTextBox id='payother' runat='server' title='其他支付' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMGPAY_TEST' BOID='ODMGPAY_TEST' FieldName='payother'></FrmFieldKeys>
	<TitleStyle Width='100px'></TitleStyle>
...
<cc1:DscOpenQuery id='empl1' runat='server' title='empl1' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMGPAY_TEST' BOID='ODMGPAY_TEST' FieldName='empl1'></FrmFieldKeys>
</cc1:DscOpenQuery>
</div>
<div style="display:none;">
<cc1:DscOpenQuery id='empl2' runat='server' title='empl2' ShowTitle='False'
	...
	ReturnVisible='True'>
	<InputStyle Width='121px' Height='22px' CssClass='Edit20'></InputStyle>
	<FrmFieldKeys FrmID='FrmODMGPAY_TEST' BOID='ODMGPAY_TEST' FieldName='empl2'></FrmFieldKeys>
</cc1:DscOpenQuery>
</div>
<cc1:DscCheckBox ID='chkkind01' runat='server' Text='一般費用' ShowTitle='False'
	...
	Checked='False' CheckedTrueValue='1' CheckedFalseValue='0'>
	<InputStyle Width='17px' Height='22px' />
	<FrmFieldKeys FrmID='FrmODMGPAY_TEST' BOID='ODMGPAY_TEST' FieldName='chkkind01'></FrmFieldKeys>
</cc1:DscCheckBox>
<cc1:DscCheckBox ID='chkkind02' runat='server' Text='資產' ShowTitle='False'
	...
	Checked='False' CheckedTrueValue='1' CheckedFalseValue='0'>
	<InputStyle Width='17px' Height='22px' />
	<FrmFieldKeys FrmID='FrmODMGPAY_TEST' BOID='ODMGPAY_TEST' FieldName='chkkind02'></FrmFieldKeys>
</cc1:DscCheckBox>
<cc1:DscCheckBox ID='chkkind03' runat='server' Text='原物料' ShowTitle='False'
	...
	Checked='False' CheckedTrueValue='1' CheckedFalseValue='0'>
	<InputStyle Width='17px' Height='22px' />
	<FrmFieldKeys FrmID='FrmODMGPAY_TEST' BOID='ODMGPAY_TEST' FieldName='chkkind03'></FrmFieldKeys>
</cc1:DscCheckBox>
<cc1:DscCheckBox ID='chkkind04' runat='server' Text='零用金' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMGPAY_TEST' BOID='ODMGPAY_TEST' FieldName='chkkind04'></FrmFieldKeys>
</cc1:DscCheckBox>
<cc1:DscCheckBox ID='chkkind05' runat='server' Text='其他' ShowTitle='False'
	...
	Checked='False' CheckedTrueValue='1' CheckedFalseValue='0'>
	<InputStyle Width='17px' Height='22px' />
	<FrmFieldKeys FrmID='FrmODMGPAY_TEST' BOID='ODMGPAY_TEST' FieldName='chkkind05'></FrmFieldKeys>
</cc1:DscCheckBox>
<cc1:DscCheckBox ID='chkpay01' runat='server' Text='現金' ShowTitle='False'
	...
	Checked='False' CheckedTrueValue='1' CheckedFalseValue='0'>
	<InputStyle Width='17px' Height='22px' />
	<FrmFieldKeys FrmID='FrmODMGPAY_TEST' BOID='ODMGPAY_TEST' FieldName='chkpay01'></FrmFieldKeys>
</cc1:DscCheckBox>
<cc1:DscCheckBox ID='chkpay02' runat='server' Text='訂金' ShowTitle='False'
	...
	Checked='False' CheckedTrueValue='1' CheckedFalseValue='0'>
	<InputStyle Width='17px' Height='22px' />
	<FrmFieldKeys FrmID='FrmODMGPAY_TEST' BOID='ODMGPAY_TEST' FieldName='chkpay02'></FrmFieldKeys>
</cc1:DscCheckBox>
<cc1:DscTextBox id='txtord' runat='server' title='訂金費用' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMGPAY_TEST' BOID='ODMGPAY_TEST' FieldName='txtord'></FrmFieldKeys>
	<TitleStyle Width='100px'></TitleStyle>
...
<cc1:DscTextBox id='txtpayday' runat='server' title='尾天天數' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMGPAY_TEST' BOID='ODMGPAY_TEST' FieldName='txtpayday'></FrmFieldKeys>
	<TitleStyle Width='100px'></TitleStyle>
	<InputStyle Width='30px' Height='20px' CssClass='Edit20'></InputStyle>
</cc1:DscTextBox>
<cc1:DscCheckBox ID='chkpay03' runat='server' Text='月結' ShowTitle='False'
	...
	Checked='False' CheckedTrueValue='1' CheckedFalseValue='0'>
	<InputStyle Width='17px' Height='22px' />
	<FrmFieldKeys FrmID='FrmODMGPAY_TEST' BOID='ODMGPAY_TEST' FieldName='chkpay03'></FrmFieldKeys>
</cc1:DscCheckBox>
<cc1:DscCheckBox ID='chkpay04' runat='server' Text='其他' ShowTitle='False'
	...
	Checked='False' CheckedTrueValue='1' CheckedFalseValue='0'>
	<InputStyle Width='17px' Height='22px' />
	<FrmFieldKeys FrmID='FrmODMGPAY_TEST' BOID='ODMGPAY_TEST' FieldName='chkpay04'></FrmFieldKeys>
</cc1:DscCheckBox>
<cc1:DscDropDownList ID='selcurr01' runat='server' Title='幣別01' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMGPAY_TEST' BOID='ODMGPAY_TEST' FieldName='selcurr01'></FrmFieldKeys>
	<CommentList F0001='Combo' F0002='ODMGPAY_TEST_selcurr01' />
</cc1:DscDropDownList>
<cc1:DscDropDownList ID='selcurr02' runat='server' Title='幣別02' ShowTitle='False'
	...
	<TitleStyle Width='100px' />
	<InputStyle Width='55px' Height='22px' />
	<FrmFieldKeys FrmID='FrmODMGPAY_TEST' BOID='ODMGPAY_TEST' FieldName='selcurr02'></FrmFieldKeys>
	<CommentList F0001='Combo' F0002='ODMGPAY_TEST_selcurr02' />
</cc1:DscDropDownList>
<cc1:DscDropDownList ID='selcurr03' runat='server' Title='幣別03' ShowTitle='False'
	...
	<TitleStyle Width='100px' />
	<InputStyle Width='55px' Height='22px' />
	<FrmFieldKeys FrmID='FrmODMGPAY_TEST' BOID='ODMGPAY_TEST' FieldName='selcurr03'></FrmFieldKeys>
	<CommentList F0001='Combo' F0002='ODMGPAY_TEST_selcurr03' />
</cc1:DscDropDownList>
<cc1:DscDropDownList ID='selcurr04' runat='server' Title='幣別04' ShowTitle='False'
	Style="z-index:666; position: absolute; left: 574px; top: 384px;"
	DDLInput_TabIndex='152'>
	<Items>
		<asp:ListItem Selected='False' Value='NTD'>NTD</asp:ListItem>
		<asp:ListItem Selected='False' Value='USD'>USD</asp:ListItem>
	...
	<TitleStyle Width='100px' />
	<InputStyle Width='55px' Height='22px' />
	<FrmFieldKeys FrmID='FrmODMGPAY_TEST' BOID='ODMGPAY_TEST' FieldName='selcurr04'></FrmFieldKeys>
	<CommentList F0001='Combo' F0002='ODMGPAY_TEST_selcurr04' />
</cc1:DscDropDownList>
<cc1:DscDropDownList ID='selcurr05' runat='server' Title='幣別05' ShowTitle='False'
	...
	<TitleStyle Width='100px' />
	<InputStyle Width='55px' Height='22px' />
	<FrmFieldKeys FrmID='FrmODMGPAY_TEST' BOID='ODMGPAY_TEST' FieldName='selcurr05'></FrmFieldKeys>
	<CommentList F0001='Combo' F0002='ODMGPAY_TEST_selcurr05' />
</cc1:DscDropDownList>
<cc1:DscDropDownList ID='selcurr06' runat='server' Title='幣別06' ShowTitle='False'
	...
	<TitleStyle Width='100px' />
	<InputStyle Width='55px' Height='22px' />
	<FrmFieldKeys FrmID='FrmODMGPAY_TEST' BOID='ODMGPAY_TEST' FieldName='selcurr06'></FrmFieldKeys>
	<CommentList F0001='Combo' F0002='ODMGPAY_TEST_selcurr06' />
</cc1:DscDropDownList>
<cc1:DscCheckBox ID='chkadd01' runat='server' Text='發票' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMGPAY_TEST' BOID='ODMGPAY_TEST' FieldName='chkadd01'></FrmFieldKeys>
</cc1:DscCheckBox>
<cc1:DscCheckBox ID='chkadd02' runat='server' Text='收據' ShowTitle='False'
	...
	Checked='False' CheckedTrueValue='1' CheckedFalseValue='0'>
	<InputStyle Width='18px' Height='22px' />
	<FrmFieldKeys FrmID='FrmODMGPAY_TEST' BOID='ODMGPAY_TEST' FieldName='chkadd02'></FrmFieldKeys>
</cc1:DscCheckBox>
<cc1:DscCheckBox ID='chkadd03' runat='server' Text='訂購單' ShowTitle='False'
	...
	Checked='False' CheckedTrueValue='1' CheckedFalseValue='0'>
	<InputStyle Width='17px' Height='22px' />
	<FrmFieldKeys FrmID='FrmODMGPAY_TEST' BOID='ODMGPAY_TEST' FieldName='chkadd03'></FrmFieldKeys>
</cc1:DscCheckBox>
<cc1:DscCheckBox ID='chkadd04' runat='server' Text='驗收' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMGPAY_TEST' BOID='ODMGPAY_TEST' FieldName='chkadd04'></FrmFieldKeys>
</cc1:DscCheckBox>
<cc1:DscCheckBox ID='chkadd05' runat='server' Text='進貨單' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMGPAY_TEST' BOID='ODMGPAY_TEST' FieldName='chkadd05'></FrmFieldKeys>
</cc1:DscCheckBox>
...
<!--引用JavaScript-->
<script src="ODMGPAY_TEST.js?NoCache=202108311455" type="text/javascript"></script>
</asp:Content>
