...
function CustomerSaveCheck(tStatus)
{
	...
	//不允許空白驗證
	var tiamar01003 = $('#MasterPage_MasterPageContent_iamar01003_txt');
	if(tiamar01003.length>0){
		var tiamar01003Value = $('#MasterPage_MasterPageContent_iamar01003_txt').val().trim();
		if (tiamar01003Value.length==0){
			//欄位不允許空白 !
			tErr += '「' + getI18NForSpecial('FD', 'IAMAR01', 'iamar01003', '../../_Common/PlatFormUtil/KernelPage/I18N/I18NForJs.aspx') + '」  ' + tFieldNotFilledMsg + '\r\n';
		}
	}
...
{ 
   ...
   var tRetVal = tw.com.dsc.easyflowDotNet.forms.IAMAR01.GetDetialRowCount(universalID); 
   if(tRetVal.value == '0') 
   { 
...
function emsOnload()
{
    ...
    {        
         ...
         divContext.innerHTML = document.getElementById("MasterPage_MasterPageContent_iamar01004_txt").value;
