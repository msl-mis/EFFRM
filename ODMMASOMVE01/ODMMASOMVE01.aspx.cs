...
namespace tw.com.dsc.easyflowDotNet.forms
{
	...
	/// ODMMASOMVE01 的摘要描述。
	/// </summary>
	public partial class ODMMASOMVE01 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
	{
		//edit by teppy 2011/02/08 Start
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			AjaxPro.Utility.RegisterTypeForAjax(typeof(ODMMASOMVE01));
			UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
			string tLanguageType = tClass.Language;

			//多國語系
			this.Title= MultiLanguage.GetComment("FD","ODMMASOMVE01","lblTitle",this.UserInfo.Language);
			string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ODMMASOMVE01", "HeadTabStrip01", tLanguageType);
			...
			this.txtdept.Title = MultiLanguage.GetComment("FD", "ODMMASOMVE01", "txtdept", tLanguageType);
			this.txtuser.Title = MultiLanguage.GetComment("FD", "ODMMASOMVE01", "txtuser", tLanguageType);
			this.date.Title = MultiLanguage.GetComment("FD", "ODMMASOMVE01", "date", tLanguageType);
			this.txtmain.Title = MultiLanguage.GetComment("FD", "ODMMASOMVE01", "txtmain", tLanguageType);
		...
		{
			// 作業代號
			this.TaskId = "ODMMASOMVE01";
			// 表單代號
			this.formID = "ODMMASOMVE01";
...
where resfc001=@resfc001 and resfc002=@resfc002 and resfc003=@resfc003 and ISNULL(resfc004,'')<>''";
		...
		{
			defalutHash.Add("odmmasomve01001", this.formID);
			defalutHash.Add("odmmasomve01002", this.SheetNo);
...
order by resdd003 desc";
		...
		{
			pReport = "ODMMASOMVE01";
			pReportID = "ODMMASOMVE01_02";//憑證式
			pWhere = "AND (odmmasomve01001='" + this.formID + "') AND (odmmasomve01002='" + this.SheetNo + "')";
			pReportDirectory = "ODMMASOMVE01";
