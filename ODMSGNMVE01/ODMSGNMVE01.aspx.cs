...
namespace tw.com.dsc.easyflowDotNet.forms
{
	...
	/// ODMSGNMVE01 的摘要描述。
	/// </summary>
	public partial class ODMSGNMVE01 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
	{
		//edit by teppy 2011/02/08 Start
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			AjaxPro.Utility.RegisterTypeForAjax(typeof(ODMSGNMVE01));
			UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
			string tLanguageType = tClass.Language;

			//多國語系
			this.Title= MultiLanguage.GetComment("FD","ODMSGNMVE01","lblTitle",this.UserInfo.Language);
			string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ODMSGNMVE01", "HeadTabStrip01", tLanguageType);
			...
			this.txtmain.Title = MultiLanguage.GetComment("FD", "ODMSGNMVE01", "txtmain", tLanguageType);
			this.contact.Title = MultiLanguage.GetComment("FD", "ODMSGNMVE01", "contact", tLanguageType);
			this.username.Title = MultiLanguage.GetComment("FD", "ODMSGNMVE01", "username", tLanguageType);
			this.datetime1.Title = MultiLanguage.GetComment("FD", "ODMSGNMVE01", "datetime1", tLanguageType);
			this.other.Title = MultiLanguage.GetComment("FD", "ODMSGNMVE01", "other", tLanguageType);
			this.empl1.Title = MultiLanguage.GetComment("FD", "ODMSGNMVE01", "empl1", tLanguageType);
			this.empl2.Title = MultiLanguage.GetComment("FD", "ODMSGNMVE01", "empl2", tLanguageType);
			this.dept.Title = MultiLanguage.GetComment("FD", "ODMSGNMVE01", "dept", tLanguageType);
		...
		protected override void Page_Prender(object sender, EventArgs e)
		{
			...
			if(strToolTipParameter=="Y"){
				this.txtmain.ToolTip = this.txtmain.Text;
this.contact.ToolTip = this.contact.Text;
		...
		{
			// 作業代號
			this.TaskId = "ODMSGNMVE01";
			// 表單代號
			this.formID = "ODMSGNMVE01";
...
this.cate_ctrolRadio5.Attributes.Add("onclick", "InitTriggerMust('" + base.FormStatus.ToString() + "');document.getElementById('MasterPage_MasterPageContent_cate_txt').value = '5';");
		...
		{
			defalutHash.Add("odmsgnmve01001", this.formID);
			defalutHash.Add("odmsgnmve01002", this.SheetNo);
			...
			defalutHash.Add("dept", ajaxGetDepartmentId());
		}
...
order by resdd003 desc";
		...
		protected override void ReGetCondValue(object[,] pAryCondValue)
		{
			...
			tValue="";
			try{
				tValue = (this.cate.Value.Trim());
			}
			catch(Exception e){
				tValue="";
			}
			pAryCondValue[0, 0] = "cate";
			...
			tValue="";
			try{
				tValue = (this.dept.Value.Trim());
			}
			catch(Exception e){
				tValue="";
			}
			pAryCondValue[0, 3] = "dept";
		...
		{
			pReport = "ODMSGNMVE01";
			pReportID = "ODMSGNMVE01_02";//憑證式
			pWhere = "AND (odmsgnmve01001='" + this.formID + "') AND (odmsgnmve01002='" + this.SheetNo + "')";
			pReportDirectory = "ODMSGNMVE01";
