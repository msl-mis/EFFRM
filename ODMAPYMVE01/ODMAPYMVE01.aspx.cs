...
namespace tw.com.dsc.easyflowDotNet.forms
{
	...
	/// ODMAPYMVE01 的摘要描述。
	/// </summary>
	public partial class ODMAPYMVE01 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
	{
		//edit by teppy 2011/02/08 Start
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			AjaxPro.Utility.RegisterTypeForAjax(typeof(ODMAPYMVE01));
			UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
			string tLanguageType = tClass.Language;

			//多國語系
			this.Title= MultiLanguage.GetComment("FD","ODMAPYMVE01","lblTitle",this.UserInfo.Language);
			string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "HeadTabStrip01", tLanguageType);
			...
			this.txtuser.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "txtuser", tLanguageType);
			this.applydate.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "applydate", tLanguageType);
			this.txtno01.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "txtno01", tLanguageType);
			this.txtname01.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "txtname01", tLanguageType);
			this.txtamt01.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "txtamt01", tLanguageType);
			this.txtunit01.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "txtunit01", tLanguageType);
			this.txtnote01.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "txtnote01", tLanguageType);
			this.txtcomp01.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "txtcomp01", tLanguageType);
			this.datetime1.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "datetime1", tLanguageType);
			this.txtno02.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "txtno02", tLanguageType);
			this.txtname02.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "txtname02", tLanguageType);
			this.txtamt02.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "txtamt02", tLanguageType);
			this.txtunit02.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "txtunit02", tLanguageType);
			this.txtnote02.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "txtnote02", tLanguageType);
			this.txtcomp02.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "txtcomp02", tLanguageType);
			this.datetime2.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "datetime2", tLanguageType);
			this.txtno03.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "txtno03", tLanguageType);
			this.txtname03.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "txtname03", tLanguageType);
			this.txtamt03.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "txtamt03", tLanguageType);
			this.txtunit03.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "txtunit03", tLanguageType);
			this.txtnote03.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "txtnote03", tLanguageType);
			this.txtcomp03.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "txtcomp03", tLanguageType);
			this.txtother.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "txtother", tLanguageType);
			this.datetime3.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "datetime3", tLanguageType);
			this.txtno04.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "txtno04", tLanguageType);
			this.txtname04.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "txtname04", tLanguageType);
			this.txtamt04.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "txtamt04", tLanguageType);
			this.txtunit04.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "txtunit04", tLanguageType);
			this.txtnote04.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "txtnote04", tLanguageType);
			this.txtcomp04.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "txtcomp04", tLanguageType);
			this.datetime4.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "datetime4", tLanguageType);
			this.txtno05.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "txtno05", tLanguageType);
			this.txtname05.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "txtname05", tLanguageType);
			this.txtamt05.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "txtamt05", tLanguageType);
			this.txtunit05.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "txtunit05", tLanguageType);
			this.txtnote05.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "txtnote05", tLanguageType);
			this.txtcomp05.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "txtcomp05", tLanguageType);
			this.datetime5.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "datetime5", tLanguageType);
			this.txtno06.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "txtno06", tLanguageType);
			this.txtname06.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "txtname06", tLanguageType);
			this.txtamt06.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "txtamt06", tLanguageType);
			this.txtunit06.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "txtunit06", tLanguageType);
			this.txtnote06.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "txtnote06", tLanguageType);
			this.txtcomp06.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "txtcomp06", tLanguageType);
			this.datetime6.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "datetime6", tLanguageType);
			this.txtno07.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "txtno07", tLanguageType);
			this.txtname07.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "txtname07", tLanguageType);
			this.txtamt07.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "txtamt07", tLanguageType);
			this.txtunit07.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "txtunit07", tLanguageType);
			this.txtnote07.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "txtnote07", tLanguageType);
			this.txtcomp07.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "txtcomp07", tLanguageType);
			this.datetime7.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "datetime7", tLanguageType);
			this.txtno08.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "txtno08", tLanguageType);
			this.txtname08.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "txtname08", tLanguageType);
			this.txtamt08.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "txtamt08", tLanguageType);
			this.txtunit08.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "txtunit08", tLanguageType);
			this.txtnote08.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "txtnote08", tLanguageType);
			this.txtcomp08.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "txtcomp08", tLanguageType);
			this.datetime8.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "datetime8", tLanguageType);
			this.txtresaon.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "txtresaon", tLanguageType);
			this.empl1.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "empl1", tLanguageType);
			this.txtdept.Title = MultiLanguage.GetComment("FD", "ODMAPYMVE01", "txtdept", tLanguageType);
		...
		protected override void Page_Prender(object sender, EventArgs e)
		{
			...
			if(strToolTipParameter=="Y"){
				this.txtname01.ToolTip = this.txtname01.Text;
this.txtname02.ToolTip = this.txtname02.Text;
this.txtname03.ToolTip = this.txtname03.Text;
this.txtname04.ToolTip = this.txtname04.Text;
this.txtname05.ToolTip = this.txtname05.Text;
this.txtname06.ToolTip = this.txtname06.Text;
this.txtname07.ToolTip = this.txtname07.Text;
this.txtname08.ToolTip = this.txtname08.Text;
this.txtresaon.ToolTip = this.txtresaon.Text;
			...
			rditem_ctrolRadio3.Checked = (rditem.Value == "3"); rditem_ctrolRadio3.Enabled = rditem.InputEnabled;
			rditem_ctrolRadio4.Checked = (rditem.Value == "4"); rditem_ctrolRadio4.Enabled = rditem.InputEnabled;
		...
		{
			// 作業代號
			this.TaskId = "ODMAPYMVE01";
			// 表單代號
			this.formID = "ODMAPYMVE01";
...
this.rditem_ctrolRadio3.Attributes.Add("onclick", "InitTriggerMust('" + base.FormStatus.ToString() + "');document.getElementById('MasterPage_MasterPageContent_rditem_txt').value = '3';");
this.rditem_ctrolRadio4.Attributes.Add("onclick", "InitTriggerMust('" + base.FormStatus.ToString() + "');document.getElementById('MasterPage_MasterPageContent_rditem_txt').value = '4';");
		...
		{
			defalutHash.Add("odmapymve01001", this.formID);
			defalutHash.Add("odmapymve01002", this.SheetNo);
...
order by resdd003 desc";
		...
		{
			pReport = "ODMAPYMVE01";
			pReportID = "ODMAPYMVE01_02";//憑證式
			pWhere = "AND (odmapymve01001='" + this.formID + "') AND (odmapymve01002='" + this.SheetNo + "')";
			pReportDirectory = "ODMAPYMVE01";
