...
namespace tw.com.dsc.easyflowDotNet.forms
{
	...
	/// ODMFODCN01 的摘要描述。
	/// </summary>
	public partial class ODMFODCN01 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
	{
		//edit by teppy 2011/02/08 Start
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			AjaxPro.Utility.RegisterTypeForAjax(typeof(ODMFODCN01));
			UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
			string tLanguageType = tClass.Language;

			//多國語系
			this.Title= MultiLanguage.GetComment("FD","ODMFODCN01","lblTitle",this.UserInfo.Language);
			string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ODMFODCN01", "HeadTabStrip01", tLanguageType);
			...
			this.lblnotic.Text = MultiLanguage.GetComment("FD", "ODMFODCN01", "lblnotic", tLanguageType);
			this.date.Title = MultiLanguage.GetComment("FD", "ODMFODCN01", "date", tLanguageType);
			this.date01.Title = MultiLanguage.GetComment("FD", "ODMFODCN01", "date01", tLanguageType);
			this.txtmain.Title = MultiLanguage.GetComment("FD", "ODMFODCN01", "txtmain", tLanguageType);
			this.txtuser.Title = MultiLanguage.GetComment("FD", "ODMFODCN01", "txtuser", tLanguageType);
		...
		{
			// 作業代號
			this.TaskId = "ODMFODCN01";
			// 表單代號
			this.formID = "ODMFODCN01";
...
where resfc001=@resfc001 and resfc002=@resfc002 and resfc003=@resfc003 and ISNULL(resfc004,'')<>''";
		...
		{
			defalutHash.Add("odmfodcn01001", this.formID);
			defalutHash.Add("odmfodcn01002", this.SheetNo);
			defalutHash.Add("date", DateTime.Now.AddDays(-5).ToString("yyyyMMdd"));
			defalutHash.Add("date01", DateTime.Now.ToString("yyyyMMdd"));
...
order by resdd003 desc";
		...
		{
			pReport = "ODMFODCN01";
			pReportID = "ODMFODCN01_02";//憑證式
			pWhere = "AND (odmfodcn01001='" + this.formID + "') AND (odmfodcn01002='" + this.SheetNo + "')";
			pReportDirectory = "ODMFODCN01";
