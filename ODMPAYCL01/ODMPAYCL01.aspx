<%@ Page language="c#" CodeFile="ODMPAYCL01.aspx.cs" MasterPageFile="~/src/_Common/AppUtil/EFMasterPage/EFBaseMasterPage.master" AutoEventWireup="false" enableEventValidation="false" Inherits="tw.com.dsc.easyflowDotNet.forms.ODMPAYCL01" %>
<%@ Register TagPrefix="uc1" TagName="gridUserControl" Src="../../_Common/PlatformUtil/KernelPage/Grid/gridUserControl.ascx" %>
<%@ Register TagPrefix="iewc" Namespace="Microsoft.Web.UI.WebControls" Assembly="Microsoft.Web.UI.WebControls" %>
<%@ Register TagPrefix="cc1" Namespace="tw.com.dsc.dscDotNet.dscWebControls" Assembly="PlatformUtil" %>

<asp:Content ID="ODMPAYCL01FormContent" ContentPlaceHolderID="MasterPageContent" runat="server">
	<!--單檔架構 -->
	<!--2009/03/19:Joseph:<div id="cover" style="OVERFLOW: auto; WIDTH: 100%;">-->
		<div id="cover" style="WIDTH: 100%;">
			<div id="createRecord" style="WIDTH: 100%; HEIGHT: 100%" runat="server">
				<cc1:DscPanel id="ecPnlMaster" runat="server" Width="98%" IniHTML='&#10;<div style="OVERFLOW: auto; WIDTH: 100%; POSITION: relative; HEIGHT: 100%" ms_positioning="GridLayout"></div>'
					FrmDefineKeys-FrmType="Query" FrmDefineKeys-FrmID="FrmODMPAYCL01" FrmDefineKeys-BOID="ODMPAYCL01"
					BorderStyle="None" BorderColor="Transparent" BorderWidth="0px" Height="641px">
					<!--單頭頁籤-->
					...
					<!--單頭頁籤 一-->
					<cc1:Dscpanel id='divheadDefault' style='DISPLAY: block' runat='server' Width='100%' Height='641px' BackColor='Transparent'>
						<div class='TabPage' style='POSITION: relative; HEIGHT: 641px; left: 0px; top: 0px;' >
							<asp:ValidationSummary id='ValidationSummaryHead01' style='Z-INDEX: 100; POSITION: absolute; LEFT: 745px; TOP: 7px;' runat='server' ShowSummary='False' ShowMessageBox='True'></asp:ValidationSummary>
							<!--此區間放入單頭頁籤 一 的各個dsc元件-->

<cc1:DscTextBox id='odmpaycl01001' runat='server' title='表單代號'
	style='display: none; Z-INDEX: 101; POSITION: absolute; LEFT: 245px; TOP: 16px;'
	TxtInput_TabIndex='0'>
	<INPUTSTYLE Width='120px'></INPUTSTYLE>
	<TITLESTYLE Width='110px'></TITLESTYLE>
	<FRMFIELDKEYS FrmID='FrmODMPAYCL01' BOID='ODMPAYCL01' FieldName='odmpaycl01001'></FRMFIELDKEYS>
</cc1:DscTextBox>
<cc1:DscTextBox id='odmpaycl01002' runat='server' title='表單單號'
	style='display: none; Z-INDEX: 102; POSITION: absolute; LEFT: 245px; TOP: 49px;'
	TxtInput_TabIndex='0'>
	<INPUTSTYLE Width='120px'></INPUTSTYLE>
	<TITLESTYLE Width='110px'></TITLESTYLE>
	<FRMFIELDKEYS FrmID='FrmODMPAYCL01' BOID='ODMPAYCL01' FieldName='odmpaycl01002'></FRMFIELDKEYS>
</cc1:DscTextBox>
...
<cc1:DscDateAssistant2 ID='datetime1' runat='server' Title='datetime1' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMPAYCL01' BOID='ODMPAYCL01' FieldName='datetime1'></FrmFieldKeys>
...
<cc1:DscTextBox id='dept' runat='server' title='部門' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMPAYCL01' BOID='ODMPAYCL01' FieldName='dept'></FrmFieldKeys>
...
<cc1:DscTextBox id='username' runat='server' title='請款人' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMPAYCL01' BOID='ODMPAYCL01' FieldName='username'></FrmFieldKeys>
	<TitleStyle Width='100px'></TitleStyle>
	<InputStyle Width='100px' Height='25px' CssClass='Edit20'></InputStyle>
</cc1:DscTextBox>
<cc1:DscTextBox id='textarea1' runat='server' title='內容01' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMPAYCL01' BOID='ODMPAYCL01' FieldName='textarea1'></FrmFieldKeys>
	<TitleStyle Width='100px'></TitleStyle>
...
<cc1:DscTextBox id='money01' runat='server' title='金額01' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMPAYCL01' BOID='ODMPAYCL01' FieldName='money01'></FrmFieldKeys>
	<TitleStyle Width='100px'></TitleStyle>
	<InputStyle Width='100px' Height='25px' CssClass='Edit20'></InputStyle>
</cc1:DscTextBox>
<cc1:DscTextBox id='mtotal' runat='server' title='總金額' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMPAYCL01' BOID='ODMPAYCL01' FieldName='mtotal'></FrmFieldKeys>
	<TitleStyle Width='100px'></TitleStyle>
	<InputStyle Width='100px' Height='25px' CssClass='Edit20'></InputStyle>
</cc1:DscTextBox>
<cc1:DscTextBox id='inv01' runat='server' title='發票張數' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMPAYCL01' BOID='ODMPAYCL01' FieldName='inv01'></FrmFieldKeys>
	<TitleStyle Width='100px'></TitleStyle>
...
<cc1:DscTextBox id='inv02' runat='server' title='數據張數' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMPAYCL01' BOID='ODMPAYCL01' FieldName='inv02'></FrmFieldKeys>
	<TitleStyle Width='100px'></TitleStyle>
...
<cc1:DscTextBox id='orderno' runat='server' title='訂購單號' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMPAYCL01' BOID='ODMPAYCL01' FieldName='orderno'></FrmFieldKeys>
	<TitleStyle Width='100px'></TitleStyle>
...
<cc1:DscTextBox id='attother' runat='server' title='其他附件' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMPAYCL01' BOID='ODMPAYCL01' FieldName='attother'></FrmFieldKeys>
	<TitleStyle Width='100px'></TitleStyle>
...
<cc1:DscCheckBox ID='other' runat='server' Text='其他附件' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMPAYCL01' BOID='ODMPAYCL01' FieldName='other'></FrmFieldKeys>
</cc1:DscCheckBox>
...
<cc1:DscOpenQuery id='empl1' runat='server' title='empl1' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMPAYCL01' BOID='ODMPAYCL01' FieldName='empl1'></FrmFieldKeys>
</cc1:DscOpenQuery>
</div>
<div style="display:none;">
<cc1:DscOpenQuery id='empl2' runat='server' title='empl2' ShowTitle='False'
	...
	ReturnVisible='True'>
	<InputStyle Width='121px' Height='22px' CssClass='Edit20'></InputStyle>
	<FrmFieldKeys FrmID='FrmODMPAYCL01' BOID='ODMPAYCL01' FieldName='empl2'></FrmFieldKeys>
</cc1:DscOpenQuery>
</div>
<cc1:DscCheckBox ID='chkkind01' runat='server' Text='一般費用' ShowTitle='False'
	...
	Checked='False' CheckedTrueValue='1' CheckedFalseValue='0'>
	<InputStyle Width='17px' Height='22px' />
	<FrmFieldKeys FrmID='FrmODMPAYCL01' BOID='ODMPAYCL01' FieldName='chkkind01'></FrmFieldKeys>
</cc1:DscCheckBox>
<cc1:DscCheckBox ID='chkkind02' runat='server' Text='資產' ShowTitle='False'
	...
	Checked='False' CheckedTrueValue='1' CheckedFalseValue='0'>
	<InputStyle Width='17px' Height='22px' />
	<FrmFieldKeys FrmID='FrmODMPAYCL01' BOID='ODMPAYCL01' FieldName='chkkind02'></FrmFieldKeys>
</cc1:DscCheckBox>
<cc1:DscCheckBox ID='chkkind03' runat='server' Text='原物料' ShowTitle='False'
	...
	Checked='False' CheckedTrueValue='1' CheckedFalseValue='0'>
	<InputStyle Width='17px' Height='22px' />
	<FrmFieldKeys FrmID='FrmODMPAYCL01' BOID='ODMPAYCL01' FieldName='chkkind03'></FrmFieldKeys>
</cc1:DscCheckBox>
<cc1:DscCheckBox ID='chkkind04' runat='server' Text='零用金' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMPAYCL01' BOID='ODMPAYCL01' FieldName='chkkind04'></FrmFieldKeys>
</cc1:DscCheckBox>
<cc1:DscCheckBox ID='chkkind05' runat='server' Text='其他' ShowTitle='False'
	...
	Checked='False' CheckedTrueValue='1' CheckedFalseValue='0'>
	<InputStyle Width='17px' Height='22px' />
	<FrmFieldKeys FrmID='FrmODMPAYCL01' BOID='ODMPAYCL01' FieldName='chkkind05'></FrmFieldKeys>
</cc1:DscCheckBox>
<cc1:DscDropDownList ID='curr' runat='server' Title='幣別' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMPAYCL01' BOID='ODMPAYCL01' FieldName='curr'></FrmFieldKeys>
	<CommentList F0001='Combo' F0002='ODMPAYCL01_curr' />
</cc1:DscDropDownList>
<cc1:DscCheckBox ID='chkadd01' runat='server' Text='發票' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMPAYCL01' BOID='ODMPAYCL01' FieldName='chkadd01'></FrmFieldKeys>
</cc1:DscCheckBox>
<cc1:DscCheckBox ID='chkadd02' runat='server' Text='收據' ShowTitle='False'
	...
	Checked='False' CheckedTrueValue='1' CheckedFalseValue='0'>
	<InputStyle Width='18px' Height='22px' />
	<FrmFieldKeys FrmID='FrmODMPAYCL01' BOID='ODMPAYCL01' FieldName='chkadd02'></FrmFieldKeys>
</cc1:DscCheckBox>
<cc1:DscCheckBox ID='chkadd04' runat='server' Text='驗收' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMPAYCL01' BOID='ODMPAYCL01' FieldName='chkadd04'></FrmFieldKeys>
</cc1:DscCheckBox>
<cc1:DscCheckBox ID='chkadd05' runat='server' Text='進貨單' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMPAYCL01' BOID='ODMPAYCL01' FieldName='chkadd05'></FrmFieldKeys>
</cc1:DscCheckBox>
<cc1:DscOpenQuery id='queryfirm' runat='server' title='受款人' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMPAYCL01' BOID='ODMPAYCL01' FieldName='queryfirm'></FrmFieldKeys>
</cc1:DscOpenQuery>
<cc1:DscTextBox id='txtother' runat='server' title='其他' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMPAYCL01' BOID='ODMPAYCL01' FieldName='txtother'></FrmFieldKeys>
	<TitleStyle Width='100px'></TitleStyle>
...
<cc1:DscTextBox id='textarea2' runat='server' title='內容02' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMPAYCL01' BOID='ODMPAYCL01' FieldName='textarea2'></FrmFieldKeys>
	<TitleStyle Width='100px'></TitleStyle>
	<InputStyle Width='350px' Height='100px' CssClass='Edit20'></InputStyle>
</cc1:DscTextBox>
<cc1:DscTextBox id='money02' runat='server' title='金額02' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMPAYCL01' BOID='ODMPAYCL01' FieldName='money02'></FrmFieldKeys>
	<TitleStyle Width='100px'></TitleStyle>
	<InputStyle Width='100px' Height='25px' CssClass='Edit20'></InputStyle>
</cc1:DscTextBox>
<cc1:DscOpenQuery id='opentype01' runat='server' title='主類別01' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMPAYCL01' BOID='ODMPAYCL01' FieldName='opentype01'></FrmFieldKeys>
</cc1:DscOpenQuery>
<cc1:DscOpenQuery id='openitem01' runat='server' title='子類別01' ShowTitle='False'
	...
	ReturnVisible='True'>
	<InputStyle Width='35px' Height='22px' CssClass='Edit20'></InputStyle>
	<FrmFieldKeys FrmID='FrmODMPAYCL01' BOID='ODMPAYCL01' FieldName='openitem01'></FrmFieldKeys>
</cc1:DscOpenQuery>
<cc1:DscOpenQuery id='opentype02' runat='server' title='主類別02' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMPAYCL01' BOID='ODMPAYCL01' FieldName='opentype02'></FrmFieldKeys>
</cc1:DscOpenQuery>
<cc1:DscOpenQuery id='openitem02' runat='server' title='子類別02' ShowTitle='False'
	...
	ReturnVisible='True'>
	<InputStyle Width='35px' Height='22px' CssClass='Edit20'></InputStyle>
	<FrmFieldKeys FrmID='FrmODMPAYCL01' BOID='ODMPAYCL01' FieldName='openitem02'></FrmFieldKeys>
</cc1:DscOpenQuery>
<cc1:DscTextBox id='useyear' runat='server' title='使用年限' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMPAYCL01' BOID='ODMPAYCL01' FieldName='useyear'></FrmFieldKeys>
	<TitleStyle Width='100px'></TitleStyle>
...
<cc1:DscTextBox id='chkvn' runat='server' title='冠志廠' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMPAYCL01' BOID='ODMPAYCL01' FieldName='chkvn'></FrmFieldKeys>
</cc1:DscTextBox>
...
<cc1:DscTextBox id='kind' runat='server' title='預付費用' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmODMPAYCL01' BOID='ODMPAYCL01' FieldName='kind'></FrmFieldKeys>
</cc1:DscTextBox>
...
<div style="position:absolute; left:2px; top:5px; z-index:10; ">
	<img src="ODMPAYCL01.png" id="Head01_file_1" runat="server" width="718" height="606" />
</div>
...
<script src="ODMPAYCL01.js?NoCache=202207291705" type="text/javascript"></script>
</asp:Content>
