...
namespace tw.com.dsc.easyflowDotNet.forms
{
    ...
    /// ODMPAYCL01 的摘要描述。
    /// </summary>
    public partial class ODMPAYCL01 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
    {
        //edit by teppy 2011/02/08 Start
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            AjaxPro.Utility.RegisterTypeForAjax(typeof(ODMPAYCL01));
            UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
            string tLanguageType = tClass.Language;

            //多國語系
            this.Title = MultiLanguage.GetComment("FD", "ODMPAYCL01", "lblTitle", this.UserInfo.Language);
            string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ODMPAYCL01", "HeadTabStrip01", tLanguageType);
            ...
            this.datetime1.Title = MultiLanguage.GetComment("FD", "ODMPAYCL01", "datetime1", tLanguageType);
            this.dept.Title = MultiLanguage.GetComment("FD", "ODMPAYCL01", "dept", tLanguageType);
            this.username.Title = MultiLanguage.GetComment("FD", "ODMPAYCL01", "username", tLanguageType);
            this.textarea1.Title = MultiLanguage.GetComment("FD", "ODMPAYCL01", "textarea1", tLanguageType);
            this.money01.Title = MultiLanguage.GetComment("FD", "ODMPAYCL01", "money01", tLanguageType);
            this.mtotal.Title = MultiLanguage.GetComment("FD", "ODMPAYCL01", "mtotal", tLanguageType);
            this.inv01.Title = MultiLanguage.GetComment("FD", "ODMPAYCL01", "inv01", tLanguageType);
            this.inv02.Title = MultiLanguage.GetComment("FD", "ODMPAYCL01", "inv02", tLanguageType);
            this.orderno.Title = MultiLanguage.GetComment("FD", "ODMPAYCL01", "orderno", tLanguageType);
            this.attother.Title = MultiLanguage.GetComment("FD", "ODMPAYCL01", "attother", tLanguageType);
            this.other.Text = MultiLanguage.GetComment("FD", "ODMPAYCL01", "other", tLanguageType);
            this.empl1.Title = MultiLanguage.GetComment("FD", "ODMPAYCL01", "empl1", tLanguageType);
            this.empl2.Title = MultiLanguage.GetComment("FD", "ODMPAYCL01", "empl2", tLanguageType);
            this.chkkind01.Text = MultiLanguage.GetComment("FD", "ODMPAYCL01", "chkkind01", tLanguageType);
            this.chkkind02.Text = MultiLanguage.GetComment("FD", "ODMPAYCL01", "chkkind02", tLanguageType);
            this.chkkind03.Text = MultiLanguage.GetComment("FD", "ODMPAYCL01", "chkkind03", tLanguageType);
            this.chkkind04.Text = MultiLanguage.GetComment("FD", "ODMPAYCL01", "chkkind04", tLanguageType);
            this.chkkind05.Text = MultiLanguage.GetComment("FD", "ODMPAYCL01", "chkkind05", tLanguageType);
            this.curr.Title = MultiLanguage.GetComment("FD", "ODMPAYCL01", "curr", tLanguageType);
            this.chkadd01.Text = MultiLanguage.GetComment("FD", "ODMPAYCL01", "chkadd01", tLanguageType);
            this.chkadd02.Text = MultiLanguage.GetComment("FD", "ODMPAYCL01", "chkadd02", tLanguageType);
            this.chkadd04.Text = MultiLanguage.GetComment("FD", "ODMPAYCL01", "chkadd04", tLanguageType);
            this.chkadd05.Text = MultiLanguage.GetComment("FD", "ODMPAYCL01", "chkadd05", tLanguageType);
            this.queryfirm.Title = MultiLanguage.GetComment("FD", "ODMPAYCL01", "queryfirm", tLanguageType);
            this.txtother.Title = MultiLanguage.GetComment("FD", "ODMPAYCL01", "txtother", tLanguageType);
            this.textarea2.Title = MultiLanguage.GetComment("FD", "ODMPAYCL01", "textarea2", tLanguageType);
            this.money02.Title = MultiLanguage.GetComment("FD", "ODMPAYCL01", "money02", tLanguageType);
            this.opentype01.Title = MultiLanguage.GetComment("FD", "ODMPAYCL01", "opentype01", tLanguageType);
            this.openitem01.Title = MultiLanguage.GetComment("FD", "ODMPAYCL01", "openitem01", tLanguageType);
            this.opentype02.Title = MultiLanguage.GetComment("FD", "ODMPAYCL01", "opentype02", tLanguageType);
            this.openitem02.Title = MultiLanguage.GetComment("FD", "ODMPAYCL01", "openitem02", tLanguageType);
            this.useyear.Title = MultiLanguage.GetComment("FD", "ODMPAYCL01", "useyear", tLanguageType);
            #region 三位一撇
            //^_^ 20230411 Peggy 
            //三位一撇
        ...
        {
            // 作業代號
            this.TaskId = "ODMPAYCL01";
            // 表單代號
            this.formID = "ODMPAYCL01";
...
where resfc001=@resfc001 and resfc002=@resfc002 and resfc003=@resfc003 and ISNULL(resfc004,'')<>''";
        ...
        protected override void SetDefaultValue(Hashtable defalutHash)
        {
            ...
            defalutHash.Add("odmpaycl01001", this.formID);
            defalutHash.Add("odmpaycl01002", this.SheetNo);
...
order by resdd003 desc";
        ...
        {
            pReport = "ODMPAYCL01";
            pReportID = "ODMPAYCL01_02";//憑證式
            pWhere = "AND (odmpaycl01001='" + this.formID + "') AND (odmpaycl01002='" + this.SheetNo + "')";
            pReportDirectory = "ODMPAYCL01";
