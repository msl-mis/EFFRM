...
namespace tw.com.dsc.easyflowDotNet.forms
{
	...
	/// PAY001 的摘要描述。
	/// </summary>
	public partial class PAY001 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
	{
		//edit by teppy 2011/02/08 Start
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			AjaxPro.Utility.RegisterTypeForAjax(typeof(PAY001));
			UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
			string tLanguageType = tClass.Language;

			//多國語系
			this.Title= MultiLanguage.GetComment("FD","PAY001","lblTitle",this.UserInfo.Language);
			string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "PAY001", "HeadTabStrip01", tLanguageType);
			...
			this.datetime1.Title = MultiLanguage.GetComment("FD", "PAY001", "datetime1", tLanguageType);
			this.text1.Title = MultiLanguage.GetComment("FD", "PAY001", "text1", tLanguageType);
			this.text2.Title = MultiLanguage.GetComment("FD", "PAY001", "text2", tLanguageType);
			this.text3.Title = MultiLanguage.GetComment("FD", "PAY001", "text3", tLanguageType);
			this.text4.Title = MultiLanguage.GetComment("FD", "PAY001", "text4", tLanguageType);
			this.text5.Title = MultiLanguage.GetComment("FD", "PAY001", "text5", tLanguageType);
			this.text6.Title = MultiLanguage.GetComment("FD", "PAY001", "text6", tLanguageType);
			this.text7.Title = MultiLanguage.GetComment("FD", "PAY001", "text7", tLanguageType);
			this.text8.Title = MultiLanguage.GetComment("FD", "PAY001", "text8", tLanguageType);
			this.text9.Title = MultiLanguage.GetComment("FD", "PAY001", "text9", tLanguageType);
			this.text10.Title = MultiLanguage.GetComment("FD", "PAY001", "text10", tLanguageType);
...
where resfc001=@resfc001 and resfc002=@resfc002 and resfc003=@resfc003 and ISNULL(resfc004,'')<>''";
		...
		{
			defalutHash.Add("mslcnpay001", this.formID);
			defalutHash.Add("mslcnpay002", this.SheetNo);
			defalutHash.Add("text1", ajaxGetDepartmentId());
			defalutHash.Add("text2", this.UserInfo.LoginName.ToString());
		}
...
order by resdd003 desc";
		...
		{
			pReport = "PAY001";
			pReportID = "PAY001_02";//憑證式
			pWhere = "AND (mslcnpay001='" + this.formID + "') AND (mslcnpay002='" + this.SheetNo + "')";
			pReportDirectory = "PAY001";
