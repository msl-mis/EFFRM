...
{
	/// <summary>
	/// ODMULPAY_T_MIMJ 的摘要描述。
	/// </summary>
	public partial class ODMULPAY_T_MIMJ : tw.com.dsc.easyflowDotNet.kernelBasePage.EFMIMJBasepage
	{
		...
		protected override void MIFunction()
		{
			switch(tBtnID)
			{
				case "MasterPage_MasterPageContent_authorID_btn":			//員工代號
				{
					base.doMI("RESAK","03");
					break;
				}
		...
		protected override void MJFunction()
		{
			...
			switch(tMJ)//欄位ID命名要規則化
			{
				case "員工代號_authorID":	
				{
					base.doMJ("RESAK","03","MasterPage_MasterPageContent_authorID_txt2=resak002");
					break;
				}
				case "員工代號_SuperID":	
				{
				...
				case "OpenMIMJ01_25_opentype03":	
				{
					bSelfResult = getMJResultByDB("OpenMIMJ01","25",1,FinalList, @"192.168.10.22", "price","MasterPage_MasterPageContent_opentype03_txt2=type_name");
					if(bSelfResult)
					{
						if (tAllInputValues["MasterPage_MasterPageContent_openitem03_txt"] != null && tAllInputValues["MasterPage_MasterPageContent_openitem03_txt"].ToString().Length > 0){
							...
							//自訂MsgCode
							bool bTriggerMJ=getMJResultByDB("TrigMIMJ01","09",aryParamger,FinalList, @"192.168.10.22", "price","MasterPage_MasterPageContent_openitem03_txt2=item_name");
							if(!bTriggerMJ){
				...
				case "TrigMIMJ01_09_openitem03":	
				{
					base.doMJByDB("TrigMIMJ01","09", @"192.168.10.22", "price","MasterPage_MasterPageContent_openitem03_txt2=item_name");
					break;
				}
				case "TrigMIMJ01_09_openitem04":	
				{
					base.doMJByDB("TrigMIMJ01","09", @"192.168.10.22", "price","MasterPage_MasterPageContent_openitem04_txt2=item_name");
					break;
				}
				case "OpenMIMJ01_25_opentype04":	
				{
					bSelfResult = getMJResultByDB("OpenMIMJ01","25",1,FinalList, @"192.168.10.22", "price","MasterPage_MasterPageContent_opentype04_txt2=type_name");
					if(bSelfResult)
					{
						if (tAllInputValues["MasterPage_MasterPageContent_openitem04_txt"] != null && tAllInputValues["MasterPage_MasterPageContent_openitem04_txt"].ToString().Length > 0){
							...
							//自訂MsgCode
							bool bTriggerMJ=getMJResultByDB("TrigMIMJ01","09",aryParamger,FinalList, @"192.168.10.22", "price","MasterPage_MasterPageContent_openitem04_txt2=item_name");
							if(!bTriggerMJ){
