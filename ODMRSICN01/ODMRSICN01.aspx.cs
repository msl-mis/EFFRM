...
namespace tw.com.dsc.easyflowDotNet.forms
{
	...
	/// ODMRSICN01 的摘要描述。
	/// </summary>
	public partial class ODMRSICN01 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
	{
		//edit by teppy 2011/02/08 Start
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			AjaxPro.Utility.RegisterTypeForAjax(typeof(ODMRSICN01));
			UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
			string tLanguageType = tClass.Language;

			//多國語系
			this.Title= MultiLanguage.GetComment("FD","ODMRSICN01","lblTitle",this.UserInfo.Language);
			string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ODMRSICN01", "HeadTabStrip01", tLanguageType);
			...
			this.label1.Text = MultiLanguage.GetComment("FD", "ODMRSICN01", "label1", tLanguageType);
			this.username.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "username", tLanguageType);
			this.datetime1.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "datetime1", tLanguageType);
			this.datetime2.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "datetime2", tLanguageType);
			this.note01.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "note01", tLanguageType);
			this.id01.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "id01", tLanguageType);
			this.name01.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "name01", tLanguageType);
			this.debt01.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "debt01", tLanguageType);
			this.amt01.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "amt01", tLanguageType);
			this.note02.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "note02", tLanguageType);
			this.id02.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "id02", tLanguageType);
			this.name02.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "name02", tLanguageType);
			this.debt02.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "debt02", tLanguageType);
			this.amt02.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "amt02", tLanguageType);
			this.dept03.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "dept03", tLanguageType);
			this.note03.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "note03", tLanguageType);
			this.id03.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "id03", tLanguageType);
			this.name03.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "name03", tLanguageType);
			this.debt03.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "debt03", tLanguageType);
			this.amt03.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "amt03", tLanguageType);
			this.dept04.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "dept04", tLanguageType);
			this.note04.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "note04", tLanguageType);
			this.id04.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "id04", tLanguageType);
			this.name04.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "name04", tLanguageType);
			this.debt04.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "debt04", tLanguageType);
			this.amt04.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "amt04", tLanguageType);
			this.dept05.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "dept05", tLanguageType);
			this.note05.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "note05", tLanguageType);
			this.id05.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "id05", tLanguageType);
			this.name05.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "name05", tLanguageType);
			this.debt05.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "debt05", tLanguageType);
			this.amt05.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "amt05", tLanguageType);
			this.dept06.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "dept06", tLanguageType);
			this.note06.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "note06", tLanguageType);
			this.id06.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "id06", tLanguageType);
			this.name06.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "name06", tLanguageType);
			this.debt06.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "debt06", tLanguageType);
			this.amt06.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "amt06", tLanguageType);
			this.dept07.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "dept07", tLanguageType);
			this.note07.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "note07", tLanguageType);
			this.id07.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "id07", tLanguageType);
			this.name07.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "name07", tLanguageType);
			this.debt07.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "debt07", tLanguageType);
			this.amt07.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "amt07", tLanguageType);
			this.dept08.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "dept08", tLanguageType);
			this.note08.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "note08", tLanguageType);
			this.id08.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "id08", tLanguageType);
			this.name08.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "name08", tLanguageType);
			this.debt08.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "debt08", tLanguageType);
			this.amt08.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "amt08", tLanguageType);
			this.dept09.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "dept09", tLanguageType);
			this.note09.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "note09", tLanguageType);
			this.id09.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "id09", tLanguageType);
			this.name09.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "name09", tLanguageType);
			this.debt09.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "debt09", tLanguageType);
			this.amt09.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "amt09", tLanguageType);
			this.dept10.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "dept10", tLanguageType);
			this.note10.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "note10", tLanguageType);
			this.id10.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "id10", tLanguageType);
			this.name10.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "name10", tLanguageType);
			this.debt10.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "debt10", tLanguageType);
			this.amt10.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "amt10", tLanguageType);
			this.totamt.Title = MultiLanguage.GetComment("FD", "ODMRSICN01", "totamt", tLanguageType);
		...
		{
			// 作業代號
			this.TaskId = "ODMRSICN01";
			// 表單代號
			this.formID = "ODMRSICN01";
...
where resfc001=@resfc001 and resfc002=@resfc002 and resfc003=@resfc003 and ISNULL(resfc004,'')<>''";
		...
		protected override void settingClientFunction()
		{
			...
			//單頭控制項
			string stramt01_DoMathScript_totamt_onChange=string.Empty;
			if(amt01.TxtInput.Attributes["onchange"]!=null){stramt01_DoMathScript_totamt_onChange=amt01.TxtInput.Attributes["onchange"].ToString().Trim(';');}
			if(stramt01_DoMathScript_totamt_onChange.Length>0)
				stramt01_DoMathScript_totamt_onChange+=";";
			amt01.TxtInput.Attributes.Add("onchange",stramt01_DoMathScript_totamt_onChange+"domath_totamt();");

			string stramt01_DoMathScript_totamt_onblur=string.Empty;
			if(amt01.TxtInput.Attributes["onblur"]!=null){stramt01_DoMathScript_totamt_onblur=amt01.TxtInput.Attributes["onblur"].ToString().Trim(';');}
			if(stramt01_DoMathScript_totamt_onblur.Length>0)
				stramt01_DoMathScript_totamt_onblur+=";";
			amt01.TxtInput.Attributes.Add("onblur",stramt01_DoMathScript_totamt_onblur+"domath_totamt();");

			string stramt02_DoMathScript_totamt_onChange=string.Empty;
			if(amt02.TxtInput.Attributes["onchange"]!=null){stramt02_DoMathScript_totamt_onChange=amt02.TxtInput.Attributes["onchange"].ToString().Trim(';');}
			if(stramt02_DoMathScript_totamt_onChange.Length>0)
				stramt02_DoMathScript_totamt_onChange+=";";
			amt02.TxtInput.Attributes.Add("onchange",stramt02_DoMathScript_totamt_onChange+"domath_totamt();");

			string stramt02_DoMathScript_totamt_onblur=string.Empty;
			if(amt02.TxtInput.Attributes["onblur"]!=null){stramt02_DoMathScript_totamt_onblur=amt02.TxtInput.Attributes["onblur"].ToString().Trim(';');}
			if(stramt02_DoMathScript_totamt_onblur.Length>0)
				stramt02_DoMathScript_totamt_onblur+=";";
			amt02.TxtInput.Attributes.Add("onblur",stramt02_DoMathScript_totamt_onblur+"domath_totamt();");

			string stramt03_DoMathScript_totamt_onChange=string.Empty;
			if(amt03.TxtInput.Attributes["onchange"]!=null){stramt03_DoMathScript_totamt_onChange=amt03.TxtInput.Attributes["onchange"].ToString().Trim(';');}
			if(stramt03_DoMathScript_totamt_onChange.Length>0)
				stramt03_DoMathScript_totamt_onChange+=";";
			amt03.TxtInput.Attributes.Add("onchange",stramt03_DoMathScript_totamt_onChange+"domath_totamt();");

			string stramt03_DoMathScript_totamt_onblur=string.Empty;
			if(amt03.TxtInput.Attributes["onblur"]!=null){stramt03_DoMathScript_totamt_onblur=amt03.TxtInput.Attributes["onblur"].ToString().Trim(';');}
			if(stramt03_DoMathScript_totamt_onblur.Length>0)
				stramt03_DoMathScript_totamt_onblur+=";";
			amt03.TxtInput.Attributes.Add("onblur",stramt03_DoMathScript_totamt_onblur+"domath_totamt();");

			string stramt04_DoMathScript_totamt_onChange=string.Empty;
			if(amt04.TxtInput.Attributes["onchange"]!=null){stramt04_DoMathScript_totamt_onChange=amt04.TxtInput.Attributes["onchange"].ToString().Trim(';');}
			if(stramt04_DoMathScript_totamt_onChange.Length>0)
				stramt04_DoMathScript_totamt_onChange+=";";
			amt04.TxtInput.Attributes.Add("onchange",stramt04_DoMathScript_totamt_onChange+"domath_totamt();");

			string stramt04_DoMathScript_totamt_onblur=string.Empty;
			if(amt04.TxtInput.Attributes["onblur"]!=null){stramt04_DoMathScript_totamt_onblur=amt04.TxtInput.Attributes["onblur"].ToString().Trim(';');}
			if(stramt04_DoMathScript_totamt_onblur.Length>0)
				stramt04_DoMathScript_totamt_onblur+=";";
			amt04.TxtInput.Attributes.Add("onblur",stramt04_DoMathScript_totamt_onblur+"domath_totamt();");

			string stramt05_DoMathScript_totamt_onChange=string.Empty;
			if(amt05.TxtInput.Attributes["onchange"]!=null){stramt05_DoMathScript_totamt_onChange=amt05.TxtInput.Attributes["onchange"].ToString().Trim(';');}
			if(stramt05_DoMathScript_totamt_onChange.Length>0)
				stramt05_DoMathScript_totamt_onChange+=";";
			amt05.TxtInput.Attributes.Add("onchange",stramt05_DoMathScript_totamt_onChange+"domath_totamt();");

			string stramt05_DoMathScript_totamt_onblur=string.Empty;
			if(amt05.TxtInput.Attributes["onblur"]!=null){stramt05_DoMathScript_totamt_onblur=amt05.TxtInput.Attributes["onblur"].ToString().Trim(';');}
			if(stramt05_DoMathScript_totamt_onblur.Length>0)
				stramt05_DoMathScript_totamt_onblur+=";";
			amt05.TxtInput.Attributes.Add("onblur",stramt05_DoMathScript_totamt_onblur+"domath_totamt();");

			string stramt06_DoMathScript_totamt_onChange=string.Empty;
			if(amt06.TxtInput.Attributes["onchange"]!=null){stramt06_DoMathScript_totamt_onChange=amt06.TxtInput.Attributes["onchange"].ToString().Trim(';');}
			if(stramt06_DoMathScript_totamt_onChange.Length>0)
				stramt06_DoMathScript_totamt_onChange+=";";
			amt06.TxtInput.Attributes.Add("onchange",stramt06_DoMathScript_totamt_onChange+"domath_totamt();");

			string stramt06_DoMathScript_totamt_onblur=string.Empty;
			if(amt06.TxtInput.Attributes["onblur"]!=null){stramt06_DoMathScript_totamt_onblur=amt06.TxtInput.Attributes["onblur"].ToString().Trim(';');}
			if(stramt06_DoMathScript_totamt_onblur.Length>0)
				stramt06_DoMathScript_totamt_onblur+=";";
			amt06.TxtInput.Attributes.Add("onblur",stramt06_DoMathScript_totamt_onblur+"domath_totamt();");

			string stramt07_DoMathScript_totamt_onChange=string.Empty;
			if(amt07.TxtInput.Attributes["onchange"]!=null){stramt07_DoMathScript_totamt_onChange=amt07.TxtInput.Attributes["onchange"].ToString().Trim(';');}
			if(stramt07_DoMathScript_totamt_onChange.Length>0)
				stramt07_DoMathScript_totamt_onChange+=";";
			amt07.TxtInput.Attributes.Add("onchange",stramt07_DoMathScript_totamt_onChange+"domath_totamt();");

			string stramt07_DoMathScript_totamt_onblur=string.Empty;
			if(amt07.TxtInput.Attributes["onblur"]!=null){stramt07_DoMathScript_totamt_onblur=amt07.TxtInput.Attributes["onblur"].ToString().Trim(';');}
			if(stramt07_DoMathScript_totamt_onblur.Length>0)
				stramt07_DoMathScript_totamt_onblur+=";";
			amt07.TxtInput.Attributes.Add("onblur",stramt07_DoMathScript_totamt_onblur+"domath_totamt();");

			string stramt08_DoMathScript_totamt_onChange=string.Empty;
			if(amt08.TxtInput.Attributes["onchange"]!=null){stramt08_DoMathScript_totamt_onChange=amt08.TxtInput.Attributes["onchange"].ToString().Trim(';');}
			if(stramt08_DoMathScript_totamt_onChange.Length>0)
				stramt08_DoMathScript_totamt_onChange+=";";
			amt08.TxtInput.Attributes.Add("onchange",stramt08_DoMathScript_totamt_onChange+"domath_totamt();");

			string stramt08_DoMathScript_totamt_onblur=string.Empty;
			if(amt08.TxtInput.Attributes["onblur"]!=null){stramt08_DoMathScript_totamt_onblur=amt08.TxtInput.Attributes["onblur"].ToString().Trim(';');}
			if(stramt08_DoMathScript_totamt_onblur.Length>0)
				stramt08_DoMathScript_totamt_onblur+=";";
			amt08.TxtInput.Attributes.Add("onblur",stramt08_DoMathScript_totamt_onblur+"domath_totamt();");

			string stramt09_DoMathScript_totamt_onChange=string.Empty;
			if(amt09.TxtInput.Attributes["onchange"]!=null){stramt09_DoMathScript_totamt_onChange=amt09.TxtInput.Attributes["onchange"].ToString().Trim(';');}
			if(stramt09_DoMathScript_totamt_onChange.Length>0)
				stramt09_DoMathScript_totamt_onChange+=";";
			amt09.TxtInput.Attributes.Add("onchange",stramt09_DoMathScript_totamt_onChange+"domath_totamt();");

			string stramt09_DoMathScript_totamt_onblur=string.Empty;
			if(amt09.TxtInput.Attributes["onblur"]!=null){stramt09_DoMathScript_totamt_onblur=amt09.TxtInput.Attributes["onblur"].ToString().Trim(';');}
			if(stramt09_DoMathScript_totamt_onblur.Length>0)
				stramt09_DoMathScript_totamt_onblur+=";";
			amt09.TxtInput.Attributes.Add("onblur",stramt09_DoMathScript_totamt_onblur+"domath_totamt();");

			string stramt10_DoMathScript_totamt_onChange=string.Empty;
			if(amt10.TxtInput.Attributes["onchange"]!=null){stramt10_DoMathScript_totamt_onChange=amt10.TxtInput.Attributes["onchange"].ToString().Trim(';');}
			if(stramt10_DoMathScript_totamt_onChange.Length>0)
				stramt10_DoMathScript_totamt_onChange+=";";
			amt10.TxtInput.Attributes.Add("onchange",stramt10_DoMathScript_totamt_onChange+"domath_totamt();");

			string stramt10_DoMathScript_totamt_onblur=string.Empty;
			if(amt10.TxtInput.Attributes["onblur"]!=null){stramt10_DoMathScript_totamt_onblur=amt10.TxtInput.Attributes["onblur"].ToString().Trim(';');}
			if(stramt10_DoMathScript_totamt_onblur.Length>0)
				stramt10_DoMathScript_totamt_onblur+=";";
			amt10.TxtInput.Attributes.Add("onblur",stramt10_DoMathScript_totamt_onblur+"domath_totamt();");
		...
		{
			defalutHash.Add("odmrsicn01001", this.formID);
			defalutHash.Add("odmrsicn01002", this.SheetNo);
...
order by resdd003 desc";
		...
		{
			pReport = "ODMRSICN01";
			pReportID = "ODMRSICN01_02";//憑證式
			pWhere = "AND (odmrsicn01001='" + this.formID + "') AND (odmrsicn01002='" + this.SheetNo + "')";
			pReportDirectory = "ODMRSICN01";
