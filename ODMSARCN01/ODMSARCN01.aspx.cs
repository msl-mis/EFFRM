...
namespace tw.com.dsc.easyflowDotNet.forms
{
	...
	/// ODMSARCN01 的摘要描述。
	/// </summary>
	public partial class ODMSARCN01 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
	{
		//edit by teppy 2011/02/08 Start
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			AjaxPro.Utility.RegisterTypeForAjax(typeof(ODMSARCN01));
			UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
			string tLanguageType = tClass.Language;

			//多國語系
			this.Title= MultiLanguage.GetComment("FD","ODMSARCN01","lblTitle",this.UserInfo.Language);
			string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ODMSARCN01", "HeadTabStrip01", tLanguageType);
			...
			this.datetime.Title = MultiLanguage.GetComment("FD", "ODMSARCN01", "datetime", tLanguageType);
			this.dept.Title = MultiLanguage.GetComment("FD", "ODMSARCN01", "dept", tLanguageType);
			this.name.Title = MultiLanguage.GetComment("FD", "ODMSARCN01", "name", tLanguageType);
			this.txtemp.Title = MultiLanguage.GetComment("FD", "ODMSARCN01", "txtemp", tLanguageType);
			this.chagedate.Title = MultiLanguage.GetComment("FD", "ODMSARCN01", "chagedate", tLanguageType);
			this.chagedept.Title = MultiLanguage.GetComment("FD", "ODMSARCN01", "chagedept", tLanguageType);
			this.chageemp.Title = MultiLanguage.GetComment("FD", "ODMSARCN01", "chageemp", tLanguageType);
			this.chagereason.Title = MultiLanguage.GetComment("FD", "ODMSARCN01", "chagereason", tLanguageType);
			this.oldsalary.Title = MultiLanguage.GetComment("FD", "ODMSARCN01", "oldsalary", tLanguageType);
			this.newsalary.Title = MultiLanguage.GetComment("FD", "ODMSARCN01", "newsalary", tLanguageType);
			this.oldbouns.Title = MultiLanguage.GetComment("FD", "ODMSARCN01", "oldbouns", tLanguageType);
			this.newbouns.Title = MultiLanguage.GetComment("FD", "ODMSARCN01", "newbouns", tLanguageType);
			this.oldother.Title = MultiLanguage.GetComment("FD", "ODMSARCN01", "oldother", tLanguageType);
			this.newother.Title = MultiLanguage.GetComment("FD", "ODMSARCN01", "newother", tLanguageType);
			this.autherid.Title = MultiLanguage.GetComment("FD", "ODMSARCN01", "autherid", tLanguageType);
			this.supervisorid.Title = MultiLanguage.GetComment("FD", "ODMSARCN01", "supervisorid", tLanguageType);
			this.opendept.Title = MultiLanguage.GetComment("FD", "ODMSARCN01", "opendept", tLanguageType);
			this.deptid.Title = MultiLanguage.GetComment("FD", "ODMSARCN01", "deptid", tLanguageType);
			this.opendeptmag.Title = MultiLanguage.GetComment("FD", "ODMSARCN01", "opendeptmag", tLanguageType);
		...
		protected override void Page_Prender(object sender, EventArgs e)
		{
			...
			if(strToolTipParameter=="Y"){
				this.chagereason.ToolTip = this.chagereason.Text;
			...
			rdemp.Attributes["style"] = "display:none;";
			rdemp_ctrolRadio0.Checked = (rdemp.Value == "0"); rdemp_ctrolRadio0.Enabled = rdemp.InputEnabled;
			rdemp_ctrolRadio1.Checked = (rdemp.Value == "1"); rdemp_ctrolRadio1.Enabled = rdemp.InputEnabled;
		...
		{
			// 作業代號
			this.TaskId = "ODMSARCN01";
			// 表單代號
			this.formID = "ODMSARCN01";
...
where resfc001=@resfc001 and resfc002=@resfc002 and resfc003=@resfc003 and ISNULL(resfc004,'')<>''";
		...
		protected override void settingClientFunction()
		{
			...
			//單頭控制項
			opendept.HtmImg.Attributes.Add("onclick",MIMJUtil.getClickParams("MasterPage_MasterPageContent_opendept_btn","MasterPage_MasterPageContent_opendept_txt","S"));
			opendept.TxtInput.Attributes.Add("onblur",MIMJUtil.getBlurParams("MasterPage_MasterPageContent_opendept_txt","OpenMIMJ01_15_opendept","MasterPage_MasterPageContent_opendept_txt"));
			opendept.TxtInput.Attributes.Add("onchange","AddtoHash('MasterPage_MasterPageContent_opendept_txt');");

			opendeptmag.HtmImg.Attributes.Add("onclick",MIMJUtil.getClickParams("MasterPage_MasterPageContent_opendeptmag_btn","MasterPage_MasterPageContent_opendeptmag_txt","S"));
			opendeptmag.TxtInput.Attributes.Add("onblur",MIMJUtil.getBlurParams("MasterPage_MasterPageContent_opendeptmag_txt","OpenMIMJ01_14_opendeptmag","MasterPage_MasterPageContent_opendeptmag_txt"));
			opendeptmag.TxtInput.Attributes.Add("onchange","AddtoHash('MasterPage_MasterPageContent_opendeptmag_txt');");


this.rdemp_ctrolRadio0.Attributes.Add("onclick", "document.getElementById('MasterPage_MasterPageContent_rdemp_txt').value = '0';");
this.rdemp_ctrolRadio1.Attributes.Add("onclick", "document.getElementById('MasterPage_MasterPageContent_rdemp_txt').value = '1';");
		...
		protected override void buildMiMjManager(Hashtable pMiMjManager)
		{
			...
			if ( FormStatus == EFFormStatus.CREATE ) {
				pMiMjManager.Add("opendept_0", opendept);
				pMiMjManager.Add("opendeptmag_0", opendeptmag);
		...
		{
			defalutHash.Add("odmsarcn01001", this.formID);
			defalutHash.Add("odmsarcn01002", this.SheetNo);
			defalutHash.Add("autherid", this.UserInfo.EmployeeId.ToString());
			defalutHash.Add("supervisorid", ajaxGetSupervisorID());
		}
...
order by resdd003 desc";
		...
		protected override void ReGetCondValue(object[,] pAryCondValue)
		{
			...
			tDbl=1;
			try{
				tDbl = double.Parse(this.rdemp.Value.Trim());
			}
			catch(Exception e){
				tDbl=1;
			}
			pAryCondValue[0, 0] = "rdold";
			...
			tValue="";
			try{
				tValue = (this.autherid.Value.Trim());
			}
			catch(Exception e){
				tValue="";
			}
			pAryCondValue[0, 2] = "UserID";
			pAryCondValue[1, 2] = tValue; 


			tValue="";
			try{
				tValue = (this.supervisorid.Value.Trim());
			}
			catch(Exception e){
				tValue="";
			}
			pAryCondValue[0, 3] = "SuperID";
		...
		{
			pReport = "ODMSARCN01";
			pReportID = "ODMSARCN01_02";//憑證式
			pWhere = "AND (odmsarcn01001='" + this.formID + "') AND (odmsarcn01002='" + this.SheetNo + "')";
			pReportDirectory = "ODMSARCN01";
