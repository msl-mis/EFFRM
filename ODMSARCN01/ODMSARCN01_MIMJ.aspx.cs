...
{
	/// <summary>
	/// ODMSARCN01_MIMJ 的摘要描述。
	/// </summary>
	public partial class ODMSARCN01_MIMJ : tw.com.dsc.easyflowDotNet.kernelBasePage.EFMIMJBasepage
	{
		...
		protected override void MIFunction()
		{
			switch(tBtnID)
			{
				case "MasterPage_MasterPageContent_opendept_btn":			//其它類型開窗
				{
					base.doMI("OpenMIMJ01","15");
					break;
				}
				case "MasterPage_MasterPageContent_opendeptmag_btn":			//其它類型開窗
				{
					base.doMI("OpenMIMJ01","14");
					break;
				}
		...
		protected override void MJFunction()
		{
			...
			{
				case "OpenMIMJ01_15_opendept":	
				{
					base.doMJ("OpenMIMJ01","15","MasterPage_MasterPageContent_opendept_txt2=resal002","MasterPage_MasterPageContent_chagedept_txt=resal002");
					break;
				}
				case "OpenMIMJ01_14_opendeptmag":	
				{
					base.doMJ("OpenMIMJ01","14","MasterPage_MasterPageContent_opendeptmag_txt2=resak002","MasterPage_MasterPageContent_deptid_txt=resak002");
					break;
				}
