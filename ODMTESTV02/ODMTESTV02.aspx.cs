...
namespace tw.com.dsc.easyflowDotNet.forms
{
	...
	/// ODMTESTV02 的摘要描述。
	/// </summary>
	public partial class ODMTESTV02 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
	{
		//edit by teppy 2011/02/08 Start
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			AjaxPro.Utility.RegisterTypeForAjax(typeof(ODMTESTV02));
			UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
			string tLanguageType = tClass.Language;

			//多國語系
			this.Title= MultiLanguage.GetComment("FD","ODMTESTV02","lblTitle",this.UserInfo.Language);
			string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ODMTESTV02", "HeadTabStrip01", tLanguageType);
			...
			this.label2.Text = MultiLanguage.GetComment("FD", "ODMTESTV02", "label2", tLanguageType);
			this.label3.Text = MultiLanguage.GetComment("FD", "ODMTESTV02", "label3", tLanguageType);
			this.datetime1.Title = MultiLanguage.GetComment("FD", "ODMTESTV02", "datetime1", tLanguageType);
			this.dept.Title = MultiLanguage.GetComment("FD", "ODMTESTV02", "dept", tLanguageType);
			this.username.Title = MultiLanguage.GetComment("FD", "ODMTESTV02", "username", tLanguageType);
			this.payee.Title = MultiLanguage.GetComment("FD", "ODMTESTV02", "payee", tLanguageType);
			this.chkitem01.Text = MultiLanguage.GetComment("FD", "ODMTESTV02", "chkitem01", tLanguageType);
			this.chkitem02.Text = MultiLanguage.GetComment("FD", "ODMTESTV02", "chkitem02", tLanguageType);
			this.chkitem03.Text = MultiLanguage.GetComment("FD", "ODMTESTV02", "chkitem03", tLanguageType);
			this.chkitem04.Text = MultiLanguage.GetComment("FD", "ODMTESTV02", "chkitem04", tLanguageType);
			this.chkitem05.Text = MultiLanguage.GetComment("FD", "ODMTESTV02", "chkitem05", tLanguageType);
			this.chkother.Title = MultiLanguage.GetComment("FD", "ODMTESTV02", "chkother", tLanguageType);
			this.textarea1.Title = MultiLanguage.GetComment("FD", "ODMTESTV02", "textarea1", tLanguageType);
			this.money01.Title = MultiLanguage.GetComment("FD", "ODMTESTV02", "money01", tLanguageType);
			this.textarea2.Title = MultiLanguage.GetComment("FD", "ODMTESTV02", "textarea2", tLanguageType);
			this.money02.Title = MultiLanguage.GetComment("FD", "ODMTESTV02", "money02", tLanguageType);
			this.textarea3.Title = MultiLanguage.GetComment("FD", "ODMTESTV02", "textarea3", tLanguageType);
			this.money03.Title = MultiLanguage.GetComment("FD", "ODMTESTV02", "money03", tLanguageType);
			this.textarea4.Title = MultiLanguage.GetComment("FD", "ODMTESTV02", "textarea4", tLanguageType);
			this.money04.Title = MultiLanguage.GetComment("FD", "ODMTESTV02", "money04", tLanguageType);
			this.textarea5.Title = MultiLanguage.GetComment("FD", "ODMTESTV02", "textarea5", tLanguageType);
			this.money05.Title = MultiLanguage.GetComment("FD", "ODMTESTV02", "money05", tLanguageType);
			this.mtotal.Title = MultiLanguage.GetComment("FD", "ODMTESTV02", "mtotal", tLanguageType);
			this.chkatt01.Text = MultiLanguage.GetComment("FD", "ODMTESTV02", "chkatt01", tLanguageType);
			this.inv01.Title = MultiLanguage.GetComment("FD", "ODMTESTV02", "inv01", tLanguageType);
			this.chkatt02.Text = MultiLanguage.GetComment("FD", "ODMTESTV02", "chkatt02", tLanguageType);
			this.inv02.Title = MultiLanguage.GetComment("FD", "ODMTESTV02", "inv02", tLanguageType);
			this.chkatt03.Text = MultiLanguage.GetComment("FD", "ODMTESTV02", "chkatt03", tLanguageType);
			this.chkatt04.Text = MultiLanguage.GetComment("FD", "ODMTESTV02", "chkatt04", tLanguageType);
			this.chkatt05.Text = MultiLanguage.GetComment("FD", "ODMTESTV02", "chkatt05", tLanguageType);
			this.orderno.Title = MultiLanguage.GetComment("FD", "ODMTESTV02", "orderno", tLanguageType);
			this.attother.Title = MultiLanguage.GetComment("FD", "ODMTESTV02", "attother", tLanguageType);
			this.other.Text = MultiLanguage.GetComment("FD", "ODMTESTV02", "other", tLanguageType);
			this.payother.Title = MultiLanguage.GetComment("FD", "ODMTESTV02", "payother", tLanguageType);
			this.empl1.Title = MultiLanguage.GetComment("FD", "ODMTESTV02", "empl1", tLanguageType);
			this.empl2.Title = MultiLanguage.GetComment("FD", "ODMTESTV02", "empl2", tLanguageType);
			this.curr01.Title = MultiLanguage.GetComment("FD", "ODMTESTV02", "curr01", tLanguageType);
			this.curr02.Title = MultiLanguage.GetComment("FD", "ODMTESTV02", "curr02", tLanguageType);
			this.curr03.Title = MultiLanguage.GetComment("FD", "ODMTESTV02", "curr03", tLanguageType);
			this.curr04.Title = MultiLanguage.GetComment("FD", "ODMTESTV02", "curr04", tLanguageType);
			this.curr05.Title = MultiLanguage.GetComment("FD", "ODMTESTV02", "curr05", tLanguageType);
			this.curr06.Title = MultiLanguage.GetComment("FD", "ODMTESTV02", "curr06", tLanguageType);
			this.typename.Title = MultiLanguage.GetComment("FD", "ODMTESTV02", "typename", tLanguageType);
			this.typename01.Title = MultiLanguage.GetComment("FD", "ODMTESTV02", "typename01", tLanguageType);
			this.itemname.Title = MultiLanguage.GetComment("FD", "ODMTESTV02", "itemname", tLanguageType);
			this.opentype.Title = MultiLanguage.GetComment("FD", "ODMTESTV02", "opentype", tLanguageType);
...
this.chkprice.Text = String.Empty;
...
where resfc001=@resfc001 and resfc002=@resfc002 and resfc003=@resfc003 and ISNULL(resfc004,'')<>''";
		...
		{
			defalutHash.Add("odmtestv02001", this.formID);
			defalutHash.Add("odmtestv02002", this.SheetNo);
...
order by resdd003 desc";
		...
		protected override void ReGetCondValue(object[,] pAryCondValue)
		{
			...
			tValue="";
			try{
				tValue = (this.chpay.Value.Trim());
			}
			catch(Exception e){
				tValue="";
			}
			pAryCondValue[0, 0] = "price";
		...
		{
			pReport = "ODMTESTV02";
			pReportID = "ODMTESTV02_02";//憑證式
			pWhere = "AND (odmtestv02001='" + this.formID + "') AND (odmtestv02002='" + this.SheetNo + "')";
			pReportDirectory = "ODMTESTV02";
