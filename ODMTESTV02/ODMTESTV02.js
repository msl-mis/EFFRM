	...
	if (tStatus == "CREATE")
	{
		...
		if(tmoney03.length>0){
			if('readonly' !== tmoney03.attr('readonly') &&
				...
				{
					tErr += '「' + getI18NForSpecial('FD', 'ODMTESTV02', 'money03', '../../_Common/PlatformUtil/KernelPage/I18N/I18NForJs.aspx') + '」  ' + getI18NForSpecial('FD', 'ODMTESTV02', 'money03_Err', '../../_Common/PlatformUtil/KernelPage/I18N/I18NForJs.aspx')+ '\r\n';
				}
				else
				{
	...
	if($("#MasterPage_MasterPageContent_chkatt03_chk").length>0){
		if($("#MasterPage_MasterPageContent_chkatt03_chk")[0].checked){
			if($("#MasterPage_MasterPageContent_orderno_txt").val().trim().length==0){
				tErr+='[orderno-'+getI18NForSpecial('FD', 'ODMTESTV02', 'orderno', '../../_Common/PlatformUtil/KernelPage/I18N/I18NForJs.aspx')+']'+tFieldNotFilledMsg+'\r\n';
			}
		}
		else{
