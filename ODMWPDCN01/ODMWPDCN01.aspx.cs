...
namespace tw.com.dsc.easyflowDotNet.forms
{
	...
	/// ODMWPDCN01 的摘要描述。
	/// </summary>
	public partial class ODMWPDCN01 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
	{
		//edit by teppy 2011/02/08 Start
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			AjaxPro.Utility.RegisterTypeForAjax(typeof(ODMWPDCN01));
			UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
			string tLanguageType = tClass.Language;

			//多國語系
			this.Title= MultiLanguage.GetComment("FD","ODMWPDCN01","lblTitle",this.UserInfo.Language);
			string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ODMWPDCN01", "HeadTabStrip01", tLanguageType);
			...
			this.usedate.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "usedate", tLanguageType);
			this.txtuser.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "txtuser", tLanguageType);
			this.txtwek.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "txtwek", tLanguageType);
			this.saturday.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "saturday", tLanguageType);
			this.sunday.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "sunday", tLanguageType);
			this.satlst01.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "satlst01", tLanguageType);
			this.day01lst01.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "day01lst01", tLanguageType);
			this.day02lst01.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "day02lst01", tLanguageType);
			this.daylst01.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "daylst01", tLanguageType);
			this.sunlst01.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "sunlst01", tLanguageType);
			this.txtnote01.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "txtnote01", tLanguageType);
			this.satlst02.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "satlst02", tLanguageType);
			this.day01lst02.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "day01lst02", tLanguageType);
			this.day02lst02.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "day02lst02", tLanguageType);
			this.daylst02.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "daylst02", tLanguageType);
			this.sunlst02.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "sunlst02", tLanguageType);
			this.txtnote02.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "txtnote02", tLanguageType);
			this.satlst03.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "satlst03", tLanguageType);
			this.day01lst03.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "day01lst03", tLanguageType);
			this.day02lst03.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "day02lst03", tLanguageType);
			this.daylst03.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "daylst03", tLanguageType);
			this.sunlst03.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "sunlst03", tLanguageType);
			this.txtnote03.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "txtnote03", tLanguageType);
			this.satlst04.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "satlst04", tLanguageType);
			this.day01lst04.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "day01lst04", tLanguageType);
			this.day02lst04.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "day02lst04", tLanguageType);
			this.daylst04.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "daylst04", tLanguageType);
			this.sunlst04.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "sunlst04", tLanguageType);
			this.txtnote04.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "txtnote04", tLanguageType);
			this.satlst05.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "satlst05", tLanguageType);
			this.day01lst05.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "day01lst05", tLanguageType);
			this.day02lst05.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "day02lst05", tLanguageType);
			this.daylst05.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "daylst05", tLanguageType);
			this.sunlst05.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "sunlst05", tLanguageType);
			this.txtnote05.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "txtnote05", tLanguageType);
			this.satlst06.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "satlst06", tLanguageType);
			this.day01lst06.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "day01lst06", tLanguageType);
			this.day02lst06.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "day02lst06", tLanguageType);
			this.daylst06.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "daylst06", tLanguageType);
			this.sunlst06.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "sunlst06", tLanguageType);
			this.txtnote06.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "txtnote06", tLanguageType);
			this.satlst07.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "satlst07", tLanguageType);
			this.day01lst07.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "day01lst07", tLanguageType);
			this.day02lst07.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "day02lst07", tLanguageType);
			this.daylst07.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "daylst07", tLanguageType);
			this.sunlst07.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "sunlst07", tLanguageType);
			this.txtnote07.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "txtnote07", tLanguageType);
			this.satlst08.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "satlst08", tLanguageType);
			this.day01lst08.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "day01lst08", tLanguageType);
			this.day02lst08.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "day02lst08", tLanguageType);
			this.daylst08.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "daylst08", tLanguageType);
			this.sunlst08.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "sunlst08", tLanguageType);
			this.txtnote08.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "txtnote08", tLanguageType);
			this.satlst09.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "satlst09", tLanguageType);
			this.day01lst09.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "day01lst09", tLanguageType);
			this.day02lst09.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "day02lst09", tLanguageType);
			this.daylst09.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "daylst09", tLanguageType);
			this.sunlst09.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "sunlst09", tLanguageType);
			this.txtnote09.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "txtnote09", tLanguageType);
			this.satlst10.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "satlst10", tLanguageType);
			this.day01lst10.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "day01lst10", tLanguageType);
			this.day02lst10.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "day02lst10", tLanguageType);
			this.daylst10.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "daylst10", tLanguageType);
			this.sunlst10.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "sunlst10", tLanguageType);
			this.txtnote10.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "txtnote10", tLanguageType);
			this.txtwk01.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "txtwk01", tLanguageType);
			this.txtwk02.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "txtwk02", tLanguageType);
			this.txtwk03.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "txtwk03", tLanguageType);
			this.txtwk04.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "txtwk04", tLanguageType);
			this.otherday01.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "otherday01", tLanguageType);
			this.otherday02.Title = MultiLanguage.GetComment("FD", "ODMWPDCN01", "otherday02", tLanguageType);
		...
		{
			// 作業代號
			this.TaskId = "ODMWPDCN01";
			// 表單代號
			this.formID = "ODMWPDCN01";
...
where resfc001=@resfc001 and resfc002=@resfc002 and resfc003=@resfc003 and ISNULL(resfc004,'')<>''";
		...
		{
			defalutHash.Add("odmwpdcn01001", this.formID);
			defalutHash.Add("odmwpdcn01002", this.SheetNo);
...
order by resdd003 desc";
		...
		{
			pReport = "ODMWPDCN01";
			pReportID = "ODMWPDCN01_02";//憑證式
			pWhere = "AND (odmwpdcn01001='" + this.formID + "') AND (odmwpdcn01002='" + this.SheetNo + "')";
			pReportDirectory = "ODMWPDCN01";
