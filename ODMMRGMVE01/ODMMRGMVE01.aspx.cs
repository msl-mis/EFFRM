...
namespace tw.com.dsc.easyflowDotNet.forms
{
	...
	/// ODMMRGMVE01 的摘要描述。
	/// </summary>
	public partial class ODMMRGMVE01 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
	{
		//edit by teppy 2011/02/08 Start
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			AjaxPro.Utility.RegisterTypeForAjax(typeof(ODMMRGMVE01));
			UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
			string tLanguageType = tClass.Language;

			//多國語系
			this.Title= MultiLanguage.GetComment("FD","ODMMRGMVE01","lblTitle",this.UserInfo.Language);
			string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ODMMRGMVE01", "HeadTabStrip01", tLanguageType);
			...
			this.txtno.Title = MultiLanguage.GetComment("FD", "ODMMRGMVE01", "txtno", tLanguageType);
			this.date.Title = MultiLanguage.GetComment("FD", "ODMMRGMVE01", "date", tLanguageType);
			this.txtuser.Title = MultiLanguage.GetComment("FD", "ODMMRGMVE01", "txtuser", tLanguageType);
			this.areadescp.Title = MultiLanguage.GetComment("FD", "ODMMRGMVE01", "areadescp", tLanguageType);
			this.txtdept.Title = MultiLanguage.GetComment("FD", "ODMMRGMVE01", "txtdept", tLanguageType);
			this.main.Title = MultiLanguage.GetComment("FD", "ODMMRGMVE01", "main", tLanguageType);
			this.effdate.Title = MultiLanguage.GetComment("FD", "ODMMRGMVE01", "effdate", tLanguageType);
		...
		{
			// 作業代號
			this.TaskId = "ODMMRGMVE01";
			// 表單代號
			this.formID = "ODMMRGMVE01";
...
where resfc001=@resfc001 and resfc002=@resfc002 and resfc003=@resfc003 and ISNULL(resfc004,'')<>''";
		...
		{
			defalutHash.Add("odmmrgmve01001", this.formID);
			defalutHash.Add("odmmrgmve01002", this.SheetNo);
...
order by resdd003 desc";
		...
		{
			pReport = "ODMMRGMVE01";
			pReportID = "ODMMRGMVE01_02";//憑證式
			pWhere = "AND (odmmrgmve01001='" + this.formID + "') AND (odmmrgmve01002='" + this.SheetNo + "')";
			pReportDirectory = "ODMMRGMVE01";
