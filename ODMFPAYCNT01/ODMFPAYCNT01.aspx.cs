...
namespace tw.com.dsc.easyflowDotNet.forms
{
	...
	/// ODMFPAYCNT01 的摘要描述。
	/// </summary>
	public partial class ODMFPAYCNT01 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
	{
		//edit by teppy 2011/02/08 Start
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			AjaxPro.Utility.RegisterTypeForAjax(typeof(ODMFPAYCNT01));
			UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
			string tLanguageType = tClass.Language;

			//多國語系
			this.Title= MultiLanguage.GetComment("FD","ODMFPAYCNT01","lblTitle",this.UserInfo.Language);
			string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ODMFPAYCNT01", "HeadTabStrip01", tLanguageType);
			...
			this.datetime1.Title = MultiLanguage.GetComment("FD", "ODMFPAYCNT01", "datetime1", tLanguageType);
			this.dept.Title = MultiLanguage.GetComment("FD", "ODMFPAYCNT01", "dept", tLanguageType);
			this.username.Title = MultiLanguage.GetComment("FD", "ODMFPAYCNT01", "username", tLanguageType);
			this.payee.Title = MultiLanguage.GetComment("FD", "ODMFPAYCNT01", "payee", tLanguageType);
			this.chkitem01.Text = MultiLanguage.GetComment("FD", "ODMFPAYCNT01", "chkitem01", tLanguageType);
			this.chkitem02.Text = MultiLanguage.GetComment("FD", "ODMFPAYCNT01", "chkitem02", tLanguageType);
			this.chkitem03.Text = MultiLanguage.GetComment("FD", "ODMFPAYCNT01", "chkitem03", tLanguageType);
			this.chkitem04.Text = MultiLanguage.GetComment("FD", "ODMFPAYCNT01", "chkitem04", tLanguageType);
			this.chkitem05.Text = MultiLanguage.GetComment("FD", "ODMFPAYCNT01", "chkitem05", tLanguageType);
			this.chkother.Title = MultiLanguage.GetComment("FD", "ODMFPAYCNT01", "chkother", tLanguageType);
			this.textarea1.Title = MultiLanguage.GetComment("FD", "ODMFPAYCNT01", "textarea1", tLanguageType);
			this.money01.Title = MultiLanguage.GetComment("FD", "ODMFPAYCNT01", "money01", tLanguageType);
			this.textarea2.Title = MultiLanguage.GetComment("FD", "ODMFPAYCNT01", "textarea2", tLanguageType);
			this.money02.Title = MultiLanguage.GetComment("FD", "ODMFPAYCNT01", "money02", tLanguageType);
			this.textarea3.Title = MultiLanguage.GetComment("FD", "ODMFPAYCNT01", "textarea3", tLanguageType);
			this.money03.Title = MultiLanguage.GetComment("FD", "ODMFPAYCNT01", "money03", tLanguageType);
			this.textarea4.Title = MultiLanguage.GetComment("FD", "ODMFPAYCNT01", "textarea4", tLanguageType);
			this.money04.Title = MultiLanguage.GetComment("FD", "ODMFPAYCNT01", "money04", tLanguageType);
			this.textarea5.Title = MultiLanguage.GetComment("FD", "ODMFPAYCNT01", "textarea5", tLanguageType);
			this.money05.Title = MultiLanguage.GetComment("FD", "ODMFPAYCNT01", "money05", tLanguageType);
			this.mtotal.Title = MultiLanguage.GetComment("FD", "ODMFPAYCNT01", "mtotal", tLanguageType);
			this.chkatt01.Text = MultiLanguage.GetComment("FD", "ODMFPAYCNT01", "chkatt01", tLanguageType);
			this.inv01.Title = MultiLanguage.GetComment("FD", "ODMFPAYCNT01", "inv01", tLanguageType);
			this.chkatt02.Text = MultiLanguage.GetComment("FD", "ODMFPAYCNT01", "chkatt02", tLanguageType);
			this.inv02.Title = MultiLanguage.GetComment("FD", "ODMFPAYCNT01", "inv02", tLanguageType);
			this.chkatt03.Text = MultiLanguage.GetComment("FD", "ODMFPAYCNT01", "chkatt03", tLanguageType);
			this.chkatt04.Text = MultiLanguage.GetComment("FD", "ODMFPAYCNT01", "chkatt04", tLanguageType);
			this.chkatt05.Text = MultiLanguage.GetComment("FD", "ODMFPAYCNT01", "chkatt05", tLanguageType);
			this.orderno.Title = MultiLanguage.GetComment("FD", "ODMFPAYCNT01", "orderno", tLanguageType);
			this.attother.Title = MultiLanguage.GetComment("FD", "ODMFPAYCNT01", "attother", tLanguageType);
			this.other.Text = MultiLanguage.GetComment("FD", "ODMFPAYCNT01", "other", tLanguageType);
			this.payother.Title = MultiLanguage.GetComment("FD", "ODMFPAYCNT01", "payother", tLanguageType);
			this.empl1.Title = MultiLanguage.GetComment("FD", "ODMFPAYCNT01", "empl1", tLanguageType);
			this.empl2.Title = MultiLanguage.GetComment("FD", "ODMFPAYCNT01", "empl2", tLanguageType);
...
this.other.Text = String.Empty;
		...
		{
			// 作業代號
			this.TaskId = "ODMFPAYCNT01";
			// 表單代號
			this.formID = "ODMFPAYCNT01";
...
this.chpay_ctrolRadio2.Attributes.Add("onclick", "InitTriggerMust('" + base.FormStatus.ToString() + "');document.getElementById('MasterPage_MasterPageContent_chpay_txt').value = '2';");
		...
		{
			defalutHash.Add("odmfpaycnt01001", this.formID);
			defalutHash.Add("odmfpaycnt01002", this.SheetNo);
...
order by resdd003 desc";
		...
		{
			pReport = "ODMFPAYCNT01";
			pReportID = "ODMFPAYCNT01_02";//憑證式
			pWhere = "AND (odmfpaycnt01001='" + this.formID + "') AND (odmfpaycnt01002='" + this.SheetNo + "')";
			pReportDirectory = "ODMFPAYCNT01";
