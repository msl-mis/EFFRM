...
namespace tw.com.dsc.easyflowDotNet.forms
{
	...
	/// ODMMASIMVE01 的摘要描述。
	/// </summary>
	public partial class ODMMASIMVE01 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
	{
		//edit by teppy 2011/02/08 Start
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			AjaxPro.Utility.RegisterTypeForAjax(typeof(ODMMASIMVE01));
			UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
			string tLanguageType = tClass.Language;

			//多國語系
			this.Title= MultiLanguage.GetComment("FD","ODMMASIMVE01","lblTitle",this.UserInfo.Language);
			string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ODMMASIMVE01", "HeadTabStrip01", tLanguageType);
			...
			this.txtdept.Title = MultiLanguage.GetComment("FD", "ODMMASIMVE01", "txtdept", tLanguageType);
			this.txtuser.Title = MultiLanguage.GetComment("FD", "ODMMASIMVE01", "txtuser", tLanguageType);
			this.date.Title = MultiLanguage.GetComment("FD", "ODMMASIMVE01", "date", tLanguageType);
			this.txtmain.Title = MultiLanguage.GetComment("FD", "ODMMASIMVE01", "txtmain", tLanguageType);
		...
		{
			// 作業代號
			this.TaskId = "ODMMASIMVE01";
			// 表單代號
			this.formID = "ODMMASIMVE01";
...
where resfc001=@resfc001 and resfc002=@resfc002 and resfc003=@resfc003 and ISNULL(resfc004,'')<>''";
		...
		{
			defalutHash.Add("odmmasimve01001", this.formID);
			defalutHash.Add("odmmasimve01002", this.SheetNo);
...
order by resdd003 desc";
		...
		{
			pReport = "ODMMASIMVE01";
			pReportID = "ODMMASIMVE01_02";//憑證式
			pWhere = "AND (odmmasimve01001='" + this.formID + "') AND (odmmasimve01002='" + this.SheetNo + "')";
			pReportDirectory = "ODMMASIMVE01";
