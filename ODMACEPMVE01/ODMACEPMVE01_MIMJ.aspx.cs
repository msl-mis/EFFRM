...
{
	/// <summary>
	/// ODMACEPMVE01_MIMJ 的摘要描述。
	/// </summary>
	public partial class ODMACEPMVE01_MIMJ : tw.com.dsc.easyflowDotNet.kernelBasePage.EFMIMJBasepage
	{
		...
		protected override void MJFunction()
		{
			...
			{
				case "OpenMIMJ01_18_opendetp":	
				{
					base.doMJ("OpenMIMJ01","18","MasterPage_MasterPageContent_opendetp_txt2=resal002");
					break;
				}
				case "OpenMIMJ01_18_opensection":	
				{
					base.doMJ("OpenMIMJ01","18","MasterPage_MasterPageContent_opensection_txt2=resal002","MasterPage_MasterPageContent_txtdept_txt=resal002");
					break;
				}
