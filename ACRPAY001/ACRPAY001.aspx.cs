...
namespace tw.com.dsc.easyflowDotNet.forms
{
	...
	/// ACRPAY001 的摘要描述。
	/// </summary>
	public partial class ACRPAY001 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
	{
		//edit by teppy 2011/02/08 Start
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			AjaxPro.Utility.RegisterTypeForAjax(typeof(ACRPAY001));
			UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
			string tLanguageType = tClass.Language;

			//多國語系
			this.Title= MultiLanguage.GetComment("FD","ACRPAY001","lblTitle",this.UserInfo.Language);
			string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ACRPAY001", "HeadTabStrip01", tLanguageType);
			...
			this.datetime1.Title = MultiLanguage.GetComment("FD", "ACRPAY001", "datetime1", tLanguageType);
			this.dept.Title = MultiLanguage.GetComment("FD", "ACRPAY001", "dept", tLanguageType);
			this.payee.Title = MultiLanguage.GetComment("FD", "ACRPAY001", "payee", tLanguageType);
			this.username.Title = MultiLanguage.GetComment("FD", "ACRPAY001", "username", tLanguageType);
			this.checkbox1.Text = MultiLanguage.GetComment("FD", "ACRPAY001", "checkbox1", tLanguageType);
			this.checkbox2.Text = MultiLanguage.GetComment("FD", "ACRPAY001", "checkbox2", tLanguageType);
			this.checkbox3.Text = MultiLanguage.GetComment("FD", "ACRPAY001", "checkbox3", tLanguageType);
			this.checkbox4.Text = MultiLanguage.GetComment("FD", "ACRPAY001", "checkbox4", tLanguageType);
			this.checkbox5.Text = MultiLanguage.GetComment("FD", "ACRPAY001", "checkbox5", tLanguageType);
			this.itemother.Title = MultiLanguage.GetComment("FD", "ACRPAY001", "itemother", tLanguageType);
			this.textarea1.Title = MultiLanguage.GetComment("FD", "ACRPAY001", "textarea1", tLanguageType);
			this.money01.Title = MultiLanguage.GetComment("FD", "ACRPAY001", "money01", tLanguageType);
			this.textarea2.Title = MultiLanguage.GetComment("FD", "ACRPAY001", "textarea2", tLanguageType);
			this.money02.Title = MultiLanguage.GetComment("FD", "ACRPAY001", "money02", tLanguageType);
			this.textarea3.Title = MultiLanguage.GetComment("FD", "ACRPAY001", "textarea3", tLanguageType);
			this.money03.Title = MultiLanguage.GetComment("FD", "ACRPAY001", "money03", tLanguageType);
			this.textarea4.Title = MultiLanguage.GetComment("FD", "ACRPAY001", "textarea4", tLanguageType);
			this.money04.Title = MultiLanguage.GetComment("FD", "ACRPAY001", "money04", tLanguageType);
			this.textarea5.Title = MultiLanguage.GetComment("FD", "ACRPAY001", "textarea5", tLanguageType);
			this.money05.Title = MultiLanguage.GetComment("FD", "ACRPAY001", "money05", tLanguageType);
			this.moneytot.Title = MultiLanguage.GetComment("FD", "ACRPAY001", "moneytot", tLanguageType);
			this.checkbox6.Text = MultiLanguage.GetComment("FD", "ACRPAY001", "checkbox6", tLanguageType);
			this.invoice.Title = MultiLanguage.GetComment("FD", "ACRPAY001", "invoice", tLanguageType);
			this.checkbox7.Text = MultiLanguage.GetComment("FD", "ACRPAY001", "checkbox7", tLanguageType);
			this.recino.Title = MultiLanguage.GetComment("FD", "ACRPAY001", "recino", tLanguageType);
			this.checkbox8.Text = MultiLanguage.GetComment("FD", "ACRPAY001", "checkbox8", tLanguageType);
			this.orderno.Title = MultiLanguage.GetComment("FD", "ACRPAY001", "orderno", tLanguageType);
			this.checkbox9.Text = MultiLanguage.GetComment("FD", "ACRPAY001", "checkbox9", tLanguageType);
			this.checkbox10.Text = MultiLanguage.GetComment("FD", "ACRPAY001", "checkbox10", tLanguageType);
			this.checkbox11.Text = MultiLanguage.GetComment("FD", "ACRPAY001", "checkbox11", tLanguageType);
			this.attother.Title = MultiLanguage.GetComment("FD", "ACRPAY001", "attother", tLanguageType);
...
this.checkbox11.Text = String.Empty;
		...
		{
			// 作業代號
			this.TaskId = "ACRPAY001";
			// 表單代號
			this.formID = "ACRPAY001";
...
where resfc001=@resfc001 and resfc002=@resfc002 and resfc003=@resfc003 and ISNULL(resfc004,'')<>''";
		...
		defalutHash.Add("checkbox1", "1");
			defalutHash.Add("acrpay001", this.formID);
			defalutHash.Add("acrpay002", this.SheetNo);
...
order by resdd003 desc";
		...
		{
			pReport = "ACRPAY001";
			pReportID = "ACRPAY001_02";//憑證式
			pWhere = "AND (acrpay001='" + this.formID + "') AND (acrpay002='" + this.SheetNo + "')";
			pReportDirectory = "ACRPAY001";
