...
namespace tw.com.dsc.easyflowDotNet.forms
{
    ...
    /// ODMADVVL01 的摘要描述。
    /// </summary>
    public partial class ODMADVVL01 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
    {
        //edit by teppy 2011/02/08 Start
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            AjaxPro.Utility.RegisterTypeForAjax(typeof(ODMADVVL01));
            UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
            string tLanguageType = tClass.Language;

            //多國語系
            this.Title = MultiLanguage.GetComment("FD", "ODMADVVL01", "lblTitle", this.UserInfo.Language);
            string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ODMADVVL01", "HeadTabStrip01", tLanguageType);
            ...
            this.name.Title = MultiLanguage.GetComment("FD", "ODMADVVL01", "name", tLanguageType);
            this.dept.Title = MultiLanguage.GetComment("FD", "ODMADVVL01", "dept", tLanguageType);
            this.applydate.Title = MultiLanguage.GetComment("FD", "ODMADVVL01", "applydate", tLanguageType);
            this.deptno.Title = MultiLanguage.GetComment("FD", "ODMADVVL01", "deptno", tLanguageType);
            this.textarea1.Title = MultiLanguage.GetComment("FD", "ODMADVVL01", "textarea1", tLanguageType);
            this.textarea2.Title = MultiLanguage.GetComment("FD", "ODMADVVL01", "textarea2", tLanguageType);
            this.textarea3.Title = MultiLanguage.GetComment("FD", "ODMADVVL01", "textarea3", tLanguageType);
            this.textarea4.Title = MultiLanguage.GetComment("FD", "ODMADVVL01", "textarea4", tLanguageType);
            this.money01.Title = MultiLanguage.GetComment("FD", "ODMADVVL01", "money01", tLanguageType);
            this.money02.Title = MultiLanguage.GetComment("FD", "ODMADVVL01", "money02", tLanguageType);
            this.money03.Title = MultiLanguage.GetComment("FD", "ODMADVVL01", "money03", tLanguageType);
            this.money04.Title = MultiLanguage.GetComment("FD", "ODMADVVL01", "money04", tLanguageType);
            this.totalmoney.Title = MultiLanguage.GetComment("FD", "ODMADVVL01", "totalmoney", tLanguageType);
            this.note01.Title = MultiLanguage.GetComment("FD", "ODMADVVL01", "note01", tLanguageType);
            this.note02.Title = MultiLanguage.GetComment("FD", "ODMADVVL01", "note02", tLanguageType);
            this.note03.Title = MultiLanguage.GetComment("FD", "ODMADVVL01", "note03", tLanguageType);
            this.note04.Title = MultiLanguage.GetComment("FD", "ODMADVVL01", "note04", tLanguageType);
            this.capital.Title = MultiLanguage.GetComment("FD", "ODMADVVL01", "capital", tLanguageType);
            this.checkdate.Title = MultiLanguage.GetComment("FD", "ODMADVVL01", "checkdate", tLanguageType);
            this.superid.Title = MultiLanguage.GetComment("FD", "ODMADVVL01", "superid", tLanguageType);
        ...
        {
            // 作業代號
            this.TaskId = "ODMADVVL01";
            // 表單代號
            this.formID = "ODMADVVL01";
...
where resfc001=@resfc001 and resfc002=@resfc002 and resfc003=@resfc003 and ISNULL(resfc004,'')<>''";
        ...
        {
            defalutHash.Add("odmadvvl01001", this.formID);
            defalutHash.Add("odmadvvl01002", this.SheetNo);
...
order by resdd003 desc";
        ...
        {
            pReport = "ODMADVVL01";
            pReportID = "ODMADVVL01_02";//憑證式
            pWhere = "AND (odmadvvl01001='" + this.formID + "') AND (odmadvvl01002='" + this.SheetNo + "')";
            pReportDirectory = "ODMADVVL01";
