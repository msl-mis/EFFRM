...
namespace tw.com.dsc.easyflowDotNet.forms
{
    ...
    /// ODMFPAYVL01 的摘要描述。
    /// </summary>
    public partial class ODMFPAYVL01 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
    {
        //edit by teppy 2011/02/08 Start
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            AjaxPro.Utility.RegisterTypeForAjax(typeof(ODMFPAYVL01));
            UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
            string tLanguageType = tClass.Language;

            //多國語系
            this.Title = MultiLanguage.GetComment("FD", "ODMFPAYVL01", "lblTitle", this.UserInfo.Language);
            string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ODMFPAYVL01", "HeadTabStrip01", tLanguageType);
            ...
            this.lblcn.Text = MultiLanguage.GetComment("FD", "ODMFPAYVL01", "lblcn", tLanguageType);
            this.lblvn.Text = MultiLanguage.GetComment("FD", "ODMFPAYVL01", "lblvn", tLanguageType);
            this.lblyear.Text = MultiLanguage.GetComment("FD", "ODMFPAYVL01", "lblyear", tLanguageType);
            this.datetime1.Title = MultiLanguage.GetComment("FD", "ODMFPAYVL01", "datetime1", tLanguageType);
            this.dept.Title = MultiLanguage.GetComment("FD", "ODMFPAYVL01", "dept", tLanguageType);
            this.username.Title = MultiLanguage.GetComment("FD", "ODMFPAYVL01", "username", tLanguageType);
            this.payee.Title = MultiLanguage.GetComment("FD", "ODMFPAYVL01", "payee", tLanguageType);
            this.chkitem01.Text = MultiLanguage.GetComment("FD", "ODMFPAYVL01", "chkitem01", tLanguageType);
            this.chkitem02.Text = MultiLanguage.GetComment("FD", "ODMFPAYVL01", "chkitem02", tLanguageType);
            this.chkitem03.Text = MultiLanguage.GetComment("FD", "ODMFPAYVL01", "chkitem03", tLanguageType);
            this.chkitem04.Text = MultiLanguage.GetComment("FD", "ODMFPAYVL01", "chkitem04", tLanguageType);
            this.chkitem05.Text = MultiLanguage.GetComment("FD", "ODMFPAYVL01", "chkitem05", tLanguageType);
            this.chkother.Title = MultiLanguage.GetComment("FD", "ODMFPAYVL01", "chkother", tLanguageType);
            this.payother.Title = MultiLanguage.GetComment("FD", "ODMFPAYVL01", "payother", tLanguageType);
            this.orderno.Title = MultiLanguage.GetComment("FD", "ODMFPAYVL01", "orderno", tLanguageType);
            this.textarea1.Title = MultiLanguage.GetComment("FD", "ODMFPAYVL01", "textarea1", tLanguageType);
            this.opentype01.Title = MultiLanguage.GetComment("FD", "ODMFPAYVL01", "opentype01", tLanguageType);
            this.openitem01.Title = MultiLanguage.GetComment("FD", "ODMFPAYVL01", "openitem01", tLanguageType);
            this.money01.Title = MultiLanguage.GetComment("FD", "ODMFPAYVL01", "money01", tLanguageType);
            this.textarea2.Title = MultiLanguage.GetComment("FD", "ODMFPAYVL01", "textarea2", tLanguageType);
            this.opentype02.Title = MultiLanguage.GetComment("FD", "ODMFPAYVL01", "opentype02", tLanguageType);
            this.openitem02.Title = MultiLanguage.GetComment("FD", "ODMFPAYVL01", "openitem02", tLanguageType);
            this.money02.Title = MultiLanguage.GetComment("FD", "ODMFPAYVL01", "money02", tLanguageType);
            this.textarea3.Title = MultiLanguage.GetComment("FD", "ODMFPAYVL01", "textarea3", tLanguageType);
            this.opentype03.Title = MultiLanguage.GetComment("FD", "ODMFPAYVL01", "opentype03", tLanguageType);
            this.openitem03.Title = MultiLanguage.GetComment("FD", "ODMFPAYVL01", "openitem03", tLanguageType);
            this.money03.Title = MultiLanguage.GetComment("FD", "ODMFPAYVL01", "money03", tLanguageType);
            this.textarea4.Title = MultiLanguage.GetComment("FD", "ODMFPAYVL01", "textarea4", tLanguageType);
            this.opentype04.Title = MultiLanguage.GetComment("FD", "ODMFPAYVL01", "opentype04", tLanguageType);
            this.openitem04.Title = MultiLanguage.GetComment("FD", "ODMFPAYVL01", "openitem04", tLanguageType);
            this.money04.Title = MultiLanguage.GetComment("FD", "ODMFPAYVL01", "money04", tLanguageType);
            this.textarea5.Title = MultiLanguage.GetComment("FD", "ODMFPAYVL01", "textarea5", tLanguageType);
            this.opentype05.Title = MultiLanguage.GetComment("FD", "ODMFPAYVL01", "opentype05", tLanguageType);
            this.openitem05.Title = MultiLanguage.GetComment("FD", "ODMFPAYVL01", "openitem05", tLanguageType);
            this.money05.Title = MultiLanguage.GetComment("FD", "ODMFPAYVL01", "money05", tLanguageType);
            this.mtotal.Title = MultiLanguage.GetComment("FD", "ODMFPAYVL01", "mtotal", tLanguageType);
            this.chkatt01.Text = MultiLanguage.GetComment("FD", "ODMFPAYVL01", "chkatt01", tLanguageType);
            this.inv01.Title = MultiLanguage.GetComment("FD", "ODMFPAYVL01", "inv01", tLanguageType);
            this.chkatt02.Text = MultiLanguage.GetComment("FD", "ODMFPAYVL01", "chkatt02", tLanguageType);
            this.SenderID.Title = MultiLanguage.GetComment("FD", "ODMFPAYVL01", "SenderID", tLanguageType);
            this.chkatt04.Text = MultiLanguage.GetComment("FD", "ODMFPAYVL01", "chkatt04", tLanguageType);
            this.inv02.Title = MultiLanguage.GetComment("FD", "ODMFPAYVL01", "inv02", tLanguageType);
            this.SuperID.Title = MultiLanguage.GetComment("FD", "ODMFPAYVL01", "SuperID", tLanguageType);
            this.chkatt05.Text = MultiLanguage.GetComment("FD", "ODMFPAYVL01", "chkatt05", tLanguageType);
            this.other.Text = MultiLanguage.GetComment("FD", "ODMFPAYVL01", "other", tLanguageType);
            this.attother.Title = MultiLanguage.GetComment("FD", "ODMFPAYVL01", "attother", tLanguageType);
            this.curr.Title = MultiLanguage.GetComment("FD", "ODMFPAYVL01", "curr", tLanguageType);
            this.useyear.Title = MultiLanguage.GetComment("FD", "ODMFPAYVL01", "useyear", tLanguageType);
            this.paydate.Title = MultiLanguage.GetComment("FD", "ODMFPAYVL01", "paydate", tLanguageType);
            this.safeno.Title = MultiLanguage.GetComment("FD", "ODMFPAYVL01", "safeno", tLanguageType);
            this.safename.Title = MultiLanguage.GetComment("FD", "ODMFPAYVL01", "safename", tLanguageType);
        ...
        {
            // 作業代號
            this.TaskId = "ODMFPAYVL01";
            // 表單代號
            this.formID = "ODMFPAYVL01";
...
where resfc001=@resfc001 and resfc002=@resfc002 and resfc003=@resfc003 and ISNULL(resfc004,'')<>''";
        ...
        {
            defalutHash.Add("odmfpayvl01001", this.formID);
            defalutHash.Add("odmfpayvl01002", this.SheetNo);
...
order by resdd003 desc";
        ...
        {
            pReport = "ODMFPAYVL01";
            pReportID = "ODMFPAYVL01_02";//憑證式
            pWhere = "AND (odmfpayvl01001='" + this.formID + "') AND (odmfpayvl01002='" + this.SheetNo + "')";
            pReportDirectory = "ODMFPAYVL01";
