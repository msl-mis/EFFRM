...
namespace tw.com.dsc.easyflowDotNet.forms
{
	...
	/// ODMRSSCN01 的摘要描述。
	/// </summary>
	public partial class ODMRSSCN01 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
	{
		//edit by teppy 2011/02/08 Start
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			AjaxPro.Utility.RegisterTypeForAjax(typeof(ODMRSSCN01));
			UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
			string tLanguageType = tClass.Language;

			//多國語系
			this.Title= MultiLanguage.GetComment("FD","ODMRSSCN01","lblTitle",this.UserInfo.Language);
			string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ODMRSSCN01", "HeadTabStrip01", tLanguageType);
			...
			this.username.Title = MultiLanguage.GetComment("FD", "ODMRSSCN01", "username", tLanguageType);
			this.userdate.Title = MultiLanguage.GetComment("FD", "ODMRSSCN01", "userdate", tLanguageType);
			this.grant01.Title = MultiLanguage.GetComment("FD", "ODMRSSCN01", "grant01", tLanguageType);
			this.money01.Title = MultiLanguage.GetComment("FD", "ODMRSSCN01", "money01", tLanguageType);
			this.debit01.Title = MultiLanguage.GetComment("FD", "ODMRSSCN01", "debit01", tLanguageType);
			this.note01.Title = MultiLanguage.GetComment("FD", "ODMRSSCN01", "note01", tLanguageType);
			this.dept01.Title = MultiLanguage.GetComment("FD", "ODMRSSCN01", "dept01", tLanguageType);
			this.grant02.Title = MultiLanguage.GetComment("FD", "ODMRSSCN01", "grant02", tLanguageType);
			this.money02.Title = MultiLanguage.GetComment("FD", "ODMRSSCN01", "money02", tLanguageType);
			this.debit02.Title = MultiLanguage.GetComment("FD", "ODMRSSCN01", "debit02", tLanguageType);
			this.note02.Title = MultiLanguage.GetComment("FD", "ODMRSSCN01", "note02", tLanguageType);
			this.dept02.Title = MultiLanguage.GetComment("FD", "ODMRSSCN01", "dept02", tLanguageType);
			this.grant03.Title = MultiLanguage.GetComment("FD", "ODMRSSCN01", "grant03", tLanguageType);
			this.money03.Title = MultiLanguage.GetComment("FD", "ODMRSSCN01", "money03", tLanguageType);
			this.debit03.Title = MultiLanguage.GetComment("FD", "ODMRSSCN01", "debit03", tLanguageType);
			this.note03.Title = MultiLanguage.GetComment("FD", "ODMRSSCN01", "note03", tLanguageType);
			this.dept03.Title = MultiLanguage.GetComment("FD", "ODMRSSCN01", "dept03", tLanguageType);
			this.grant04.Title = MultiLanguage.GetComment("FD", "ODMRSSCN01", "grant04", tLanguageType);
			this.money04.Title = MultiLanguage.GetComment("FD", "ODMRSSCN01", "money04", tLanguageType);
			this.debit04.Title = MultiLanguage.GetComment("FD", "ODMRSSCN01", "debit04", tLanguageType);
			this.note04.Title = MultiLanguage.GetComment("FD", "ODMRSSCN01", "note04", tLanguageType);
			this.dept04.Title = MultiLanguage.GetComment("FD", "ODMRSSCN01", "dept04", tLanguageType);
			this.grant05.Title = MultiLanguage.GetComment("FD", "ODMRSSCN01", "grant05", tLanguageType);
			this.money05.Title = MultiLanguage.GetComment("FD", "ODMRSSCN01", "money05", tLanguageType);
			this.debit05.Title = MultiLanguage.GetComment("FD", "ODMRSSCN01", "debit05", tLanguageType);
			this.note05.Title = MultiLanguage.GetComment("FD", "ODMRSSCN01", "note05", tLanguageType);
			this.dept05.Title = MultiLanguage.GetComment("FD", "ODMRSSCN01", "dept05", tLanguageType);
			this.id01.Title = MultiLanguage.GetComment("FD", "ODMRSSCN01", "id01", tLanguageType);
			this.id02.Title = MultiLanguage.GetComment("FD", "ODMRSSCN01", "id02", tLanguageType);
			this.id03.Title = MultiLanguage.GetComment("FD", "ODMRSSCN01", "id03", tLanguageType);
			this.id04.Title = MultiLanguage.GetComment("FD", "ODMRSSCN01", "id04", tLanguageType);
			this.id05.Title = MultiLanguage.GetComment("FD", "ODMRSSCN01", "id05", tLanguageType);
			this.name01.Title = MultiLanguage.GetComment("FD", "ODMRSSCN01", "name01", tLanguageType);
			this.name02.Title = MultiLanguage.GetComment("FD", "ODMRSSCN01", "name02", tLanguageType);
			this.name03.Title = MultiLanguage.GetComment("FD", "ODMRSSCN01", "name03", tLanguageType);
			this.name04.Title = MultiLanguage.GetComment("FD", "ODMRSSCN01", "name04", tLanguageType);
			this.name05.Title = MultiLanguage.GetComment("FD", "ODMRSSCN01", "name05", tLanguageType);
		...
		{
			// 作業代號
			this.TaskId = "ODMRSSCN01";
			// 表單代號
			this.formID = "ODMRSSCN01";
...
where resfc001=@resfc001 and resfc002=@resfc002 and resfc003=@resfc003 and ISNULL(resfc004,'')<>''";
		...
		{
			defalutHash.Add("odmrsscn01001", this.formID);
			defalutHash.Add("odmrsscn01002", this.SheetNo);
			defalutHash.Add("userdate", DateTime.Now.ToString("yyyyMMdd"));
...
order by resdd003 desc";
		...
		{
			pReport = "ODMRSSCN01";
			pReportID = "ODMRSSCN01_02";//憑證式
			pWhere = "AND (odmrsscn01001='" + this.formID + "') AND (odmrsscn01002='" + this.SheetNo + "')";
			pReportDirectory = "ODMRSSCN01";
