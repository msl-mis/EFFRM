<%@ Page language="c#" CodeFile="ACRPAY001_V01.aspx.cs" MasterPageFile="~/src/_Common/AppUtil/EFMasterPage/EFBaseMasterPage.master" AutoEventWireup="false" enableEventValidation="false" Inherits="tw.com.dsc.easyflowDotNet.forms.ACRPAY001_V01" %>
<%@ Register TagPrefix="uc1" TagName="gridUserControl" Src="../../_Common/PlatformUtil/KernelPage/Grid/gridUserControl.ascx" %>
<%@ Register TagPrefix="iewc" Namespace="Microsoft.Web.UI.WebControls" Assembly="Microsoft.Web.UI.WebControls" %>
<%@ Register TagPrefix="cc1" Namespace="tw.com.dsc.dscDotNet.dscWebControls" Assembly="PlatformUtil" %>

<asp:Content ID="ACRPAY001_V01FormContent" ContentPlaceHolderID="MasterPageContent" runat="server">
	<!--單檔架構 -->
	<!--2009/03/19:Joseph:<div id="cover" style="OVERFLOW: auto; WIDTH: 100%;">-->
		<div id="cover" style="WIDTH: 100%;">
			<div id="createRecord" style="WIDTH: 100%; HEIGHT: 100%" runat="server">
				<cc1:DscPanel id="ecPnlMaster" runat="server" Width="98%" IniHTML='&#10;<div style="OVERFLOW: auto; WIDTH: 100%; POSITION: relative; HEIGHT: 100%" ms_positioning="GridLayout"></div>'
					FrmDefineKeys-FrmType="Query" FrmDefineKeys-FrmID="FrmACRPAY001_V01" FrmDefineKeys-BOID="ACRPAY001_V01"
					BorderStyle="None" BorderColor="Transparent" BorderWidth="0px" Height="660px">
					<!--單頭頁籤-->
					...
					<!--單頭頁籤 一-->
					<cc1:Dscpanel id='divheadDefault' style='DISPLAY: block' runat='server' Width='100%' Height='660px' BackColor='Transparent'>
						<div class='TabPage' style='POSITION: relative; HEIGHT: 660px; left: 0px; top: 0px;' >
							<asp:ValidationSummary id='ValidationSummaryHead01' style='Z-INDEX: 100; POSITION: absolute; LEFT: 745px; TOP: 7px;' runat='server' ShowSummary='False' ShowMessageBox='True'></asp:ValidationSummary>
							<!--此區間放入單頭頁籤 一 的各個dsc元件-->

<cc1:DscTextBox id='acrpay_v01001' runat='server' title='表單代號'
	style='display: none; Z-INDEX: 101; POSITION: absolute; LEFT: 245px; TOP: 16px;'
	TxtInput_TabIndex='0'>
	<INPUTSTYLE Width='120px'></INPUTSTYLE>
	<TITLESTYLE Width='110px'></TITLESTYLE>
	<FRMFIELDKEYS FrmID='FrmACRPAY001_V01' BOID='ACRPAY001_V01' FieldName='acrpay_v01001'></FRMFIELDKEYS>
</cc1:DscTextBox>
<cc1:DscTextBox id='acrpay_v01002' runat='server' title='表單單號'
	style='display: none; Z-INDEX: 102; POSITION: absolute; LEFT: 245px; TOP: 49px;'
	TxtInput_TabIndex='0'>
	<INPUTSTYLE Width='120px'></INPUTSTYLE>
	<TITLESTYLE Width='110px'></TITLESTYLE>
	<FRMFIELDKEYS FrmID='FrmACRPAY001_V01' BOID='ACRPAY001_V01' FieldName='acrpay_v01002'></FRMFIELDKEYS>
</cc1:DscTextBox>
...
<cc1:DscDateAssistant2 ID='datetime1' runat='server' Title='datetime1' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmACRPAY001_V01' BOID='ACRPAY001_V01' FieldName='datetime1'></FrmFieldKeys>
...
<cc1:DscTextBox id='dept' runat='server' title='部門' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmACRPAY001_V01' BOID='ACRPAY001_V01' FieldName='dept'></FrmFieldKeys>
...
<cc1:DscTextBox id='payee' runat='server' title='受款人' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmACRPAY001_V01' BOID='ACRPAY001_V01' FieldName='payee'></FrmFieldKeys>
	<TitleStyle Width='100px'></TitleStyle>
...
<cc1:DscTextBox id='username' runat='server' title='申請人' ShowTitle='False'
	...
	TxtInput_TabIndex='103'>
	<FrmFieldKeys FrmID='FrmACRPAY001_V01' BOID='ACRPAY001_V01' FieldName='username'></FrmFieldKeys>
	<TitleStyle Width='100px'></TitleStyle>
...
<cc1:DscCheckBox ID='checkbox1' runat='server' Text='一般費用支出' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmACRPAY001_V01' BOID='ACRPAY001_V01' FieldName='checkbox1'></FrmFieldKeys>
</cc1:DscCheckBox>
<cc1:DscCheckBox ID='checkbox2' runat='server' Text='資產' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmACRPAY001_V01' BOID='ACRPAY001_V01' FieldName='checkbox2'></FrmFieldKeys>
</cc1:DscCheckBox>
<cc1:DscCheckBox ID='checkbox3' runat='server' Text='原物料' ShowTitle='False'
	...
	Checked='False' CheckedTrueValue='1' CheckedFalseValue='0'>
	<InputStyle Width='23px' Height='22px' />
	<FrmFieldKeys FrmID='FrmACRPAY001_V01' BOID='ACRPAY001_V01' FieldName='checkbox3'></FrmFieldKeys>
</cc1:DscCheckBox>
<cc1:DscCheckBox ID='checkbox4' runat='server' Text='零用金' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmACRPAY001_V01' BOID='ACRPAY001_V01' FieldName='checkbox4'></FrmFieldKeys>
</cc1:DscCheckBox>
<cc1:DscCheckBox ID='checkbox5' runat='server' Text='其他' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmACRPAY001_V01' BOID='ACRPAY001_V01' FieldName='checkbox5'></FrmFieldKeys>
</cc1:DscCheckBox>
<cc1:DscTextBox id='itemother' runat='server' title='其他' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmACRPAY001_V01' BOID='ACRPAY001_V01' FieldName='itemother'></FrmFieldKeys>
	<TitleStyle Width='100px'></TitleStyle>
...
<cc1:DscTextBox id='textarea1' runat='server' title='項目1' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmACRPAY001_V01' BOID='ACRPAY001_V01' FieldName='textarea1'></FrmFieldKeys>
	<TitleStyle Width='100px'></TitleStyle>
...
<cc1:DscTextBox id='money01' runat='server' title='金額01' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmACRPAY001_V01' BOID='ACRPAY001_V01' FieldName='money01'></FrmFieldKeys>
	<TitleStyle Width='100px'></TitleStyle>
...
<cc1:DscTextBox id='textarea2' runat='server' title='項目2' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmACRPAY001_V01' BOID='ACRPAY001_V01' FieldName='textarea2'></FrmFieldKeys>
	<TitleStyle Width='100px'></TitleStyle>
	<InputStyle Width='472px' Height='32px' CssClass='Edit20'></InputStyle>
</cc1:DscTextBox>
<cc1:DscTextBox id='money02' runat='server' title='金額02' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmACRPAY001_V01' BOID='ACRPAY001_V01' FieldName='money02'></FrmFieldKeys>
	<TitleStyle Width='100px'></TitleStyle>
	<InputStyle Width='103px' Height='25px' CssClass='Edit20'></InputStyle>
</cc1:DscTextBox>
<cc1:DscTextBox id='textarea3' runat='server' title='項目3' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmACRPAY001_V01' BOID='ACRPAY001_V01' FieldName='textarea3'></FrmFieldKeys>
	<TitleStyle Width='100px'></TitleStyle>
	<InputStyle Width='472px' Height='32px' CssClass='Edit20'></InputStyle>
</cc1:DscTextBox>
<cc1:DscTextBox id='money03' runat='server' title='金額03' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmACRPAY001_V01' BOID='ACRPAY001_V01' FieldName='money03'></FrmFieldKeys>
	<TitleStyle Width='100px'></TitleStyle>
	<InputStyle Width='103px' Height='25px' CssClass='Edit20'></InputStyle>
</cc1:DscTextBox>
<cc1:DscTextBox id='textarea4' runat='server' title='項目4' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmACRPAY001_V01' BOID='ACRPAY001_V01' FieldName='textarea4'></FrmFieldKeys>
	<TitleStyle Width='100px'></TitleStyle>
	<InputStyle Width='472px' Height='32px' CssClass='Edit20'></InputStyle>
</cc1:DscTextBox>
<cc1:DscTextBox id='money04' runat='server' title='金額04' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmACRPAY001_V01' BOID='ACRPAY001_V01' FieldName='money04'></FrmFieldKeys>
	<TitleStyle Width='100px'></TitleStyle>
	<InputStyle Width='103px' Height='25px' CssClass='Edit20'></InputStyle>
</cc1:DscTextBox>
<cc1:DscTextBox id='textarea5' runat='server' title='項目5' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmACRPAY001_V01' BOID='ACRPAY001_V01' FieldName='textarea5'></FrmFieldKeys>
	<TitleStyle Width='100px'></TitleStyle>
	<InputStyle Width='472px' Height='32px' CssClass='Edit20'></InputStyle>
</cc1:DscTextBox>
<cc1:DscTextBox id='money05' runat='server' title='金額05' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmACRPAY001_V01' BOID='ACRPAY001_V01' FieldName='money05'></FrmFieldKeys>
	<TitleStyle Width='100px'></TitleStyle>
	<InputStyle Width='103px' Height='25px' CssClass='Edit20'></InputStyle>
</cc1:DscTextBox>
<cc1:DscTextBox id='moneytot' runat='server' title='總計' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmACRPAY001_V01' BOID='ACRPAY001_V01' FieldName='moneytot'></FrmFieldKeys>
	<TitleStyle Width='100px'></TitleStyle>
	<InputStyle Width='103px' Height='25px' CssClass='Edit20'></InputStyle>
</cc1:DscTextBox>
<cc1:DscCheckBox ID='checkbox6' runat='server' Text='發票' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmACRPAY001_V01' BOID='ACRPAY001_V01' FieldName='checkbox6'></FrmFieldKeys>
</cc1:DscCheckBox>
<cc1:DscTextBox id='invoice' runat='server' title='發票張數' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmACRPAY001_V01' BOID='ACRPAY001_V01' FieldName='invoice'></FrmFieldKeys>
	<TitleStyle Width='100px'></TitleStyle>
...
<cc1:DscCheckBox ID='checkbox7' runat='server' Text='收據' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmACRPAY001_V01' BOID='ACRPAY001_V01' FieldName='checkbox7'></FrmFieldKeys>
</cc1:DscCheckBox>
<cc1:DscTextBox id='recino' runat='server' title='收據張數' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmACRPAY001_V01' BOID='ACRPAY001_V01' FieldName='recino'></FrmFieldKeys>
	<TitleStyle Width='100px'></TitleStyle>
...
<cc1:DscCheckBox ID='checkbox8' runat='server' Text='訂購單' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmACRPAY001_V01' BOID='ACRPAY001_V01' FieldName='checkbox8'></FrmFieldKeys>
</cc1:DscCheckBox>
<cc1:DscTextBox id='orderno' runat='server' title='訂購單號' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmACRPAY001_V01' BOID='ACRPAY001_V01' FieldName='orderno'></FrmFieldKeys>
	<TitleStyle Width='100px'></TitleStyle>
...
<cc1:DscCheckBox ID='checkbox9' runat='server' Text='驗收單' ShowTitle='False'
	...
	Checked='False' CheckedTrueValue='1' CheckedFalseValue='0'>
	<InputStyle Width='22px' Height='22px' />
	<FrmFieldKeys FrmID='FrmACRPAY001_V01' BOID='ACRPAY001_V01' FieldName='checkbox9'></FrmFieldKeys>
</cc1:DscCheckBox>
<cc1:DscCheckBox ID='checkbox10' runat='server' Text='進貨單' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmACRPAY001_V01' BOID='ACRPAY001_V01' FieldName='checkbox10'></FrmFieldKeys>
</cc1:DscCheckBox>
<cc1:DscCheckBox ID='checkbox11' runat='server' Text='其他' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmACRPAY001_V01' BOID='ACRPAY001_V01' FieldName='checkbox11'></FrmFieldKeys>
</cc1:DscCheckBox>
<cc1:DscTextBox id='attother' runat='server' title='其他附件' ShowTitle='False'
	...
	<FrmFieldKeys FrmID='FrmACRPAY001_V01' BOID='ACRPAY001_V01' FieldName='attother'></FrmFieldKeys>
	<TitleStyle Width='100px'></TitleStyle>
...
<!--引用JavaScript-->
<script src="ACRPAY001_V01.js" type="text/javascript"></script>
</asp:Content>
