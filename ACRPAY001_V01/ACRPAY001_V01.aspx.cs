...
namespace tw.com.dsc.easyflowDotNet.forms
{
	...
	/// ACRPAY001_V01 的摘要描述。
	/// </summary>
	public partial class ACRPAY001_V01 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
	{
		//edit by teppy 2011/02/08 Start
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			AjaxPro.Utility.RegisterTypeForAjax(typeof(ACRPAY001_V01));
			UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
			string tLanguageType = tClass.Language;

			//多國語系
			this.Title= MultiLanguage.GetComment("FD","ACRPAY001_V01","lblTitle",this.UserInfo.Language);
			string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ACRPAY001_V01", "HeadTabStrip01", tLanguageType);
			...
			this.datetime1.Title = MultiLanguage.GetComment("FD", "ACRPAY001_V01", "datetime1", tLanguageType);
			this.dept.Title = MultiLanguage.GetComment("FD", "ACRPAY001_V01", "dept", tLanguageType);
			this.payee.Title = MultiLanguage.GetComment("FD", "ACRPAY001_V01", "payee", tLanguageType);
			this.username.Title = MultiLanguage.GetComment("FD", "ACRPAY001_V01", "username", tLanguageType);
			this.checkbox1.Text = MultiLanguage.GetComment("FD", "ACRPAY001_V01", "checkbox1", tLanguageType);
			this.checkbox2.Text = MultiLanguage.GetComment("FD", "ACRPAY001_V01", "checkbox2", tLanguageType);
			this.checkbox3.Text = MultiLanguage.GetComment("FD", "ACRPAY001_V01", "checkbox3", tLanguageType);
			this.checkbox4.Text = MultiLanguage.GetComment("FD", "ACRPAY001_V01", "checkbox4", tLanguageType);
			this.checkbox5.Text = MultiLanguage.GetComment("FD", "ACRPAY001_V01", "checkbox5", tLanguageType);
			this.itemother.Title = MultiLanguage.GetComment("FD", "ACRPAY001_V01", "itemother", tLanguageType);
			this.textarea1.Title = MultiLanguage.GetComment("FD", "ACRPAY001_V01", "textarea1", tLanguageType);
			this.money01.Title = MultiLanguage.GetComment("FD", "ACRPAY001_V01", "money01", tLanguageType);
			this.textarea2.Title = MultiLanguage.GetComment("FD", "ACRPAY001_V01", "textarea2", tLanguageType);
			this.money02.Title = MultiLanguage.GetComment("FD", "ACRPAY001_V01", "money02", tLanguageType);
			this.textarea3.Title = MultiLanguage.GetComment("FD", "ACRPAY001_V01", "textarea3", tLanguageType);
			this.money03.Title = MultiLanguage.GetComment("FD", "ACRPAY001_V01", "money03", tLanguageType);
			this.textarea4.Title = MultiLanguage.GetComment("FD", "ACRPAY001_V01", "textarea4", tLanguageType);
			this.money04.Title = MultiLanguage.GetComment("FD", "ACRPAY001_V01", "money04", tLanguageType);
			this.textarea5.Title = MultiLanguage.GetComment("FD", "ACRPAY001_V01", "textarea5", tLanguageType);
			this.money05.Title = MultiLanguage.GetComment("FD", "ACRPAY001_V01", "money05", tLanguageType);
			this.moneytot.Title = MultiLanguage.GetComment("FD", "ACRPAY001_V01", "moneytot", tLanguageType);
			this.checkbox6.Text = MultiLanguage.GetComment("FD", "ACRPAY001_V01", "checkbox6", tLanguageType);
			this.invoice.Title = MultiLanguage.GetComment("FD", "ACRPAY001_V01", "invoice", tLanguageType);
			this.checkbox7.Text = MultiLanguage.GetComment("FD", "ACRPAY001_V01", "checkbox7", tLanguageType);
			this.recino.Title = MultiLanguage.GetComment("FD", "ACRPAY001_V01", "recino", tLanguageType);
			this.checkbox8.Text = MultiLanguage.GetComment("FD", "ACRPAY001_V01", "checkbox8", tLanguageType);
			this.orderno.Title = MultiLanguage.GetComment("FD", "ACRPAY001_V01", "orderno", tLanguageType);
			this.checkbox9.Text = MultiLanguage.GetComment("FD", "ACRPAY001_V01", "checkbox9", tLanguageType);
			this.checkbox10.Text = MultiLanguage.GetComment("FD", "ACRPAY001_V01", "checkbox10", tLanguageType);
			this.checkbox11.Text = MultiLanguage.GetComment("FD", "ACRPAY001_V01", "checkbox11", tLanguageType);
			this.attother.Title = MultiLanguage.GetComment("FD", "ACRPAY001_V01", "attother", tLanguageType);
...
this.textarea5.ToolTip = this.textarea5.Text;
			...
			this.checkbox1.Text = String.Empty;
this.checkbox2.Text = String.Empty;
this.checkbox3.Text = String.Empty;
this.checkbox4.Text = String.Empty;
this.checkbox5.Text = String.Empty;
this.checkbox6.Text = String.Empty;
this.checkbox7.Text = String.Empty;
this.checkbox8.Text = String.Empty;
this.checkbox9.Text = String.Empty;
this.checkbox10.Text = String.Empty;
this.checkbox11.Text = String.Empty;


			moneytot.InputEnabled = false;//設定為欄位計算，預設唯讀
		...
		{
			// 作業代號
			this.TaskId = "ACRPAY001_V01";
			// 表單代號
			this.formID = "ACRPAY001_V01";
...
where resfc001=@resfc001 and resfc002=@resfc002 and resfc003=@resfc003 and ISNULL(resfc004,'')<>''";
		...
		protected override void settingClientFunction()
		{
			...
			//單頭控制項
			string strmoney01_DoMathScript_moneytot_onChange=string.Empty;
			if(money01.TxtInput.Attributes["onchange"]!=null){strmoney01_DoMathScript_moneytot_onChange=money01.TxtInput.Attributes["onchange"].ToString().Trim(';');}
			if(strmoney01_DoMathScript_moneytot_onChange.Length>0)
				strmoney01_DoMathScript_moneytot_onChange+=";";
			money01.TxtInput.Attributes.Add("onchange",strmoney01_DoMathScript_moneytot_onChange+"domath_moneytot();");

			string strmoney01_DoMathScript_moneytot_onblur=string.Empty;
			if(money01.TxtInput.Attributes["onblur"]!=null){strmoney01_DoMathScript_moneytot_onblur=money01.TxtInput.Attributes["onblur"].ToString().Trim(';');}
			if(strmoney01_DoMathScript_moneytot_onblur.Length>0)
				strmoney01_DoMathScript_moneytot_onblur+=";";
			money01.TxtInput.Attributes.Add("onblur",strmoney01_DoMathScript_moneytot_onblur+"domath_moneytot();");

			string strmoney02_DoMathScript_moneytot_onChange=string.Empty;
			if(money02.TxtInput.Attributes["onchange"]!=null){strmoney02_DoMathScript_moneytot_onChange=money02.TxtInput.Attributes["onchange"].ToString().Trim(';');}
			if(strmoney02_DoMathScript_moneytot_onChange.Length>0)
				strmoney02_DoMathScript_moneytot_onChange+=";";
			money02.TxtInput.Attributes.Add("onchange",strmoney02_DoMathScript_moneytot_onChange+"domath_moneytot();");

			string strmoney02_DoMathScript_moneytot_onblur=string.Empty;
			if(money02.TxtInput.Attributes["onblur"]!=null){strmoney02_DoMathScript_moneytot_onblur=money02.TxtInput.Attributes["onblur"].ToString().Trim(';');}
			if(strmoney02_DoMathScript_moneytot_onblur.Length>0)
				strmoney02_DoMathScript_moneytot_onblur+=";";
			money02.TxtInput.Attributes.Add("onblur",strmoney02_DoMathScript_moneytot_onblur+"domath_moneytot();");

			string strmoney03_DoMathScript_moneytot_onChange=string.Empty;
			if(money03.TxtInput.Attributes["onchange"]!=null){strmoney03_DoMathScript_moneytot_onChange=money03.TxtInput.Attributes["onchange"].ToString().Trim(';');}
			if(strmoney03_DoMathScript_moneytot_onChange.Length>0)
				strmoney03_DoMathScript_moneytot_onChange+=";";
			money03.TxtInput.Attributes.Add("onchange",strmoney03_DoMathScript_moneytot_onChange+"domath_moneytot();");

			string strmoney03_DoMathScript_moneytot_onblur=string.Empty;
			if(money03.TxtInput.Attributes["onblur"]!=null){strmoney03_DoMathScript_moneytot_onblur=money03.TxtInput.Attributes["onblur"].ToString().Trim(';');}
			if(strmoney03_DoMathScript_moneytot_onblur.Length>0)
				strmoney03_DoMathScript_moneytot_onblur+=";";
			money03.TxtInput.Attributes.Add("onblur",strmoney03_DoMathScript_moneytot_onblur+"domath_moneytot();");

			string strmoney04_DoMathScript_moneytot_onChange=string.Empty;
			if(money04.TxtInput.Attributes["onchange"]!=null){strmoney04_DoMathScript_moneytot_onChange=money04.TxtInput.Attributes["onchange"].ToString().Trim(';');}
			if(strmoney04_DoMathScript_moneytot_onChange.Length>0)
				strmoney04_DoMathScript_moneytot_onChange+=";";
			money04.TxtInput.Attributes.Add("onchange",strmoney04_DoMathScript_moneytot_onChange+"domath_moneytot();");

			string strmoney04_DoMathScript_moneytot_onblur=string.Empty;
			if(money04.TxtInput.Attributes["onblur"]!=null){strmoney04_DoMathScript_moneytot_onblur=money04.TxtInput.Attributes["onblur"].ToString().Trim(';');}
			if(strmoney04_DoMathScript_moneytot_onblur.Length>0)
				strmoney04_DoMathScript_moneytot_onblur+=";";
			money04.TxtInput.Attributes.Add("onblur",strmoney04_DoMathScript_moneytot_onblur+"domath_moneytot();");

			string strmoney05_DoMathScript_moneytot_onChange=string.Empty;
			if(money05.TxtInput.Attributes["onchange"]!=null){strmoney05_DoMathScript_moneytot_onChange=money05.TxtInput.Attributes["onchange"].ToString().Trim(';');}
			if(strmoney05_DoMathScript_moneytot_onChange.Length>0)
				strmoney05_DoMathScript_moneytot_onChange+=";";
			money05.TxtInput.Attributes.Add("onchange",strmoney05_DoMathScript_moneytot_onChange+"domath_moneytot();");

			string strmoney05_DoMathScript_moneytot_onblur=string.Empty;
			if(money05.TxtInput.Attributes["onblur"]!=null){strmoney05_DoMathScript_moneytot_onblur=money05.TxtInput.Attributes["onblur"].ToString().Trim(';');}
			if(strmoney05_DoMathScript_moneytot_onblur.Length>0)
				strmoney05_DoMathScript_moneytot_onblur+=";";
			money05.TxtInput.Attributes.Add("onblur",strmoney05_DoMathScript_moneytot_onblur+"domath_moneytot();");
		...
		{
		defalutHash.Add("checkbox1", "1");
			defalutHash.Add("acrpay_v01001", this.formID);
			defalutHash.Add("acrpay_v01002", this.SheetNo);
		...
		//2012/08/23:3.5.1.20:hiro:S00-20120823001:下拉式選單連結資料庫進階設定↓
		...
		//2012/08/23:3.5.1.20:hiro:S00-20120823001:下拉式選單連結資料庫進階設定↑
		{
			...
			//2012/08/22:3.5.1.19:hiro:C01-20120821008:修正下拉式選單連結EasyFlow資料庫異常↓
			//int intFromPosition = pSQLString.ToLower().IndexOf("from");
			//pSQLString = pSQLString.Substring(0, intFromPosition) + "from " + tClass.Company.ToString().Trim() + ".." +pSQLString.Substring(intFromPosition+5);
			//2012/08/22:3.5.1.19:hiro:C01-20120821008:修正下拉式選單連結EasyFlow資料庫異常↑
			//2010/12/27:3.2.1.15:hiro:Q00-20101227002:修正下拉選單預設值中包含「+」、「-」字元，無法新增表單↑
...
order by resdd003 desc";
		...
		{
			pReport = "ACRPAY001_V01";
			pReportID = "ACRPAY001_V01_02";//憑證式
			pWhere = "AND (acrpay_v01001='" + this.formID + "') AND (acrpay_v01002='" + this.SheetNo + "')";
			pReportDirectory = "ACRPAY001_V01";
