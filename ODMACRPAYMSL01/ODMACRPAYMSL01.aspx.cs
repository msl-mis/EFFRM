...
{
	/// <summary>
	/// ODMACRPAYMSL01 的摘要描述。
	/// </summary>
	public partial class ODMACRPAYMSL01 : tw.com.dsc.easyflowDotNet.kernelBasePage.EFBasePage
	{
		//edit by teppy 2011/02/08 Start
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			AjaxPro.Utility.RegisterTypeForAjax(typeof(ODMACRPAYMSL01));
			UserInfoClass tClass = (UserInfoClass)Session["UserInfo"];
			string tLanguageType = tClass.Language;

			//多國語系
			this.Title= MultiLanguage.GetComment("FD","ODMACRPAYMSL01","lblTitle",this.UserInfo.Language);
			string tHeadTabStrip01Text = MultiLanguage.GetComment("FD", "ODMACRPAYMSL01", "HeadTabStrip01", tLanguageType);
			...
			this.datetime1.Title = MultiLanguage.GetComment("FD", "ODMACRPAYMSL01", "datetime1", tLanguageType);
			this.dept.Title = MultiLanguage.GetComment("FD", "ODMACRPAYMSL01", "dept", tLanguageType);
			this.username.Title = MultiLanguage.GetComment("FD", "ODMACRPAYMSL01", "username", tLanguageType);
			this.payee.Title = MultiLanguage.GetComment("FD", "ODMACRPAYMSL01", "payee", tLanguageType);
			this.chkother.Title = MultiLanguage.GetComment("FD", "ODMACRPAYMSL01", "chkother", tLanguageType);
			this.textarea1.Title = MultiLanguage.GetComment("FD", "ODMACRPAYMSL01", "textarea1", tLanguageType);
			this.money01.Title = MultiLanguage.GetComment("FD", "ODMACRPAYMSL01", "money01", tLanguageType);
			this.textarea2.Title = MultiLanguage.GetComment("FD", "ODMACRPAYMSL01", "textarea2", tLanguageType);
			this.money02.Title = MultiLanguage.GetComment("FD", "ODMACRPAYMSL01", "money02", tLanguageType);
			this.textarea3.Title = MultiLanguage.GetComment("FD", "ODMACRPAYMSL01", "textarea3", tLanguageType);
			this.money03.Title = MultiLanguage.GetComment("FD", "ODMACRPAYMSL01", "money03", tLanguageType);
			this.textarea4.Title = MultiLanguage.GetComment("FD", "ODMACRPAYMSL01", "textarea4", tLanguageType);
			this.money04.Title = MultiLanguage.GetComment("FD", "ODMACRPAYMSL01", "money04", tLanguageType);
			this.textarea5.Title = MultiLanguage.GetComment("FD", "ODMACRPAYMSL01", "textarea5", tLanguageType);
			this.money05.Title = MultiLanguage.GetComment("FD", "ODMACRPAYMSL01", "money05", tLanguageType);
			this.mtotal.Title = MultiLanguage.GetComment("FD", "ODMACRPAYMSL01", "mtotal", tLanguageType);
			this.inv01.Title = MultiLanguage.GetComment("FD", "ODMACRPAYMSL01", "inv01", tLanguageType);
			this.inv02.Title = MultiLanguage.GetComment("FD", "ODMACRPAYMSL01", "inv02", tLanguageType);
			this.orderno.Title = MultiLanguage.GetComment("FD", "ODMACRPAYMSL01", "orderno", tLanguageType);
			this.attother.Title = MultiLanguage.GetComment("FD", "ODMACRPAYMSL01", "attother", tLanguageType);
			this.other.Text = MultiLanguage.GetComment("FD", "ODMACRPAYMSL01", "other", tLanguageType);
			this.payother.Title = MultiLanguage.GetComment("FD", "ODMACRPAYMSL01", "payother", tLanguageType);
			this.empl1.Title = MultiLanguage.GetComment("FD", "ODMACRPAYMSL01", "empl1", tLanguageType);
			this.empl2.Title = MultiLanguage.GetComment("FD", "ODMACRPAYMSL01", "empl2", tLanguageType);
			this.chkkind01.Text = MultiLanguage.GetComment("FD", "ODMACRPAYMSL01", "chkkind01", tLanguageType);
			this.chkkind02.Text = MultiLanguage.GetComment("FD", "ODMACRPAYMSL01", "chkkind02", tLanguageType);
			this.chkkind03.Text = MultiLanguage.GetComment("FD", "ODMACRPAYMSL01", "chkkind03", tLanguageType);
			this.chkkind04.Text = MultiLanguage.GetComment("FD", "ODMACRPAYMSL01", "chkkind04", tLanguageType);
			this.chkkind05.Text = MultiLanguage.GetComment("FD", "ODMACRPAYMSL01", "chkkind05", tLanguageType);
			this.chkpay01.Text = MultiLanguage.GetComment("FD", "ODMACRPAYMSL01", "chkpay01", tLanguageType);
			this.chkpay02.Text = MultiLanguage.GetComment("FD", "ODMACRPAYMSL01", "chkpay02", tLanguageType);
			this.txtord.Title = MultiLanguage.GetComment("FD", "ODMACRPAYMSL01", "txtord", tLanguageType);
			this.txtpayday.Title = MultiLanguage.GetComment("FD", "ODMACRPAYMSL01", "txtpayday", tLanguageType);
			this.chkpay03.Text = MultiLanguage.GetComment("FD", "ODMACRPAYMSL01", "chkpay03", tLanguageType);
			this.chkpay04.Text = MultiLanguage.GetComment("FD", "ODMACRPAYMSL01", "chkpay04", tLanguageType);
			this.selcurr01.Title = MultiLanguage.GetComment("FD", "ODMACRPAYMSL01", "selcurr01", tLanguageType);
			this.selcurr02.Title = MultiLanguage.GetComment("FD", "ODMACRPAYMSL01", "selcurr02", tLanguageType);
			this.selcurr03.Title = MultiLanguage.GetComment("FD", "ODMACRPAYMSL01", "selcurr03", tLanguageType);
			this.selcurr04.Title = MultiLanguage.GetComment("FD", "ODMACRPAYMSL01", "selcurr04", tLanguageType);
			this.selcurr05.Title = MultiLanguage.GetComment("FD", "ODMACRPAYMSL01", "selcurr05", tLanguageType);
			this.selcurr06.Title = MultiLanguage.GetComment("FD", "ODMACRPAYMSL01", "selcurr06", tLanguageType);
			this.chkadd01.Text = MultiLanguage.GetComment("FD", "ODMACRPAYMSL01", "chkadd01", tLanguageType);
			this.chkadd02.Text = MultiLanguage.GetComment("FD", "ODMACRPAYMSL01", "chkadd02", tLanguageType);
			this.chkadd03.Text = MultiLanguage.GetComment("FD", "ODMACRPAYMSL01", "chkadd03", tLanguageType);
			this.chkadd04.Text = MultiLanguage.GetComment("FD", "ODMACRPAYMSL01", "chkadd04", tLanguageType);
			this.chkadd05.Text = MultiLanguage.GetComment("FD", "ODMACRPAYMSL01", "chkadd05", tLanguageType);
...
this.chkadd05.Text = String.Empty;
		...
		{
			// 作業代號
			this.TaskId = "ODMACRPAYMSL01";
			// 表單代號
			this.formID = "ODMACRPAYMSL01";
...
this.chkadd03.Attributes.Add("onclick", " if($('#MasterPage_MasterPageContent_chkadd03_chk')[0].checked){{$('#MasterPage_MasterPageContent_orderno').show();}} else{{$('#MasterPage_MasterPageContent_orderno').hide();}} ");
		...
		{
			defalutHash.Add("odmacrpaymsl01001", this.formID);
			defalutHash.Add("odmacrpaymsl01002", this.SheetNo);
...
order by resdd003 desc";
		...
		{
			pReport = "ODMACRPAYMSL01";
			pReportID = "ODMACRPAYMSL01_02";//憑證式
			pWhere = "AND (odmacrpaymsl01001='" + this.formID + "') AND (odmacrpaymsl01002='" + this.SheetNo + "')";
			pReportDirectory = "ODMACRPAYMSL01";
